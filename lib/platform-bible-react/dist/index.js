import { jsxs as Pe, jsx as S, Fragment as Go } from "react/jsx-runtime";
import { MenuItem as Yn, ListItemIcon as Ri, ListItemText as Xa, TextField as si, Menu as Ga, ListSubheader as Ja, Divider as Qa, Button as Za, Autocomplete as el, FormControlLabel as Pi, FormLabel as tl, Checkbox as rl, Grid as Xn, IconButton as Gn, Paper as ol, Slider as sl, Snackbar as il, Switch as nl, AppBar as al, Toolbar as ll, Drawer as cl } from "@mui/material";
import * as I from "react";
import { useCallback as Tt, useState as ft, useMemo as ii, useRef as Bs, useEffect as Jo } from "react";
import { getChaptersForBook as ni, offsetBook as Mi, FIRST_SCR_BOOK_NUM as dl, offsetChapter as Di, FIRST_SCR_CHAPTER_NUM as ul, offsetVerse as Li, FIRST_SCR_VERSE_NUM as hl } from "platform-bible-utils";
...
function vl(e = "") {
  if (!Vs) {
    ...
    if (r)
      Fs(r.getAttribute("data-shoelace"));
    else {
      const o = t.find((i) => /shoelace(\.min)?\.js($|\?)/.test(i.src) || /shoelace-autoloader(\.min)?\.js($|\?)/.test(i.src));
      let s = "";
      o && (s = o.getAttribute("src")), Fs(s.split("/").slice(0, -1).join("/"));
    }
  }
  return Vs.replace(/\/$/, "") + (e ? `/${e.replace(/^\//, "")}` : "");
}
var Jn = Object.defineProperty, yl = Object.defineProperties, wl = Object.getOwnPropertyDescriptor, xl = Object.getOwnPropertyDescriptors, Bi = Object.getOwnPropertySymbols, _l = Object.prototype.hasOwnProperty, kl = Object.prototype.propertyIsEnumerable, fs = (e, t) => (t = Symbol[e]) ? t : Symbol.for("Symbol." + e), Vi = (e, t, r) => t in e ? Jn(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, Lt = (e, t) => {
  for (var r in t || (t = {}))
    _l.call(t, r) && Vi(e, r, t[r]);
  if (Bi)
    for (var r of Bi(t))
      kl.call(t, r) && Vi(e, r, t[r]);
  return e;
...
function zl(e) {
  const t = typeof e == "string" ? Mr(e) : e;
  return t >= 40 && t <= 66;
}
function Al(e) {
  return (typeof e == "string" ? Mr(e) : e) <= 39;
}
function Zn(e) {
  return e <= 66;
}
...
function ra(e) {
  const t = typeof e == "number" ? ci(e) : e;
  return li(t) && !ai.includes(t);
}
function Pl(e) {
  const t = typeof e == "number" ? ci(e) : e;
  return li(t) && ai.includes(t);
...
const Qe = class le {
    ...
    if (t = t.replace(this.rtlMark, ""), t.includes("/")) {
      ...
      if (t = i[0], i.length > 1)
        try {
          ...
          throw new Wr("Invalid reference : " + t);
        }
    }
  ...
  allVerses(t = !1, r = le.verseRangeSeparators, o = le.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const s = [], i = Hi(this._verse, o);
    for (const n of i.map((c) => Hi(c, r))) {
      const c = this.clone();
      c.verse = n[0];
      const l = c.verseNum;
...
function Vl() {
  return ji || (ji = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function mr(T) {
      return It || (It = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), $(T) || w(T) === l;
    }
    function $(T) {
      return w(T) === d;
    }
    ...
    ge.AsyncMode = y, ge.ConcurrentMode = E, ge.ContextConsumer = H, ge.ContextProvider = j, ge.Element = M, ge.ForwardRef = N, ge.Fragment = Y, ge.Lazy = K, ge.Memo = _e, ge.Portal = te, ge.Profiler = re, ge.StrictMode = ke, ge.Suspense = Re, ge.isAsyncMode = mr, ge.isConcurrentMode = $, ge.isContextConsumer = O, ge.isContextProvider = Q, ge.isElement = G, ge.isForwardRef = W, ge.isFragment = ie, ge.isLazy = X, ge.isMemo = J, ge.isPortal = ne, ge.isProfiler = ue, ge.isStrictMode = ae, ge.isSuspense = Xe, ge.isValidElementType = k, ge.typeOf = w;
  }()), ge;
}
var Wi;
function ia() {
  return Wi || (Wi = 1, process.env.NODE_ENV === "production" ? zo.exports = Bl() : zo.exports = Vl()), zo.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
var bs, Yi;
function na() {
  return Yi || (Yi = 1, bs = Function.call.bind(Object.prototype.hasOwnProperty)), bs;
}
var vs, Xi;
function Hl() {
  if (Xi)
...
function Ul() {
  if (Gi)
    return ys;
  Gi = 1;
  var e = ia(), t = Fl(), r = di(), o = na(), s = Hl(), i = function() {
  };
  ...
  return ys = function(c, l) {
    ...
    function g($) {
      ...
      function G(ie, X, J, ne, ue, ae, Xe) {
        ...
        return X[J] == null ? ie ? X[J] === null ? new v("The " + ue + " `" + ae + "` is marked as required " + ("in `" + ne + "`, but its value is `null`.")) : new v("The " + ue + " `" + ae + "` is marked as required in " + ("`" + ne + "`, but its value is `undefined`.")) : null : $(X, J, ne, ue, ae);
      }
      var W = G.bind(null, !1);
    ...
    function x($) {
      function O(Q, G, W, ie, X, J) {
        ...
        if (ue !== $) {
          var ae = Re(ne);
          return new v(
            "Invalid " + ie + " `" + X + "` of type " + ("`" + ae + "` supplied to `" + W + "`, expected ") + ("`" + $ + "`."),
            { expectedType: $ }
          );
        }
        return null;
    ...
    function H($) {
      ...
      function O(Q, G, W, ie, X) {
        for (var J = Q[G], ne = 0; ne < $.length; ne++)
          if (b(J, $[ne]))
            return null;
        var ue = JSON.stringify($, function(Xe, T) {
          var ht = Re(T);
    ...
    function M($) {
      ...
      function G(W, ie, X, J, ne) {
        for (var ue = [], ae = 0; ae < $.length; ae++) {
          var Xe = $[ae], T = Xe(W, ie, X, J, ne, r);
          if (T == null)
            return null;
    ...
    function Y($, O, Q, G, W) {
      return new v(
        ($ || "React class") + ": " + O + " type `" + Q + "." + G + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + W + "`."
      );
    }
    function K($) {
      function O(Q, G, W, ie, X) {
...
Valid keys: ` + JSON.stringify(Object.keys($), null, "  ")
    ...
    function ke($) {
      var O = typeof $;
      return Array.isArray($) ? "array" : $ instanceof RegExp ? "object" : re(O, $) ? "symbol" : O;
    }
    function Re($) {
      if (typeof $ > "u" || $ === null)
        return "" + $;
...
function ua(e, t) {
  const r = da(e.theme);
  return Object.keys(e).map((o) => xc(e, t, o, r)).reduce(eo, {});
}
function Ae(e) {
  return ua(e, Zo);
}
...
function ts(...e) {
  const t = e.reduce((o, s) => (s.filterProps.forEach((i) => {
    o[i] = s;
  }), o), {}), r = (o) => Object.keys(o).reduce((s, i) => t[i] ? eo(s, t[i](o)) : s, {});
...
const Kc = Me({
  ...
  if (e.maxWidth !== void 0 && e.maxWidth !== null) {
    const t = (r) => {
      var o, s;
      const i = ((o = e.theme) == null || (o = o.breakpoints) == null || (o = o.values) == null ? void 0 : o[r]) || hi[r];
...
function rd() {
  ...
  function t(r) {
    ...
    if (!s)
      return null;
    const n = (o = i.unstable_sxConfig) != null ? o : fi;
    function c(l) {
      let d = l;
...
function gi(e = {}, ...t) {
  ...
  return d.applyStyles = od, d = t.reduce((f, h) => Pt(f, h), d), d.unstable_sxConfig = Z({}, fi, n == null ? void 0 : n.unstable_sxConfig), d.unstable_sx = function(h) {
    return mi({
      sx: h,
      theme: this
    });
...
const fd = gi(), nn = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Ao({
  defaultTheme: e,
  theme: t,
  themeId: r
...
function gd(e = {}) {
  ...
  return i.__mui_systemSx = !0, (n, c = {}) => {
    ...
    let g;
    process.env.NODE_ENV !== "production" && l && (g = `${l}-${nn(d || "Root")}`);
    let x = Mo;
...
The following color spaces are supported: srgb, display-p3, a98-rgb, prophoto-rgb, rec-2020.` : Or(10, s));
  } else
    o = o.split(",");
...
function an(e) {
  e = Nr(e);
  let t = e.type === "hsl" || e.type === "hsla" ? Nr(wd(e)).values : e.values;
...
function xd(e, t) {
  if (e = Nr(e), t = pa(t), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - t;
...
const Cd = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, xr = Nd, Id = ["mode", "contrastThreshold", "tonalOffset"], cn = {
...
function Vd(e) {
  ...
  function h(v) {
    const g = ln(v, xs.text.primary) >= r ? xs.text.primary : cn.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const x = ln(v, g);
...
The color object needs to have a \`main\` property or a \`${x}\` property.` : Or(11, g ? ` (${g})` : "", x));
...
} });` : Or(12, g ? ` (${g})` : "", JSON.stringify(v.main)));
    return dn(v, "light", _, o), dn(v, "dark", k, o), v.contrastText || (v.contrastText = h(v.main)), v;
  }, m = {
    dark: xs,
    light: cn
  };
...
function Ud(e, t) {
  ...
  const m = s / 14, b = h || ((x) => `${x / d * m}rem`), v = (x, _, k, w, y) => Z({
    ...
    button: v(c, 14, 1.75, 0.4, un),
    caption: v(n, 12, 1.66, 0.4),
    overline: v(n, 12, 2.66, 1, un),
...
`)), Object.keys(d).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(d).join(",")}].`);
      ...
      return (Array.isArray(s) ? s : [s]).map((f) => `${f} ${typeof n == "string" ? n : pn(n)} ${c} ${typeof l == "string" ? l : pn(l)}`).join(",");
    }
  }, e, {
    easing: t,
    duration: r
...
`));
  ...
  return d.unstable_sxConfig = Z({}, fi, n == null ? void 0 : n.unstable_sxConfig), d.unstable_sx = function(h) {
    return mi({
      sx: h,
      theme: this
    });
...
const du = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], uu = (e) => {
...
}), vi = /* @__PURE__ */ I.forwardRef(function(t, r) {
  const o = iu({
    props: t,
    name: "MuiSvgIcon"
  }), {
  ...
  return /* @__PURE__ */ Pe(hu, Z({
    ...
    ownerState: v,
    children: [b ? s.props.children : s, h ? /* @__PURE__ */ S("title", {
      children: h
    }) : null]
  }));
});
...
function ns(e, t) {
  ...
  return process.env.NODE_ENV !== "production" && (r.displayName = `${t}Icon`), r.muiName = fn.muiName, /* @__PURE__ */ I.memo(/* @__PURE__ */ I.forwardRef(r));
}
const pu = ns(/* @__PURE__ */ S("path", {
  d: "M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9m-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8z"
}), "History"), fu = ns(/* @__PURE__ */ S("path", {
  d: "M7.41 15.41 12 10.83l4.59 4.58L18 14l-6-6-6 6z"
}), "KeyboardArrowUp"), mu = ns(/* @__PURE__ */ S("path", {
  d: "M3 18h18v-2H3zm0-5h18v-2H3zm0-7v2h18V6z"
}), "Menu"), gu = ns(/* @__PURE__ */ S("path", {
  ...
  return /* @__PURE__ */ Pe("div", { children: [
    /* @__PURE__ */ Pe(
      Yn,
      {
        ...
        onClick: () => t(e),
        children: [
          r ? /* @__PURE__ */ S(Ri, { children: /* @__PURE__ */ S("div", { className: `selected-book-color-label ${o.toLowerCase()}`, slot: "prefix" }) }) : /* @__PURE__ */ S(Ri, { children: /* @__PURE__ */ S("div", { className: `book-color-label ${o.toLowerCase()}`, slot: "prefix" }) }),
          /* @__PURE__ */ S(Xa, { children: ce.bookIdToEnglishName(e) }),
          r ? /* @__PURE__ */ S(fu, {}) : void 0
        ]
      },
      e
    ),
...
function vu({
  ...
  return /* @__PURE__ */ S(
    si,
    {
      ...
      onClick: t,
      InputProps: {
        startAdornment: /* @__PURE__ */ S(gu, { fontSize: "small" }),
        endAdornment: /* @__PURE__ */ S(pu, { fontSize: "small" })
      }
    }
  );
}
function yu({ endChapter: e, activeChapter: t, handleSelectChapter: r }) {
  ...
  return /* @__PURE__ */ S("div", { className: "chapter-select", children: o.map((s) => (
...
function pb({ scrRef: e, handleSubmit: t }) {
  const { allBookIds: r } = ce, o = Tt(
    ...
    [o, n]
  ), h = Tt((g) => ni(ce.bookIdToNumber(g)), []), p = (g) => {
    i(s !== g ? g : ""), h(g) === -1 && (t({
  ...
  return /* @__PURE__ */ Pe(Go, { children: [
    ...
    /* @__PURE__ */ S("div", { className: "book-chapter-menu", children: /* @__PURE__ */ S(
      Ga,
      {
        tabIndex: -1,
        open: l,
        ...
        children: xu.map((g) => /* @__PURE__ */ Pe("div", { children: [
          /* @__PURE__ */ S(Ja, { children: wu[g] }),
          f(g).map((x) => /* @__PURE__ */ S("div", { children: /* @__PURE__ */ S(
            bu,
            {
              bookId: x,
          ...
          g === "OT" || g === "NT" ? /* @__PURE__ */ S(Qa, {}) : void 0
        ] }, g))
      }
    ) })
  ] });
 ...
 */
const Lo = globalThis, yi = Lo.ShadowRoot && (Lo.ShadyCSS === void 0 || Lo.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, wi = Symbol(), mn = /* @__PURE__ */ new WeakMap();
let ga = class {
  constructor(t, r, o) {
    if (this._$cssResult$ = !0, o !== wi)
  ...
  get styleSheet() {
    ...
    if (yi && t === void 0) {
      ...
      o && (t = mn.get(r)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), o && mn.set(r, t));
    }
    return t;
  }
  toString() {
...
const _u = (e) => new ga(typeof e == "string" ? e : e + "", void 0, wi), L = (e, ...t) => {
...
}, gn = yi ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let r = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Cu, defineProperty: Su, getOwnPropertyDescriptor: $u, getOwnPropertyNames: Eu, getOwnPropertySymbols: zu, getPrototypeOf: Au } = Object, qt = globalThis, bn = qt.trustedTypes, Tu = bn ? bn.emptyScript : "", _s = qt.reactiveElementPolyfillSupport, to = (e, t) => e, Ir = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Tu : null;
      break;
  ...
  return r;
} }, xi = (e, t) => !Cu(e, t), vn = { attribute: !0, type: String, converter: Ir, reflect: !1, hasChanged: xi };
...
class Sr extends HTMLElement {
  ...
  static getPropertyOptions(t) {
    return this.elementProperties.get(t) ?? vn;
  }
  static _$Ei() {
    if (this.hasOwnProperty(to("elementProperties")))
      return;
    const t = Au(this);
    t.finalize(), t.l !== void 0 && (this.l = [...t.l]), this.elementProperties = new Map(t.elementProperties);
  }
  static finalize() {
    if (this.hasOwnProperty(to("finalized")))
      return;
  ...
  _$EC(t, r) {
    ...
    if (s !== void 0 && o.reflect === !0) {
      const n = (((i = o.converter) == null ? void 0 : i.toAttribute) !== void 0 ? o.converter : Ir).toAttribute(r, o.type);
  ...
  _$AK(t, r) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const n = o.getPropertyOptions(s), c = typeof n.converter == "function" ? { fromAttribute: n.converter } : ((i = n.converter) == null ? void 0 : i.fromAttribute) !== void 0 ? n.converter : Ir;
      this._$Em = s, this[s] = c.fromAttribute(r, n.type), this._$Em = null;
    }
  }
  requestUpdate(t, r, o) {
    if (t !== void 0) {
      if (o ?? (o = this.constructor.getPropertyOptions(t)), !(o.hasChanged ?? xi)(this[t], r))
        return;
      this.P(t, r, o);
    }
...
Sr.elementStyles = [], Sr.shadowRootOptions = { mode: "open" }, Sr[to("elementProperties")] = /* @__PURE__ */ new Map(), Sr[to("finalized")] = /* @__PURE__ */ new Map(), _s == null || _s({ ReactiveElement: Sr }), (qt.reactiveElementVersions ?? (qt.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ro = globalThis, Ho = ro.trustedTypes, yn = Ho ? Ho.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, ba = "$lit$", jt = `lit$${(Math.random() + "").slice(9)}$`, va = "?" + jt, Ou = `<${va}>`, lr = document, uo = () => lr.createComment(""), ho = (e) => e === null || typeof e != "object" && typeof e != "function", ya = Array.isArray, Nu = (e) => ya(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", ks = `[ 	
\f\r]`, Kr = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, wn = /-->/g, xn = />/g, tr = RegExp(`>|${ks}(?:([^\\s"'>=/]+)(${ks}*=${ks}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), _n = /'/g, kn = /"/g, wa = /^(?:script|style|textarea|title)$/i, Iu = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r }), C = Iu(1), ct = Symbol.for("lit-noChange"), Se = Symbol.for("lit-nothing"), Cn = /* @__PURE__ */ new WeakMap(), sr = lr.createTreeWalker(lr, 129);
function xa(e, t) {
...
const Ru = (e, t) => {
  ...
  let s, i = t === 2 ? "<svg>" : "", n = Kr;
  for (let c = 0; c < r; c++) {
    const l = e[c];
    let d, f, h = -1, p = 0;
    for (; p < l.length && (n.lastIndex = p, f = n.exec(l), f !== null); )
      p = n.lastIndex, n === Kr ? f[1] === "!--" ? n = wn : f[1] !== void 0 ? n = xn : f[2] !== void 0 ? (wa.test(f[2]) && (s = RegExp("</" + f[2], "g")), n = tr) : f[3] !== void 0 && (n = tr) : n === tr ? f[0] === ">" ? (n = s ?? Kr, h = -1) : f[1] === void 0 ? h = -2 : (h = n.lastIndex - f[2].length, d = f[1], n = f[3] === void 0 ? tr : f[3] === '"' ? kn : _n) : n === kn || n === _n ? n = tr : n === wn || n === xn ? n = Kr : (n = tr, s = void 0);
    const m = n === tr && e[c + 1].startsWith("/>") ? " " : "";
    i += n === Kr ? l + Ou : h >= 0 ? (o.push(d), l.slice(0, h) + ba + l.slice(h) + jt + m) : l + jt + (h === -2 ? c : m);
  }
...
class po {
  constructor({ strings: t, _$litType$: r }, o) {
    ...
    if (this.el = po.createElement(d, o), sr.currentNode = this.el.content, r === 2) {
      ...
      if (s.nodeType === 1) {
        ...
        if (wa.test(s.tagName)) {
          ...
          if (p > 0) {
            ...
            for (let m = 0; m < p; m++)
              s.append(h[m], uo()), sr.nextNode(), l.push({ type: 2, index: ++i });
            s.append(h[p], uo());
          }
        }
...
function Rr(e, t, r = e, o) {
  var n, c;
  if (t === ct)
    return t;
  let s = o !== void 0 ? (n = r._$Co) == null ? void 0 : n[o] : r._$Cl;
  const i = ho(t) ? void 0 : t._$litDirective$;
  return (s == null ? void 0 : s.constructor) !== i && ((c = s == null ? void 0 : s._$AO) == null || c.call(s, !1), i === void 0 ? s = void 0 : (s = new i(e), s._$AT(e, r, o)), o !== void 0 ? (r._$Co ?? (r._$Co = []))[o] = s : r._$Cl = s), s !== void 0 && (t = Rr(e, s._$AS(e, t.values), s, o)), t;
}
class Pu {
  constructor(t, r) {
...
class yo {
  ...
  _$AI(t, r = this) {
    t = Rr(this, t, r), ho(t) ? t === Se || t == null || t === "" ? (this._$AH !== Se && this._$AR(), this._$AH = Se) : t !== this._$AH && t !== ct && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Nu(t) ? this.k(t) : this._(t);
  }
  S(t) {
  ...
  _(t) {
    this._$AH !== Se && ho(this._$AH) ? this._$AA.nextSibling.data = t : this.T(lr.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var i;
    const { values: r, _$litType$: o } = t, s = typeof o == "number" ? this._$AC(t) : (o.el === void 0 && (o.el = po.createElement(xa(o.h, o.h[0]), this.options)), o);
  ...
  _$AC(t) {
    ...
    return r === void 0 && Cn.set(t.strings, r = new po(t)), r;
  }
  k(t) {
    ...
    let o, s = 0;
    for (const i of t)
      s === r.length ? r.push(o = new yo(this.S(uo()), this.S(uo()), this, this.options)) : o = r[s], o._$AI(i), s++;
...
class as {
  ...
  _$AI(t, r = this, o, s) {
    ...
    let n = !1;
    if (i === void 0)
      t = Rr(this, t, r, 0), n = !ho(t) || t !== this._$AH && t !== ct, n && (this._$AH = t);
    else {
      const c = t;
      let l, d;
      for (t = i[0], l = 0; l < i.length - 1; l++)
        d = Rr(this, c[o + l], r, l), d === ct && (d = this._$AH[l]), n || (n = !ho(d) || d !== this._$AH[l]), d === Se ? t = Se : t !== Se && (t += (d ?? "") + i[l + 1]), this._$AH[l] = d;
    }
    n && !s && this.j(t);
  }
  j(t) {
...
const Cs = ro.litHtmlPolyfillSupport;
Cs == null || Cs(po, yo), (ro.litHtmlVersions ?? (ro.litHtmlVersions = [])).push("3.1.2");
const Vu = (e, t, r) => {
  const o = (r == null ? void 0 : r.renderBefore) ?? t;
  let s = o._$litPart$;
  if (s === void 0) {
    const i = (r == null ? void 0 : r.renderBefore) ?? null;
    o._$litPart$ = s = new yo(t.insertBefore(uo(), i), i, void 0, r ?? {});
  }
  return s._$AI(e), s;
};
/**
...
var Kn;
oo._$litElement$ = !0, oo.finalized = !0, (Kn = globalThis.litElementHydrateSupport) == null || Kn.call(globalThis, { LitElement: oo });
const Ss = globalThis.litElementPolyfillSupport;
Ss == null || Ss({ LitElement: oo });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Hu = { attribute: !0, type: String, converter: Ir, reflect: !1, hasChanged: xi }, Uu = (e = Hu, t, r) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Wu = /* @__PURE__ */ new Set(["children", "localName", "ref", "style", "className"]), Sn = /* @__PURE__ */ new WeakMap(), qu = (e, t, r, o, s) => {
  const i = s == null ? void 0 : s[t];
  i === void 0 || r === o ? (e[t] = r, r == null && t in HTMLElement.prototype && e.removeAttribute(t)) : ((n, c, l) => {
    let d = Sn.get(n);
    d === void 0 && Sn.set(n, d = /* @__PURE__ */ new Map());
    let f = d.get(c);
...
`, ur = (e = "value") => (t, r) => {
  ...
  o.prototype.attributeChangedCallback = function(i, n, c) {
    ...
    if (i === f) {
      const h = d.converter || Ir, m = (typeof h == "function" ? h : (l = h == null ? void 0 : h.fromAttribute) != null ? l : Ir.fromAttribute)(c, d.type);
      this[e] !== m && (this[r] = m);
    }
    s.call(this, i, n, c);
  };
}, Yr = /* @__PURE__ */ new WeakMap(), Xr = /* @__PURE__ */ new WeakMap(), Gr = /* @__PURE__ */ new WeakMap(), $s = /* @__PURE__ */ new WeakSet(), To = /* @__PURE__ */ new WeakMap(), Bt = class {
  constructor(e, t) {
    this.handleFormData = (r) => {
      ...
      this.form && !this.form.noValidate && ((o = Yr.get(this.form)) == null || o.forEach((n) => {
...
var Zu = {
  ...
  name: "system",
  resolver: (e) => e in $n ? `data:image/svg+xml,${encodeURIComponent($n[e])}` : ""
}, rh = th, oh = [eh, rh], Ws = [];
function sh(e) {
  Ws.push(e);
}
...
var Jr = Symbol(), Oo = Symbol(), Es, zs = /* @__PURE__ */ new Map(), xe = class extends R {
  constructor() {
  ...
  async resolveIcon(e, t) {
    ...
    try {
      ...
      return c ? (c.part.add("svg"), document.adoptNode(c)) : Jr;
    } catch {
      return Jr;
    }
  }
  ...
  async setIcon() {
    var e;
    const { url: t, fromLibrary: r } = this.getIconSource(), o = r ? En(this.library) : void 0;
    if (!t) {
      this.svg = null;
      return;
    }
...
`;
const qs = /* @__PURE__ */ new Set(), uh = new MutationObserver($a), Er = /* @__PURE__ */ new Map();
...
function Sa(...e) {
  e.map((t) => {
    ...
    Er.has(r) ? Er.set(r, Object.assign(Object.assign({}, Er.get(r)), t)) : Er.set(r, t), or || (or = t);
  }), $a();
}
function $a() {
  ka = document.documentElement.dir || "ltr", Ca = document.documentElement.lang || navigator.language, [...qs.keys()].map((e) => {
...
var Ie = class Ys extends R {
  ...
  getChildrenItems({ includeDisabled: t = !0 } = {}) {
    return this.childrenSlot ? [...this.childrenSlot.assignedElements({ flatten: !0 })].filter(
      (r) => Ys.isTreeItem(r) && (t || !r.disabled)
    ) : [];
  }
  render() {
    ...
    return C`
      ...
      "tree-item__expand-button--visible": r
            ...
            aria-hidden="true"
          >
            ${Tn(this.loading, () => C` <sl-spinner></sl-spinner> `)}
...
const Aa = Symbol.for(""), xh = (e) => {
...
})(o) + e[s + 1], e[0]), r: Aa }), On = /* @__PURE__ */ new Map(), _h = (e) => (t, ...r) => {
  const o = r.length;
  let s, i;
  const n = [], c = [];
  let l, d = 0, f = !1;
  ...
  if (d === o && n.push(t[o]), f) {
    const h = n.join("$$lit$$");
    (t = On.get(h)) === void 0 && (n.raw = n, On.set(h, t = n)), r = c;
  }
  return e(t, ...r);
}, so = _h(C);
...
a([
  z("active")
], Br.prototype, "handleActiveChange", 1);
var Eh = "sl-tab-panel";
Br.define("sl-tab-panel");
D({
  tagName: Eh,
  elementClass: Br,
  react: I,
...
function io(e) {
  if (Xs.add(e), !document.body.classList.contains("sl-scroll-lock")) {
    const t = Th();
    document.body.classList.add("sl-scroll-lock"), document.body.style.setProperty("--sl-scroll-lock-size", `${t}px`);
  }
}
function no(e) {
  Xs.delete(e), Xs.size === 0 && (document.body.classList.remove("sl-scroll-lock"), document.body.style.removeProperty("--sl-scroll-lock-size"));
}
function Gs(e, t, r = "vertical", o = "smooth") {
...
var et = class extends R {
  ...
  setActiveTab(e, t) {
    if (t = Lt({
      ...
      }), this.syncIndicator(), ["top", "bottom"].includes(this.placement) && Gs(this.activeTab, this.nav, "horizontal", t.scrollBehavior), t.emitEvents && (r && this.emit("sl-tab-hide", { detail: { name: r.panel } }), this.emit("sl-tab-show", { detail: { name: this.activeTab.panel } }));
    }
  }
  setAriaLabels() {
    this.tabs.forEach((e) => {
...
function Nn(e, t, r) {
  ...
  const i = _o(t), n = Ci(t), c = ki(n), l = Xt(t), d = i === "y", f = o.x + o.width / 2 - s.width / 2, h = o.y + o.height / 2 - s.height / 2, p = o[c] / 2 - s[c] / 2;
  let m;
  switch (l) {
    case "top":
      m = {
...
async function Si(e, t) {
  ...
  const {
    ...
    altBoundary: p = !1,
    padding: m = 0
  } = Vr(t, e), b = Oa(m), g = c[p ? h === "floating" ? "reference" : "floating" : h], x = Ko(await i.getClippingRect({
...
const jh = (e) => ({
  ...
  async fn(t) {
    ...
    const h = Oa(f), p = {
      x: r,
      y: o
    }, m = Ci(s), b = ki(m), v = await n.getDimensions(d), g = m === "y", x = g ? "top" : "left", _ = g ? "bottom" : "right", k = g ? "clientHeight" : "clientWidth", w = i.reference[b] + i.reference[m] - p[m] - i.floating[b], y = p[m] - i.reference[m], E = await (n.getOffsetParent == null ? void 0 : n.getOffsetParent(d));
    let H = E ? E[k] : 0;
    (!H || !await (n.isElement == null ? void 0 : n.isElement(E))) && (H = c.floating[k] || i.floating[b]);
    const j = w / 2 - y / 2, M = H / 2 - v[b] / 2 - 1, N = Kt(h[x], M), Y = Kt(h[_], M), K = N, _e = H - v[b] - Y, te = H / 2 - v[b] / 2 + j, re = Js(K, te, _e), ke = !l.arrow && Fr(s) != null && te !== re && i.reference[b] / 2 - (te < K ? N : Y) - v[b] / 2 < 0, Re = ke ? te < K ? te - K : te - _e : 0;
    return {
      [m]: p[m] + Re,
      data: {
        [m]: re,
...
async function qh(e, t) {
  const {
    ...
    platform: o,
    elements: s
  } = e, i = await (o.isRTL == null ? void 0 : o.isRTL(s.floating)), n = Xt(r), c = Fr(r), l = _o(r) === "y", d = ["left", "top"].includes(n) ? -1 : 1, f = i && l ? -1 : 1, h = Vr(t, e);
  let {
    mainAxis: p,
    crossAxis: m,
    alignmentAxis: b
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: r,
        y: o
      }, f = await Si(t, l), h = _o(Xt(s)), p = Ta(h);
      let m = d[p], b = d[h];
      if (i) {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        ...c
      } = Vr(e, t), l = await Si(t, c), d = Xt(r), f = Fr(r), h = _o(r) === "y", {
        width: p,
        height: m
      } = o.floating;
      let b, v;
...
function fo(e, t, r) {
  ...
  return i ? t.concat(n, n.visualViewport || [], ko(s) ? s : [], n.frameElement && r ? fo(n.frameElement) : []) : t.concat(s, fo(s, [], r));
}
function Ra(e) {
  const t = mt(e);
...
function dr(e, t, r, o) {
  ...
  if (i) {
    ...
    for (; v && o && m !== b; ) {
      const g = Tr(v), x = v.getBoundingClientRect(), _ = mt(v), k = x.left + (v.clientLeft + parseFloat(_.paddingLeft)) * g.x, w = x.top + (v.clientTop + parseFloat(_.paddingTop)) * g.y;
...
function tp(e) {
  ...
  if ((h || !h && !i) && ((Gt(o) !== "body" || ko(n)) && (l = us(o)), Nt(o))) {
    const p = dr(o);
    d = Tr(o), f.x = p.x + o.clientLeft, f.y = p.y + o.clientTop;
  }
  return {
    width: r.width * d.x,
    height: r.height * d.y,
...
function ip(e, t) {
  const r = dr(e, !0, t === "fixed"), o = r.top + e.clientTop, s = r.left + e.clientLeft, i = Nt(e) ? Tr(e) : Yt(1), n = e.clientWidth * i.x, c = e.clientHeight * i.y, l = s * i.x, d = o * i.y;
  return {
    width: n,
    height: c,
    x: l,
...
function np(e, t) {
  ...
  if (r)
    return r;
  let o = fo(e, [], !1).filter((c) => Dt(c) && Gt(c) !== "body"), s = null;
  const i = mt(e).position === "fixed";
  let n = i ? Pr(e) : e;
  for (; Dt(n) && !ds(n); ) {
    const c = mt(n), l = $i(n);
    !l && c.position === "fixed" && (s = null), (i ? !l && !s : !l && c.position === "static" && !!s && ["absolute", "fixed"].includes(s.position) || ko(n) && !l && La(e, n)) ? o = o.filter((f) => f !== n) : s = c, n = Pr(n);
  }
  return t.set(e, o), o;
}
function ap(e) {
...
function Ba(e, t) {
  ...
  for (; o && Gh(o) && mt(o).position === "static"; )
    o = Pn(o, t);
  return o && (Gt(o) === "html" || Gt(o) === "body" && mt(o).position === "static" && !$i(o)) ? r : o || Jh(e) || r;
}
...
const fp = Yh, mp = Wh, Mn = Xh, gp = jh, bp = (e, t, r) => {
  ...
  constructor() {
    super(), this.localize = new he(this), this.content = "", this.placement = "top", this.disabled = !1, this.distance = 8, this.open = !1, this.skidding = 0, this.trigger = "hover focus", this.hoist = !1, this.handleBlur = () => {
      ...
      if (this.hasTrigger("hover")) {
        const e = An(getComputedStyle(this).getPropertyValue("--show-delay"));
        clearTimeout(this.hoverTimeout), this.hoverTimeout = window.setTimeout(() => this.show(), e);
      }
    }, this.handleMouseOut = () => {
      if (this.hasTrigger("hover")) {
        const e = An(getComputedStyle(this).getPropertyValue("--hide-delay"));
...
var Qt = class extends R {
  constructor() {
    super(), this.selection = "single", this.localize = new he(this), this.clickTarget = null, this.initTreeItem = (e) => {
      ...
      for (const t of e) {
        const r = [...t.addedNodes].filter(Ar.isTreeItem), o = [...t.removedNodes].filter(Ar.isTreeItem);
      ...
      const t = e.target;
      e.target === this && this.focusItem(this.lastFocusedItem || this.getAllTreeItems()[0]), Ar.isTreeItem(t) && !t.disabled && (this.lastFocusedItem && (this.lastFocusedItem.tabIndex = -1), this.lastFocusedItem = t, this.tabIndex = -1, t.tabIndex = 0);
  ...
  selectItem(e) {
    ...
    if (this.selection === "multiple")
      e.selected = !e.selected, e.lazy && (e.expanded = !0), Dn(e);
...
`, oe = class extends R {
  ...
  async handleOpenChange() {
    if (this.open && !this.disabled) {
      ...
      await Ne(this.popup.popup, e, t), this.currentOption && Gs(this.currentOption, this.listbox, "vertical", "auto"), this.emit("sl-after-show");
    } else {
...
var tt = class extends R {
  ...
  handleDrag(e) {
    ...
    this.disabled || (e.cancelable && e.preventDefault(), ao(this, {
      onMove: (r, o) => {
...
a([
  u({ type: Boolean, reflect: !0 })
], Hr.prototype, "indeterminate", 2);
a([
  u()
], Hr.prototype, "label", 2);
var Qp = "sl-progress-bar";
Hr.define("sl-progress-bar");
D({
  tagName: Qp,
  elementClass: Hr,
  react: I,
...
var pr = class extends R {
  ...
  async handleSrcChange() {
    try {
      const e = this.src, t = await bf(e, this.mode);
      if (e !== this.src)
        return;
      if (!t.ok) {
...
const lo = (e, t) => {
  ...
  if (r === void 0)
    return !1;
  for (const s of r)
    (o = s._$AO) == null || o.call(s, t, !1), lo(s, t);
  return !0;
}, Yo = (e) => {
  let t, r;
  do {
...
const zf = (e) => {
  e.type == At.CHILD && (e._$AP ?? (e._$AP = Ef), e._$AQ ?? (e._$AQ = $f));
};
class Af extends xo {
  constructor() {
  ...
  _$AO(t, r = !0) {
    var o, s;
    t !== this.isConnected && (this.isConnected = t, t ? (o = this.reconnected) == null || o.call(this) : (s = this.disconnected) == null || s.call(this)), r && (lo(this, t), Yo(this));
  }
  setValue(t) {
    if (_a(this._$Ct))
...
const Ns = /* @__PURE__ */ new WeakMap(), Nf = wo(class extends Af {
  render(e) {
    return Se;
  }
  update(e, [t]) {
  ...
  rt(e) {
    if (typeof this.Y == "function") {
      ...
      let r = Ns.get(t);
      r === void 0 && (r = /* @__PURE__ */ new WeakMap(), Ns.set(t, r)), r.get(this.Y) !== void 0 && this.Y.call(this.ht, void 0), r.set(this.Y, e), e !== void 0 && this.Y.call(this.ht, e);
    } else
      this.Y.value = e;
  }
  get lt() {
    var e, t;
    return typeof this.Y == "function" ? (e = Ns.get(this.ht ?? globalThis)) == null ? void 0 : e.get(this.Y) : (t = this.Y) == null ? void 0 : t.value;
  }
  disconnected() {
...
var If = class {
  constructor(e, t, r) {
    this.popupRef = Tf(), this.enableSubmenuTimer = -1, this.isConnected = !1, this.isPopupConnected = !1, this.skidding = 0, this.submenuOpenDelay = 100, this.handleMouseMove = (o) => {
  ...
  constructor() {
    super(...arguments), this.type = "normal", this.checked = !1, this.value = "", this.loading = !1, this.disabled = !1, this.localize = new he(this), this.hasSlotController = new Je(this, "submenu"), this.submenuController = new If(this, this.hasSlotController, this.localize), this.handleHostClick = (e) => {
...
Ai.styles = [V, Mf];
var Df = "sl-menu-label";
Ai.define("sl-menu-label");
var Lf = D({
  tagName: Df,
  elementClass: Ai,
  react: I,
...
function Kf(e) {
  ...
  return e.hasAttribute("tabindex") && (isNaN(r) || r <= -1) || e.hasAttribute("disabled") || e.closest("[inert]") || t === "input" && e.getAttribute("type") === "radio" && !e.hasAttribute("checked") || !Wf(e) ? !1 : (t === "audio" || t === "video") && e.hasAttribute("controls") || e.hasAttribute("tabindex") || e.hasAttribute("contenteditable") && e.getAttribute("contenteditable") !== "false" || [
    "button",
    "input",
    "select",
    "textarea",
...
function Yf(e) {
  var t, r;
  const o = ti(e), s = (t = o[0]) != null ? t : null, i = (r = o[o.length - 1]) != null ? r : null;
  ...
  function o(s) {
    if (s instanceof Element) {
      if (s.hasAttribute("inert") || s.closest("[inert]") || t.has(s))
        return;
      t.set(s, !0), !r.includes(s) && Kf(s) && r.push(s), s instanceof HTMLSlotElement && Xf(s, e) && s.assignedElements({ flatten: !0 }).forEach((i) => {
        o(i);
...
function* Ti(e = document.activeElement) {
  e != null && (yield e, "shadowRoot" in e && e.shadowRoot && e.shadowRoot.mode !== "closed" && (yield* Sl(Ti(e.shadowRoot.activeElement))));
}
function Gf() {
  return [...Ti()].pop();
}
var Zr = [], qa = class {
  ...
  activate() {
    Zr.push(this.element), document.addEventListener("focusin", this.handleFocusIn), document.addEventListener("keydown", this.handleKeyDown), document.addEventListener("keyup", this.handleKeyUp);
  }
  /** Deactivates focus trapping. */
  deactivate() {
    Zr = Zr.filter((e) => e !== this.element), this.currentFocus = null, document.removeEventListener("focusin", this.handleFocusIn), document.removeEventListener("keydown", this.handleKeyDown), document.removeEventListener("keyup", this.handleKeyUp);
  }
  /** Determines if this modal element is currently active or not. */
  isActive() {
    return Zr[Zr.length - 1] === this.element;
  }
...
var ot = class extends R {
  ...
  firstUpdated() {
    this.drawer.hidden = !this.open, this.open && (this.addOpenListeners(), this.contained || (this.modal.activate(), io(this)));
  }
  disconnectedCallback() {
    var e;
    super.disconnectedCallback(), no(this), (e = this.closeWatcher) == null || e.destroy();
  }
  requestClose(e) {
  ...
  async handleOpenChange() {
    if (this.open) {
      this.emit("sl-show"), this.addOpenListeners(), this.originalTrigger = document.activeElement, this.contained || (this.modal.activate(), io(this));
      ...
      this.emit("sl-hide"), this.removeOpenListeners(), this.contained || (this.modal.deactivate(), no(this)), await Promise.all([Le(this.drawer), Le(this.overlay)]);
  ...
  handleNoModalChange() {
    this.open && !this.contained && (this.modal.activate(), io(this)), this.open && this.contained && (this.modal.deactivate(), no(this));
  }
  /** Shows the drawer. */
  async show() {
    if (!this.open)
...
`, $t = class extends R {
  ...
  firstUpdated() {
    this.dialog.hidden = !this.open, this.open && (this.addOpenListeners(), this.modal.activate(), io(this));
  }
  disconnectedCallback() {
    var e;
    super.disconnectedCallback(), this.modal.deactivate(), no(this), (e = this.closeWatcher) == null || e.destroy();
  }
  requestClose(e) {
    if (this.emit("sl-request-close", {
      cancelable: !0,
  ...
  async handleOpenChange() {
    if (this.open) {
      this.emit("sl-show"), this.addOpenListeners(), this.originalTrigger = document.activeElement, this.modal.activate(), io(this);
      const e = this.querySelector("[autofocus]");
      ...
      ]), this.dialog.hidden = !0, this.overlay.hidden = !1, this.panel.hidden = !1, no(this);
      const r = this.originalTrigger;
      typeof (r == null ? void 0 : r.focus) == "function" && setTimeout(() => r.focus()), this.emit("sl-after-hide");
    }
  }
...
`, Ye = class extends R {
  ...
  updateAccessibleTrigger() {
    const t = this.trigger.assignedElements({ flatten: !0 }).find((o) => Yf(o).start);
    let r;
    if (t) {
...
var ze = class extends R {
  ...
  goToSlide(e, t = "smooth") {
    ...
    this.scrollToSlide(l, Ks() ? "auto" : t);
  }
...
Ni.styles = [V, b0];
var v0 = "sl-carousel-item";
Ni.define("sl-carousel-item");
D({
  tagName: v0,
  elementClass: Ni,
  react: I,
...
function C0(e, t, r) {
  ...
  if (e = We(e, 360), t = We(t, 100), r = We(r, 100), t === 0)
    ...
    o = Is(c, n, e + 1 / 3), s = Is(c, n, e), i = Is(c, n, e - 1 / 3);
  }
...
function A0(e) {
  ...
  return typeof e == "string" && (e = N0(e)), typeof e == "object" && (Rt(e.r) && Rt(e.g) && Rt(e.b) ? (t = k0(e.r, e.g, e.b), n = !0, c = String(e.r).substr(-1) === "%" ? "prgb" : "rgb") : Rt(e.h) && Rt(e.s) && Rt(e.v) ? (o = Po(e.s), s = Po(e.v), t = S0(e.h, o, s), n = !0, c = "hsv") : Rt(e.h) && Rt(e.s) && Rt(e.l) && (o = Po(e.s), i = Po(e.l), t = C0(e.h, o, i), n = !0, c = "hsl"), Object.prototype.hasOwnProperty.call(e, "a") && (r = e.a)), r = Ka(r), {
    ok: n,
    format: e.format || c,
...
const T0 = "[-\\+]?\\d+%?", O0 = "[-\\+]?\\d*\\.\\d+%?", Wt = "(?:" + O0 + ")|(?:" + T0 + ")", Rs = "[\\s|\\(]+(" + Wt + ")[,|\\s]+(" + Wt + ")[,|\\s]+(" + Wt + ")\\s*\\)?", Ps = (
...
class Oe {
  constructor(t = "", r = {}) {
    if (t instanceof Oe)
      return t;
    typeof t == "number" && (t = z0(t)), this.originalInput = t;
    const o = A0(t);
   ...
   */
  toHex8(t = !1) {
    return $0(this.r, this.g, this.b, this.a, t);
  }
  /**
  ...
  toName() {
    ...
    for (const [r, o] of Object.entries(ri))
      if (t === o)
        return r;
    return !1;
  }
...
var Wn = "EyeDropper" in window, se = class extends R {
  ...
  handleGridDrag(e) {
    ...
    r.focus(), e.preventDefault(), this.isDraggingGridHandle = !0, ao(t, {
      onMove: (c, l) => {
...
const j0 = [
  ...
  fadeInUpBig: Im,
  fadeOut: Rm,
  fadeOutBottomLeft: Pm,
  fadeOutBottomRight: Mm,
  fadeOutDown: Dm,
  fadeOutDownBig: Lm,
  fadeOutLeft: Bm,
  fadeOutLeftBig: Vm,
  ...
  jello: Y0,
  lightSpeedInLeft: Qm,
  lightSpeedInRight: Zm,
  lightSpeedOutLeft: eg,
  lightSpeedOutRight: tg,
  pulse: X0,
  rollIn: _g,
  rollOut: kg,
  rotateIn: rg,
  rotateInDownLeft: og,
  rotateInDownRight: sg,
  rotateInUpLeft: ig,
  rotateInUpRight: ng,
  rotateOut: ag,
  rotateOutDownLeft: lg,
  rotateOutDownRight: cg,
  rotateOutUpLeft: dg,
  rotateOutUpRight: ug,
  rubberBand: G0,
  shake: J0,
...
`, Ue = class extends R {
  ...
  async createAnimation() {
    var e, t;
    const r = (e = Ya[this.easing]) != null ? e : this.easing, o = (t = this.keyframes) != null ? t : Rg[this.name], i = (await this.defaultSlot).assignedElements()[0];
...
a([
  u({ reflect: !0 })
], jr.prototype, "variant", 2);
a([
  u({ type: Boolean, reflect: !0 })
], jr.prototype, "pill", 2);
a([
  u({ type: Boolean, reflect: !0 })
], jr.prototype, "pulse", 2);
var Wg = "sl-badge";
jr.define("sl-badge");
D({
  tagName: Wg,
      ...
      ei,
      {
        ...
        children: [
          ...
          r ? /* @__PURE__ */ Pe(Go, { children: [
            /* @__PURE__ */ S("div", { className: `selected-book-color-label ${o.toLowerCase()}`, slot: "prefix" }),
            /* @__PURE__ */ S(mo, { name: "chevron-up", slot: "suffix" })
          ] }) : /* @__PURE__ */ S("div", { className: `book-color-label ${o.toLowerCase()}`, slot: "prefix" })
        ]
      },
      e
    ),
...
function Kg({
  ...
  return /* @__PURE__ */ Pe(
    mf,
    {
      ...
      onClick: t,
      children: [
        /* @__PURE__ */ S(mo, { name: "search", slot: "prefix" }),
        /* @__PURE__ */ S(mo, { name: "clock-history", slot: "suffix" })
      ]
    }
  );
}
...
function wb({ scrRef: e, handleSubmit: t }) {
  ...
  return /* @__PURE__ */ Pe(Go, { children: [
    ...
    /* @__PURE__ */ S("div", { className: "book-chapter-menu", children: l && /* @__PURE__ */ Pe(
      Cf,
      {
        tabIndex: -1,
        children: [
          /* @__PURE__ */ Pe(ei, { onClick: (g) => g.preventDefault(), style: { fontSize: "14px" }, children: [
            /* @__PURE__ */ S(mo, { name: "zoom-in", slot: "prefix" }),
            "Zoom",
            /* @__PURE__ */ Pe("div", { slot: "suffix", style: { display: "flex", alignItems: "center" }, children: [
              /* @__PURE__ */ S(
                "span",
                {
                  style: {
          ...
          /* @__PURE__ */ Pe(ei, { onClick: (g) => g.preventDefault(), style: { fontSize: "14px" }, children: [
            /* @__PURE__ */ S(mo, { name: "view-list", slot: "prefix" }),
            "View",
            /* @__PURE__ */ Pe(Vp, { slot: "suffix", placeholder: "Publish", onSlInput: () => d(!1), children: [
              /* @__PURE__ */ S(Ts, { children: "Publish" }),
              /* @__PURE__ */ S(Ts, { children: "Draft" }),
              /* @__PURE__ */ S(Ts, { children: "Reading" })
            ] })
          ] }),
          Gg.map((g) => /* @__PURE__ */ Pe("div", { children: [
            /* @__PURE__ */ S(Bf, { children: Xg[g] }),
            f(g).map((x) => /* @__PURE__ */ S("div", { children: /* @__PURE__ */ S(
              qg,
              {
                bookId: x,
            ...
            g === "OT" || g === "NT" ? /* @__PURE__ */ S(B0, {}) : void 0
          ] }, g))
        ]
      }
    ) })
...
function Jg({
  ...
  let h;
  if (r) {
    const p = o === $r.Before || o === $r.Above, m = /* @__PURE__ */ S("span", { className: `papi-checkbox-label ${c ? "error" : ""} ${l ?? ""}`, children: r }), b = o === $r.Before || o === $r.After, v = b ? m : /* @__PURE__ */ S("div", { children: m }), g = b ? f : /* @__PURE__ */ S("div", { children: f });
    h = /* @__PURE__ */ Pe(
      tl,
      {
...
function Zg({ commandHandler: e, name: t, className: r, items: o, id: s }) {
  return /* @__PURE__ */ Pe(Xn, { id: s, item: !0, xs: "auto", className: `papi-menu-column ${r ?? ""}`, children: [
    /* @__PURE__ */ S("h3", { className: `papi-menu ${r ?? ""}`, children: t }),
    o.map((i, n) => /* @__PURE__ */ S(
      Qg,
      {
...
let Ms;
const Ds = () => (Ms || (Ms = ce.allBookIds.map((e) => ({
  bookId: e,
...
function kb({ scrRef: e, handleSubmit: t, id: r }) {
  ...
  return /* @__PURE__ */ Pe("span", { id: r, children: [
    ...
    /* @__PURE__ */ S(
      ...
      {
        onClick: () => o(Mi(e, 1)),
        isDisabled: e.bookNum >= Ds().length,
        children: ">"
      }
    ),
    /* @__PURE__ */ S(
    ...
    /* @__PURE__ */ S(
      ...
      {
        onClick: () => t(Di(e, 1)),
        isDisabled: e.chapterNum >= ni(e.bookNum),
        children: ">"
      }
    ),
    /* @__PURE__ */ S(
    ...
    /* @__PURE__ */ S(kr, { onClick: () => t(Li(e, 1)), children: ">" })
  ] });
}
function Cb({ onSearch: e, placeholder: t, isFullWidth: r }) {
  ...
  return /* @__PURE__ */ S(ol, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ S(
    Xo,
    {
      isFullWidth: r,
...
function qn({ onRowChange: e, row: t, column: r }) {
  ...
  return /* @__PURE__ */ S(Xo, { defaultValue: t[r.key], onChange: o });
}
const tb = ({ onChange: e, disabled: t, checked: r, ...o }) => /* @__PURE__ */ S(
  Jg,
  {
    ...o,
    isChecked: r,
...
function Ab({
  ...
  let g = e;
  return !g && t && (g = t(l)), /* @__PURE__ */ S("div", { ref: p, style: { position: "relative" }, children: /* @__PURE__ */ S(al, { position: "static", id: s, children: /* @__PURE__ */ Pe(ll, { className: `papi-toolbar ${o ?? ""}`, variant: "dense", children: [
    g ? /* @__PURE__ */ S(
      Gn,
      {
        edge: "start",
    ...
    g ? /* @__PURE__ */ S(
      cl,
      {
        ...
        children: /* @__PURE__ */ S(eb, { commandHandler: v, columns: g.columns })
      }
    ) : void 0
  ] }) }) });
}
...
Fs("https://cdn.jsdelivr.net/npm/@shoelace-style/shoelace@2.14.0/cdn/");
function sb(e, t = "top") {
