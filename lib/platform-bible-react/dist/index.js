...
const Je = class le {
  ...
  parse(t) {
    ...
    if (o.length !== 2 || Me.bookIdToNumber(r[0]) === 0 || !Number.isInteger(s) || s < 0 || !le.isVerseParseable(o[1]))
      throw new Zr("Invalid reference : " + t);
  ...
  updateInternal(t, r, o) {
    this.bookNum = Me.bookIdToNumber(t), this.chapter = r, this.verse = o;
  }
};
...
function Jf({ bookId: e, handleSelectBook: t, isSelected: r, children: o }) {
      ...
      Eu,
      {
        ...
        children: [
          ...
          r ? /* @__PURE__ */ pt(ei, { children: [
            /* @__PURE__ */ P("div", { className: "selected-book-color-label", slot: "prefix" }),
            /* @__PURE__ */ P(Xs, { name: "chevron-up", slot: "suffix" })
          ] }) : /* @__PURE__ */ P("div", { className: "book-color-label", slot: "prefix" })
        ]
      },
      e
    ),
...
function Qf({ endChapter: e, handleSelectChapter: t }) {
  const r = Array.from({ length: e }, (o, s) => s + 1);
  return /* @__PURE__ */ P("div", { className: "chapter-select", children: r.map((o) => (
    // Fix this once selecting chapter is working
    // eslint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-static-element-interactions
    /* @__PURE__ */ P("div", { onClick: () => t(o), children: o }, o)
  )) });
}
const e0 = {
  OT: "Old Testament",
...
function ab({ scrRef: e, handleSubmit: t }) {
  const { allBookIds: r } = Me, o = ir(
    (v) => ({
      OT: r.filter((x) => Me.isBookOT(x)),
      NT: r.filter((x) => Me.isBookNT(x)),
      DC: r.filter((x) => Me.isBookDC(x))
    })[v],
    [r]
  ), [s, i] = It(""), [n, c] = It(""), [l, d] = It(!1), f = ir(
    (v) => o(v).filter(
      (_) => Me.bookIdToEnglishName(_).toLowerCase().includes(n.toLowerCase()) || _.toLowerCase().includes(n.toLowerCase())
    ),
    [o, n]
  ), h = ir((v) => Hn(Me.bookIdToNumber(v)), []), p = (v) => {
    i(v), t({
      bookNum: Me.bookIdToNumber(v),
      chapterNum: 1,
      verseNum: 1
    }), h(v) === -1 && d(!1);
  }, m = (v) => {
  ...
  return /* @__PURE__ */ pt(ei, { children: [
    ...
    /* @__PURE__ */ P("div", { className: "book-chapter-control", children: l && /* @__PURE__ */ P(mu, { children: t0.map((v) => /* @__PURE__ */ pt("div", { children: [
...
let Cs;
const Ss = () => (Cs || (Cs = Me.allBookIds.map((e) => ({
  bookId: e,
...
function db({ scrRef: e, handleSubmit: t, id: r }) {
  const o = (l) => {
    ...
    const h = { bookNum: Me.bookIdToNumber(d.bookId), chapterNum: 1, verseNum: 1 };
    o(h);
  }, i = (l) => {
