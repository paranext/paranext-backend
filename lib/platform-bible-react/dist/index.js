...
import { useCallback as lo, useState as Rt, useMemo as Qs, useRef as Rs, useEffect as Xr } from "react";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Sa, defineProperty: $a, getOwnPropertyDescriptor: za, getOwnPropertyNames: Ea, getOwnPropertySymbols: Aa, getPrototypeOf: Ta } = Object, Kt = globalThis, Mi = Kt.trustedTypes, Oa = Mi ? Mi.emptyScript : "", us = Kt.reactiveElementPolyfillSupport, tr = (e, t) => e, No = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Oa : null;
      break;
  ...
  return o;
} }, oi = (e, t) => !Sa(e, t), Di = { attribute: !0, type: String, converter: No, reflect: !1, hasChanged: oi };
...
class $o extends HTMLElement {
  ...
  static _$Ei() {
    if (this.hasOwnProperty(tr("elementProperties")))
      return;
    const t = Ta(this);
    t.finalize(), t.l !== void 0 && (this.l = [...t.l]), this.elementProperties = new Map(t.elementProperties);
  }
  static finalize() {
    if (this.hasOwnProperty(tr("finalized")))
      return;
  ...
  _$EC(t, o) {
    ...
    if (s !== void 0 && r.reflect === !0) {
      const n = (((i = r.converter) == null ? void 0 : i.toAttribute) !== void 0 ? r.converter : No).toAttribute(o, r.type);
  ...
  _$AK(t, o) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const n = r.getPropertyOptions(s), c = typeof n.converter == "function" ? { fromAttribute: n.converter } : ((i = n.converter) == null ? void 0 : i.fromAttribute) !== void 0 ? n.converter : No;
...
$o.elementStyles = [], $o.shadowRootOptions = { mode: "open" }, $o[tr("elementProperties")] = /* @__PURE__ */ new Map(), $o[tr("finalized")] = /* @__PURE__ */ new Map(), us == null || us({ ReactiveElement: $o }), (Kt.reactiveElementVersions ?? (Kt.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const or = globalThis, Dr = or.trustedTypes, Li = Dr ? Dr.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Gn = "$lit$", jt = `lit$${(Math.random() + "").slice(9)}$`, Jn = "?" + jt, Na = `<${Jn}>`, ao = document, dr = () => ao.createComment(""), ur = (e) => e === null || typeof e != "object" && typeof e != "function", Zn = Array.isArray, Ia = (e) => Zn(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", hs = `[ 	
\f\r]`, qo = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Bi = /-->/g, Vi = />/g, oo = RegExp(`>|${hs}(?:([^\\s"'>=/]+)(${hs}*=${hs}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Fi = /'/g, Hi = /"/g, Qn = /^(?:script|style|textarea|title)$/i, Ra = (e) => (t, ...o) => ({ _$litType$: e, strings: t, values: o }), C = Ra(1), nt = Symbol.for("lit-noChange"), Ce = Symbol.for("lit-nothing"), Ui = /* @__PURE__ */ new WeakMap(), io = ao.createTreeWalker(ao, 129);
function el(e, t) {
...
const Pa = (e, t) => {
  ...
  let s, i = t === 2 ? "<svg>" : "", n = qo;
  for (let c = 0; c < o; c++) {
    const a = e[c];
    let d, f, h = -1, p = 0;
    for (; p < a.length && (n.lastIndex = p, f = n.exec(a), f !== null); )
      p = n.lastIndex, n === qo ? f[1] === "!--" ? n = Bi : f[1] !== void 0 ? n = Vi : f[2] !== void 0 ? (Qn.test(f[2]) && (s = RegExp("</" + f[2], "g")), n = oo) : f[3] !== void 0 && (n = oo) : n === oo ? f[0] === ">" ? (n = s ?? qo, h = -1) : f[1] === void 0 ? h = -2 : (h = n.lastIndex - f[2].length, d = f[1], n = f[3] === void 0 ? oo : f[3] === '"' ? Hi : Fi) : n === Hi || n === Fi ? n = oo : n === Bi || n === Vi ? n = qo : (n = oo, s = void 0);
    const m = n === oo && e[c + 1].startsWith("/>") ? " " : "";
    i += n === qo ? a + Na : h >= 0 ? (r.push(d), a.slice(0, h) + Gn + a.slice(h) + jt + m) : a + jt + (h === -2 ? c : m);
  }
      ...
      if (s.nodeType === 1) {
        ...
        if (Qn.test(s.tagName)) {
          ...
          if (p > 0) {
            ...
            for (let m = 0; m < p; m++)
              s.append(h[m], dr()), io.nextNode(), a.push({ type: 2, index: ++i });
            s.append(h[p], dr());
          }
        }
...
function Io(e, t, o = e, r) {
  ...
  const i = ur(t) ? void 0 : t._$litDirective$;
...
let Ma = class {
  ...
  u(t) {
    const { el: { content: o }, parts: r } = this._$AD, s = ((t == null ? void 0 : t.creationScope) ?? ao).importNode(o, !0);
    io.currentNode = s;
  ...
  _$AI(t, o = this) {
    t = Io(this, t, o), ur(t) ? t === Ce || t == null || t === "" ? (this._$AH !== Ce && this._$AR(), this._$AH = Ce) : t !== this._$AH && t !== nt && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Ia(t) ? this.k(t) : this._(t);
  }
  S(t) {
  ...
  _(t) {
    this._$AH !== Ce && ur(this._$AH) ? this._$AA.nextSibling.data = t : this.T(ao.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var i;
  ...
  k(t) {
    ...
    let r, s = 0;
    for (const i of t)
      s === o.length ? o.push(r = new ol(this.S(dr()), this.S(dr()), this, this.options)) : r = o[s], r._$AI(i), s++;
  ...
  _$AI(t, o = this, r, s) {
    ...
    let n = !1;
    if (i === void 0)
      t = Io(this, t, o, 0), n = !ur(t) || t !== this._$AH && t !== nt, n && (this._$AH = t);
    else {
      const c = t;
      let a, d;
      for (t = i[0], a = 0; a < i.length - 1; a++)
        d = Io(this, c[r + a], o, a), d === nt && (d = this._$AH[a]), n || (n = !ur(d) || d !== this._$AH[a]), d === Ce ? t = Ce : t !== Ce && (t += (d ?? "") + i[a + 1]), this._$AH[a] = d;
    }
    n && !s && this.j(t);
  }
  j(t) {
...
const ps = or.litHtmlPolyfillSupport;
ps == null || ps(Ds, ri), (or.litHtmlVersions ?? (or.litHtmlVersions = [])).push("3.1.2");
const Fa = (e, t, o) => {
  const r = (o == null ? void 0 : o.renderBefore) ?? t;
  let s = r._$litPart$;
  if (s === void 0) {
    const i = (o == null ? void 0 : o.renderBefore) ?? null;
    r._$litPart$ = s = new ri(t.insertBefore(dr(), i), i, void 0, o ?? {});
  }
  return s._$AI(e), s;
};
/**
...
var Un;
rr._$litElement$ = !0, rr.finalized = !0, (Un = globalThis.litElementHydrateSupport) == null || Un.call(globalThis, { LitElement: rr });
const fs = globalThis.litElementPolyfillSupport;
fs == null || fs({ LitElement: rr });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ua = { attribute: !0, type: String, converter: No, reflect: !1, hasChanged: oi }, ja = (e = Ua, t, o) => {
...
`, po = (e = "value") => (t, o) => {
  ...
  r.prototype.attributeChangedCallback = function(i, n, c) {
    ...
    if (i === f) {
      const h = d.converter || No, m = (typeof h == "function" ? h : (a = h == null ? void 0 : h.fromAttribute) != null ? a : No.fromAttribute)(c, d.type);
      this[e] !== m && (this[o] = m);
    }
    s.call(this, i, n, c);
  };
}, Ko = /* @__PURE__ */ new WeakMap(), Xo = /* @__PURE__ */ new WeakMap(), Yo = /* @__PURE__ */ new WeakMap(), ms = /* @__PURE__ */ new WeakSet(), Sr = /* @__PURE__ */ new WeakMap(), Lt = class {
  constructor(e, t) {
    this.handleFormData = (o) => {
      ...
      this.form && !this.form.noValidate && ((r = Ko.get(this.form)) == null || r.forEach((n) => {
  ...
  attachForm(e) {
    e ? (this.form = e, Ko.has(this.form) ? Ko.get(this.form).add(this.host) : Ko.set(this.form, /* @__PURE__ */ new Set([this.host])), this.form.addEventListener("formdata", this.handleFormData), this.form.addEventListener("submit", this.handleFormSubmit), this.form.addEventListener("reset", this.handleFormReset), Xo.has(this.form) || (Xo.set(this.form, this.form.reportValidity), this.form.reportValidity = () => this.reportFormValidity()), Yo.has(this.form) || (Yo.set(this.form, this.form.checkValidity), this.form.checkValidity = () => this.checkFormValidity())) : this.form = void 0;
  }
  detachForm() {
    if (!this.form)
      return;
    const e = Ko.get(this.form);
    e && (e.delete(this.host), e.size <= 0 && (this.form.removeEventListener("formdata", this.handleFormData), this.form.removeEventListener("submit", this.handleFormSubmit), this.form.removeEventListener("reset", this.handleFormReset), Xo.has(this.form) && (this.form.reportValidity = Xo.get(this.form), Xo.delete(this.form)), Yo.has(this.form) && (this.form.checkValidity = Yo.get(this.form), Yo.delete(this.form)), this.form = void 0));
  }
  ...
  valid: !0,
  valueMissing: !1
}), Ja = Object.freeze(fr(Dt({}, Jr), {
  valid: !1,
  valueMissing: !0
})), Za = Object.freeze(fr(Dt({}, Jr), {
  valid: !1,
  customError: !0
})), Ge = class {
  constructor(e, ...t) {
...
var Go = Symbol(), $r = Symbol(), gs, bs = /* @__PURE__ */ new Map(), we = class extends I {
  constructor() {
  ...
  async resolveIcon(e, t) {
    ...
    try {
      ...
      return c ? (c.part.add("svg"), document.adoptNode(c)) : Go;
    } catch {
      return Go;
    }
  }
...
`;
const Vs = /* @__PURE__ */ new Set(), hc = new MutationObserver(ll), Eo = /* @__PURE__ */ new Map();
...
function nl(...e) {
  e.map((t) => {
    ...
    Eo.has(o) ? Eo.set(o, Object.assign(Object.assign({}, Eo.get(o)), t)) : Eo.set(o, t), so || (so = t);
  }), ll();
}
function ll() {
...
let pc = class {
  ...
  getTranslationData(t) {
    var o, r;
    const s = new Intl.Locale(t.replace(/_/g, "-")), i = s == null ? void 0 : s.language.toLowerCase(), n = (r = (o = s == null ? void 0 : s.region) === null || o === void 0 ? void 0 : o.toLowerCase()) !== null && r !== void 0 ? r : "", c = Eo.get(`${i}-${n}`), a = Eo.get(i);
...
l([
  u({ type: Boolean, reflect: !0 })
], Bo.prototype, "active", 2);
l([
  z("active")
], Bo.prototype, "handleActiveChange", 1);
var Ec = "sl-tab-panel";
Bo.define("sl-tab-panel");
D({
  tagName: Ec,
  elementClass: Bo,
  react: N,
...
`;
const Xt = Math.min, st = Math.max, Vr = Math.round, zr = Math.floor, Yt = (e) => ({
  x: e,
  y: e
}), Dc = {
  left: "right",
...
function Ji(e, t, o) {
  ...
  const i = br(t), n = ni(t), c = ii(n), a = Gt(t), d = i === "y", f = r.x + r.width / 2 - s.width / 2, h = r.y + r.height / 2 - s.height / 2, p = r[c] / 2 - s[c] / 2;
  let m;
  switch (a) {
    case "top":
      m = {
...
const jc = async (e, t, o) => {
  ...
  for (let b = 0; b < c.length; b++) {
    ...
    if (f = x ?? f, h = k ?? h, m = {
      ...
      g++, typeof y == "object" && (y.placement && (p = y.placement), y.rects && (d = y.rects === !0 ? await n.getElementRects({
        reference: e,
        floating: t,
        strategy: s
      }) : y.rects), {
...
async function li(e, t) {
  ...
  const {
    ...
    altBoundary: p = !1,
    padding: m = 0
  } = Vo(t, e), g = hl(m), v = c[p ? h === "floating" ? "reference" : "floating" : h], _ = Hr(await i.getClippingRect({
    element: (o = await (i.isElement == null ? void 0 : i.isElement(v))) == null || o ? v : v.contextElement || await (i.getDocumentElement == null ? void 0 : i.getDocumentElement(c.floating)),
    boundary: d,
    rootBoundary: f,
    strategy: a
  })), x = h === "floating" ? {
    ...
    x: 1,
    y: 1
  }, y = Hr(i.convertOffsetParentRelativeRectToViewportRelativeRect ? await i.convertOffsetParentRelativeRectToViewportRelativeRect({
    rect: x,
    offsetParent: k,
    strategy: a
  }) : x);
...
const Wc = (e) => ({
  ...
  async fn(t) {
    ...
    const h = hl(f), p = {
      x: o,
      y: r
    }, m = ni(s), g = ii(m), b = await n.getDimensions(d), v = m === "y", _ = v ? "top" : "left", x = v ? "bottom" : "right", k = v ? "clientHeight" : "clientWidth", w = i.reference[g] + i.reference[m] - p[m] - i.floating[g], y = p[m] - i.reference[m], E = await (n.getOffsetParent == null ? void 0 : n.getOffsetParent(d));
    let V = E ? E[k] : 0;
    (!V || !await (n.isElement == null ? void 0 : n.isElement(E))) && (V = c.floating[k] || i.floating[g]);
    const j = w / 2 - y / 2, P = V / 2 - b[g] / 2 - 1, S = Xt(h[_], P), X = Xt(h[x], P), K = S, xe = V - b[g] - X, G = V / 2 - b[g] / 2 + j, J = Ws(K, G, xe), _e = !a.arrow && Fo(s) != null && G != J && i.reference[g] / 2 - (G < K ? S : X) - b[g] / 2 < 0, Ie = _e ? G < K ? G - K : G - xe : 0;
    return {
      [m]: p[m] + Ie,
      data: {
        [m]: J,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((o = i.arrow) != null && o.alignmentOffset)
        return {};
      const _ = Gt(s), x = Gt(c) === c, k = await (a.isRTL == null ? void 0 : a.isRTL(d.floating)), w = p || (x || !b ? [Fr(c)] : Vc(c));
      !p && g !== "none" && w.push(...Hc(c, b, g, k));
      const y = [c, ...w], E = await li(t, v), V = [];
      ...
      if (j = [...j, {
        ...
        var P, S;
        const K = (((P = i.flip) == null ? void 0 : P.index) || 0) + 1, xe = y[K];
        if (xe)
          return {
            data: {
              index: K,
...
async function Kc(e, t) {
  const {
    ...
    platform: r,
    elements: s
  } = e, i = await (r.isRTL == null ? void 0 : r.isRTL(s.floating)), n = Gt(o), c = Fo(o), a = br(o) === "y", d = ["left", "top"].includes(n) ? -1 : 1, f = i && a ? -1 : 1, h = Vo(t, e);
  let {
    mainAxis: p,
    crossAxis: m,
    alignmentAxis: g
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: o,
        y: r
      }, f = await li(t, a), h = br(Gt(s)), p = ul(h);
      let m = d[p], g = d[h];
      if (i) {
...
function fl(e) {
  const t = Ro(e);
  return Zr(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : Tt(t) && vr(t) ? t : fl(t);
}
function hr(e, t, o) {
  var r;
  t === void 0 && (t = []), o === void 0 && (o = !0);
  const s = fl(e), i = s === ((r = e.ownerDocument) == null ? void 0 : r.body), n = lt(s);
  return i ? t.concat(n, n.visualViewport || [], vr(s) ? s : [], n.frameElement && o ? hr(n.frameElement) : []) : t.concat(s, hr(s, [], o));
}
function ml(e) {
  const t = ht(e);
...
function uo(e, t, o, r) {
  ...
  if (i) {
    ...
    for (; g && r && m !== p; ) {
      const b = To(g), v = g.getBoundingClientRect(), _ = ht(g), x = v.left + (g.clientLeft + parseFloat(_.paddingLeft)) * b.x, k = v.top + (g.clientTop + parseFloat(_.paddingTop)) * b.y;
      a *= b.x, d *= b.y, f *= b.x, h *= b.y, a += x, d += k, g = lt(g).frameElement;
    }
  }
  return Hr({
    width: f,
...
function td(e) {
  ...
  const a = Yt(0);
  if ((s || !s && r !== "fixed") && ((Jt(o) !== "body" || vr(i)) && (n = Qr(o)), Tt(o))) {
    const d = uo(o);
    c = To(o), a.x = d.x + o.clientLeft, a.y = d.y + o.clientTop;
  }
  return {
    width: t.width * c.x,
    height: t.height * c.y,
...
function bl(e) {
  return uo(Vt(e)).left + Qr(e).scrollLeft;
}
function rd(e) {
...
function id(e, t) {
  const o = uo(e, !0, t === "fixed"), r = o.top + e.clientTop, s = o.left + e.clientLeft, i = Tt(e) ? To(e) : Yt(1), n = e.clientWidth * i.x, c = e.clientHeight * i.y, a = s * i.x, d = r * i.y;
  return {
    width: n,
    height: c,
    x: a,
...
function nd(e, t) {
  ...
  if (o)
    return o;
  let r = hr(e, [], !1).filter((c) => Pt(c) && Jt(c) !== "body"), s = null;
  const i = ht(e).position === "fixed";
  let n = i ? Ro(e) : e;
  for (; Pt(n) && !Zr(n); ) {
    const c = ht(n), a = ai(n);
    !a && c.position === "fixed" && (s = null), (i ? !a && !s : !a && c.position === "static" && !!s && ["absolute", "fixed"].includes(s.position) || vr(n) && !a && vl(e, n)) ? r = r.filter((f) => f !== n) : s = c, n = Ro(n);
  }
  return t.set(e, r), r;
}
function ld(e) {
...
function cd(e, t, o) {
  const r = Tt(t), s = Vt(t), i = o === "fixed", n = uo(e, !0, i, t);
  let c = {
    scrollLeft: 0,
    scrollTop: 0
  };
...
function hd(e, t) {
  ...
  function n(c, a) {
    ...
    if (c || t(), !h || !p)
      return;
    const m = zr(f), g = zr(s.clientWidth - (d + h)), b = zr(s.clientHeight - (f + p)), v = zr(d), x = {
...
function pd(e, t, o, r) {
  ...
  const {
    ...
    animationFrame: a = !1
  } = r, d = di(e), f = s || i ? [...d ? hr(d) : [], ...hr(t)] : [];
  f.forEach((_) => {
    s && _.addEventListener("scroll", o, {
      passive: !0
    }), i && _.addEventListener("resize", o);
  });
  ...
  function v() {
    const _ = uo(e);
    b && (_.x !== b.x || _.y !== b.y || _.width !== b.width || _.height !== b.height) && o(), b = _, g = requestAnimationFrame(v);
  }
  return o(), () => {
    f.forEach((_) => {
...
var Zt = class extends I {
  constructor() {
    super(), this.selection = "single", this.localize = new ue(this), this.clickTarget = null, this.initTreeItem = (e) => {
      ...
      for (const t of e) {
        const o = [...t.addedNodes].filter(Ao.isTreeItem), r = [...t.removedNodes].filter(Ao.isTreeItem);
      ...
      const t = e.target;
      e.target === this && this.focusItem(this.lastFocusedItem || this.getAllTreeItems()[0]), Ao.isTreeItem(t) && !t.disabled && (this.lastFocusedItem && (this.lastFocusedItem.tabIndex = -1), this.lastFocusedItem = t, this.tabIndex = -1, t.tabIndex = 0);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const wl = "important", Od = " !" + wl, Je = mr(class extends gr {
  constructor(e) {
    var t;
...
var Qe = class extends I {
  ...
  handleDrag(e) {
    ...
    this.disabled || (e.cancelable && e.preventDefault(), lr(this, {
      onMove: (o, r) => {
...
], fo.prototype, "indicator", 2);
l([
  U()
], fo.prototype, "indicatorOffset", 2);
l([
  u({ type: Number, reflect: !0 })
...
l([
  u({ type: Boolean, reflect: !0 })
], Ho.prototype, "indeterminate", 2);
l([
  u()
], Ho.prototype, "label", 2);
var Kd = "sl-progress-bar";
Ho.define("sl-progress-bar");
D({
  tagName: Kd,
  elementClass: Ho,
  react: N,
...
(function(e) {
  function t(c, a, d, f) {
    ...
    p.u(c), p.J(), f = f || 0;
    var m = p.h(), g = p.h() + 2 * f;
    return h.text = c, h.level = a, h.version = d, h.O = g, h.a = function(b, v) {
      return b -= f, v -= f, 0 > b || b >= m || 0 > v || v >= m ? !1 : p.a(b, v);
    }, h;
  }
  function o(c, a, d, f, h, p, m, g, b, v) {
    function _(x, k, w, y, E, V, j) {
      x ? (c.lineTo(k + V, w + j), c.arcTo(k, w, y, E, p)) : c.lineTo(k, w);
    }
    m ? c.moveTo(a + p, d) : c.moveTo(a, d), _(g, f, d, f, h, -p, 0), _(b, f, h, a, h, 0, -p), _(v, a, h, a, d, p, 0), _(m, a, d, f, d, 0, p);
  }
  function r(c, a, d, f, h, p, m, g, b, v) {
    function _(x, k, w, y) {
    ...
    m && _(a, d, p, p), g && _(f, d, -p, p), b && _(f, h, -p, -p), v && _(a, h, p, -p);
  }
  function s(c, a) {
    var d = a.fill;
    if (typeof d == "string")
  ...
  function i(c, a) {
    ...
    for (d = c.getContext("2d"), a.background && (d.fillStyle = a.background, d.fillRect(a.left, a.top, a.size, a.size)), f = g.O, p = a.size / f, d.beginPath(), m = 0; m < f; m += 1)
      for (h = 0; h < f; h += 1) {
        var b = d, v = a.left + h * p, _ = a.top + m * p, x = m, k = h, w = g.a, y = v + p, E = _ + p, V = x - 1, j = x + 1, P = k - 1, S = k + 1, X = Math.floor(Math.min(0.5, Math.max(0, a.R)) * p), K = w(x, k), xe = w(V, P), G = w(V, k);
        V = w(V, S);
        var J = w(x, S);
        S = w(j, S), k = w(
          j,
          k
        ), j = w(j, P), x = w(x, P), v = Math.round(v), _ = Math.round(_), y = Math.round(y), E = Math.round(E), K ? o(b, v, _, y, E, X, !G && !x, !G && !J, !k && !J, !k && !x) : r(b, v, _, y, E, X, G && x && xe, G && J && V, k && J && S, k && x && j);
      }
  ...
  function o(a, d) {
    ...
    function h(x, k) {
      for (var w = g = 4 * a + 17, y = Array(w), E = 0; E < w; E += 1) {
        y[E] = Array(w);
        for (var V = 0; V < w; V += 1)
          y[E][V] = null;
      }
      for (m = y, f(0, 0), f(g - 7, 0), f(0, g - 7), w = i.G(a), y = 0; y < w.length; y += 1)
      ...
      for (w = i.w(p << 3 | k), y = 0; 15 > y; y += 1)
        E = !x && (w >> y & 1) == 1, m[6 > y ? y : 8 > y ? y + 1 : g - 15 + y][8] = E, m[8][8 > y ? g - y - 1 : 9 > y ? 15 - y : 14 - y] = E;
      if (m[g - 8][8] = !x, 7 <= a) {
        for (w = i.A(a), y = 0; 18 > y; y += 1)
          E = !x && (w >> y & 1) == 1, m[Math.floor(y / 3)][y % 3 + g - 8 - 3] = E;
        for (y = 0; 18 > y; y += 1)
          E = !x && (w >> y & 1) == 1, m[y % 3 + g - 8 - 3][Math.floor(y / 3)] = E;
      }
      if (b == null) {
        for (x = c.I(a, p), w = t(), y = 0; y < v.length; y += 1)
          E = v[y], w.put(4, 4), w.put(E.b(), i.f(4, a)), E.write(w);
        for (y = E = 0; y < x.length; y += 1)
          E += x[y].j;
        if (w.f() > 8 * E)
        ...
        for (; !(w.f() >= 8 * E) && (w.put(236, 8), !(w.f() >= 8 * E)); )
          w.put(17, 8);
        var X = 0;
        for (E = y = 0, V = Array(x.length), j = Array(x.length), P = 0; P < x.length; P += 1) {
          var K = x[P].j, xe = x[P].o - K;
          for (y = Math.max(y, K), E = Math.max(E, xe), V[P] = Array(K), S = 0; S < V[P].length; S += 1)
            V[P][S] = 255 & w.B()[S + X];
      ...
      for (x = b, w = -1, y = g - 1, E = 7, V = 0, k = i.F(k), j = g - 1; 0 < j; j -= 2)
        for (j == 6 && --j; ; ) {
          for (P = 0; 2 > P; P += 1)
            m[y][j - P] == null && (S = !1, V < x.length && (S = (x[V] >>> E & 1) == 1), k(y, j - P) && (S = !S), m[y][j - P] = S, --E, E == -1 && (V += 1, E = 7));
          if (y += w, 0 > y || g <= y) {
            y -= w, w = -w;
            break;
          }
...
], mo.prototype, "allowScripts", 2);
l([
  z("src")
], mo.prototype, "handleSrcChange", 1);
var hu = "sl-include";
mo.define("sl-include");
D({
  tagName: hu,
  elementClass: mo,
  react: N,
...
const ar = (e, t) => {
  ...
  if (o === void 0)
    return !1;
  for (const s of o)
    (r = s._$AO) == null || r.call(s, t, !1), ar(s, t);
  return !0;
}, Ur = (e) => {
  let t, o;
  do {
...
let ku = class extends gr {
  ...
  _$AO(t, o = !0) {
    var r, s;
    t !== this.isConnected && (this.isConnected = t, t ? (r = this.reconnected) == null || r.call(this) : (s = this.disconnected) == null || s.call(this)), o && (ar(this, t), Ur(this));
  }
  setValue(t) {
    if (rl(this._$Ct))
...
const ws = /* @__PURE__ */ new WeakMap(), $u = mr(class extends ku {
  render(e) {
    return Ce;
  }
  update(e, [t]) {
...
var Zo = [], $l = class {
  ...
  activate() {
    Zo.push(this.element), document.addEventListener("focusin", this.handleFocusIn), document.addEventListener("keydown", this.handleKeyDown), document.addEventListener("keyup", this.handleKeyUp);
  }
  /** Deactivates focus trapping. */
  deactivate() {
    Zo = Zo.filter((e) => e !== this.element), this.currentFocus = null, document.removeEventListener("focusin", this.handleFocusIn), document.removeEventListener("keydown", this.handleKeyDown), document.removeEventListener("keyup", this.handleKeyUp);
  }
  /** Determines if this modal element is currently active or not. */
  isActive() {
    return Zo[Zo.length - 1] === this.element;
  }
...
var tt = class extends I {
  ...
  firstUpdated() {
    this.drawer.hidden = !this.open, this.open && (this.addOpenListeners(), this.contained || (this.modal.activate(), ir(this)));
  }
  disconnectedCallback() {
    var e;
    super.disconnectedCallback(), nr(this), (e = this.closeWatcher) == null || e.destroy();
  }
  requestClose(e) {
  ...
  async handleOpenChange() {
    if (this.open) {
      this.emit("sl-show"), this.addOpenListeners(), this.originalTrigger = document.activeElement, this.contained || (this.modal.activate(), ir(this));
      ...
      this.emit("sl-hide"), this.removeOpenListeners(), this.contained || (this.modal.deactivate(), nr(this)), await Promise.all([Me(this.drawer), Me(this.overlay)]);
  ...
  handleNoModalChange() {
    this.open && !this.contained && (this.modal.activate(), ir(this)), this.open && this.contained && (this.modal.deactivate(), nr(this));
  }
  /** Shows the drawer. */
  async show() {
    if (!this.open)
...
`, St = class extends I {
  ...
  firstUpdated() {
    this.dialog.hidden = !this.open, this.open && (this.addOpenListeners(), this.modal.activate(), ir(this));
  }
  disconnectedCallback() {
    var e;
    super.disconnectedCallback(), this.modal.deactivate(), nr(this), (e = this.closeWatcher) == null || e.destroy();
  }
  requestClose(e) {
    if (this.emit("sl-request-close", {
      cancelable: !0,
  ...
  async handleOpenChange() {
    if (this.open) {
      this.emit("sl-show"), this.addOpenListeners(), this.originalTrigger = document.activeElement, this.modal.activate(), ir(this);
      const e = this.querySelector("[autofocus]");
      ...
      ]), this.dialog.hidden = !0, this.overlay.hidden = !1, this.panel.hidden = !1, nr(this);
      const o = this.originalTrigger;
      typeof (o == null ? void 0 : o.focus) == "function" && setTimeout(() => o.focus()), this.emit("sl-after-hide");
    }
  }
...
function Ch(e) {
  ...
  return typeof e == "string" && (e = zh(e)), typeof e == "object" && (Nt(e.r) && Nt(e.g) && Nt(e.b) ? (t = vh(e.r, e.g, e.b), n = !0, c = String(e.r).substr(-1) === "%" ? "prgb" : "rgb") : Nt(e.h) && Nt(e.s) && Nt(e.v) ? (r = Tr(e.s), s = Tr(e.v), t = wh(e.h, r, s), n = !0, c = "hsv") : Nt(e.h) && Nt(e.s) && Nt(e.l) && (r = Tr(e.s), i = Tr(e.l), t = yh(e.h, r, i), n = !0, c = "hsl"), Object.prototype.hasOwnProperty.call(e, "a") && (o = e.a)), o = zl(o), {
    ok: n,
    format: e.format || c,
...
var hn = "EyeDropper" in window, se = class extends I {
  ...
  handleGridDrag(e) {
    ...
    o.focus(), e.preventDefault(), this.isDraggingGridHandle = !0, lr(t, {
      onMove: (c, a) => {
...
`, yo = Object.assign(document.createElement("div"), { className: "sl-toast-stack" }), $t = class extends I {
  constructor() {
  ...
  async toast() {
    return new Promise((e) => {
      yo.parentElement === null && document.body.append(yo), yo.appendChild(this), requestAnimationFrame(() => {
        this.clientWidth, this.show();
      }), this.addEventListener(
        "sl-after-hide",
        () => {
          yo.removeChild(this), e(), yo.querySelector("sl-alert") === null && yo.remove();
        },
        { once: !0 }
      );
    });
...
go.styles = [F, If];
go.dependencies = { "sl-icon": we };
l([
  A("slot")
], go.prototype, "defaultSlot", 2);
l([
  A('slot[name="separator"]')
], go.prototype, "separatorSlot", 2);
l([
  u()
], go.prototype, "label", 2);
var Rf = "sl-breadcrumb";
go.define("sl-breadcrumb");
D({
  tagName: Rf,
  elementClass: go,
  react: N,
...
l([
  u()
], Uo.prototype, "target", 2);
l([
  u()
], Uo.prototype, "rel", 2);
var Df = "sl-breadcrumb-item";
Uo.define("sl-breadcrumb-item");
D({
  tagName: Df,
  elementClass: Uo,
  react: N,
...
l([
  u({ reflect: !0 })
], jo.prototype, "variant", 2);
l([
  u({ type: Boolean, reflect: !0 })
], jo.prototype, "pill", 2);
l([
  u({ type: Boolean, reflect: !0 })
], jo.prototype, "pulse", 2);
var Bf = "sl-badge";
jo.define("sl-badge");
D({
  tagName: Bf,
...
function Hf(e) {
  const t = typeof e == "string" ? Wo(e) : e;
  return t >= 40 && t <= 66;
}
function Uf(e) {
  return (typeof e == "string" ? Wo(e) : e) <= 39;
}
function Tl(e) {
  return e <= 66;
}
...
function* Wf() {
  for (let e = 1; e <= ho.length; e++)
    yield e;
}
const qf = 1, Ol = ho.length;
function Kf() {
  return ["XXA", "XXB", "XXC", "XXD", "XXE", "XXF", "XXG"];
}
function bi(e, t = "***") {
  const o = e - 1;
  return o < 0 || o >= ho.length ? t : ho[o];
}
function Nl(e) {
...
const te = class {
  ...
  parse(t) {
    if (t = t.replace(this.rtlMark, ""), t.includes("/")) {
      ...
      if (t = i[0], i.length > 1)
        try {
          ...
          throw new Qo("Invalid reference : " + t);
        }
    }
    ...
    if (r.length !== 2 || Be.bookIdToNumber(o[0]) === 0 || !Number.isInteger(s) || s < 0 || !te.isVerseParseable(r[1]))
      throw new Qo("Invalid reference : " + t);
   ...
   */
  get internalValid() {
    return this.versification == null ? 1 : this._bookNum <= 0 || this._bookNum > Be.lastBook ? 2 : 0;
  }
  setEmpty(t = te.defaultVersification) {
    this._bookNum = 0, this._chapterNum = -1, this._verse = void 0, this.versification = t;
  }
  updateInternal(t, o, r) {
    this.bookNum = Be.bookIdToNumber(t), this.chapter = o, this.verse = r;
  }
};
let It = te;
...
function cb({ scrRef: e, handleSubmit: t }) {
  const { allBookIds: o } = Be, r = lo(
    (v) => ({
      OT: o.filter((x) => Be.isBookOT(x)),
      NT: o.filter((x) => Be.isBookNT(x)),
      DC: o.filter((x) => Be.isBookDC(x))
    })[v],
    [o]
  ), [s, i] = Rt(""), [n, c] = Rt(""), [a, d] = Rt(!1), f = lo(
    (v) => r(v).filter(
      (_) => Be.bookIdToEnglishName(_).toLowerCase().includes(n.toLowerCase()) || _.toLowerCase().includes(n.toLowerCase())
    ),
    [r, n]
  ), h = lo((v) => jn(Be.bookIdToNumber(v)), []), p = (v) => {
    i(v), t({
      bookNum: Be.bookIdToNumber(v),
      chapterNum: 1,
      verseNum: 1
    }), h(v) === -1 && d(!1);
  }, m = (v) => {
  ...
  return /* @__PURE__ */ xt("div", { className: "book-chapter-control", children: [
    /* @__PURE__ */ M(
      Qf,
      {
        ...
        handleSearch: m,
        handleClick: g,
        placeholder: `${Be.bookNumberToEnglishName(e.bookNum)} ${e.chapterNum}:${e.verseNum}`
      }
    ),
    a && /* @__PURE__ */ M(vu, { className: "book-chapter-menu", children: o0.map((v) => /* @__PURE__ */ xt("div", { children: [
      /* @__PURE__ */ M(Ru, { children: t0[v] }),
      f(v).map((_) => /* @__PURE__ */ M("div", { className: "menu-item-container", children: /* @__PURE__ */ M(
        Zf,
        {
          bookId: _,
...
var zo = /* @__PURE__ */ ((e) => (e.After = "after", e.Before = "before", e.Above = "above", e.Below = "below", e))(zo || {});
function r0({
  id: e,
  isChecked: t,
  labelText: o = "",
  labelPosition: r = zo.After,
  isIndeterminate: s = !1,
  isDefaultChecked: i,
  isDisabled: n = !1,
  hasError: c = !1,
  ...
  let h;
  if (o) {
    const p = r === zo.Before || r === zo.Above, m = /* @__PURE__ */ M("span", { className: `papi-checkbox-label ${c ? "error" : ""} ${a ?? ""}`, children: o }), g = r === zo.Before || r === zo.After, b = g ? m : /* @__PURE__ */ M("div", { children: m }), v = g ? f : /* @__PURE__ */ M("div", { children: f });
    h = /* @__PURE__ */ xt(
      ea,
      {
...
function i0({ commandHandler: e, name: t, className: o, items: r, id: s }) {
...
function n0({ commandHandler: e, className: t, columns: o, id: r }) {
  return /* @__PURE__ */ M(
    qn,
    {
      container: !0,
...
let Cs;
const Ss = () => (Cs || (Cs = Be.allBookIds.map((e) => ({
  bookId: e,
  label: Be.bookIdToEnglishName(e)
}))), Cs);
function hb({ scrRef: e, handleSubmit: t, id: o }) {
  const r = (a) => {
    t(a);
  }, s = (a, d) => {
    const h = { bookNum: Be.bookIdToNumber(d.bookId), chapterNum: 1, verseNum: 1 };
    r(h);
  }, i = (a) => {
  ...
  return /* @__PURE__ */ xt("span", { id: o, children: [
    ...
    /* @__PURE__ */ M(wo, { onClick: () => t(Ti(e, 1)), children: ">" })
  ] });
}
function pb({ onSearch: e, placeholder: t, isFullWidth: o }) {
  const [r, s] = Rt(""), i = (n) => {
    s(n), e(n);
  };
...
const l0 = ({ onChange: e, disabled: t, checked: o, ...r }) => /* @__PURE__ */ M(
  r0,
  {
    ...r,
    isChecked: o,
...
function c0() {
  ...
  return fe.AsyncMode = a, fe.ConcurrentMode = d, fe.ContextConsumer = c, fe.ContextProvider = n, fe.Element = t, fe.ForwardRef = f, fe.Fragment = r, fe.Lazy = g, fe.Memo = m, fe.Portal = o, fe.Profiler = i, fe.StrictMode = s, fe.Suspense = h, fe.isAsyncMode = function(y) {
    return w(y) || k(y) === a;
    ...
    return typeof y == "string" || typeof y == "function" || y === r || y === d || y === i || y === s || y === h || y === p || typeof y == "object" && y !== null && (y.$$typeof === g || y.$$typeof === m || y.$$typeof === n || y.$$typeof === c || y.$$typeof === f || y.$$typeof === v || y.$$typeof === _ || y.$$typeof === x || y.$$typeof === b);
  }, fe.typeOf = k, fe;
}
var me = {};
/** @license React v16.13.1
...
function d0() {
  return bn || (bn = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function k(T) {
      ...
      T === r || T === d || T === i || T === s || T === h || T === p || typeof T == "object" && T !== null && (T.$$typeof === g || T.$$typeof === m || T.$$typeof === n || T.$$typeof === c || T.$$typeof === f || T.$$typeof === v || T.$$typeof === _ || T.$$typeof === x || T.$$typeof === b);
    }
    function w(T) {
    ...
    var y = a, E = d, V = c, j = n, P = t, S = f, X = r, K = g, xe = m, G = o, J = i, _e = s, Ie = h, Ot = !1;
    function bo(T) {
    ...
    me.AsyncMode = y, me.ConcurrentMode = E, me.ContextConsumer = V, me.ContextProvider = j, me.Element = P, me.ForwardRef = S, me.Fragment = X, me.Lazy = K, me.Memo = xe, me.Portal = G, me.Profiler = J, me.StrictMode = _e, me.Suspense = Ie, me.isAsyncMode = bo, me.isConcurrentMode = $, me.isContextConsumer = O, me.isContextProvider = ee, me.isElement = Z, me.isForwardRef = W, me.isFragment = ie, me.isLazy = Y, me.isMemo = Q, me.isPortal = ne, me.isProfiler = de, me.isStrictMode = le, me.isSuspense = Xe, me.isValidElementType = k, me.typeOf = w;
  }()), me;
}
var vn;
function Ml() {
  return vn || (vn = 1, process.env.NODE_ENV === "production" ? Or.exports = c0() : Or.exports = d0()), Or.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function p0() {
  if (kn)
    return Ts;
  kn = 1;
  var e = Ml(), t = u0(), o = vi(), r = Dl(), s = h0(), i = function() {
  };
...
if (process.env.NODE_ENV !== "production") {
  var m0 = Ml(), g0 = !0;
  Js.exports = p0()(m0.isElement, g0);
} else
  Js.exports = f0()();
var b0 = Js.exports;
const ye = /* @__PURE__ */ a0(b0);
function Po(e) {
...
function v0() {
  ...
  return ge.ContextConsumer = n, ge.ContextProvider = i, ge.Element = e, ge.ForwardRef = a, ge.Fragment = o, ge.Lazy = p, ge.Memo = h, ge.Portal = t, ge.Profiler = s, ge.StrictMode = r, ge.Suspense = d, ge.SuspenseList = f, ge.isAsyncMode = function() {
    ...
    return typeof v == "string" || typeof v == "function" || v === o || v === s || v === r || v === d || v === f || v === m || typeof v == "object" && v !== null && (v.$$typeof === p || v.$$typeof === h || v.$$typeof === i || v.$$typeof === n || v.$$typeof === a || v.$$typeof === g || v.getModuleId !== void 0);
  }, ge.typeOf = b, ge;
}
var be = {};
/**
...
function y0() {
  return $n || ($n = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function w(B) {
      return !!(typeof B == "string" || typeof B == "function" || B === o || B === s || x || B === r || B === d || B === f || _ || B === m || g || b || v || typeof B == "object" && B !== null && (B.$$typeof === p || B.$$typeof === h || B.$$typeof === i || B.$$typeof === n || B.$$typeof === a || // This needs to include all possible module reference object
    ...
    var E = n, V = i, j = e, P = a, S = o, X = p, K = h, xe = t, G = s, J = r, _e = d, Ie = f, Ot = !1, bo = !1;
    function $(B) {
      return Ot || (Ot = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 18+.")), !1;
    }
    function O(B) {
      return bo || (bo = !0, console.warn("The ReactIs.isConcurrentMode() alias has been deprecated, and will be removed in React 18+.")), !1;
    }
    function ee(B) {
      return y(B) === n;
    }
...
process.env.NODE_ENV === "production" ? Zs.exports = v0() : Zs.exports = y0();
var zn = Zs.exports;
const w0 = /^\s*function(?:\s|\s*\/\*.*\*\/\s*)+([^(\s/]*)\s*/;
function x0(e) {
  const t = `${e}`.match(w0);
  return t && t[1] || "";
}
...
function yi(e, t, o = "Mui") {
  const r = z0[t];
  return r ? `${o}-${r}` : `${$0.generate(e)}-${t}`;
}
function E0(e, t, o = "Mui") {
  const r = {};
  return t.forEach((s) => {
    r[s] = yi(e, s, o);
  }), r;
}
function A0(e, t = Number.MIN_SAFE_INTEGER, o = Number.MAX_SAFE_INTEGER) {
...
const O0 = ["values", "unit", "step"], N0 = (e) => {
...
function I0(e) {
  const {
    ...
    unit: o = "px",
    step: r = 5
  } = e, s = Ht(e, O0), i = N0(t), n = Object.keys(i);
  function c(p) {
...
const R0 = {
  borderRadius: 4
}, P0 = R0, M0 = process.env.NODE_ENV !== "production" ? ye.oneOfType([ye.number, ye.string, ye.object, ye.array]) : {}, to = M0;
function cr(e, t) {
  return t ? wt(e, t, {
    clone: !1
...
function W0(e, t, o, r) {
  if (t.indexOf(o) === -1)
    return null;
  const s = H0(o), i = j0(s, r), n = e[o];
  return Mt(e, n, i);
}
function Hl(e, t) {
  const o = Fl(e.theme);
  return Object.keys(e).map((r) => W0(e, t, r, o)).reduce(cr, {});
}
function Ee(e) {
  return Hl(e, rs);
}
...
Ae.filterProps = ss;
process.env.NODE_ENV !== "production" && U0.reduce((e, t) => (e[t] = to, e), {});
function q0(e = 8) {
  if (e.mui)
    return e;
  const t = Fl({
...
function is(...e) {
  const t = e.reduce((r, s) => (s.filterProps.forEach((i) => {
    r[i] = s;
  }), r), {}), o = (r) => Object.keys(r).reduce((s, i) => t[i] ? cr(s, t[i](r)) : s, {});
...
const K0 = vt("border", ut), X0 = vt("borderTop", ut), Y0 = vt("borderRight", ut), G0 = vt("borderBottom", ut), J0 = vt("borderLeft", ut), Z0 = vt("borderColor"), Q0 = vt("borderTopColor"), em = vt("borderRightColor"), tm = vt("borderBottomColor"), om = vt("borderLeftColor"), rm = vt("outline", ut), sm = vt("outlineColor"), ns = (e) => {
...
is(K0, X0, Y0, G0, J0, Z0, Q0, em, tm, om, ns, rm, sm);
const ls = (e) => {
...
is(ls, as, cs, im, nm, lm, am, cm, dm, um, hm, pm);
function Oo(e, t) {
  return t === "grey" ? t : e;
}
const fm = Re({
...
function $m() {
  ...
  function t(o) {
    ...
    function c(a) {
      ...
      if (!d)
        return null;
      const f = D0(i.breakpoints), h = Object.keys(f);
      let p = f;
...
const Ul = $m();
Ul.filterProps = ["sx"];
const ki = Ul, zm = ["breakpoints", "palette", "spacing", "shape"];
function Ci(e = {}, ...t) {
  const {
    breakpoints: o = {},
    palette: r = {},
...
const Im = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function Rm(e) {
  return Object.keys(e).length === 0;
}
function Pm(e) {
...
const Mm = (e, t) => t.components && t.components[e] && t.components[e].styleOverrides ? t.components[e].styleOverrides : null, qr = (e) => {
  let t = 0;
  const o = {};
...
const Bm = Ci(), In = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Mr({
  defaultTheme: e,
  theme: t,
  themeId: o
...
function Fm(e = {}) {
  ...
  return i.__mui_systemSx = !0, (n, c = {}) => {
    fa(n, (w) => w.filter((y) => !(y != null && y.__mui_systemSx)));
    const {
      name: a,
      slot: d,
      ...
      overridesResolver: p = Vm(In(d))
    } = c, m = Ht(c, Im), g = f !== void 0 ? f : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      d && d !== "Root" && d !== "root" || !1
    ), b = h || !1;
    let v;
    process.env.NODE_ENV !== "production" && a && (v = `${a}-${In(d || "Root")}`);
    let _ = Pr;
    d === "Root" || d === "root" ? _ = r : d ? _ = s : Pm(n) && (_ = void 0);
    const x = ha(n, ae({
      shouldForwardProp: _,
      label: v
    }, m)), k = (w, ...y) => {
      ...
      a && p && E.push((S) => {
        ...
        return Lm(S, Dm(a, X), X, a);
      }), b || E.push(i);
      const j = E.length - y.length;
      ...
      if (process.env.NODE_ENV !== "production") {
        let S;
        a && (S = `${a}${At(d || "")}`), S === void 0 && (S = `Styled(${_0(n)})`), P.displayName = S;
      }
      return n.muiName && (P.muiName = n.muiName), P;
    };
    return x.withConfig && (k.withConfig = x.withConfig), k;
  };
}
function Hm(e) {
  const {
...
function Wl(e, t = 0, o = 1) {
  return process.env.NODE_ENV !== "production" && (e < t || e > o) && console.error(`MUI: The value provided ${e} is out of range [${t}, ${o}].`), A0(e, t, o);
}
function jm(e) {
  e = e.slice(1);
...
The following formats are supported: #nnn, #nnnnnn, rgb(), rgba(), hsl(), hsla(), color().` : Po(9, e));
...
The following color spaces are supported: srgb, display-p3, a98-rgb, prophoto-rgb, rec-2020.` : Po(10, s));
  } else
    r = r.split(",");
...
function Pn(e) {
  e = Mo(e);
  let t = e.type === "hsl" || e.type === "hsla" ? Mo(Wm(e)).values : e.values;
...
function qm(e, t) {
  if (e = Mo(e), t = Wl(t), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - t;
...
const Ym = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, So = rg, sg = ["mode", "contrastThreshold", "tonalOffset"], Dn = {
...
function Ln(e, t, o, r) {
  ...
  e[t] || (e.hasOwnProperty(o) ? e[t] = e[o] : t === "light" ? e.light = Km(e.main, s) : t === "dark" && (e.dark = qm(e.main, i)));
}
function ig(e = "light") {
  return e === "dark" ? {
    main: ko[200],
...
function ug(e) {
  const {
    ...
    tonalOffset: r = 0.2
  } = e, s = Ht(e, sg), i = e.primary || ig(t), n = e.secondary || ng(t), c = e.error || lg(t), a = e.info || ag(t), d = e.success || cg(t), f = e.warning || dg(t);
  function h(b) {
    const v = Mn(b, Ns.text.primary) >= o ? Ns.text.primary : Dn.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const _ = Mn(b, v);
...
`));
  ...
  const p = ({
    ...
    if (b = ae({}, b), !b.main && b[_] && (b.main = b[_]), !b.hasOwnProperty("main"))
      throw new Error(process.env.NODE_ENV !== "production" ? `MUI: The color${v ? ` (${v})` : ""} provided to augmentColor(color) is invalid.
The color object needs to have a \`main\` property or a \`${_}\` property.` : Po(11, v ? ` (${v})` : "", _));
...
} });` : Po(12, v ? ` (${v})` : "", JSON.stringify(b.main)));
    return Ln(b, "light", x, r), Ln(b, "dark", k, r), b.contrastText || (b.contrastText = h(b.main)), b;
  }, m = {
    dark: Ns,
    light: Dn
  };
...
const hg = ["fontFamily", "fontSize", "fontWeightLight", "fontWeightRegular", "fontWeightMedium", "fontWeightBold", "htmlFontSize", "allVariants", "pxToRem"];
function pg(e) {
...
function fg(e, t) {
  ...
  const m = s / 14, g = h || ((_) => `${_ / d * m}rem`), b = (_, x, k, w, y) => ae({
    fontFamily: r,
    fontWeight: _,
    fontSize: g(x),
...
const mg = 0.2, gg = 0.14, bg = 0.12;
function ke(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${mg})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${gg})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${bg})`].join(",");
}
const vg = ["none", ke(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), ke(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), ke(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), ke(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), ke(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), ke(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), ke(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), ke(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), ke(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), ke(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), ke(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), ke(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), ke(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), ke(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), ke(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), ke(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), ke(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), ke(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), ke(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), ke(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), ke(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), ke(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), ke(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), ke(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], yg = vg, wg = ["duration", "easing", "delay"], xg = {
...
function Cg(e) {
  const t = ae({}, xg, e.easing), o = ae({}, _g, e.duration);
  return ae({
...
const Sg = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, $g = Sg, zg = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function Eg(e = {}, ...t) {
  const {
    mixins: o = {},
    palette: r = {},
...
const Og = (e) => Pr(e) && e !== "classes", Ng = Fm({
  themeId: Kl,
  defaultTheme: ql,
  rootShouldForwardProp: Og
}), Ig = Ng;
function Rg(e) {
...
const Pg = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Mg = (e) => {
  const {
    color: t,
    fontSize: o,
    classes: r
  ...
  const r = Tg({
    ...
    titleAccess: h,
    viewBox: p = "0 0 24 24"
  } = r, m = Ht(r, Pg), g = /* @__PURE__ */ N.isValidElement(s) && s.type === "svg", b = ae({}, r, {
    color: n,
    component: c,
    fontSize: a,
  ...
  f || (v.viewBox = p);
  const _ = Mg(b);
  return /* @__PURE__ */ xt(Dg, ae({
    as: c,
    className: T0(_.root, i),
    focusable: "false",
    color: d,
...
function vb({
  ...
  let v = e;
  return !v && t && (v = t(a)), /* @__PURE__ */ M("div", { ref: p, style: { position: "relative" }, children: /* @__PURE__ */ M(la, { position: "static", id: s, children: /* @__PURE__ */ xt(aa, { className: `papi-toolbar ${r ?? ""}`, variant: "dense", children: [
    v ? /* @__PURE__ */ M(
      Kn,
      {
        edge: "start",
    ...
    v ? /* @__PURE__ */ M(
      ca,
      {
        ...
        children: /* @__PURE__ */ M(n0, { commandHandler: b, columns: v.columns })
      }
    ) : void 0
  ] }) }) });
}
...
`, "top");
export {
  cb as BookChapterControl,
  wo as Button,
  db as ChapterRangeSelector,
  r0 as Checkbox,
  Gs as ComboBox,
  n0 as GridMenu,
  ub as IconButton,
