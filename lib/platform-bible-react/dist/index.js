import { jsxs as Xe, jsx as E, Fragment as Xo } from "react/jsx-runtime";
import { MenuItem as qn, ListItemIcon as Ni, ListItemText as Ka, TextField as ri, Menu as Ya, ListSubheader as Xa, Divider as Ga, Button as Ja, Autocomplete as Qa, FormControlLabel as Ii, FormLabel as Za, Checkbox as el, Grid as Kn, IconButton as Yn, Paper as tl, Slider as rl, Snackbar as ol, Switch as sl, AppBar as il, Toolbar as nl, Drawer as al } from "@mui/material";
import * as I from "react";
import { useCallback as Tt, useState as ft, useMemo as oi, useRef as Ls, useEffect as Go } from "react";
import { getChaptersForBook as si, offsetBook as Ri, FIRST_SCR_BOOK_NUM as ll, offsetChapter as Pi, FIRST_SCR_CHAPTER_NUM as cl, offsetVerse as Mi, FIRST_SCR_VERSE_NUM as dl } from "platform-bible-utils";
import ul, { ThemeContext as hl, internal_processStyles as pl } from "@mui/styled-engine";
import fl, { SelectColumn as ml } from "react-data-grid";
var Ds = "";
function Bs(e) {
  Ds = e;
}
...
var Xn = Object.defineProperty, bl = Object.defineProperties, vl = Object.getOwnPropertyDescriptor, yl = Object.getOwnPropertyDescriptors, Li = Object.getOwnPropertySymbols, wl = Object.prototype.hasOwnProperty, xl = Object.prototype.propertyIsEnumerable, ps = (e, t) => (t = Symbol[e]) ? t : Symbol.for("Symbol." + e), Di = (e, t, r) => t in e ? Xn(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, Dt = (e, t) => {
  for (var r in t || (t = {}))
    wl.call(t, r) && Di(e, r, t[r]);
  if (Li)
    for (var r of Li(t))
      xl.call(t, r) && Di(e, r, t[r]);
  return e;
}, mo = (e, t) => bl(e, yl(t)), a = (e, t, r, o) => {
  for (var s = o > 1 ? void 0 : o ? vl(t, r) : t, i = e.length - 1, n; i >= 0; i--)
...
}, Cl = Object.defineProperty, Sl = (e, t, r) => t in e ? Cl(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, ee = (e, t, r) => (Sl(e, typeof t != "symbol" ? t + "" : t, r), r);
const nr = [
  "GEN",
  "EXO",
  "LEV",
...
function Fl() {
  if (Yi)
    return vs;
  Yi = 1;
  var e = oa(), t = Bl(), r = li(), o = sa(), s = Vl(), i = function() {
  };
    ...
    function H(S) {
      ...
      function O(Q, G, W, ie, X) {
        for (var J = Q[G], ne = 0; ne < S.length; ne++)
          if (g(J, S[ne]))
            return null;
        var ue = JSON.stringify(S, function(Ye, T) {
          var ht = Re(T);
    ...
    function M(S) {
      ...
      function G(W, ie, X, J, ne) {
        for (var ue = [], ae = 0; ae < S.length; ae++) {
          var Ye = S[ae], T = Ye(W, ie, X, J, ne, r);
          if (T == null)
            return null;
...
if (process.env.NODE_ENV !== "production") {
  var Ul = oa(), jl = !0;
  Vs.exports = Fl()(Ul.isElement, jl);
} else
  Vs.exports = Hl()();
var Wl = Vs.exports;
const we = /* @__PURE__ */ Ml(Wl);
function Or(e) {
...
function ci(e, t, r = "Mui") {
  const o = tc[t];
  return o ? `${r}-${o}` : `${ec.generate(e)}-${t}`;
}
function rc(e, t, r = "Mui") {
  const o = {};
  return t.forEach((s) => {
    o[s] = ci(e, s, r);
  }), o;
...
const ic = ["values", "unit", "step"], nc = (e) => {
...
function ac(e) {
  const {
    ...
    unit: r = "px",
    step: o = 5
  } = e, s = Ot(e, ic), i = nc(t), n = Object.keys(i);
  function c(p) {
...
const lc = {
  borderRadius: 4
}, cc = lc, dc = process.env.NODE_ENV !== "production" ? we.oneOfType([we.number, we.string, we.object, we.array]) : {}, Jt = dc;
function eo(e, t) {
  return t ? Pt(e, t, {
    clone: !1
...
function yc(e, t, r, o) {
  if (t.indexOf(r) === -1)
    return null;
  const s = gc(r), i = vc(s, o), n = e[r];
  return Mt(e, n, i);
}
function ca(e, t) {
  const r = la(e.theme);
  return Object.keys(e).map((o) => yc(e, t, o, r)).reduce(eo, {});
}
function Ae(e) {
  return ca(e, Qo);
}
...
Te.filterProps = Zo;
process.env.NODE_ENV !== "production" && bc.reduce((e, t) => (e[t] = Jt, e), {});
function wc(e = 8) {
  if (e.mui)
    return e;
  const t = la({
...
const xc = gt("border", pt), _c = gt("borderTop", pt), kc = gt("borderRight", pt), Cc = gt("borderBottom", pt), Sc = gt("borderLeft", pt), $c = gt("borderColor"), Ec = gt("borderTopColor"), zc = gt("borderRightColor"), Ac = gt("borderBottomColor"), Tc = gt("borderLeftColor"), Oc = gt("outline", pt), Nc = gt("outlineColor"), ts = (e) => {
...
es(xc, _c, kc, Cc, Sc, $c, Ec, zc, Ac, Tc, ts, Oc, Nc);
const rs = (e) => {
...
es(rs, os, ss, Ic, Rc, Pc, Mc, Lc, Dc, Bc, Vc, Fc);
function zr(e, t) {
  return t === "grey" ? t : e;
}
const Hc = Pe({
...
function ed() {
  ...
  function t(r) {
    ...
    function c(l) {
      ...
      if (!d)
        return null;
      const f = uc(i.breakpoints), h = Object.keys(f);
      let p = f;
...
function fi(e = {}, ...t) {
  ...
  return d.applyStyles = td, d = t.reduce((f, h) => Pt(f, h), d), d.unstable_sxConfig = Z({}, hi, n == null ? void 0 : n.unstable_sxConfig), d.unstable_sx = function(h) {
    return pi({
      sx: h,
      theme: this
    });
...
const ad = ["ownerState"], ld = ["variants"], cd = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function dd(e) {
  return Object.keys(e).length === 0;
}
function ud(e) {
...
const hd = fi(), on = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function zo({
  defaultTheme: e,
  theme: t,
  themeId: r
...
function fd(e = {}) {
  ...
  return i.__mui_systemSx = !0, (n, c = {}) => {
    pl(n, (y) => y.filter(($) => !($ != null && $.__mui_systemSx)));
    const {
      name: l,
      slot: d,
      ...
      overridesResolver: p = pd(on(d))
    } = c, m = Ot(c, cd), g = f !== void 0 ? f : (
    ...
    let x = Po;
    d === "Root" || d === "root" ? x = o : d ? x = s : ud(n) && (x = void 0);
    const _ = ul(n, Z({
      shouldForwardProp: x,
      label: b
      ...
      if (process.env.NODE_ENV !== "production") {
        let Y;
        l && (Y = `${l}${ar(d || "")}`), Y === void 0 && (Y = `Styled(${Gl(n)})`), N.displayName = Y;
      }
...
function ua(e, t = 0, r = 1) {
  return process.env.NODE_ENV !== "production" && (e < t || e > r) && console.error(`MUI: The value provided ${e} is out of range [${t}, ${r}].`), oc(e, t, r);
}
function bd(e) {
  e = e.slice(1);
...
function sn(e) {
  e = Nr(e);
  let t = e.type === "hsl" || e.type === "hsla" ? Nr(vd(e)).values : e.values;
...
const _d = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, xr = Td, Od = ["mode", "contrastThreshold", "tonalOffset"], an = {
...
function ln(e, t, r, o) {
  ...
  e[t] || (e.hasOwnProperty(r) ? e[t] = e[r] : t === "light" ? e.light = wd(e.main, s) : t === "dark" && (e.dark = yd(e.main, i)));
}
function Nd(e = "light") {
  return e === "dark" ? {
    main: yr[200],
...
function Dd(e) {
  const {
    ...
    tonalOffset: o = 0.2
  } = e, s = Ot(e, Od), i = e.primary || Nd(t), n = e.secondary || Id(t), c = e.error || Rd(t), l = e.info || Pd(t), d = e.success || Md(t), f = e.warning || Ld(t);
  function h(v) {
...
const Bd = ["fontFamily", "fontSize", "fontWeightLight", "fontWeightRegular", "fontWeightMedium", "fontWeightBold", "htmlFontSize", "allVariants", "pxToRem"];
function Vd(e) {
...
const Hd = 0.2, Ud = 0.14, jd = 0.12;
function Ce(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${Hd})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${Ud})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${jd})`].join(",");
}
const Wd = ["none", Ce(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), Ce(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), Ce(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), Ce(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), Ce(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), Ce(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), Ce(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), Ce(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), Ce(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), Ce(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), Ce(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), Ce(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), Ce(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), Ce(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), Ce(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), Ce(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), Ce(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), Ce(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), Ce(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), Ce(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), Ce(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), Ce(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), Ce(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), Ce(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], qd = Wd, Kd = ["duration", "easing", "delay"], Yd = {
...
function Jd(e) {
  const t = Z({}, Yd, e.easing), r = Z({}, Xd, e.duration);
  return Z({
    getAutoHeightDuration: Gd,
    create: (s = ["all"], i = {}) => {
      const {
...
const Qd = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, Zd = Qd, eu = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function tu(e = {}, ...t) {
  const {
    mixins: r = {},
    palette: o = {},
...
const su = (e) => Po(e) && e !== "classes", iu = fd({
  themeId: pa,
  defaultTheme: ha,
...
rc("MuiSvgIcon", ["root", "colorPrimary", "colorSecondary", "colorAction", "colorError", "colorDisabled", "fontSizeInherit", "fontSizeSmall", "fontSizeMedium", "fontSizeLarge"]);
const lu = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], cu = (e) => {
  const {
    color: t,
    fontSize: r,
    classes: o
  ...
  const o = ou({
    ...
    titleAccess: h,
    viewBox: p = "0 0 24 24"
  } = o, m = Ot(o, lu), g = /* @__PURE__ */ I.isValidElement(s) && s.type === "svg", v = Z({}, o, {
    color: n,
    component: c,
    fontSize: l,
  ...
  f || (b.viewBox = p);
  const x = cu(v);
  return /* @__PURE__ */ Xe(du, Z({
    as: c,
    className: sc(x.root, i),
    focusable: "false",
    color: d,
...
const uu = is(/* @__PURE__ */ E("path", {
  d: "M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9m-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8z"
}), "History"), hu = is(/* @__PURE__ */ E("path", {
  d: "M7.41 15.41 12 10.83l4.59 4.58L18 14l-6-6-6 6z"
}), "KeyboardArrowUp"), pu = is(/* @__PURE__ */ E("path", {
  d: "M3 18h18v-2H3zm0-5h18v-2H3zm0-7v2h18V6z"
}), "Menu"), fu = is(/* @__PURE__ */ E("path", {
...
function mu({
  ...
  return /* @__PURE__ */ Xe("div", { children: [
    /* @__PURE__ */ Xe(
      qn,
      {
        value: e,
        ...
        children: [
          ...
          /* @__PURE__ */ E(Ka, { children: ce.bookIdToEnglishName(e) }),
          r ? /* @__PURE__ */ E(hu, {}) : void 0
        ]
      },
      e
    ),
...
function gu({
  ...
  return /* @__PURE__ */ E(
    ri,
    {
      ...
      onClick: t,
      InputProps: {
        startAdornment: /* @__PURE__ */ E(fu, { fontSize: "small" }),
        endAdornment: /* @__PURE__ */ E(uu, { fontSize: "small" })
      }
    }
  );
}
function bu({ endChapter: e, activeChapter: t, handleSelectChapter: r }) {
...
function ab({ scrRef: e, handleSubmit: t }) {
  ...
  return /* @__PURE__ */ Xe(Xo, { children: [
    /* @__PURE__ */ E(
      gu,
      {
        value: n,
    ...
    /* @__PURE__ */ E("div", { className: "book-chapter-menu", children: /* @__PURE__ */ E(
      Ya,
      {
        ...
        children: yu.map((b) => /* @__PURE__ */ Xe("div", { children: [
          /* @__PURE__ */ E(Xa, { children: vu[b] }),
          ...
          b === "OT" || b === "NT" ? /* @__PURE__ */ E(Ga, {}) : void 0
        ] }, b))
      }
    ) })
  ] });
...
const wu = (e) => new fa(typeof e == "string" ? e : e + "", void 0, vi), D = (e, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: _u, defineProperty: ku, getOwnPropertyDescriptor: Cu, getOwnPropertyNames: Su, getOwnPropertySymbols: $u, getPrototypeOf: Eu } = Object, qt = globalThis, mn = qt.trustedTypes, zu = mn ? mn.emptyScript : "", xs = qt.reactiveElementPolyfillSupport, to = (e, t) => e, Ir = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? zu : null;
      break;
  ...
  return r;
} }, yi = (e, t) => !_u(e, t), gn = { attribute: !0, type: String, converter: Ir, reflect: !1, hasChanged: yi };
...
class Sr extends HTMLElement {
  ...
  static createProperty(t, r = gn) {
    if (r.state && (r.attribute = !1), this._$Ei(), this.elementProperties.set(t, r), !r.noAccessor) {
      ...
      s !== void 0 && ku(this.prototype, t, s);
    }
  }
  static getPropertyDescriptor(t, r, o) {
    const { get: s, set: i } = Cu(this.prototype, t) ?? { get() {
      return this[r];
    }, set(n) {
      this[r] = n;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(to("properties"))) {
      const r = this.properties, o = [...Su(r), ...$u(r)];
      for (const s of o)
  ...
  createRenderRoot() {
    ...
    return xu(t, this.constructor.elementStyles), t;
  }
  connectedCallback() {
    var t;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ro = globalThis, Fo = ro.trustedTypes, bn = Fo ? Fo.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, ma = "$lit$", jt = `lit$${(Math.random() + "").slice(9)}$`, ga = "?" + jt, Au = `<${ga}>`, lr = document, uo = () => lr.createComment(""), ho = (e) => e === null || typeof e != "object" && typeof e != "function", ba = Array.isArray, Tu = (e) => ba(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", _s = `[ 	
\f\r]`, Kr = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, vn = /-->/g, yn = />/g, tr = RegExp(`>|${_s}(?:([^\\s"'>=/]+)(${_s}*=${_s}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), wn = /'/g, xn = /"/g, va = /^(?:script|style|textarea|title)$/i, Ou = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r }), C = Ou(1), ct = Symbol.for("lit-noChange"), Se = Symbol.for("lit-nothing"), _n = /* @__PURE__ */ new WeakMap(), sr = lr.createTreeWalker(lr, 129);
function ya(e, t) {
...
const Nu = (e, t) => {
  ...
  for (let c = 0; c < r; c++) {
    ...
    i += n === Kr ? l + Au : h >= 0 ? (o.push(d), l.slice(0, h) + ma + l.slice(h) + jt + m) : l + jt + (h === -2 ? c : m);
  }
...
class po {
  constructor({ strings: t, _$litType$: r }, o) {
    ...
    this.parts = [];
    let i = 0, n = 0;
    const c = t.length - 1, l = this.parts, [d, f] = Nu(t, r);
        ...
        if (s.hasAttributes())
          for (const h of s.getAttributeNames())
            if (h.endsWith(ma)) {
              ...
              l.push({ type: 1, index: i, name: g[2], strings: m, ctor: g[1] === "." ? Ru : g[1] === "?" ? Pu : g[1] === "@" ? Mu : ns }), s.removeAttribute(h);
            } else
...
class Iu {
  ...
  u(t) {
    ...
    for (; l !== void 0; ) {
      if (n === l.index) {
        let d;
        l.type === 2 ? d = new vo(i, i.nextSibling, this, t) : l.type === 1 ? d = new l.ctor(i, l.name, l.strings, this, t) : l.type === 6 && (d = new Lu(i, this, t)), this._$AV.push(d), l = o[++c];
      }
...
class vo {
  ...
  _$AI(t, r = this) {
    t = Rr(this, t, r), ho(t) ? t === Se || t == null || t === "" ? (this._$AH !== Se && this._$AR(), this._$AH = Se) : t !== this._$AH && t !== ct && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Tu(t) ? this.k(t) : this._(t);
  }
  S(t) {
  ...
  $(t) {
    ...
    if (((i = this._$AH) == null ? void 0 : i._$AD) === s)
      ...
      const n = new Iu(s, this), c = n.u(this.options);
...
let oo = class extends Sr {
  ...
  update(t) {
    const r = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = Du(r, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var t;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Vu = { attribute: !0, type: String, converter: Ir, reflect: !1, hasChanged: yi }, Fu = (e = Vu, t, r) => {
...
function u(e) {
  return (t, r) => typeof r == "object" ? Fu(e, t, r) : ((o, s, i) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Uu = /* @__PURE__ */ new Set(["children", "localName", "ref", "style", "className"]), kn = /* @__PURE__ */ new WeakMap(), ju = (e, t, r, o, s) => {
  ...
  const i = new Set(Object.keys(o ?? {})), n = e.forwardRef((c, l) => {
    ...
    for (const [m, g] of Object.entries(c))
      Uu.has(m) ? h[m === "className" ? "class" : m] = g : i.has(m) || m in r.prototype ? p[m] = g : h[m] = g;
    return e.useLayoutEffect(() => {
      if (f.current !== null) {
        for (const m in p)
          ju(f.current, m, c[m], d.current ? d.current[m] : void 0, o);
        d.current = c;
      }
    }), e.useLayoutEffect(() => {
      var m;
...
var Ju = {
  name: "default",
  resolver: (e) => gl(`assets/icons/${e}.svg`)
}, Qu = Ju, Cn = {
  caret: `
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ih = (e, t) => t === void 0 ? (e == null ? void 0 : e._$litType$) !== void 0 : (e == null ? void 0 : e._$litType$) === t, wa = (e) => e.strings === void 0, nh = {}, ah = (e, t = nh) => e._$AH = t;
var Jr = Symbol(), To = Symbol(), $s, Es = /* @__PURE__ */ new Map(), xe = class extends R {
  ...
  connectedCallback() {
    super.connectedCallback(), rh(this);
  }
  firstUpdated() {
    this.initialRender = !0, this.setIcon();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), oh(this);
  }
  getIconSource() {
...
`;
const js = /* @__PURE__ */ new Set(), ch = new MutationObserver(Ca), Er = /* @__PURE__ */ new Map();
let xa = document.documentElement.dir || "ltr", _a = document.documentElement.lang || navigator.language, or;
ch.observe(document.documentElement, {
  attributes: !0,
...
Lr.styles = [V, lh];
var $a = /* @__PURE__ */ new Map(), hh = /* @__PURE__ */ new WeakMap();
function ph(e) {
...
})(o) + e[s + 1], e[0]), r: Ea }), An = /* @__PURE__ */ new Map(), wh = (e) => (t, ...r) => {
  const o = r.length;
  let s, i;
  const n = [], c = [];
  let l, d = 0, f = !1;
  for (; d < o; ) {
    for (l = t[d]; d < o && (i = r[d], (s = yh(i)) !== void 0); )
      l += s + t[++d], f = !0;
...
var xh = 0, kt = class extends R {
  constructor() {
    super(...arguments), this.localize = new he(this), this.attrId = ++xh, this.componentId = `sl-tab-${this.attrId}`, this.panel = "", this.active = !1, this.closable = !1, this.disabled = !1;
  }
  connectedCallback() {
...
`, Ch = 0, Br = class extends R {
  constructor() {
    super(...arguments), this.attrId = ++Ch, this.componentId = `sl-tab-panel-${this.attrId}`, this.name = "", this.active = !1;
  }
  connectedCallback() {
...
function Ys(e, t, r = "vertical", o = "smooth") {
  const s = Eh(e, t), i = s.top + t.scrollTop, n = s.left + t.scrollLeft, c = t.scrollLeft, l = t.scrollLeft + t.offsetWidth, d = t.scrollTop, f = t.scrollTop + t.offsetHeight;
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((r = i.arrow) != null && r.alignmentOffset)
        return {};
      const x = Xt(s), _ = Xt(c) === c, k = await (l.isRTL == null ? void 0 : l.isRTL(d.floating)), w = p || (_ || !v ? [Wo(c)] : Lh(c));
      !p && g !== "none" && w.push(...Bh(c, v, g, k));
...
const Gh = /* @__PURE__ */ Yt(0);
function Ia(e) {
  const t = dt(e);
  return !Si() || !t.visualViewport ? Gh : {
...
function ip(e) {
  ...
  const n = [...r === "clippingAncestors" ? sp(t, this._c) : [].concat(r), o], c = n[0], l = n.reduce((d, f) => {
    const h = Nn(t, f, s);
...
function La(e, t) {
  ...
  if (!Nt(e) || Ra(e))
    return r;
  let o = In(e, t);
  for (; o && Yh(o) && mt(o).position === "static"; )
    o = In(o, t);
  return o && (Gt(o) === "html" || Gt(o) === "body" && mt(o).position === "static" && !Ci(o)) ? r : o || Xh(e) || r;
}
...
const hp = qh, pp = Uh, Rn = Kh, fp = Hh, mp = (e, t, r) => {
...
var pe = class extends R {
  ...
  async handleAnchorChange() {
    if (await this.stop(), this.anchor && typeof this.anchor == "string") {
      ...
      this.anchor instanceof Element || vp(this.anchor) ? this.anchorEl = this.anchor : this.anchorEl = this.querySelector('[slot="anchor"]');
  ...
  start() {
    this.anchorEl && (this.cleanup = up(this.anchorEl, this.popup, () => {
      this.reposition();
    }));
  }
  async stop() {
  ...
  reposition() {
    ...
    const e = [
      ...
      Wh({ mainAxis: this.distance, crossAxis: this.skidding })
    ];
    this.sync ? e.push(
      Rn({
        apply: ({ rects: r }) => {
    ...
    const t = this.strategy === "absolute" ? (r) => Do.getOffsetParent(r, gp) : Do.getOffsetParent;
    mp(this.anchorEl, this.popup, {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Da = "important", Ap = " !" + Da, Ze = yo(class extends wo {
  constructor(e) {
    var t;
  ...
  update(e, [t]) {
    ...
    for (const o in t) {
      ...
      if (s != null) {
        this.ft.add(o);
        const i = typeof s == "string" && s.endsWith(Ap);
...
var Op = [
  ...
  render() {
    ...
    const r = t.getTime() - e.getTime(), { unit: o, value: s } = Op.find((i) => Math.abs(r) < i.max);
...
var Ue = class extends R {
  ...
  get validity() {
    ...
    return this.customValidityMessage !== "" ? Xu : e ? Yu : ls;
  }
  /** Gets the validation message */
  get validationMessage() {
    const e = this.required && !this.value;
...
var pr = class extends R {
  ...
  async handleSrcChange() {
    try {
      const e = this.src, t = await df(e, this.mode);
      if (e !== this.src)
        return;
      if (!t.ok) {
...
const xf = (e) => {
  e.type == At.CHILD && (e._$AP ?? (e._$AP = wf), e._$AQ ?? (e._$AQ = yf));
};
class _f extends wo {
  constructor() {
...
const Ts = /* @__PURE__ */ new WeakMap(), Sf = yo(class extends _f {
  render(e) {
    return Se;
  }
  update(e, [t]) {
...
var $f = class {
  constructor(e, t, r) {
    this.popupRef = kf(), this.enableSubmenuTimer = -1, this.isConnected = !1, this.isPopupConnected = !1, this.skidding = 0, this.submenuOpenDelay = 100, this.handleMouseMove = (o) => {
  ...
  constructor() {
    super(...arguments), this.type = "normal", this.checked = !1, this.value = "", this.loading = !1, this.disabled = !1, this.localize = new he(this), this.hasSlotController = new Je(this, "submenu"), this.submenuController = new $f(this, this.hasSlotController, this.localize), this.handleHostClick = (e) => {
...
function Vf(e) {
  const t = Ua(e), { overflowY: r, overflowX: o } = t;
...
function* zi(e = document.activeElement) {
  e != null && (yield e, "shadowRoot" in e && e.shadowRoot && e.shadowRoot.mode !== "closed" && (yield* kl(zi(e.shadowRoot.activeElement))));
}
function jf() {
  return [...zi()].pop();
}
...
var ot = class extends R {
  constructor() {
    super(...arguments), this.hasSlotController = new Je(this, "footer"), this.localize = new he(this), this.modal = new ja(this), this.open = !1, this.label = "", this.placement = "end", this.contained = !1, this.noHeader = !1, this.handleDocumentKeyDown = (e) => {
...
`, $t = class extends R {
  constructor() {
    super(...arguments), this.hasSlotController = new Je(this, "footer"), this.localize = new he(this), this.modal = new ja(this), this.open = !1, this.label = "", this.noHeader = !1, this.handleDocumentKeyDown = (e) => {
...
function k0(e) {
  ...
  return typeof e == "string" && (e = $0(e)), typeof e == "object" && (Rt(e.r) && Rt(e.g) && Rt(e.b) ? (t = b0(e.r, e.g, e.b), n = !0, c = String(e.r).substr(-1) === "%" ? "prgb" : "rgb") : Rt(e.h) && Rt(e.s) && Rt(e.v) ? (o = Ro(e.s), s = Ro(e.v), t = y0(e.h, o, s), n = !0, c = "hsv") : Rt(e.h) && Rt(e.s) && Rt(e.l) && (o = Ro(e.s), i = Ro(e.l), t = v0(e.h, o, i), n = !0, c = "hsl"), Object.prototype.hasOwnProperty.call(e, "a") && (r = e.a)), r = Wa(r), {
    ok: n,
    format: e.format || c,
...
class Oe {
   ...
   */
  setAlpha(t) {
    return this.a = Wa(t), this.roundA = Math.round(100 * this.a) / 100, this;
  }
  /**
...
`, He = class extends R {
  ...
  async createAnimation() {
    var e, t;
    const r = (e = qa[this.easing]) != null ? e : this.easing, o = (t = this.keyframes) != null ? t : zg[this.name], i = (await this.defaultSlot).assignedElements()[0];
...
function fb({ scrRef: e, handleSubmit: t }) {
  const { allBookIds: r } = ce, o = Tt(
    (b) => ({
      OT: r.filter((_) => ce.isBookOT(_)),
      NT: r.filter((_) => ce.isBookNT(_)),
  ...
  return /* @__PURE__ */ Xe(Xo, { children: [
    ...
    /* @__PURE__ */ E("div", { className: "book-chapter-menu", children: l && /* @__PURE__ */ E(
      bf,
      {
        ...
        children: jg.map((b) => /* @__PURE__ */ Xe("div", { children: [
          /* @__PURE__ */ E(If, { children: Ug[b] }),
          f(b).map((x) => /* @__PURE__ */ E("div", { children: /* @__PURE__ */ E(
            Vg,
            {
              bookId: x,
...
function Kg({ commandHandler: e, name: t, className: r, items: o, id: s }) {
  return /* @__PURE__ */ Xe(Kn, { id: s, item: !0, xs: "auto", className: `papi-menu-column ${r ?? ""}`, children: [
...
function Yg({ commandHandler: e, className: t, columns: r, id: o }) {
  return /* @__PURE__ */ E(
    Kn,
    {
      container: !0,
...
function bb({ scrRef: e, handleSubmit: t, id: r }) {
  const o = (l) => {
    t(l);
  }, s = (l, d) => {
  ...
  return /* @__PURE__ */ Xe("span", { id: r, children: [
    /* @__PURE__ */ E(
      ti,
      {
        title: "Book",
...
function vb({ onSearch: e, placeholder: t, isFullWidth: r }) {
  const [o, s] = ft(""), i = (n) => {
    s(n), e(n);
  };
  return /* @__PURE__ */ E(tl, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ E(
    Yo,
    {
      isFullWidth: r,
...
const Xg = ({ onChange: e, disabled: t, checked: r, ...o }) => /* @__PURE__ */ E(
  Wg,
  {
    ...o,
    isChecked: r,
...
function kb({
  ...
  let b = e;
  return !b && t && (b = t(l)), /* @__PURE__ */ E("div", { ref: p, style: { position: "relative" }, children: /* @__PURE__ */ E(il, { position: "static", id: s, children: /* @__PURE__ */ Xe(nl, { className: `papi-toolbar ${o ?? ""}`, variant: "dense", children: [
    b ? /* @__PURE__ */ E(
      Yn,
      {
        edge: "start",
    ...
    b ? /* @__PURE__ */ E(
      al,
      {
        ...
        children: /* @__PURE__ */ E(Yg, { commandHandler: v, columns: b.columns })
      }
    ) : void 0
  ] }) }) });
}
...
`, "top");
export {
  fb as BookChapterControl,
  kr as Button,
  mb as ChapterRangeSelector,
  Wg as Checkbox,
  ti as ComboBox,
  Yg as GridMenu,
  gb as IconButton,
