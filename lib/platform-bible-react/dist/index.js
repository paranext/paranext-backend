import { jsxs as wt, jsx as D, Fragment as Yl } from "react/jsx-runtime";
import * as I from "react";
import { useState as no, useMemo as Qs, useCallback as Or, useRef as Rs, useEffect as Yr } from "react";
import { getChaptersForBook as jn, offsetBook as Ei, FIRST_SCR_BOOK_NUM as Xl, offsetChapter as Ai, FIRST_SCR_CHAPTER_NUM as Gl, offsetVerse as Ti, FIRST_SCR_VERSE_NUM as Jl } from "platform-bible-utils";
...
var Yn = Object.defineProperty, ga = Object.defineProperties, ba = Object.getOwnPropertyDescriptor, va = Object.getOwnPropertyDescriptors, Ii = Object.getOwnPropertySymbols, ya = Object.prototype.hasOwnProperty, wa = Object.prototype.propertyIsEnumerable, ds = (e, t) => (t = Symbol[e]) ? t : Symbol.for("Symbol." + e), Ni = (e, t, o) => t in e ? Yn(e, t, { enumerable: !0, configurable: !0, writable: !0, value: o }) : e[t] = o, Mt = (e, t) => {
  for (var o in t || (t = {}))
    ya.call(t, o) && Ni(e, o, t[o]);
  if (Ii)
    for (var o of Ii(t))
      wa.call(t, o) && Ni(e, o, t[o]);
  return e;
}, pr = (e, t) => ga(e, va(t)), l = (e, t, o, r) => {
  for (var s = r > 1 ? void 0 : r ? ba(t, o) : t, i = e.length - 1, n; i >= 0; i--)
    (n = e[i]) && (s = (r ? n(t, o, s) : n(s)) || s);
  return r && s && Yn(t, o, s), s;
}, xa = function(e, t) {
  this[0] = e, this[1] = t;
}, _a = (e) => {
 ...
 */
const Ir = globalThis, ei = Ir.ShadowRoot && (Ir.ShadyCSS === void 0 || Ir.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ti = Symbol(), Ri = /* @__PURE__ */ new WeakMap();
let Xn = class {
  constructor(t, o, r) {
...
const ka = (e) => new Xn(typeof e == "string" ? e : e + "", void 0, ti), L = (e, ...t) => {
  ...
  return new Xn(o, e, ti);
}, Ca = (e, t) => {
  if (ei)
    e.adoptedStyleSheets = t.map((o) => o instanceof CSSStyleSheet ? o : o.styleSheet);
  else
    for (const o of t) {
      const r = document.createElement("style"), s = Ir.litNonce;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Sa, defineProperty: $a, getOwnPropertyDescriptor: za, getOwnPropertyNames: Ea, getOwnPropertySymbols: Aa, getPrototypeOf: Ta } = Object, qt = globalThis, Mi = qt.trustedTypes, Oa = Mi ? Mi.emptyScript : "", us = qt.reactiveElementPolyfillSupport, er = (e, t) => e, Oo = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Oa : null;
      break;
...
So.elementStyles = [], So.shadowRootOptions = { mode: "open" }, So[er("elementProperties")] = /* @__PURE__ */ new Map(), So[er("finalized")] = /* @__PURE__ */ new Map(), us == null || us({ ReactiveElement: So }), (qt.reactiveElementVersions ?? (qt.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const tr = globalThis, Dr = tr.trustedTypes, Li = Dr ? Dr.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Gn = "$lit$", Ut = `lit$${(Math.random() + "").slice(9)}$`, Jn = "?" + Ut, Ia = `<${Jn}>`, lo = document, cr = () => lo.createComment(""), dr = (e) => e === null || typeof e != "object" && typeof e != "function", Zn = Array.isArray, Na = (e) => Zn(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", hs = `[ 	
\f\r]`, Wo = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Bi = /-->/g, Vi = />/g, to = RegExp(`>|${hs}(?:([^\\s"'>=/]+)(${hs}*=${hs}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Fi = /'/g, Hi = /"/g, Qn = /^(?:script|style|textarea|title)$/i, Ra = (e) => (t, ...o) => ({ _$litType$: e, strings: t, values: o }), C = Ra(1), nt = Symbol.for("lit-noChange"), Ce = Symbol.for("lit-nothing"), Ui = /* @__PURE__ */ new WeakMap(), so = lo.createTreeWalker(lo, 129);
function el(e, t) {
...
const Pa = (e, t) => {
  ...
  for (let c = 0; c < o; c++) {
    ...
    for (; p < a.length && (n.lastIndex = p, f = n.exec(a), f !== null); )
      p = n.lastIndex, n === Wo ? f[1] === "!--" ? n = Bi : f[1] !== void 0 ? n = Vi : f[2] !== void 0 ? (Qn.test(f[2]) && (s = RegExp("</" + f[2], "g")), n = to) : f[3] !== void 0 && (n = to) : n === to ? f[0] === ">" ? (n = s ?? Wo, h = -1) : f[1] === void 0 ? h = -2 : (h = n.lastIndex - f[2].length, d = f[1], n = f[3] === void 0 ? to : f[3] === '"' ? Hi : Fi) : n === Hi || n === Fi ? n = to : n === Bi || n === Vi ? n = Wo : (n = to, s = void 0);
    const m = n === to && e[c + 1].startsWith("/>") ? " " : "";
    i += n === Wo ? a + Ia : h >= 0 ? (r.push(d), a.slice(0, h) + Gn + a.slice(h) + Ut + m) : a + Ut + (h === -2 ? c : m);
  }
...
let Ds = class tl {
  constructor({ strings: t, _$litType$: o }, r) {
    ...
    if (this.el = tl.createElement(d, r), so.currentNode = this.el.content, o === 2) {
      const h = this.el.content.firstChild;
      h.replaceWith(...h.childNodes);
    }
    for (; (s = so.nextNode()) !== null && a.length < c; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes())
          for (const h of s.getAttributeNames())
            if (h.endsWith(Gn)) {
              const p = f[n++], m = s.getAttribute(h).split(Ut), g = /([.?@])?(.*)/.exec(p);
              a.push({ type: 1, index: i, name: g[2], strings: m, ctor: g[1] === "." ? Da : g[1] === "?" ? La : g[1] === "@" ? Ba : Xr }), s.removeAttribute(h);
            } else
        ...
        if (Qn.test(s.tagName)) {
          ...
          if (p > 0) {
            ...
            for (let m = 0; m < p; m++)
              s.append(h[m], cr()), so.nextNode(), a.push({ type: 2, index: ++i });
            s.append(h[p], cr());
          }
        }
...
function Io(e, t, o = e, r) {
  var n, c;
  if (t === nt)
    return t;
  let s = r !== void 0 ? (n = o._$Co) == null ? void 0 : n[r] : o._$Cl;
  const i = dr(t) ? void 0 : t._$litDirective$;
  return (s == null ? void 0 : s.constructor) !== i && ((c = s == null ? void 0 : s._$AO) == null || c.call(s, !1), i === void 0 ? s = void 0 : (s = new i(e), s._$AT(e, o, r)), r !== void 0 ? (o._$Co ?? (o._$Co = []))[r] = s : o._$Cl = s), s !== void 0 && (t = Io(e, s._$AS(e, t.values), s, r)), t;
}
let Ma = class {
  constructor(t, o) {
  ...
  u(t) {
    ...
    so.currentNode = s;
    let i = so.nextNode(), n = 0, c = 0, a = r[0];
    for (; a !== void 0; ) {
      if (n === a.index) {
        let d;
      ...
      n !== (a == null ? void 0 : a.index) && (i = so.nextNode(), n++);
    }
    return so.currentNode = lo, s;
  }
  p(t) {
    let o = 0;
  ...
  _$AI(t, o = this) {
    t = Io(this, t, o), dr(t) ? t === Ce || t == null || t === "" ? (this._$AH !== Ce && this._$AR(), this._$AH = Ce) : t !== this._$AH && t !== nt && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Na(t) ? this.k(t) : this._(t);
  }
  S(t) {
  ...
  _$AI(t, o = this, r, s) {
    ...
    let n = !1;
    if (i === void 0)
      t = Io(this, t, o, 0), n = !dr(t) || t !== this._$AH && t !== nt, n && (this._$AH = t);
    else {
      const c = t;
      let a, d;
      for (t = i[0], a = 0; a < i.length - 1; a++)
        d = Io(this, c[r + a], o, a), d === nt && (d = this._$AH[a]), n || (n = !dr(d) || d !== this._$AH[a]), d === Ce ? t = Ce : t !== Ce && (t += (d ?? "") + i[a + 1]), this._$AH[a] = d;
    }
    n && !s && this.j(t);
  }
  j(t) {
...
}, M = ({ react: e, tagName: t, elementClass: o, events: r, displayName: s }) => {
...
`, ho = (e = "value") => (t, o) => {
...
}, qo = /* @__PURE__ */ new WeakMap(), Ko = /* @__PURE__ */ new WeakMap(), Yo = /* @__PURE__ */ new WeakMap(), ms = /* @__PURE__ */ new WeakSet(), Cr = /* @__PURE__ */ new WeakMap(), Dt = class {
  constructor(e, t) {
  ...
  attachForm(e) {
    e ? (this.form = e, qo.has(this.form) ? qo.get(this.form).add(this.host) : qo.set(this.form, /* @__PURE__ */ new Set([this.host])), this.form.addEventListener("formdata", this.handleFormData), this.form.addEventListener("submit", this.handleFormSubmit), this.form.addEventListener("reset", this.handleFormReset), Ko.has(this.form) || (Ko.set(this.form, this.form.reportValidity), this.form.reportValidity = () => this.reportFormValidity()), Yo.has(this.form) || (Yo.set(this.form, this.form.checkValidity), this.form.checkValidity = () => this.checkFormValidity())) : this.form = void 0;
  }
  detachForm() {
    if (!this.form)
      return;
    const e = qo.get(this.form);
    e && (e.delete(this.host), e.size <= 0 && (this.form.removeEventListener("formdata", this.handleFormData), this.form.removeEventListener("submit", this.handleFormSubmit), this.form.removeEventListener("reset", this.handleFormReset), Ko.has(this.form) && (this.form.reportValidity = Ko.get(this.form), Ko.delete(this.form)), Yo.has(this.form) && (this.form.checkValidity = Yo.get(this.form), Yo.delete(this.form)), this.form = void 0));
  }
  ...
  valid: !0,
  valueMissing: !1
}), Ja = Object.freeze(pr(Mt({}, Jr), {
  valid: !1,
  valueMissing: !0
})), Za = Object.freeze(pr(Mt({}, Jr), {
  valid: !1,
  customError: !0
})), Xe = class {
  constructor(e, ...t) {
...
var Xo = Symbol(), Sr = Symbol(), gs, bs = /* @__PURE__ */ new Map(), we = class extends N {
  constructor() {
  ...
  async resolveIcon(e, t) {
    ...
    try {
      ...
      return c ? (c.part.add("svg"), document.adoptNode(c)) : Xo;
    } catch {
      return Xo;
    }
  }
...
let sl = document.documentElement.dir || "ltr", il = document.documentElement.lang || navigator.language, ro;
...
function nl(...e) {
  e.map((t) => {
    ...
    zo.has(o) ? zo.set(o, Object.assign(Object.assign({}, zo.get(o)), t)) : zo.set(o, t), ro || (ro = t);
  }), ll();
}
function ll() {
...
let pc = class {
  ...
  exists(t, o) {
    ...
    return o = Object.assign({ includeFallback: !1 }, o), !!(s && s[t] || i && i[t] || o.includeFallback && ro && ro[t]);
  }
  term(t, ...o) {
...
Ze.styles = [F, Ac];
Ze.dependencies = { "sl-icon-button": Le };
l([
  A(".tab-group")
...
Lt.styles = [F, Nc];
Lt.dependencies = { "sl-icon-button": Le };
l([
  u({ reflect: !0 })
...
`;
const Kt = Math.min, st = Math.max, Vr = Math.round, $r = Math.floor, Yt = (e) => ({
  x: e,
  y: e
}), Dc = {
  left: "right",
...
function Ji(e, t, o) {
  ...
  const i = gr(t), n = ni(t), c = ii(n), a = Xt(t), d = i === "y", f = r.x + r.width / 2 - s.width / 2, h = r.y + r.height / 2 - s.height / 2, p = r[c] / 2 - s[c] / 2;
  let m;
  switch (a) {
    case "top":
      m = {
...
async function li(e, t) {
  ...
  const {
    ...
    altBoundary: p = !1,
    padding: m = 0
  } = Bo(t, e), g = hl(m), y = c[p ? h === "floating" ? "reference" : "floating" : h], k = Hr(await i.getClippingRect({
...
const Wc = (e) => ({
  ...
  async fn(t) {
    ...
    const h = hl(f), p = {
      x: o,
      y: r
    }, m = ni(s), g = ii(m), b = await n.getDimensions(d), y = m === "y", k = y ? "top" : "left", x = y ? "bottom" : "right", _ = y ? "clientHeight" : "clientWidth", w = i.reference[g] + i.reference[m] - p[m] - i.floating[g], v = p[m] - i.reference[m], E = await (n.getOffsetParent == null ? void 0 : n.getOffsetParent(d));
    let V = E ? E[_] : 0;
    (!V || !await (n.isElement == null ? void 0 : n.isElement(E))) && (V = c.floating[_] || i.floating[g]);
    const j = w / 2 - v / 2, P = V / 2 - b[g] / 2 - 1, S = Kt(h[k], P), Y = Kt(h[x], P), K = S, xe = V - b[g] - Y, G = V / 2 - b[g] / 2 + j, J = Ws(K, G, xe), _e = !a.arrow && Vo(s) != null && G != J && i.reference[g] / 2 - (G < K ? S : Y) - b[g] / 2 < 0, Ne = _e ? G < K ? G - K : G - xe : 0;
    return {
      [m]: p[m] + Ne,
      data: {
        [m]: J,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((o = i.arrow) != null && o.alignmentOffset)
        return {};
      const k = Xt(s), x = Xt(c) === c, _ = await (a.isRTL == null ? void 0 : a.isRTL(d.floating)), w = p || (x || !b ? [Fr(c)] : Vc(c));
      ...
      if (j = [...j, {
        ...
        if (!G)
          switch (m) {
            case "bestFit": {
              var Y;
              const J = (Y = j.map((_e) => [_e.placement, _e.overflows.filter((Ne) => Ne > 0).reduce((Ne, Ot) => Ne + Ot, 0)]).sort((_e, Ne) => _e[1] - Ne[1])[0]) == null ? void 0 : Y[0];
              J && (G = J);
              break;
            }
...
async function Kc(e, t) {
  const {
    ...
    platform: r,
    elements: s
  } = e, i = await (r.isRTL == null ? void 0 : r.isRTL(s.floating)), n = Xt(o), c = Vo(o), a = gr(o) === "y", d = ["left", "top"].includes(n) ? -1 : 1, f = i && a ? -1 : 1, h = Bo(t, e);
  let {
    mainAxis: p,
    crossAxis: m,
    alignmentAxis: g
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: o,
        y: r
      }, f = await li(t, a), h = gr(Xt(s)), p = ul(h);
      let m = d[p], g = d[h];
      if (i) {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if (x && !f) {
        ...
        h ? w = p - 2 * (E !== 0 || V !== 0 ? E + V : st(a.left, a.right)) : _ = m - 2 * (j !== 0 || P !== 0 ? j + P : st(a.top, a.bottom));
      }
      await n({
        ...t,
        availableWidth: w,
...
function co(e, t, o, r) {
  ...
  let n = Yt(1);
  t && (r ? Rt(r) && (n = Ao(r)) : n = Ao(e));
  const c = ed(i, o, r) ? gl(i) : Yt(0);
  let a = (s.left + c.x) / n.x, d = (s.top + c.y) / n.y, f = s.width / n.x, h = s.height / n.y;
  if (i) {
    const p = lt(i), m = r && Rt(r) ? lt(r) : r;
    let g = p.frameElement;
    for (; g && r && m !== p; ) {
      const b = Ao(g), y = g.getBoundingClientRect(), k = ht(g), x = y.left + (g.clientLeft + parseFloat(k.paddingLeft)) * b.x, _ = y.top + (g.clientTop + parseFloat(k.paddingTop)) * b.y;
      a *= b.x, d *= b.y, f *= b.x, h *= b.y, a += x, d += _, g = lt(g).frameElement;
    }
  }
  return Hr({
    width: f,
...
function td(e) {
  ...
  const a = Yt(0);
  if ((s || !s && r !== "fixed") && ((Gt(o) !== "body" || br(i)) && (n = Qr(o)), Tt(o))) {
    const d = co(o);
...
function bl(e) {
  return co(Bt(e)).left + Qr(e).scrollLeft;
}
function rd(e) {
  const t = Bt(e), o = Qr(e), r = e.ownerDocument.body, s = st(t.scrollWidth, t.clientWidth, r.scrollWidth, r.clientWidth), i = st(t.scrollHeight, t.clientHeight, r.scrollHeight, r.clientHeight);
...
function sd(e, t) {
  const o = lt(e), r = Bt(e), s = o.visualViewport;
...
function vl(e, t) {
  const o = No(e);
  return o === t || !Rt(o) || Zr(o) ? !1 : ht(o).position === "fixed" || vl(o, t);
}
function nd(e, t) {
  const o = t.get(e);
  if (o)
    return o;
  let r = ur(e, [], !1).filter((c) => Rt(c) && Gt(c) !== "body"), s = null;
  const i = ht(e).position === "fixed";
  let n = i ? No(e) : e;
  for (; Rt(n) && !Zr(n); ) {
    const c = ht(n), a = ai(n);
    !a && c.position === "fixed" && (s = null), (i ? !a && !s : !a && c.position === "static" && !!s && ["absolute", "fixed"].includes(s.position) || br(n) && !a && vl(e, n)) ? r = r.filter((f) => f !== n) : s = c, n = No(n);
  }
  return t.set(e, r), r;
}
function ld(e) {
...
function cd(e, t, o) {
  const r = Tt(t), s = Bt(t), i = o === "fixed", n = co(e, !0, i, t);
  let c = {
    scrollLeft: 0,
    scrollTop: 0
  };
...
function yl(e, t) {
  ...
  for (; r && Jc(r) && ht(r).position === "static"; )
    r = en(r, t);
  return r && (Gt(r) === "html" || Gt(r) === "body" && ht(r).position === "static" && !ai(r)) ? o : r || Zc(e) || o;
}
...
function hd(e, t) {
  ...
  function n(c, a) {
    ...
    if (c || t(), !h || !p)
      return;
    const m = $r(f), g = $r(s.clientWidth - (d + h)), b = $r(s.clientHeight - (f + p)), y = $r(d), x = {
      rootMargin: -m + "px " + -g + "px " + -b + "px " + -y + "px",
      threshold: st(0, Kt(1, a)) || 1
    };
    let _ = !0;
    function w(v) {
    ...
    try {
      ...
      o = new IntersectionObserver(w, x);
    }
    o.observe(e);
  }
  return n(!0), i;
...
function pd(e, t, o, r) {
  ...
  f.forEach((k) => {
    s && k.addEventListener("scroll", o, {
      passive: !0
    }), i && k.addEventListener("resize", o);
  });
  ...
  function y() {
    const k = co(e);
    b && (k.x !== b.x || k.y !== b.y || k.width !== b.width || k.height !== b.height) && o(), b = k, g = requestAnimationFrame(y);
  }
  return o(), () => {
    f.forEach((k) => {
...
const fd = Xc, md = qc, tn = Gc, gd = Wc, bd = (e, t, o) => {
...
var he = class extends N {
  ...
  reposition() {
    ...
    const t = this.strategy === "absolute" ? (o) => Nr.getOffsetParent(o, vd) : Nr.getOffsetParent;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const wl = "important", Od = " !" + wl, Ge = fr(class extends mr {
  constructor(e) {
    var t;
...
var Nd = [
  ...
  render() {
    ...
    const o = t.getTime() - e.getTime(), { unit: r, value: s } = Nd.find((i) => Math.abs(o) < i.max);
...
var Qe = class extends N {
  ...
  handleKeyDown(e) {
    if (!this.disabled && ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Home", "End"].includes(e.key)) {
      ...
      e.preventDefault(), (e.key === "ArrowLeft" && !this.vertical || e.key === "ArrowUp" && this.vertical) && (t -= o), (e.key === "ArrowRight" && !this.vertical || e.key === "ArrowDown" && this.vertical) && (t += o), e.key === "Home" && (t = this.primary === "end" ? 100 : 0), e.key === "End" && (t = this.primary === "end" ? 0 : 100), this.position = Pe(t, 0, 100);
    }
  }
  handleResize(e) {
...
(function(e) {
  ...
  function o(c, a, d, f, h, p, m, g, b, y) {
    function k(x, _, w, v, E, V, j) {
      x ? (c.lineTo(_ + V, w + j), c.arcTo(_, w, v, E, p)) : c.lineTo(_, w);
    }
    m ? c.moveTo(a + p, d) : c.moveTo(a, d), k(g, f, d, f, h, -p, 0), k(b, f, h, a, h, 0, -p), k(y, a, h, a, d, p, 0), k(m, a, d, f, d, 0, p);
  }
  function r(c, a, d, f, h, p, m, g, b, y) {
    ...
    m && k(a, d, p, p), g && k(f, d, -p, p), b && k(f, h, -p, -p), y && k(a, h, p, -p);
  }
  function s(c, a) {
    var d = a.fill;
    if (typeof d == "string")
  ...
  function i(c, a) {
    ...
    for (d = c.getContext("2d"), a.background && (d.fillStyle = a.background, d.fillRect(a.left, a.top, a.size, a.size)), f = g.O, p = a.size / f, d.beginPath(), m = 0; m < f; m += 1)
      for (h = 0; h < f; h += 1) {
        var b = d, y = a.left + h * p, k = a.top + m * p, x = m, _ = h, w = g.a, v = y + p, E = k + p, V = x - 1, j = x + 1, P = _ - 1, S = _ + 1, Y = Math.floor(Math.min(0.5, Math.max(0, a.R)) * p), K = w(x, _), xe = w(V, P), G = w(V, _);
        V = w(V, S);
        var J = w(x, S);
        S = w(j, S), _ = w(
          j,
          _
        ), j = w(j, P), x = w(x, P), y = Math.round(y), k = Math.round(k), v = Math.round(v), E = Math.round(E), K ? o(b, y, k, v, E, Y, !G && !x, !G && !J, !_ && !J, !_ && !x) : r(b, y, k, v, E, Y, G && x && xe, G && J && V, _ && J && S, _ && x && j);
      }
  ...
  function o(a, d) {
    ...
    function h(x, _) {
      ...
      for (w = i.w(p << 3 | _), v = 0; 15 > v; v += 1)
        E = !x && (w >> v & 1) == 1, m[6 > v ? v : 8 > v ? v + 1 : g - 15 + v][8] = E, m[8][8 > v ? g - v - 1 : 9 > v ? 15 - v : 14 - v] = E;
      if (m[g - 8][8] = !x, 7 <= a) {
        for (w = i.A(a), v = 0; 18 > v; v += 1)
          E = !x && (w >> v & 1) == 1, m[Math.floor(v / 3)][v % 3 + g - 8 - 3] = E;
        for (v = 0; 18 > v; v += 1)
          E = !x && (w >> v & 1) == 1, m[v % 3 + g - 8 - 3][Math.floor(v / 3)] = E;
      }
      if (b == null) {
        for (x = c.I(a, p), w = t(), v = 0; v < y.length; v += 1)
          E = y[v], w.put(4, 4), w.put(E.b(), i.f(4, a)), E.write(w);
        for (v = E = 0; v < x.length; v += 1)
          E += x[v].j;
        if (w.f() > 8 * E)
        ...
        for (; !(w.f() >= 8 * E) && (w.put(236, 8), !(w.f() >= 8 * E)); )
          w.put(17, 8);
        var Y = 0;
        for (E = v = 0, V = Array(x.length), j = Array(x.length), P = 0; P < x.length; P += 1) {
          var K = x[P].j, xe = x[P].o - K;
          for (v = Math.max(v, K), E = Math.max(E, xe), V[P] = Array(K), S = 0; S < V[P].length; S += 1)
            V[P][S] = 255 & w.B()[S + Y];
          for (Y += K, S = i.C(xe), K = r(V[P], S.b() - 1).l(S), j[P] = Array(S.b() - 1), S = 0; S < j[P].length; S += 1)
        ...
        for (w = Array(w), S = Y = 0; S < v; S += 1)
          for (P = 0; P < x.length; P += 1)
            S < V[P].length && (w[Y] = V[P][S], Y += 1);
        for (S = 0; S < E; S += 1)
          for (P = 0; P < x.length; P += 1)
            S < j[P].length && (w[Y] = j[P][S], Y += 1);
        b = w;
      }
      for (x = b, w = -1, v = g - 1, E = 7, V = 0, _ = i.F(_), j = g - 1; 0 < j; j -= 2)
        for (j == 6 && --j; ; ) {
          for (P = 0; 2 > P; P += 1)
            m[v][j - P] == null && (S = !1, V < x.length && (S = (x[V] >>> E & 1) == 1), _(v, j - P) && (S = !S), m[v][j - P] = S, --E, E == -1 && (V += 1, E = 7));
          if (v += w, 0 > v || g <= v) {
            v -= w, w = -w;
            break;
          }
...
`, Qt = class extends N {
  ...
  handleDrag(e) {
    ...
    e.preventDefault(), nr(this.base, {
      onMove: (r) => {
        this.position = parseFloat(Pe(r / t * 100, 0, 100).toFixed(2)), o && (this.position = 100 - this.position);
      },
      initialEvent: e
    });
  }
  handleKeyDown(e) {
    ...
    if (["ArrowLeft", "ArrowRight", "Home", "End"].includes(e.key)) {
      ...
      let s = this.position;
      e.preventDefault(), (t && e.key === "ArrowLeft" || o && e.key === "ArrowRight") && (s -= r), (t && e.key === "ArrowRight" || o && e.key === "ArrowLeft") && (s += r), e.key === "Home" && (s = 0), e.key === "End" && (s = 100), s = Pe(s, 0, 100), this.position = s;
    }
  }
  handlePositionChange() {
    this.emit("sl-change");
...
var zu = class {
  ...
  constructor() {
    super(...arguments), this.type = "normal", this.checked = !1, this.value = "", this.loading = !1, this.disabled = !1, this.localize = new ue(this), this.hasSlotController = new Xe(this, "submenu"), this.submenuController = new zu(this, this.hasSlotController, this.localize), this.handleHostClick = (e) => {
...
function ju(e) {
  ...
  return e.hasAttribute("tabindex") && (isNaN(o) || o <= -1) || e.hasAttribute("disabled") || e.closest("[inert]") || t === "input" && e.getAttribute("type") === "radio" && !e.hasAttribute("checked") || !Hu(e) ? !1 : (t === "audio" || t === "video") && e.hasAttribute("controls") || e.hasAttribute("tabindex") || e.hasAttribute("contenteditable") && e.getAttribute("contenteditable") !== "false" || [
    "button",
    "input",
    "select",
    "textarea",
...
function Wu(e) {
  var t, o;
  const r = Ys(e), s = (t = r[0]) != null ? t : null, i = (o = r[r.length - 1]) != null ? o : null;
  ...
  function r(s) {
    if (s instanceof Element) {
      if (s.hasAttribute("inert") || s.closest("[inert]") || t.has(s))
        return;
      t.set(s, !0), !o.includes(s) && ju(s) && o.push(s), s instanceof HTMLSlotElement && qu(s, e) && s.assignedElements({ flatten: !0 }).forEach((i) => {
        r(i);
...
var tt = class extends N {
  constructor() {
    super(...arguments), this.hasSlotController = new Xe(this, "footer"), this.localize = new ue(this), this.modal = new $l(this), this.open = !1, this.label = "", this.placement = "end", this.contained = !1, this.noHeader = !1, this.handleDocumentKeyDown = (e) => {
  ...
  async handleOpenChange() {
    if (this.open) {
      ...
      this.emit("sl-hide"), this.removeOpenListeners(), this.contained || (this.modal.deactivate(), ir(this)), await Promise.all([Me(this.drawer), Me(this.overlay)]);
...
tt.styles = [F, Fu];
tt.dependencies = { "sl-icon-button": Le };
l([
  A(".drawer")
...
`, St = class extends N {
  constructor() {
    super(...arguments), this.hasSlotController = new Xe(this, "footer"), this.localize = new ue(this), this.modal = new $l(this), this.open = !1, this.label = "", this.noHeader = !1, this.handleDocumentKeyDown = (e) => {
...
`, qe = class extends N {
  ...
  updateAccessibleTrigger() {
    const t = this.trigger.assignedElements({ flatten: !0 }).find((r) => Wu(r).start);
    let o;
    if (t) {
...
var ze = class extends N {
  ...
  goToSlide(e, t = "smooth") {
    ...
    if (!s.length)
      return;
    const n = r ? (e + s.length) % s.length : Pe(e, 0, s.length - 1);
    this.activeSlide = n;
    const c = Pe(e + (r ? o : 0), 0, i.length - 1), a = i[c];
...
function xh(e, t, o) {
  let r, s, i;
  if (e = Ue(e, 360), t = Ue(t, 100), o = Ue(o, 100), t === 0)
    s = o, i = o, r = o;
  else {
...
function _h(e, t, o) {
  e = Ue(e, 360) * 6, t = Ue(t, 100), o = Ue(o, 100);
...
function dn(e, t, o, r) {
  const s = [
    io(Math.round(e).toString(16)),
    io(Math.round(t).toString(16)),
    io(Math.round(o).toString(16))
  ];
...
function $h(e) {
  ...
  return typeof e == "string" && (e = Ah(e)), typeof e == "object" && (It(e.r) && It(e.g) && It(e.b) ? (t = wh(e.r, e.g, e.b), n = !0, c = String(e.r).substr(-1) === "%" ? "prgb" : "rgb") : It(e.h) && It(e.s) && It(e.v) ? (r = Ar(e.s), s = Ar(e.v), t = _h(e.h, r, s), n = !0, c = "hsv") : It(e.h) && It(e.s) && It(e.l) && (r = Ar(e.s), i = Ar(e.l), t = xh(e.h, r, i), n = !0, c = "hsl"), Object.prototype.hasOwnProperty.call(e, "a") && (o = e.a)), o = zl(o), {
    ok: n,
    format: e.format || c,
...
const zh = "[-\\+]?\\d+%?", Eh = "[-\\+]?\\d*\\.\\d+%?", Wt = "(?:" + Eh + ")|(?:" + zh + ")", _s = "[\\s|\\(]+(" + Wt + ")[,|\\s]+(" + Wt + ")[,|\\s]+(" + Wt + ")\\s*\\)?", ks = (
...
class Te {
   ...
   */
  toPercentageRgb() {
    const t = (o) => `${Math.round(Ue(o, 255) * 100)}%`;
    return {
      r: t(this.r),
      g: t(this.g),
      b: t(this.b),
  ...
  toName() {
    ...
    for (const [o, r] of Object.entries(Xs))
      if (t === r)
        return o;
    return !1;
  }
...
var hn = "EyeDropper" in window, se = class extends N {
  ...
  handleAlphaDrag(e) {
    ...
    o.focus(), e.preventDefault(), nr(t, {
      onMove: (n) => {
        this.alpha = Pe(n / r * 100, 0, 100), this.syncValues(), this.value !== i && (i = this.value, this.emit("sl-input"));
      },
      onStop: () => {
  ...
  handleHueDrag(e) {
    ...
    o.focus(), e.preventDefault(), nr(t, {
      onMove: (n) => {
        this.hue = Pe(n / r * 360, 0, 360), this.syncValues(), this.value !== i && (i = this.value, this.emit("sl-input"));
      },
      onStop: () => {
        this.value !== s && (s = this.value, this.emit("sl-change"));
      },
  ...
  handleGridDrag(e) {
    ...
    o.focus(), e.preventDefault(), this.isDraggingGridHandle = !0, nr(t, {
      onMove: (c, a) => {
        this.saturation = Pe(c / r * 100, 0, 100), this.brightness = Pe(100 - a / s * 100, 0, 100), this.syncValues(), this.value !== n && (n = this.value, this.emit("sl-input"));
      },
      onStop: () => {
  ...
  handleAlphaKeyDown(e) {
    ...
    e.key === "ArrowLeft" && (e.preventDefault(), this.alpha = Pe(this.alpha - t, 0, 100), this.syncValues()), e.key === "ArrowRight" && (e.preventDefault(), this.alpha = Pe(this.alpha + t, 0, 100), this.syncValues()), e.key === "Home" && (e.preventDefault(), this.alpha = 0, this.syncValues()), e.key === "End" && (e.preventDefault(), this.alpha = 100, this.syncValues()), this.value !== o && (this.emit("sl-change"), this.emit("sl-input"));
  }
  handleHueKeyDown(e) {
    const t = e.shiftKey ? 10 : 1, o = this.value;
    e.key === "ArrowLeft" && (e.preventDefault(), this.hue = Pe(this.hue - t, 0, 360), this.syncValues()), e.key === "ArrowRight" && (e.preventDefault(), this.hue = Pe(this.hue + t, 0, 360), this.syncValues()), e.key === "Home" && (e.preventDefault(), this.hue = 0, this.syncValues()), e.key === "End" && (e.preventDefault(), this.hue = 360, this.syncValues()), this.value !== o && (this.emit("sl-change"), this.emit("sl-input"));
  }
  handleGridKeyDown(e) {
    const t = e.shiftKey ? 10 : 1, o = this.value;
    e.key === "ArrowLeft" && (e.preventDefault(), this.saturation = Pe(this.saturation - t, 0, 100), this.syncValues()), e.key === "ArrowRight" && (e.preventDefault(), this.saturation = Pe(this.saturation + t, 0, 100), this.syncValues()), e.key === "ArrowUp" && (e.preventDefault(), this.brightness = Pe(this.brightness + t, 0, 100), this.syncValues()), e.key === "ArrowDown" && (e.preventDefault(), this.brightness = Pe(this.brightness - t, 0, 100), this.syncValues()), this.value !== o && (this.emit("sl-change"), this.emit("sl-input"));
  }
  handleInputChange(e) {
...
`, vo = Object.assign(document.createElement("div"), { className: "sl-toast-stack" }), $t = class extends N {
  constructor() {
...
const Fh = [
  ...
  fadeInUpBig: Tp,
  fadeOut: Op,
  fadeOutBottomLeft: Ip,
  fadeOutBottomRight: Np,
  fadeOutDown: Rp,
  fadeOutDownBig: Pp,
  fadeOutLeft: Mp,
  fadeOutLeftBig: Dp,
...
`, Fe = class extends N {
  ...
  async createAnimation() {
    var e, t;
    const o = (e = El[this.easing]) != null ? e : this.easing, r = (t = this.keyframes) != null ? t : If[this.name], i = (await this.defaultSlot).assignedElements()[0];
...
var jf = Object.defineProperty, Wf = (e, t, o) => t in e ? jf(e, t, { enumerable: !0, configurable: !0, writable: !0, value: o }) : e[t] = o, oe = (e, t, o) => (Wf(e, typeof t != "symbol" ? t + "" : t, o), o);
const uo = [
  "GEN",
  "EXO",
  "LEV",
...
let dt = oo;
oe(dt, "Original", new oo(Ht.Original)), oe(dt, "Septuagint", new oo(Ht.Septuagint)), oe(dt, "Vulgate", new oo(Ht.Vulgate)), oe(dt, "English", new oo(Ht.English)), oe(dt, "RussianProtestant", new oo(Ht.RussianProtestant)), oe(dt, "RussianOrthodox", new oo(Ht.RussianOrthodox));
function fn(e, t) {
  const o = t[0];
...
const te = class {
  ...
  parse(t) {
    ...
    if (r.length !== 2 || Je.bookIdToNumber(o[0]) === 0 || !Number.isInteger(s) || s < 0 || !te.isVerseParseable(r[1]))
      throw new Zo("Invalid reference : " + t);
  ...
  updateInternal(t, o, r) {
    this.bookNum = Je.bookIdToNumber(t), this.chapter = o, this.verse = r;
  }
};
let Nt = te;
oe(Nt, "defaultVersification", dt.English), oe(Nt, "verseRangeSeparator", "-"), oe(Nt, "verseSequenceIndicator", ","), oe(Nt, "verseRangeSeparators", [te.verseRangeSeparator]), oe(Nt, "verseSequenceIndicators", [te.verseSequenceIndicator]), oe(Nt, "chapterDigitShifter", 1e3), oe(Nt, "bookDigitShifter", te.chapterDigitShifter * te.chapterDigitShifter), oe(Nt, "bcvMaxValue", te.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
oe(Nt, "ValidStatusType", Rl);
class Zo extends Error {
}
function o0({ bookId: e, handleSelect: t, isSelected: o, children: r }) {
    ...
    /* @__PURE__ */ wt(
      Tu,
      {
        ...
        children: [
          ...
          o ? /* @__PURE__ */ D("div", { className: "selected-book-color-label", slot: "prefix" }) : /* @__PURE__ */ D("div", { className: "book-color-label", slot: "prefix" })
        ]
      },
      e
    ),
...
function r0({ endChapter: e }) {
  const t = Array.from({ length: e }, (o, r) => r + 1);
  return /* @__PURE__ */ D("div", { className: "chapter-select", children: t.map((o) => /* @__PURE__ */ D("div", { children: o })) });
}
function db() {
  const { allBookIds: e } = Je, t = e.filter((i) => Je.isBookOT(i)), [o, r] = no(""), s = (i) => {
    r(i);
  };
    ...
    /* @__PURE__ */ wt(vu, { className: "menu", children: [
      ...
      t.map((i) => /* @__PURE__ */ D(
        o0,
        {
          ...
          handleSelect: () => s(i),
          isSelected: o === i,
          children: o === i ? /* @__PURE__ */ D("div", { className: "selected-book-details", children: /* @__PURE__ */ D(Vu, { summary: Je.bookIdToEnglishName(o), children: /* @__PURE__ */ D(
            r0,
            {
              endChapter: jn(Je.bookIdToNumber(o))
            }
          ) }) }) : void 0
        },
        i
...
function ub({
  ...
  return /* @__PURE__ */ wt(Yl, { children: [
    /* @__PURE__ */ D(
      Oi,
      {
...
function s0({
  ...
  let h;
  if (o) {
    const p = r === $o.Before || r === $o.Above, m = /* @__PURE__ */ D("span", { className: `papi-checkbox-label ${c ? "error" : ""} ${a ?? ""}`, children: o }), g = r === $o.Before || r === $o.After, b = g ? m : /* @__PURE__ */ D("div", { children: m }), y = g ? f : /* @__PURE__ */ D("div", { children: f });
    h = /* @__PURE__ */ wt(
      ea,
      {
...
function n0({ commandHandler: e, name: t, className: o, items: r, id: s }) {
  return /* @__PURE__ */ wt(qn, { id: s, item: !0, xs: "auto", className: `papi-menu-column ${o ?? ""}`, children: [
    /* @__PURE__ */ D("h3", { className: `papi-menu ${o ?? ""}`, children: t }),
    r.map((i, n) => /* @__PURE__ */ D(
      i0,
      {
...
function l0({ commandHandler: e, className: t, columns: o, id: r }) {
  return /* @__PURE__ */ D(
    qn,
    {
      container: !0,
...
function pb({ scrRef: e, handleSubmit: t, id: o }) {
  const r = (a) => {
    t(a);
  }, s = (a, d) => {
  ...
  return /* @__PURE__ */ wt("span", { id: o, children: [
    /* @__PURE__ */ D(
      Gs,
      {
        title: "Book",
    ...
    /* @__PURE__ */ D(yo, { onClick: () => t(Ti(e, 1)), children: ">" })
  ] });
}
function fb({ onSearch: e, placeholder: t, isFullWidth: o }) {
  const [r, s] = no(""), i = (n) => {
    s(n), e(n);
  };
  return /* @__PURE__ */ D(ra, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ D(
    jr,
    {
      isFullWidth: o,
...
function mn({ onRowChange: e, row: t, column: o }) {
  ...
  return /* @__PURE__ */ D(jr, { defaultValue: t[o.key], onChange: r });
}
const a0 = ({ onChange: e, disabled: t, checked: o, ...r }) => /* @__PURE__ */ D(
  s0,
  {
    ...r,
    isChecked: o,
...
function xt(e, t, o = {
  ...
  return jt(e) && jt(t) && Object.keys(t).forEach((s) => {
    s !== "__proto__" && (jt(t[s]) && s in e && jt(e[s]) ? r[s] = xt(e[s], t[s], o) : o.clone ? r[s] = jt(t[s]) ? Pl(t[s]) : t[s] : r[s] = t[s]);
  }), r;
}
function c0(e) {
...
function d0() {
  ...
  return fe.AsyncMode = a, fe.ConcurrentMode = d, fe.ContextConsumer = c, fe.ContextProvider = n, fe.Element = t, fe.ForwardRef = f, fe.Fragment = r, fe.Lazy = g, fe.Memo = m, fe.Portal = o, fe.Profiler = i, fe.StrictMode = s, fe.Suspense = h, fe.isAsyncMode = function(v) {
    ...
    return typeof v == "string" || typeof v == "function" || v === r || v === d || v === i || v === s || v === h || v === p || typeof v == "object" && v !== null && (v.$$typeof === g || v.$$typeof === m || v.$$typeof === n || v.$$typeof === c || v.$$typeof === f || v.$$typeof === y || v.$$typeof === k || v.$$typeof === x || v.$$typeof === b);
  }, fe.typeOf = _, fe;
}
var me = {};
/** @license React v16.13.1
...
function u0() {
  return bn || (bn = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function _(T) {
      ...
      T === r || T === d || T === i || T === s || T === h || T === p || typeof T == "object" && T !== null && (T.$$typeof === g || T.$$typeof === m || T.$$typeof === n || T.$$typeof === c || T.$$typeof === f || T.$$typeof === y || T.$$typeof === k || T.$$typeof === x || T.$$typeof === b);
    }
    function w(T) {
    ...
    var v = a, E = d, V = c, j = n, P = t, S = f, Y = r, K = g, xe = m, G = o, J = i, _e = s, Ne = h, Ot = !1;
    function go(T) {
    ...
    me.AsyncMode = v, me.ConcurrentMode = E, me.ContextConsumer = V, me.ContextProvider = j, me.Element = P, me.ForwardRef = S, me.Fragment = Y, me.Lazy = K, me.Memo = xe, me.Portal = G, me.Profiler = J, me.StrictMode = _e, me.Suspense = Ne, me.isAsyncMode = go, me.isConcurrentMode = $, me.isContextConsumer = O, me.isContextProvider = ee, me.isElement = Z, me.isForwardRef = W, me.isFragment = ie, me.isLazy = X, me.isMemo = Q, me.isPortal = ne, me.isProfiler = de, me.isStrictMode = le, me.isSuspense = Ke, me.isValidElementType = _, me.typeOf = w;
  }()), me;
}
var vn;
function Ml() {
  return vn || (vn = 1, process.env.NODE_ENV === "production" ? Tr.exports = d0() : Tr.exports = u0()), Tr.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function f0() {
  if (kn)
    return Ts;
  kn = 1;
  var e = Ml(), t = h0(), o = vi(), r = Dl(), s = p0(), i = function() {
  };
  ...
  return Ts = function(c, a) {
    ...
    function y($) {
      if (process.env.NODE_ENV !== "production")
        var O = {}, ee = 0;
      function Z(ie, X, Q, ne, de, le, Ke) {
        if (ne = ne || p, le = le || Q, Ke !== o) {
          if (a) {
            var T = new Error(
        ...
        return X[Q] == null ? ie ? X[Q] === null ? new b("The " + de + " `" + le + "` is marked as required " + ("in `" + ne + "`, but its value is `null`.")) : new b("The " + de + " `" + le + "` is marked as required in " + ("`" + ne + "`, but its value is `undefined`.")) : null : $(X, Q, ne, de, le);
      }
      var W = Z.bind(null, !1);
    ...
    function k($) {
      function O(ee, Z, W, ie, X, Q) {
        ...
        if (de !== $) {
          var le = Ne(ne);
          return new b(
            "Invalid " + ie + " `" + X + "` of type " + ("`" + le + "` supplied to `" + W + "`, expected ") + ("`" + $ + "`."),
            { expectedType: $ }
          );
        }
        return null;
      ...
      function O(ee, Z, W, ie, X) {
        ...
        for (var de in $) {
          ...
          if (typeof le != "function")
            return Y(W, ie, X, de, Ne(le));
          var Ke = le(Q, de, W, ie, X + "." + de, o);
          if (Ke)
            return Ke;
        }
        return null;
    ...
    function xe($) {
      function O(ee, Z, W, ie, X) {
        ...
        for (var le in de) {
          var Ke = $[le];
          if (r($, le) && typeof Ke != "function")
            return Y(W, ie, X, le, Ne(Ke));
          if (!Ke)
            return new b(
              "Invalid " + ie + " `" + X + "` key `" + le + "` supplied to `" + W + "`.\nBad object: " + JSON.stringify(ee[Z], null, "  ") + `
Valid keys: ` + JSON.stringify(Object.keys($), null, "  ")
            );
          var T = Ke(Q, le, W, ie, X + "." + le, o);
          if (T)
            return T;
        }
        return null;
...
if (process.env.NODE_ENV !== "production") {
  var g0 = Ml(), b0 = !0;
  Js.exports = f0()(g0.isElement, b0);
} else
  Js.exports = m0()();
var v0 = Js.exports;
const ye = /* @__PURE__ */ c0(v0);
function Ro(e) {
...
function w0() {
  return $n || ($n = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function w(B) {
      return !!(typeof B == "string" || typeof B == "function" || B === o || B === s || x || B === r || B === d || B === f || k || B === m || g || b || y || typeof B == "object" && B !== null && (B.$$typeof === p || B.$$typeof === h || B.$$typeof === i || B.$$typeof === n || B.$$typeof === a || // This needs to include all possible module reference object
    ...
    var E = n, V = i, j = e, P = a, S = o, Y = p, K = h, xe = t, G = s, J = r, _e = d, Ne = f, Ot = !1, go = !1;
    function $(B) {
    ...
    be.ContextConsumer = E, be.ContextProvider = V, be.Element = j, be.ForwardRef = P, be.Fragment = S, be.Lazy = Y, be.Memo = K, be.Portal = xe, be.Profiler = G, be.StrictMode = J, be.Suspense = _e, be.SuspenseList = Ne, be.isAsyncMode = $, be.isConcurrentMode = O, be.isContextConsumer = ee, be.isContextProvider = Z, be.isElement = W, be.isForwardRef = ie, be.isFragment = X, be.isLazy = Q, be.isMemo = ne, be.isPortal = de, be.isProfiler = le, be.isStrictMode = Ke, be.isSuspense = T, be.isSuspenseList = ct, be.isValidElementType = w, be.typeOf = v;
  }()), be;
}
process.env.NODE_ENV === "production" ? Zs.exports = y0() : Zs.exports = w0();
var zn = Zs.exports;
...
function T0(e, t = Number.MIN_SAFE_INTEGER, o = Number.MAX_SAFE_INTEGER) {
...
const I0 = ["values", "unit", "step"], N0 = (e) => {
...
function R0(e) {
  const {
    ...
    unit: o = "px",
    step: r = 5
  } = e, s = Ft(e, I0), i = N0(t), n = Object.keys(i);
  function c(p) {
...
const P0 = {
  borderRadius: 4
}, M0 = P0, D0 = process.env.NODE_ENV !== "production" ? ye.oneOfType([ye.number, ye.string, ye.object, ye.array]) : {}, eo = D0;
function ar(e, t) {
  return t ? xt(e, t, {
    clone: !1
...
function q0(e, t, o, r) {
  if (t.indexOf(o) === -1)
    return null;
  const s = U0(o), i = W0(s, r), n = e[o];
  return Pt(e, n, i);
}
function Hl(e, t) {
  const o = Fl(e.theme);
  return Object.keys(e).map((r) => q0(e, t, r, o)).reduce(ar, {});
}
function Ee(e) {
  return Hl(e, rs);
}
Ee.propTypes = process.env.NODE_ENV !== "production" ? rs.reduce((e, t) => (e[t] = eo, e), {}) : {};
Ee.filterProps = rs;
function Ae(e) {
  return Hl(e, ss);
}
Ae.propTypes = process.env.NODE_ENV !== "production" ? ss.reduce((e, t) => (e[t] = eo, e), {}) : {};
Ae.filterProps = ss;
process.env.NODE_ENV !== "production" && j0.reduce((e, t) => (e[t] = eo, e), {});
function K0(e = 8) {
  if (e.mui)
    return e;
  const t = Fl({
...
const Y0 = vt("border", ut), X0 = vt("borderTop", ut), G0 = vt("borderRight", ut), J0 = vt("borderBottom", ut), Z0 = vt("borderLeft", ut), Q0 = vt("borderColor"), em = vt("borderTopColor"), tm = vt("borderRightColor"), om = vt("borderBottomColor"), rm = vt("borderLeftColor"), sm = vt("outline", ut), im = vt("outlineColor"), ns = (e) => {
...
is(Y0, X0, G0, J0, Z0, Q0, em, tm, om, rm, ns, sm, im);
const ls = (e) => {
...
is(ls, as, cs, nm, lm, am, cm, dm, um, hm, pm, fm);
function To(e, t) {
  return t === "grey" ? t : e;
}
const mm = Re({
...
const Ul = zm();
Ul.filterProps = ["sx"];
const ki = Ul, Em = ["breakpoints", "palette", "spacing", "shape"];
function Ci(e = {}, ...t) {
  const {
    breakpoints: o = {},
    palette: r = {},
  ...
  return d = t.reduce((f, h) => xt(f, h), d), d.unstable_sxConfig = ae({}, _i, n == null ? void 0 : n.unstable_sxConfig), d.unstable_sx = function(h) {
    return ki({
      sx: h,
      theme: this
    });
...
function jl(e) {
  ...
  return Object.keys(o).sort().forEach((s) => {
    s === "color" ? r += In(r) ? e[s] : At(e[s]) : r += `${In(r) ? s : At(s)}${At(e[s].toString())}`;
  }), r;
}
...
const Dm = (e, t) => t.components && t.components[e] && t.components[e].styleOverrides ? t.components[e].styleOverrides : null, qr = (e) => {
  let t = 0;
  const o = {};
...
const Vm = Ci(), Nn = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Mr({
  defaultTheme: e,
  theme: t,
  themeId: o
...
function Hm(e = {}) {
  ...
  return i.__mui_systemSx = !0, (n, c = {}) => {
    ...
    let y;
    process.env.NODE_ENV !== "production" && a && (y = `${a}-${Nn(d || "Root")}`);
    let k = Pr;
    d === "Root" || d === "root" ? k = r : d ? k = s : Mm(n) && (k = void 0);
    const x = ha(n, ae({
      shouldForwardProp: k,
      label: y
    }, m)), _ = (w, ...v) => {
      const E = v ? v.map((S) => {
        ...
        if (jt(S)) {
          let Y = S, K;
          return S && S.variants && (K = S.variants, delete Y.variants, Y = (xe) => {
            let G = S;
      ...
      if (jt(w)) {
        let S;
        w && w.variants && (S = w.variants, delete V.variants, V = (Y) => {
          let K = w;
          return Kr(Y, qr(S), S).forEach((G) => {
            K = xt(K, G);
          }), K;
        });
      } else
      ...
      if (process.env.NODE_ENV !== "production") {
        let S;
        a && (S = `${a}${At(d || "")}`), S === void 0 && (S = `Styled(${k0(n)})`), P.displayName = S;
      }
...
function Wl(e, t = 0, o = 1) {
  return process.env.NODE_ENV !== "production" && (e < t || e > o) && console.error(`MUI: The value provided ${e} is out of range [${t}, ${o}].`), T0(e, t, o);
}
function Wm(e) {
  e = e.slice(1);
...
function Pn(e) {
  e = Po(e);
  let t = e.type === "hsl" || e.type === "hsla" ? Po(qm(e)).values : e.values;
...
const Gm = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Co = sg, ig = ["mode", "contrastThreshold", "tonalOffset"], Dn = {
...
function Ln(e, t, o, r) {
  ...
  e[t] || (e.hasOwnProperty(o) ? e[t] = e[o] : t === "light" ? e.light = Ym(e.main, s) : t === "dark" && (e.dark = Km(e.main, i)));
}
function ng(e = "light") {
  return e === "dark" ? {
    main: _o[200],
...
function hg(e) {
  const {
    ...
    tonalOffset: r = 0.2
  } = e, s = Ft(e, ig), i = e.primary || ng(t), n = e.secondary || lg(t), c = e.error || ag(t), a = e.info || cg(t), d = e.success || dg(t), f = e.warning || ug(t);
  function h(b) {
    const y = Mn(b, Is.text.primary) >= o ? Is.text.primary : Dn.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const k = Mn(b, y);
...
The color object needs to have a \`main\` property or a \`${k}\` property.` : Ro(11, y ? ` (${y})` : "", k));
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return Ln(b, "light", x, r), Ln(b, "dark", _, r), b.contrastText || (b.contrastText = h(b.main)), b;
  }, m = {
    dark: Is,
    light: Dn
  };
...
function Sg(e) {
  const t = ae({}, _g, e.easing), o = ae({}, kg, e.duration);
  return ae({
...
const $g = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, zg = $g, Eg = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function Ag(e = {}, ...t) {
  const {
    mixins: o = {},
    palette: r = {},
...
const Ig = (e) => Pr(e) && e !== "classes", Ng = Hm({
  themeId: Kl,
  defaultTheme: ql,
  rootShouldForwardProp: Ig
}), Rg = Ng;
function Pg(e) {
...
}), $i = /* @__PURE__ */ I.forwardRef(function(t, o) {
  const r = Og({
    props: t,
    name: "MuiSvgIcon"
  }), {
    ...
    titleAccess: h,
    viewBox: p = "0 0 24 24"
  } = r, m = Ft(r, Mg), g = /* @__PURE__ */ I.isValidElement(s) && s.type === "svg", b = ae({}, r, {
    color: n,
    component: c,
    fontSize: a,
...
function Bg(e, t) {
  ...
  return process.env.NODE_ENV !== "production" && (o.displayName = `${t}Icon`), o.muiName = Hn.muiName, /* @__PURE__ */ I.memo(/* @__PURE__ */ I.forwardRef(o));
}
...
function yb({
  ...
  let y = e;
  return !y && t && (y = t(a)), /* @__PURE__ */ D("div", { ref: p, style: { position: "relative" }, children: /* @__PURE__ */ D(la, { position: "static", id: s, children: /* @__PURE__ */ wt(aa, { className: `papi-toolbar ${r ?? ""}`, variant: "dense", children: [
    y ? /* @__PURE__ */ D(
      Kn,
      {
        edge: "start",
    ...
    y ? /* @__PURE__ */ D(
      ca,
      {
        ...
        children: /* @__PURE__ */ D(l0, { commandHandler: b, columns: y.columns })
      }
    ) : void 0
  ] }) }) });
}
...
const Hg = (e, t, o = {}) => {
  ...
  const [i, n] = no(() => r.current), [c, a] = no(!0);
  return Yr(() => {
    let d = !0;
    return a(!!e), (async () => {
      if (e) {
