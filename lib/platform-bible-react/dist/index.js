import { jsxs as wt, jsx as D, Fragment as Ya } from "react/jsx-runtime";
import * as N from "react";
import { useState as nr, useMemo as Zs, useCallback as Oo, useRef as Rs, useEffect as Yo } from "react";
import { getChaptersForBook as jn, offsetBook as Ei, FIRST_SCR_BOOK_NUM as Xa, offsetChapter as zi, FIRST_SCR_CHAPTER_NUM as Ga, offsetVerse as Ai, FIRST_SCR_VERSE_NUM as Ja } from "platform-bible-utils";
import { Button as Za, Autocomplete as Qa, TextField as Wn, FormControlLabel as Ti, FormLabel as el, Checkbox as tl, MenuItem as rl, Grid as qn, IconButton as Kn, Paper as ol, Slider as sl, Snackbar as il, Switch as nl, AppBar as al, Toolbar as ll, Drawer as cl } from "@mui/material";
import dl, { SelectColumn as ul } from "react-data-grid";
 ...
 */
const No = globalThis, Qs = No.ShadowRoot && (No.ShadyCSS === void 0 || No.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ei = Symbol(), Oi = /* @__PURE__ */ new WeakMap();
let Yn = class {
  constructor(t, r, o) {
...
const ml = (e) => new Yn(typeof e == "string" ? e : e + "", void 0, ei), L = (e, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: bl, defineProperty: vl, getOwnPropertyDescriptor: yl, getOwnPropertyNames: wl, getOwnPropertySymbols: xl, getPrototypeOf: _l } = Object, qt = globalThis, Ii = qt.trustedTypes, kl = Ii ? Ii.emptyScript : "", ds = qt.reactiveElementPolyfillSupport, Qr = (e, t) => e, Tr = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? kl : null;
      break;
  ...
  return r;
} }, ti = (e, t) => !bl(e, t), Ri = { attribute: !0, type: String, converter: Tr, reflect: !1, hasChanged: ti };
...
class Cr extends HTMLElement {
  ...
  static createProperty(t, r = Ri) {
    if (r.state && (r.attribute = !1), this._$Ei(), this.elementProperties.set(t, r), !r.noAccessor) {
      ...
      s !== void 0 && vl(this.prototype, t, s);
    }
  }
  static getPropertyDescriptor(t, r, o) {
    const { get: s, set: i } = yl(this.prototype, t) ?? { get() {
      return this[r];
    }, set(n) {
      this[r] = n;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(Qr("properties"))) {
      const r = this.properties, o = [...wl(r), ...xl(r)];
      for (const s of o)
  ...
  _$EC(t, r) {
    ...
    if (s !== void 0 && o.reflect === !0) {
      const n = (((i = o.converter) == null ? void 0 : i.toAttribute) !== void 0 ? o.converter : Tr).toAttribute(r, o.type);
  ...
  _$AK(t, r) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const n = o.getPropertyOptions(s), c = typeof n.converter == "function" ? { fromAttribute: n.converter } : ((i = n.converter) == null ? void 0 : i.fromAttribute) !== void 0 ? n.converter : Tr;
...
Cr.elementStyles = [], Cr.shadowRootOptions = { mode: "open" }, Cr[Qr("elementProperties")] = /* @__PURE__ */ new Map(), Cr[Qr("finalized")] = /* @__PURE__ */ new Map(), ds == null || ds({ ReactiveElement: Cr }), (qt.reactiveElementVersions ?? (qt.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const eo = globalThis, Do = eo.trustedTypes, Pi = Do ? Do.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Xn = "$lit$", Ut = `lit$${(Math.random() + "").slice(9)}$`, Gn = "?" + Ut, Cl = `<${Gn}>`, ar = document, lo = () => ar.createComment(""), co = (e) => e === null || typeof e != "object" && typeof e != "function", Jn = Array.isArray, Sl = (e) => Jn(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", us = `[ 	
\f\r]`, jr = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Mi = /-->/g, Di = />/g, tr = RegExp(`>|${us}(?:([^\\s"'>=/]+)(${us}*=${us}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Li = /'/g, Bi = /"/g, Zn = /^(?:script|style|textarea|title)$/i, $l = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r }), C = $l(1), nt = Symbol.for("lit-noChange"), Ce = Symbol.for("lit-nothing"), Vi = /* @__PURE__ */ new WeakMap(), sr = ar.createTreeWalker(ar, 129);
function Qn(e, t) {
...
const El = (e, t) => {
  ...
  for (let c = 0; c < r; c++) {
    ...
    for (; p < l.length && (n.lastIndex = p, f = n.exec(l), f !== null); )
      p = n.lastIndex, n === jr ? f[1] === "!--" ? n = Mi : f[1] !== void 0 ? n = Di : f[2] !== void 0 ? (Zn.test(f[2]) && (s = RegExp("</" + f[2], "g")), n = tr) : f[3] !== void 0 && (n = tr) : n === tr ? f[0] === ">" ? (n = s ?? jr, h = -1) : f[1] === void 0 ? h = -2 : (h = n.lastIndex - f[2].length, d = f[1], n = f[3] === void 0 ? tr : f[3] === '"' ? Bi : Li) : n === Bi || n === Li ? n = tr : n === Mi || n === Di ? n = jr : (n = tr, s = void 0);
    const m = n === tr && e[c + 1].startsWith("/>") ? " " : "";
    i += n === jr ? l + Cl : h >= 0 ? (o.push(d), l.slice(0, h) + Xn + l.slice(h) + Ut + m) : l + Ut + (h === -2 ? c : m);
  }
  return [Qn(e, i + (e[r] || "<?>") + (t === 2 ? "</svg>" : "")), o];
};
let Ps = class ea {
  constructor({ strings: t, _$litType$: r }, o) {
    ...
    this.parts = [];
    let i = 0, n = 0;
    const c = t.length - 1, l = this.parts, [d, f] = El(t, r);
    if (this.el = ea.createElement(d, o), sr.currentNode = this.el.content, r === 2) {
      ...
      if (s.nodeType === 1) {
        if (s.hasAttributes())
          for (const h of s.getAttributeNames())
            if (h.endsWith(Xn)) {
              ...
              l.push({ type: 1, index: i, name: g[2], strings: m, ctor: g[1] === "." ? Al : g[1] === "?" ? Tl : g[1] === "@" ? Ol : Xo }), s.removeAttribute(h);
            } else
        ...
        if (Zn.test(s.tagName)) {
          ...
          if (p > 0) {
            ...
            for (let m = 0; m < p; m++)
              s.append(h[m], lo()), sr.nextNode(), l.push({ type: 2, index: ++i });
            s.append(h[p], lo());
          }
        }
...
function Or(e, t, r = e, o) {
  var n, c;
  if (t === nt)
    return t;
  let s = o !== void 0 ? (n = r._$Co) == null ? void 0 : n[o] : r._$Cl;
  const i = co(t) ? void 0 : t._$litDirective$;
  return (s == null ? void 0 : s.constructor) !== i && ((c = s == null ? void 0 : s._$AO) == null || c.call(s, !1), i === void 0 ? s = void 0 : (s = new i(e), s._$AT(e, r, o)), o !== void 0 ? (r._$Co ?? (r._$Co = []))[o] = s : r._$Cl = s), s !== void 0 && (t = Or(e, s._$AS(e, t.values), s, o)), t;
}
let zl = class {
  constructor(t, r) {
  ...
  u(t) {
    ...
    for (; l !== void 0; ) {
      if (n === l.index) {
        let d;
        l.type === 2 ? d = new ri(i, i.nextSibling, this, t) : l.type === 1 ? d = new l.ctor(i, l.name, l.strings, this, t) : l.type === 6 && (d = new Nl(i, this, t)), this._$AV.push(d), l = o[++c];
      }
      n !== (l == null ? void 0 : l.index) && (i = sr.nextNode(), n++);
    }
    return sr.currentNode = ar, s;
  }
  p(t) {
    let r = 0;
  ...
  _$AI(t, r = this) {
    t = Or(this, t, r), co(t) ? t === Ce || t == null || t === "" ? (this._$AH !== Ce && this._$AR(), this._$AH = Ce) : t !== this._$AH && t !== nt && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Sl(t) ? this.k(t) : this._(t);
  }
  S(t) {
  ...
  _(t) {
    this._$AH !== Ce && co(this._$AH) ? this._$AA.nextSibling.data = t : this.T(ar.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var i;
    const { values: r, _$litType$: o } = t, s = typeof o == "number" ? this._$AC(t) : (o.el === void 0 && (o.el = Ps.createElement(Qn(o.h, o.h[0]), this.options)), o);
    if (((i = this._$AH) == null ? void 0 : i._$AD) === s)
      this._$AH.p(r);
    else {
      const n = new zl(s, this), c = n.u(this.options);
  ...
  k(t) {
    ...
    let o, s = 0;
    for (const i of t)
      s === r.length ? r.push(o = new ta(this.S(lo()), this.S(lo()), this, this.options)) : o = r[s], o._$AI(i), s++;
  ...
  _$AI(t, r = this, o, s) {
    ...
    let n = !1;
    if (i === void 0)
      t = Or(this, t, r, 0), n = !co(t) || t !== this._$AH && t !== nt, n && (this._$AH = t);
    else {
      const c = t;
      let l, d;
      for (t = i[0], l = 0; l < i.length - 1; l++)
        d = Or(this, c[o + l], r, l), d === nt && (d = this._$AH[l]), n || (n = !co(d) || d !== this._$AH[l]), d === Ce ? t = Ce : t !== Ce && (t += (d ?? "") + i[l + 1]), this._$AH[l] = d;
    }
    n && !s && this.j(t);
  }
  j(t) {
...
var Un;
to._$litElement$ = !0, to.finalized = !0, (Un = globalThis.litElementHydrateSupport) == null || Un.call(globalThis, { LitElement: to });
...
`, ra = Object.defineProperty, Pl = Object.defineProperties, Ml = Object.getOwnPropertyDescriptor, Dl = Object.getOwnPropertyDescriptors, Fi = Object.getOwnPropertySymbols, Ll = Object.prototype.hasOwnProperty, Bl = Object.prototype.propertyIsEnumerable, fs = (e, t) => (t = Symbol[e]) ? t : Symbol.for("Symbol." + e), Hi = (e, t, r) => t in e ? ra(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, Mt = (e, t) => {
  for (var r in t || (t = {}))
    Ll.call(t, r) && Hi(e, r, t[r]);
  if (Fi)
    for (var r of Fi(t))
      Bl.call(t, r) && Hi(e, r, t[r]);
  return e;
}, po = (e, t) => Pl(e, Dl(t)), a = (e, t, r, o) => {
  for (var s = o > 1 ? void 0 : o ? Ml(t, r) : t, i = e.length - 1, n; i >= 0; i--)
    (n = e[i]) && (s = (o ? n(t, r, s) : n(s)) || s);
  return o && s && ra(t, r, s), s;
}, Vl = function(e, t) {
  this[0] = e, this[1] = t;
}, Fl = (e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Hl = { attribute: !0, type: String, converter: Tr, reflect: !1, hasChanged: ti }, Ul = (e = Hl, t, r) => {
...
function u(e) {
  return (t, r) => typeof r == "object" ? Ul(e, t, r) : ((o, s, i) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Wl = /* @__PURE__ */ new Set(["children", "localName", "ref", "style", "className"]), Ui = /* @__PURE__ */ new WeakMap(), ql = (e, t, r, o, s) => {
  ...
  const i = new Set(Object.keys(o ?? {})), n = e.forwardRef((c, l) => {
    ...
    for (const [m, g] of Object.entries(c))
      Wl.has(m) ? h[m === "className" ? "class" : m] = g : i.has(m) || m in r.prototype ? p[m] = g : h[m] = g;
    return e.useLayoutEffect(() => {
      if (f.current !== null) {
        for (const m in p)
          ql(f.current, m, c[m], d.current ? d.current[m] : void 0, o);
        d.current = c;
      }
    }), e.useLayoutEffect(() => {
      var m;
...
`, ur = (e = "value") => (t, r) => {
  ...
  o.prototype.attributeChangedCallback = function(i, n, c) {
    ...
    if (i === f) {
      const h = d.converter || Tr, m = (typeof h == "function" ? h : (l = h == null ? void 0 : h.fromAttribute) != null ? l : Tr.fromAttribute)(c, d.type);
      this[e] !== m && (this[r] = m);
    }
    s.call(this, i, n, c);
  };
}, Wr = /* @__PURE__ */ new WeakMap(), qr = /* @__PURE__ */ new WeakMap(), Kr = /* @__PURE__ */ new WeakMap(), ms = /* @__PURE__ */ new WeakSet(), Co = /* @__PURE__ */ new WeakMap(), Dt = class {
  constructor(e, t) {
    this.handleFormData = (r) => {
      ...
      return !0;
    }, (this.host = e).addController(this), this.options = Mt({
      form: (r) => {
        const o = r.form;
        if (o) {
  ...
  valid: !0,
  valueMissing: !1
}), Gl = Object.freeze(po(Mt({}, Jo), {
  valid: !1,
  valueMissing: !0
})), Jl = Object.freeze(po(Mt({}, Jo), {
  valid: !1,
  customError: !0
})), Xe = class {
  constructor(e, ...t) {
...
var ec = {
  name: "default",
  resolver: (e) => Ql(`assets/icons/${e}.svg`)
}, tc = ec, Wi = {
  caret: `
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const lc = (e, t) => t === void 0 ? (e == null ? void 0 : e._$litType$) !== void 0 : (e == null ? void 0 : e._$litType$) === t, oa = (e) => e.strings === void 0, cc = {}, dc = (e, t = cc) => e._$AH = t;
var Yr = Symbol(), So = Symbol(), gs, bs = /* @__PURE__ */ new Map(), xe = class extends I {
  constructor() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const zt = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, fo = (e) => (...t) => ({ _$litDirective$: e, values: t });
let mo = class {
  constructor(t) {
  }
  get _$AU() {
...
var Me = class extends I {
  constructor() {
    super(...arguments), this.formControlController = new Dt(this, {
...
], Me.prototype, "handleStateChange", 1);
var uc = L`
  :host {
    --track-width: 2px;
...
`;
const Bs = /* @__PURE__ */ new Set(), hc = new MutationObserver(aa), $r = /* @__PURE__ */ new Map();
let sa = document.documentElement.dir || "ltr", ia = document.documentElement.lang || navigator.language, or;
...
function na(...e) {
  e.map((t) => {
    ...
    $r.has(r) ? $r.set(r, Object.assign(Object.assign({}, $r.get(r)), t)) : $r.set(r, t), or || (or = t);
  }), aa();
}
function aa() {
  sa = document.documentElement.dir || "ltr", ia = document.documentElement.lang || navigator.language, [...Bs.keys()].map((e) => {
...
let pc = class {
  ...
  dir() {
    return `${this.host.dir || sa}`.toLowerCase();
  }
  lang() {
    return `${this.host.lang || ia}`.toLowerCase();
  }
...
Pr.styles = [F, uc];
var ca = /* @__PURE__ */ new Map(), mc = /* @__PURE__ */ new WeakMap();
function gc(e) {
...
var Ne = class Fs extends I {
  ...
  async animateExpand() {
    this.emit("sl-expand"), await Pe(this.childrenContainer), this.childrenContainer.hidden = !1;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const da = Symbol.for(""), _c = (e) => {
  if ((e == null ? void 0 : e.r) === da)
...
})(o) + e[s + 1], e[0]), r: da }), Gi = /* @__PURE__ */ new Map(), kc = (e) => (t, ...r) => {
  const o = r.length;
  let s, i;
  const n = [], c = [];
  let l, d = 0, f = !1;
...
var Cc = 0, _t = class extends I {
  constructor() {
    super(...arguments), this.localize = new de(this), this.attrId = ++Cc, this.componentId = `sl-tab-${this.attrId}`, this.panel = "", this.active = !1, this.closable = !1, this.disabled = !1;
  }
  connectedCallback() {
...
_t.styles = [F, wc];
_t.dependencies = { "sl-icon-button": De };
a([
  A(".tab")
], _t.prototype, "tab", 2);
a([
...
`, Ec = 0, Dr = class extends I {
  constructor() {
    super(...arguments), this.attrId = ++Ec, this.componentId = `sl-tab-panel-${this.attrId}`, this.name = "", this.active = !1;
  }
  connectedCallback() {
...
function Us(e, t, r = "vertical", o = "smooth") {
  const s = Tc(e, t), i = s.top + t.scrollTop, n = s.left + t.scrollLeft, c = t.scrollLeft, l = t.scrollLeft + t.offsetWidth, d = t.scrollTop, f = t.scrollTop + t.offsetHeight;
...
Ze.styles = [F, Ac];
Ze.dependencies = { "sl-icon-button": De };
a([
  A(".tab-group")
...
Lt.styles = [F, Ic];
Lt.dependencies = { "sl-icon-button": De };
a([
  u({ reflect: !0 })
...
`;
const Kt = Math.min, st = Math.max, Vo = Math.round, $o = Math.floor, Yt = (e) => ({
  x: e,
  y: e
}), Dc = {
  left: "right",
...
function Ji(e, t, r) {
  ...
  const i = go(t), n = ii(t), c = si(n), l = Xt(t), d = i === "y", f = o.x + o.width / 2 - s.width / 2, h = o.y + o.height / 2 - s.height / 2, p = o[c] / 2 - s[c] / 2;
  let m;
  switch (l) {
    case "top":
      m = {
...
async function ni(e, t) {
  ...
  const {
    ...
    altBoundary: p = !1,
    padding: m = 0
  } = Lr(t, e), g = ha(m), y = c[p ? h === "floating" ? "reference" : "floating" : h], k = Ho(await i.getClippingRect({
...
const Wc = (e) => ({
  ...
  async fn(t) {
    ...
    const h = ha(f), p = {
      x: r,
      y: o
    }, m = ii(s), g = si(m), b = await n.getDimensions(d), y = m === "y", k = y ? "top" : "left", x = y ? "bottom" : "right", _ = y ? "clientHeight" : "clientWidth", w = i.reference[g] + i.reference[m] - p[m] - i.floating[g], v = p[m] - i.reference[m], z = await (n.getOffsetParent == null ? void 0 : n.getOffsetParent(d));
    let V = z ? z[_] : 0;
    (!V || !await (n.isElement == null ? void 0 : n.isElement(z))) && (V = c.floating[_] || i.floating[g]);
    const j = w / 2 - v / 2, P = V / 2 - b[g] / 2 - 1, S = Kt(h[k], P), X = Kt(h[x], P), Y = S, ve = V - b[g] - X, W = V / 2 - b[g] / 2 + j, _e = js(Y, W, ve), ye = !l.arrow && Br(s) != null && W != _e && i.reference[g] / 2 - (W < Y ? S : X) - b[g] / 2 < 0, Le = ye ? W < Y ? W - Y : W - ve : 0;
    return {
      [m]: p[m] + Le,
      data: {
        [m]: _e,
        centerOffset: W - _e - Le,
        ...ye && {
          alignmentOffset: Le
        }
      },
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((r = i.arrow) != null && r.alignmentOffset)
        return {};
      const k = Xt(s), x = Xt(c) === c, _ = await (l.isRTL == null ? void 0 : l.isRTL(d.floating)), w = p || (x || !b ? [Fo(c)] : Vc(c));
      !p && g !== "none" && w.push(...Hc(c, b, g, _));
      const v = [c, ...w], z = await ni(t, y), V = [];
      ...
      if (j = [...j, {
        ...
        var P, S;
        const Y = (((P = i.flip) == null ? void 0 : P.index) || 0) + 1, ve = v[Y];
        if (ve)
          return {
            data: {
              index: Y,
        ...
        if (!W)
          switch (m) {
            case "bestFit": {
              var X;
              const _e = (X = j.map((ye) => [ye.placement, ye.overflows.filter((Le) => Le > 0).reduce((Le, Ot) => Le + Ot, 0)]).sort((ye, Le) => ye[1] - Le[1])[0]) == null ? void 0 : X[0];
              _e && (W = _e);
              break;
            }
...
async function Kc(e, t) {
  const {
    ...
    platform: o,
    elements: s
  } = e, i = await (o.isRTL == null ? void 0 : o.isRTL(s.floating)), n = Xt(r), c = Br(r), l = go(r) === "y", d = ["left", "top"].includes(n) ? -1 : 1, f = i && l ? -1 : 1, h = Lr(t, e);
  let {
    mainAxis: p,
    crossAxis: m,
    alignmentAxis: g
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: r,
        y: o
      }, f = await ni(t, l), h = go(Xt(s)), p = ua(h);
      let m = d[p], g = d[h];
      if (i) {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        ...c
      } = Lr(e, t), l = await ni(t, c), d = Xt(r), f = Br(r), h = go(r) === "y", {
        width: p,
        height: m
      } = o.floating;
      let g, b;
      ...
      if (x && !f) {
        const z = st(l.left, 0), V = st(l.right, 0), j = st(l.top, 0), P = st(l.bottom, 0);
        h ? w = p - 2 * (z !== 0 || V !== 0 ? z + V : st(l.left, l.right)) : _ = m - 2 * (j !== 0 || P !== 0 ? j + P : st(l.top, l.bottom));
      }
      await n({
        ...t,
        availableWidth: w,
...
function fa(e) {
  const t = Nr(e);
  return Zo(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : Tt(t) && bo(t) ? t : fa(t);
}
function uo(e, t, r) {
  var o;
  t === void 0 && (t = []), r === void 0 && (r = !0);
  const s = fa(e), i = s === ((o = e.ownerDocument) == null ? void 0 : o.body), n = at(s);
...
function ma(e) {
  ...
  const s = Tt(e), i = s ? e.offsetWidth : r, n = s ? e.offsetHeight : o, c = Vo(r) !== i || Vo(o) !== n;
  return c && (r = i, o = n), {
    width: r,
    height: o,
    $: c
...
function ga(e) {
  const t = at(e);
  return !li() || !t.visualViewport ? Qc : {
    x: t.visualViewport.offsetLeft,
    y: t.visualViewport.offsetTop
  };
}
function ed(e, t, r) {
  return t === void 0 && (t = !1), !r || t && r !== at(e) ? !1 : t;
}
function cr(e, t, r, o) {
  t === void 0 && (t = !1), r === void 0 && (r = !1);
  const s = e.getBoundingClientRect(), i = ci(e);
  let n = Yt(1);
  t && (o ? Rt(o) && (n = zr(o)) : n = zr(e));
  const c = ed(i, r, o) ? ga(i) : Yt(0);
  let l = (s.left + c.x) / n.x, d = (s.top + c.y) / n.y, f = s.width / n.x, h = s.height / n.y;
  if (i) {
    const p = at(i), m = o && Rt(o) ? at(o) : o;
    let g = p.frameElement;
    for (; g && o && m !== p; ) {
      const b = zr(g), y = g.getBoundingClientRect(), k = ht(g), x = y.left + (g.clientLeft + parseFloat(k.paddingLeft)) * b.x, _ = y.top + (g.clientTop + parseFloat(k.paddingTop)) * b.y;
      l *= b.x, d *= b.y, f *= b.x, h *= b.y, l += x, d += _, g = at(g).frameElement;
    }
  }
  return Ho({
    width: f,
...
function td(e) {
  ...
  const l = Yt(0);
  if ((s || !s && o !== "fixed") && ((Gt(r) !== "body" || bo(i)) && (n = Qo(r)), Tt(r))) {
    const d = cr(r);
    c = zr(r), l.x = d.x + r.clientLeft, l.y = d.y + r.clientTop;
  }
  return {
    width: t.width * c.x,
    height: t.height * c.y,
...
function ba(e) {
  return cr(Bt(e)).left + Qo(e).scrollLeft;
}
function od(e) {
  const t = Bt(e), r = Qo(e), o = e.ownerDocument.body, s = st(t.scrollWidth, t.clientWidth, o.scrollWidth, o.clientWidth), i = st(t.scrollHeight, t.clientHeight, o.scrollHeight, o.clientHeight);
  let n = -r.scrollLeft + ba(e);
  const c = -r.scrollTop;
  return ht(o).direction === "rtl" && (n += st(t.clientWidth, o.clientWidth) - s), {
    width: s,
    height: i,
    x: n,
    y: c
...
function sd(e, t) {
  const r = at(e), o = Bt(e), s = r.visualViewport;
...
function id(e, t) {
  const r = cr(e, !0, t === "fixed"), o = r.top + e.clientTop, s = r.left + e.clientLeft, i = Tt(e) ? zr(e) : Yt(1), n = e.clientWidth * i.x, c = e.clientHeight * i.y, l = s * i.x, d = o * i.y;
  return {
    width: n,
    height: c,
    x: l,
...
function va(e, t) {
  const r = Nr(e);
  return r === t || !Rt(r) || Zo(r) ? !1 : ht(r).position === "fixed" || va(r, t);
}
function nd(e, t) {
  const r = t.get(e);
  if (r)
    return r;
  let o = uo(e, [], !1).filter((c) => Rt(c) && Gt(c) !== "body"), s = null;
  const i = ht(e).position === "fixed";
  let n = i ? Nr(e) : e;
  for (; Rt(n) && !Zo(n); ) {
    const c = ht(n), l = ai(n);
    !l && c.position === "fixed" && (s = null), (i ? !l && !s : !l && c.position === "static" && !!s && ["absolute", "fixed"].includes(s.position) || bo(n) && !l && va(e, n)) ? o = o.filter((f) => f !== n) : s = c, n = Nr(n);
  }
  return t.set(e, o), o;
}
function ad(e) {
  ...
  const n = [...r === "clippingAncestors" ? nd(t, this._c) : [].concat(r), o], c = n[0], l = n.reduce((d, f) => {
    const h = Qi(t, f, s);
    return d.top = st(h.top, d.top), d.right = Kt(h.right, d.right), d.bottom = Kt(h.bottom, d.bottom), d.left = st(h.left, d.left), d;
  }, Qi(t, c, s));
  return {
...
function cd(e, t, r) {
  const o = Tt(t), s = Bt(t), i = r === "fixed", n = cr(e, !0, i, t);
  let c = {
    scrollLeft: 0,
    scrollTop: 0
  };
...
function ya(e, t) {
  ...
  if (!Tt(e))
    return r;
  let o = en(e, t);
  for (; o && Jc(o) && ht(o).position === "static"; )
    o = en(o, t);
  return o && (Gt(o) === "html" || Gt(o) === "body" && ht(o).position === "static" && !ai(o)) ? r : o || Zc(e) || r;
}
const dd = async function(e) {
  ...
  const s = this.getOffsetParent || ya, i = this.getDimensions;
  return {
    reference: cd(t, await s(r), o),
    floating: {
      x: 0,
      y: 0,
      ...await i(r)
...
function hd(e, t) {
  ...
  function n(c, l) {
    ...
    if (c || t(), !h || !p)
      return;
    const m = $o(f), g = $o(s.clientWidth - (d + h)), b = $o(s.clientHeight - (f + p)), y = $o(d), x = {
      rootMargin: -m + "px " + -g + "px " + -b + "px " + -y + "px",
      threshold: st(0, Kt(1, l)) || 1
    };
    let _ = !0;
    function w(v) {
...
const fd = Xc, md = qc, tn = Gc, gd = Wc, bd = (e, t, r) => {
...
var ue = class extends I {
  ...
  reposition() {
    ...
    const e = [
      ...
      Yc({ mainAxis: this.distance, crossAxis: this.skidding })
    ];
    this.sync ? e.push(
      tn({
        apply: ({ rects: r }) => {
    ...
    const t = this.strategy === "absolute" ? (r) => Io.getOffsetParent(r, vd) : Io.getOffsetParent;
  ...
  async handleOpenChange() {
    ...
    if (this.open) {
      ...
      this.emit("sl-show"), "CloseWatcher" in window ? ((e = this.closeWatcher) == null || e.destroy(), this.closeWatcher = new CloseWatcher(), this.closeWatcher.onclose = () => {
        this.hide();
      }) : document.addEventListener("keydown", this.handleDocumentKeyDown), await Pe(this.body), this.body.hidden = !1, this.popup.active = !0;
      ...
      this.emit("sl-hide"), (t = this.closeWatcher) == null || t.destroy(), document.removeEventListener("keydown", this.handleDocumentKeyDown), await Pe(this.body);
...
var Jt = class extends I {
  constructor() {
    super(), this.selection = "single", this.localize = new de(this), this.clickTarget = null, this.initTreeItem = (e) => {
      ...
      for (const t of e) {
        const r = [...t.addedNodes].filter(Er.isTreeItem), o = [...t.removedNodes].filter(Er.isTreeItem);
      ...
      const t = e.target;
      e.target === this && this.focusItem(this.lastFocusedItem || this.getAllTreeItems()[0]), Er.isTreeItem(t) && !t.disabled && (this.lastFocusedItem && (this.lastFocusedItem.tabIndex = -1), this.lastFocusedItem = t, this.tabIndex = -1, t.tabIndex = 0);
...
], Jt.prototype, "expandedIconSlot", 2);
a([
  A("slot[name=collapse-icon]")
], Jt.prototype, "collapsedIconSlot", 2);
a([
  u()
], Jt.prototype, "selection", 2);
a([
  E("selection")
], Jt.prototype, "handleSelectionChange", 1);
var kd = "sl-tree";
Jt.define("sl-tree");
M({
  tagName: kd,
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const wa = "important", Od = " !" + wa, Ge = fo(class extends mo {
  constructor(e) {
    var t;
  ...
  update(e, [t]) {
    ...
    for (const o in t) {
      ...
      if (s != null) {
        ...
        o.includes("-") || i ? r.setProperty(o, i ? s.slice(0, -11) : s, i ? wa : "") : r[o] = s;
      }
    }
    return nt;
  }
...
a([
  U()
], Vt.prototype, "isoTime", 2);
a([
  U()
], Vt.prototype, "relativeTime", 2);
a([
  U()
], Vt.prototype, "titleTime", 2);
a([
  u()
], Vt.prototype, "date", 2);
a([
...
`, re = class extends I {
  ...
  async handleOpenChange() {
    if (this.open && !this.disabled) {
      this.setCurrentOption(this.selectedOptions[0] || this.getFirstOption()), this.emit("sl-show"), this.addOpenListeners(), await Pe(this), this.listbox.hidden = !1, this.popup.active = !0, requestAnimationFrame(() => {
...
var Qe = class extends I {
  ...
  handleDrag(e) {
    ...
    this.disabled || (e.cancelable && e.preventDefault(), io(this, {
      onMove: (r, o) => {
        ...
        }), this.position = Re(this.pixelsToPercentage(s), 0, 100);
      },
      initialEvent: e
    }));
  }
  handleKeyDown(e) {
    if (!this.disabled && ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Home", "End"].includes(e.key)) {
      ...
      e.preventDefault(), (e.key === "ArrowLeft" && !this.vertical || e.key === "ArrowUp" && this.vertical) && (t -= r), (e.key === "ArrowRight" && !this.vertical || e.key === "ArrowDown" && this.vertical) && (t += r), e.key === "Home" && (t = this.primary === "end" ? 100 : 0), e.key === "End" && (t = this.primary === "end" ? 0 : 100), this.position = Re(t, 0, 100);
    }
  }
  handleResize(e) {
...
lt.styles = [F, Hd];
lt.dependencies = { "sl-icon": xe };
a([
  A(".option__label")
], lt.prototype, "defaultSlot", 2);
a([
  U()
], lt.prototype, "current", 2);
a([
  U()
], lt.prototype, "selected", 2);
a([
  U()
], lt.prototype, "hasHover", 2);
a([
  u({ reflect: !0 })
...
a([
  E("disabled")
], lt.prototype, "handleDisabledChange", 1);
a([
  E("selected")
], lt.prototype, "handleSelectedChange", 1);
a([
  E("value")
], lt.prototype, "handleValueChange", 1);
var Ud = "sl-option";
lt.define("sl-option");
M({
  tagName: Ud,
...
`;
let xa = null, _a = class {
};
_a.render = function(e, t) {
  xa(e, t);
};
self.QrCreator = _a;
(function(e) {
  ...
  function i(c, l) {
    ...
    for (d = c.getContext("2d"), l.background && (d.fillStyle = l.background, d.fillRect(l.left, l.top, l.size, l.size)), f = g.O, p = l.size / f, d.beginPath(), m = 0; m < f; m += 1)
      for (h = 0; h < f; h += 1) {
        var b = d, y = l.left + h * p, k = l.top + m * p, x = m, _ = h, w = g.a, v = y + p, z = k + p, V = x - 1, j = x + 1, P = _ - 1, S = _ + 1, X = Math.floor(Math.min(0.5, Math.max(0, l.R)) * p), Y = w(x, _), ve = w(V, P), W = w(V, _);
        V = w(V, S);
        var _e = w(x, S);
        S = w(j, S), _ = w(
          j,
          _
        ), j = w(j, P), x = w(x, P), y = Math.round(y), k = Math.round(k), v = Math.round(v), z = Math.round(z), Y ? r(b, y, k, v, z, X, !W && !x, !W && !_e, !_ && !_e, !_ && !x) : o(b, y, k, v, z, X, W && x && ve, W && _e && V, _ && _e && S, _ && x && j);
      }
    ...
    function h(x, _) {
      ...
      if (b == null) {
        ...
        for (; !(w.f() >= 8 * z) && (w.put(236, 8), !(w.f() >= 8 * z)); )
          w.put(17, 8);
        var X = 0;
        for (z = v = 0, V = Array(x.length), j = Array(x.length), P = 0; P < x.length; P += 1) {
          var Y = x[P].j, ve = x[P].o - Y;
          for (v = Math.max(v, Y), z = Math.max(z, ve), V[P] = Array(Y), S = 0; S < V[P].length; S += 1)
            V[P][S] = 255 & w.B()[S + X];
          for (X += Y, S = i.C(ve), Y = o(V[P], S.b() - 1).l(S), j[P] = Array(S.b() - 1), S = 0; S < j[P].length; S += 1)
            ve = S + Y.b() - j[P].length, j[P][S] = 0 <= ve ? Y.c(ve) : 0;
        }
      ...
      for (x = b, w = -1, v = g - 1, z = 7, V = 0, _ = i.F(_), j = g - 1; 0 < j; j -= 2)
        for (j == 6 && --j; ; ) {
          for (P = 0; 2 > P; P += 1)
            m[v][j - P] == null && (S = !1, V < x.length && (S = (x[V] >>> z & 1) == 1), _(v, j - P) && (S = !S), m[v][j - P] = S, --z, z == -1 && (V += 1, z = 7));
          if (v += w, 0 > v || g <= v) {
            v -= w, w = -w;
            break;
          }
...
var He = class extends I {
  constructor() {
    super(...arguments), this.formControlController = new Dt(this), this.hasSlotController = new Xe(this, "help-text", "label"), this.customValidityMessage = "", this.hasButtonGroup = !1, this.errorMessage = "", this.defaultValue = "", this.label = "", this.helpText = "", this.name = "option", this.value = "", this.size = "medium", this.form = "", this.required = !1;
  }
  /** Gets the validity state object */
  get validity() {
    const e = this.required && !this.value;
    return this.customValidityMessage !== "" ? Jl : e ? Gl : Jo;
  }
  /** Gets the validation message */
  get validationMessage() {
    const e = this.required && !this.value;
...
He.styles = [F, Mr, ru];
He.dependencies = { "sl-button-group": Zt };
a([
  A("slot:not([name])")
...
`, Qt = class extends I {
  ...
  handleDrag(e) {
    ...
    e.preventDefault(), io(this.base, {
      onMove: (o) => {
        this.position = parseFloat(Re(o / t * 100, 0, 100).toFixed(2)), r && (this.position = 100 - this.position);
      },
      initialEvent: e
    });
  }
  handleKeyDown(e) {
    ...
    if (["ArrowLeft", "ArrowRight", "Home", "End"].includes(e.key)) {
      ...
      let s = this.position;
      e.preventDefault(), (t && e.key === "ArrowLeft" || r && e.key === "ArrowRight") && (s -= o), (t && e.key === "ArrowRight" || r && e.key === "ArrowLeft") && (s += o), e.key === "Home" && (s = 0), e.key === "End" && (s = 100), s = Re(s, 0, 100), this.position = s;
    }
  }
  handlePositionChange() {
    this.emit("sl-change");
...
Qt.styles = [F, pu];
Qt.scopedElement = { "sl-icon": xe };
a([
  A(".image-comparer")
], Qt.prototype, "base", 2);
a([
  A(".image-comparer__handle")
], Qt.prototype, "handle", 2);
a([
  u({ type: Number, reflect: !0 })
], Qt.prototype, "position", 2);
a([
  E("position", { waitUntilFirstUpdate: !0 })
], Qt.prototype, "handlePositionChange", 1);
var fu = "sl-image-comparer";
Qt.define("sl-image-comparer");
M({
  tagName: fu,
  elementClass: Qt,
  react: N,
...
function wu(e) {
  this._$AN !== void 0 ? (Uo(this), this._$AM = e, Ca(this)) : this._$AM = e;
}
function xu(e, t = !1, r = 0) {
...
const _u = (e) => {
  e.type == zt.CHILD && (e._$AP ?? (e._$AP = xu), e._$AQ ?? (e._$AQ = wu));
};
let ku = class extends mo {
  constructor() {
    super(...arguments), this._$AN = void 0;
  }
  _$AT(t, r, o) {
    super._$AT(t, r, o), Ca(this), this.isConnected = t._$AU;
  }
  _$AO(t, r = !0) {
    var o, s;
...
const ws = /* @__PURE__ */ new WeakMap(), $u = fo(class extends ku {
  render(e) {
    return Ce;
  }
  update(e, [t]) {
...
var Eu = class {
  constructor(e, t, r) {
    this.popupRef = Cu(), this.enableSubmenuTimer = -1, this.isConnected = !1, this.isPopupConnected = !1, this.skidding = 0, this.submenuOpenDelay = 100, this.handleMouseMove = (o) => {
  ...
  constructor() {
    super(...arguments), this.type = "normal", this.checked = !1, this.value = "", this.loading = !1, this.disabled = !1, this.localize = new de(this), this.hasSlotController = new Xe(this, "submenu"), this.submenuController = new Eu(this, this.hasSlotController, this.localize), this.handleHostClick = (e) => {
...
function Uu(e) {
  const t = Sa(e), { overflowY: r, overflowX: o } = t;
...
function ju(e) {
  ...
  return e.hasAttribute("tabindex") && (isNaN(r) || r <= -1) || e.hasAttribute("disabled") || e.closest("[inert]") || t === "input" && e.getAttribute("type") === "radio" && !e.hasAttribute("checked") || !Hu(e) ? !1 : (t === "audio" || t === "video") && e.hasAttribute("controls") || e.hasAttribute("tabindex") || e.hasAttribute("contenteditable") && e.getAttribute("contenteditable") !== "false" || [
    "button",
    "input",
    "select",
    "textarea",
  ...
  function o(s) {
    if (s instanceof Element) {
      if (s.hasAttribute("inert") || s.closest("[inert]") || t.has(s))
        return;
      t.set(s, !0), !r.includes(s) && ju(s) && r.push(s), s instanceof HTMLSlotElement && qu(s, e) && s.assignedElements({ flatten: !0 }).forEach((i) => {
        o(i);
...
function* ui(e = document.activeElement) {
  e != null && (yield e, "shadowRoot" in e && e.shadowRoot && e.shadowRoot.mode !== "closed" && (yield* Fl(ui(e.shadowRoot.activeElement))));
}
function Ku() {
  return [...ui()].pop();
}
...
var tt = class extends I {
  constructor() {
    super(...arguments), this.hasSlotController = new Xe(this, "footer"), this.localize = new de(this), this.modal = new $a(this), this.open = !1, this.label = "", this.placement = "end", this.contained = !1, this.noHeader = !1, this.handleDocumentKeyDown = (e) => {
  ...
  async handleOpenChange() {
    if (this.open) {
      ...
      e && e.removeAttribute("autofocus"), await Promise.all([Pe(this.drawer), Pe(this.overlay)]), this.drawer.hidden = !1, requestAnimationFrame(() => {
      ...
      this.emit("sl-hide"), this.removeOpenListeners(), this.contained || (this.modal.deactivate(), so(this)), await Promise.all([Pe(this.drawer), Pe(this.overlay)]);
...
`, St = class extends I {
  constructor() {
    super(...arguments), this.hasSlotController = new Xe(this, "footer"), this.localize = new de(this), this.modal = new $a(this), this.open = !1, this.label = "", this.noHeader = !1, this.handleDocumentKeyDown = (e) => {
  ...
  async handleOpenChange() {
    if (this.open) {
      ...
      const e = this.querySelector("[autofocus]");
      e && e.removeAttribute("autofocus"), await Promise.all([Pe(this.dialog), Pe(this.overlay)]), this.dialog.hidden = !1, requestAnimationFrame(() => {
        this.emit("sl-initial-focus", { cancelable: !0 }).defaultPrevented || (e ? e.focus({ preventScroll: !0 }) : this.panel.focus({ preventScroll: !0 })), e && e.setAttribute("autofocus", "");
      });
      ...
      this.emit("sl-hide"), this.removeOpenListeners(), this.modal.deactivate(), await Promise.all([Pe(this.dialog), Pe(this.overlay)]);
...
`, qe = class extends I {
  ...
  updateAccessibleTrigger() {
    const t = this.trigger.assignedElements({ flatten: !0 }).find((o) => Wu(o).start);
    let r;
    if (t) {
  ...
  async handleOpenChange() {
    ...
    if (this.updateAccessibleTrigger(), this.open) {
      this.emit("sl-show"), this.addOpenListeners(), await Pe(this), this.panel.hidden = !1, this.popup.active = !0;
...
var Ee = class extends I {
  ...
  goToSlide(e, t = "smooth") {
    ...
    if (!s.length)
      return;
    const n = o ? (e + s.length) % s.length : Re(e, 0, s.length - 1);
    this.activeSlide = n;
    const c = Re(e + (o ? r : 0), 0, i.length - 1), l = i[c];
...
function $h(e) {
  ...
  return typeof e == "string" && (e = Ah(e)), typeof e == "object" && (Nt(e.r) && Nt(e.g) && Nt(e.b) ? (t = wh(e.r, e.g, e.b), n = !0, c = String(e.r).substr(-1) === "%" ? "prgb" : "rgb") : Nt(e.h) && Nt(e.s) && Nt(e.v) ? (o = Ao(e.s), s = Ao(e.v), t = _h(e.h, o, s), n = !0, c = "hsv") : Nt(e.h) && Nt(e.s) && Nt(e.l) && (o = Ao(e.s), i = Ao(e.l), t = xh(e.h, o, i), n = !0, c = "hsl"), Object.prototype.hasOwnProperty.call(e, "a") && (r = e.a)), r = Ea(r), {
    ok: n,
    format: e.format || c,
...
const Eh = "[-\\+]?\\d+%?", zh = "[-\\+]?\\d*\\.\\d+%?", Wt = "(?:" + zh + ")|(?:" + Eh + ")", _s = "[\\s|\\(]+(" + Wt + ")[,|\\s]+(" + Wt + ")[,|\\s]+(" + Wt + ")\\s*\\)?", ks = (
...
function Ah(e) {
  ...
  let r = yt.rgb.exec(e);
  return r ? { r: r[1], g: r[2], b: r[3] } : (r = yt.rgba.exec(e), r ? { r: r[1], g: r[2], b: r[3], a: r[4] } : (r = yt.hsl.exec(e), r ? { h: r[1], s: r[2], l: r[3] } : (r = yt.hsla.exec(e), r ? { h: r[1], s: r[2], l: r[3], a: r[4] } : (r = yt.hsv.exec(e), r ? { h: r[1], s: r[2], v: r[3] } : (r = yt.hsva.exec(e), r ? { h: r[1], s: r[2], v: r[3], a: r[4] } : (r = yt.hex8.exec(e), r ? {
    r: ot(r[1]),
    g: ot(r[2]),
    b: ot(r[3]),
    a: un(r[4]),
...
class Te {
  constructor(t = "", r = {}) {
    if (t instanceof Te)
      return t;
    typeof t == "number" && (t = Sh(t)), this.originalInput = t;
    const o = $h(t);
   ...
   */
  toHex8(t = !1) {
    return kh(this.r, this.g, this.b, this.a, t);
  }
  /**
...
var hn = "EyeDropper" in window, oe = class extends I {
  constructor() {
    super(), this.formControlController = new Dt(this), this.isSafeValue = !1, this.localize = new de(this), this.hasFocus = !1, this.isDraggingGridHandle = !1, this.isEmpty = !1, this.inputValue = "", this.hue = 0, this.saturation = 100, this.brightness = 100, this.alpha = 100, this.value = "", this.defaultValue = "", this.label = "", this.format = "hex", this.inline = !1, this.size = "medium", this.noFormatToggle = !1, this.name = "", this.disabled = !1, this.hoist = !1, this.opacity = !1, this.uppercase = !1, this.swatches = "", this.form = "", this.required = !1, this.handleFocusIn = () => {
      this.hasFocus = !0, this.emit("sl-focus");
    }, this.handleFocusOut = () => {
      this.hasFocus = !1, this.emit("sl-blur");
  ...
  handleAlphaDrag(e) {
    ...
    r.focus(), e.preventDefault(), io(t, {
      onMove: (n) => {
        this.alpha = Re(n / o * 100, 0, 100), this.syncValues(), this.value !== i && (i = this.value, this.emit("sl-input"));
      },
      onStop: () => {
  ...
  handleHueDrag(e) {
    ...
    r.focus(), e.preventDefault(), io(t, {
      onMove: (n) => {
        this.hue = Re(n / o * 360, 0, 360), this.syncValues(), this.value !== i && (i = this.value, this.emit("sl-input"));
      },
      onStop: () => {
        this.value !== s && (s = this.value, this.emit("sl-change"));
      },
  ...
  handleGridDrag(e) {
    ...
    r.focus(), e.preventDefault(), this.isDraggingGridHandle = !0, io(t, {
      onMove: (c, l) => {
        this.saturation = Re(c / o * 100, 0, 100), this.brightness = Re(100 - l / s * 100, 0, 100), this.syncValues(), this.value !== n && (n = this.value, this.emit("sl-input"));
      },
      onStop: () => {
  ...
  handleAlphaKeyDown(e) {
    ...
    e.key === "ArrowLeft" && (e.preventDefault(), this.alpha = Re(this.alpha - t, 0, 100), this.syncValues()), e.key === "ArrowRight" && (e.preventDefault(), this.alpha = Re(this.alpha + t, 0, 100), this.syncValues()), e.key === "Home" && (e.preventDefault(), this.alpha = 0, this.syncValues()), e.key === "End" && (e.preventDefault(), this.alpha = 100, this.syncValues()), this.value !== r && (this.emit("sl-change"), this.emit("sl-input"));
  }
  handleHueKeyDown(e) {
    const t = e.shiftKey ? 10 : 1, r = this.value;
    e.key === "ArrowLeft" && (e.preventDefault(), this.hue = Re(this.hue - t, 0, 360), this.syncValues()), e.key === "ArrowRight" && (e.preventDefault(), this.hue = Re(this.hue + t, 0, 360), this.syncValues()), e.key === "Home" && (e.preventDefault(), this.hue = 0, this.syncValues()), e.key === "End" && (e.preventDefault(), this.hue = 360, this.syncValues()), this.value !== r && (this.emit("sl-change"), this.emit("sl-input"));
  }
  handleGridKeyDown(e) {
    const t = e.shiftKey ? 10 : 1, r = this.value;
    e.key === "ArrowLeft" && (e.preventDefault(), this.saturation = Re(this.saturation - t, 0, 100), this.syncValues()), e.key === "ArrowRight" && (e.preventDefault(), this.saturation = Re(this.saturation + t, 0, 100), this.syncValues()), e.key === "ArrowUp" && (e.preventDefault(), this.brightness = Re(this.brightness + t, 0, 100), this.syncValues()), e.key === "ArrowDown" && (e.preventDefault(), this.brightness = Re(this.brightness - t, 0, 100), this.syncValues()), this.value !== r && (this.emit("sl-change"), this.emit("sl-input"));
  }
  handleInputChange(e) {
...
`, br = Object.assign(document.createElement("div"), { className: "sl-toast-stack" }), $t = class extends I {
  constructor() {
    super(...arguments), this.hasSlotController = new Xe(this, "icon", "suffix"), this.localize = new de(this), this.open = !1, this.closable = !1, this.variant = "primary", this.duration = 1 / 0;
  }
  firstUpdated() {
  ...
  async handleOpenChange() {
    if (this.open) {
      this.emit("sl-show"), this.duration < 1 / 0 && this.restartAutoHide(), await Pe(this.base), this.base.hidden = !1;
      const { keyframes: e, options: t } = Se(this, "alert.show", { dir: this.localize.dir() });
      await Oe(this.base, e, t), this.emit("sl-after-show");
    } else {
      this.emit("sl-hide"), clearTimeout(this.autoHideTimeout), await Pe(this.base);
...
$t.styles = [F, Dh];
$t.dependencies = { "sl-icon-button": De };
a([
  A('[part~="base"]')
], $t.prototype, "base", 2);
a([
...
const Fh = [
  ...
  fadeInUpBig: Tp,
  fadeOut: Op,
  fadeOutBottomLeft: Np,
  fadeOutBottomRight: Ip,
  fadeOutDown: Rp,
  fadeOutDownBig: Pp,
  fadeOutLeft: Mp,
  fadeOutLeftBig: Dp,
  ...
  jello: Wh,
  lightSpeedInLeft: Xp,
  lightSpeedInRight: Gp,
  lightSpeedOutLeft: Jp,
  lightSpeedOutRight: Zp,
  pulse: qh,
  rollIn: wf,
  rollOut: xf,
  rotateIn: Qp,
  rotateInDownLeft: ef,
  rotateInDownRight: tf,
  rotateInUpLeft: rf,
  rotateInUpRight: of,
  rotateOut: sf,
  rotateOutDownLeft: nf,
  rotateOutDownRight: af,
  rotateOutUpLeft: lf,
  rotateOutUpRight: cf,
  rubberBand: Kh,
  shake: Yh,
...
`, Fe = class extends I {
  ...
  async createAnimation() {
    var e, t;
    const r = (e = za[this.easing]) != null ? e : this.easing, o = (t = this.keyframes) != null ? t : Nf[this.name], i = (await this.defaultSlot).assignedElements()[0];
...
var jf = Object.defineProperty, Wf = (e, t, r) => t in e ? jf(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, te = (e, t, r) => (Wf(e, typeof t != "symbol" ? t + "" : t, r), r);
const dr = [
  "GEN",
  "EXO",
  "LEV",
...
function e0(e) {
  return Aa[e - 1].includes("*obsolete*");
}
function t0() {
  const e = {};
...
let dt = rr;
te(dt, "Original", new rr(Ht.Original)), te(dt, "Septuagint", new rr(Ht.Septuagint)), te(dt, "Vulgate", new rr(Ht.Vulgate)), te(dt, "English", new rr(Ht.English)), te(dt, "RussianProtestant", new rr(Ht.RussianProtestant)), te(dt, "RussianOrthodox", new rr(Ht.RussianOrthodox));
function fn(e, t) {
  const r = t[0];
...
var Ra = /* @__PURE__ */ ((e) => (e[e.Valid = 0] = "Valid", e[e.UnknownVersification = 1] = "UnknownVersification", e[e.OutOfRange = 2] = "OutOfRange", e[e.VerseOutOfOrder = 3] = "VerseOutOfOrder", e[e.VerseRepeated = 4] = "VerseRepeated", e))(Ra || {});
const ee = class {
  constructor(t, r, o, s) {
    if (te(this, "firstChapter"), te(this, "lastChapter"), te(this, "lastVerse"), te(this, "hasSegmentsDefined"), te(this, "text"), te(this, "BBBCCCVVVS"), te(this, "longHashCode"), te(this, "versification"), te(this, "rtlMark", "‏"), te(this, "_bookNum", 0), te(this, "_chapterNum", 0), te(this, "_verseNum", 0), te(this, "_verse"), o == null && s == null)
      if (t != null && typeof t == "string") {
        const i = t, n = r != null && r instanceof dt ? r : void 0;
        this.setEmpty(n), this.parse(i);
      } else if (t != null && typeof t == "number") {
        const i = r != null && r instanceof dt ? r : void 0;
        ...
        if (t != null && t instanceof ee) {
          ...
          if (t == null)
            return;
          const i = t instanceof dt ? t : ee.defaultVersification;
          this.setEmpty(i);
        }
      else
   ...
   */
  get book() {
    return Je.bookNumberToId(this.bookNum, "");
  }
  set book(t) {
    this.bookNum = Je.bookIdToNumber(t);
  }
  /**
  ...
  parse(t) {
    if (t = t.replace(this.rtlMark, ""), t.includes("/")) {
      ...
      if (t = i[0], i.length > 1)
        try {
          const n = +i[1].trim();
          this.versification = new dt(Ht[n]);
        } catch {
    ...
    if (o.length !== 2 || Je.bookIdToNumber(r[0]) === 0 || !Number.isInteger(s) || s < 0 || !ee.isVerseParseable(o[1]))
      throw new Jr("Invalid reference : " + t);
   ...
   */
  get internalValid() {
    return this.versification == null ? 1 : this._bookNum <= 0 || this._bookNum > Je.lastBook ? 2 : 0;
  }
  setEmpty(t = ee.defaultVersification) {
    this._bookNum = 0, this._chapterNum = -1, this._verse = void 0, this.versification = t;
  }
  updateInternal(t, r, o) {
    this.bookNum = Je.bookIdToNumber(t), this.chapter = r, this.verse = o;
  }
};
let It = ee;
te(It, "defaultVersification", dt.English), te(It, "verseRangeSeparator", "-"), te(It, "verseSequenceIndicator", ","), te(It, "verseRangeSeparators", [ee.verseRangeSeparator]), te(It, "verseSequenceIndicators", [ee.verseSequenceIndicator]), te(It, "chapterDigitShifter", 1e3), te(It, "bookDigitShifter", ee.chapterDigitShifter * ee.chapterDigitShifter), te(It, "bcvMaxValue", ee.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
te(It, "ValidStatusType", Ra);
class Jr extends Error {
}
function r0({ bookId: e, handleSelect: t, isSelected: r, children: o }) {
  return /* @__PURE__ */ wt("div", { children: [
    /* @__PURE__ */ wt(
      Tu,
      {
        value: e,
        ...
        onClick: () => t(e),
        children: [
          Je.bookIdToEnglishName(e),
          r ? /* @__PURE__ */ D("div", { className: "selected-book-color-label", slot: "prefix" }) : /* @__PURE__ */ D("div", { className: "book-color-label", slot: "prefix" })
        ]
      },
      e
    ),
...
function o0({ endChapter: e }) {
  const t = Array.from({ length: e }, (r, o) => o + 1);
  return /* @__PURE__ */ D("div", { className: "chapter-select", children: t.map((r) => /* @__PURE__ */ D("div", { children: r })) });
}
function db() {
  const { allBookIds: e } = Je, t = e.filter((i) => Je.isBookOT(i)), [r, o] = nr(""), s = (i) => {
    o(i);
  };
  return /* @__PURE__ */ wt("div", { className: "book-chapter-control", children: [
    /* @__PURE__ */ wt(cu, { placeholder: "Deuteronomy 4:7", size: "small", children: [
      /* @__PURE__ */ D(nn, { name: "search", slot: "prefix" }),
      /* @__PURE__ */ D(nn, { name: "clock-history", slot: "suffix" })
    ] }),
    /* @__PURE__ */ wt(vu, { className: "menu", children: [
      /* @__PURE__ */ D(Ru, { children: "Old Testament" }),
      t.map((i) => /* @__PURE__ */ D(
        r0,
        {
          bookId: i,
          handleSelect: () => s(i),
          isSelected: r === i,
          children: r === i ? /* @__PURE__ */ D("div", { className: "selected-book-details", children: /* @__PURE__ */ D(Vu, { summary: Je.bookIdToEnglishName(r), children: /* @__PURE__ */ D(
            o0,
            {
              endChapter: jn(Je.bookIdToNumber(r))
            }
          ) }) }) : void 0
        },
        i
...
function ub({
  ...
  return /* @__PURE__ */ wt(Ya, { children: [
    /* @__PURE__ */ D(
      Ti,
      {
...
function s0({
  ...
  let h;
  if (r) {
    const p = o === Sr.Before || o === Sr.Above, m = /* @__PURE__ */ D("span", { className: `papi-checkbox-label ${c ? "error" : ""} ${l ?? ""}`, children: r }), g = o === Sr.Before || o === Sr.After, b = g ? m : /* @__PURE__ */ D("div", { children: m }), y = g ? f : /* @__PURE__ */ D("div", { children: f });
    h = /* @__PURE__ */ wt(
      el,
      {
...
function n0({ commandHandler: e, name: t, className: r, items: o, id: s }) {
  return /* @__PURE__ */ wt(qn, { id: s, item: !0, xs: "auto", className: `papi-menu-column ${r ?? ""}`, children: [
    /* @__PURE__ */ D("h3", { className: `papi-menu ${r ?? ""}`, children: t }),
    o.map((i, n) => /* @__PURE__ */ D(
      i0,
      {
...
function a0({ commandHandler: e, className: t, columns: r, id: o }) {
  return /* @__PURE__ */ D(
    qn,
    {
      container: !0,
...
let Cs;
const Ss = () => (Cs || (Cs = Je.allBookIds.map((e) => ({
  bookId: e,
  label: Je.bookIdToEnglishName(e)
}))), Cs);
function pb({ scrRef: e, handleSubmit: t, id: r }) {
  const o = (l) => {
    t(l);
  }, s = (l, d) => {
    const h = { bookNum: Je.bookIdToNumber(d.bookId), chapterNum: 1, verseNum: 1 };
    o(h);
  }, i = (l) => {
  ...
  return /* @__PURE__ */ wt("span", { id: r, children: [
    /* @__PURE__ */ D(
      Xs,
      {
        title: "Book",
    ...
    /* @__PURE__ */ D(
      ...
      {
        onClick: () => t(Ai(e, -1)),
        isDisabled: e.verseNum <= Ja,
        children: "<"
      }
    ),
    /* @__PURE__ */ D(vr, { onClick: () => t(Ai(e, 1)), children: ">" })
  ] });
}
function fb({ onSearch: e, placeholder: t, isFullWidth: r }) {
  const [o, s] = nr(""), i = (n) => {
    s(n), e(n);
  };
  return /* @__PURE__ */ D(ol, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ D(
    jo,
    {
      isFullWidth: r,
...
function mn({ onRowChange: e, row: t, column: r }) {
  ...
  return /* @__PURE__ */ D(jo, { defaultValue: t[r.key], onChange: o });
}
const l0 = ({ onChange: e, disabled: t, checked: r, ...o }) => /* @__PURE__ */ D(
  s0,
  {
    ...o,
    isChecked: r,
...
function vb({
  ...
  const Y = Zs(() => {
    const ve = e.map((W) => typeof W.editable == "function" ? {
      ...
      renderEditCell: W.renderEditCell || mn
    } : W.editable && !W.renderEditCell ? { ...W, renderEditCell: mn } : W.renderEditCell && !W.editable ? { ...W, editable: !1 } : W);
    return f ? [{ ...ul, minWidth: h }, ...ve] : ve;
  }, [e, f, h]);
  return /* @__PURE__ */ D(
    dl,
    {
...
function xt(e, t, r = {
  ...
  return jt(e) && jt(t) && Object.keys(t).forEach((s) => {
    s !== "__proto__" && (jt(t[s]) && s in e && jt(e[s]) ? o[s] = xt(e[s], t[s], r) : r.clone ? o[s] = jt(t[s]) ? Pa(t[s]) : t[s] : o[s] = t[s]);
  }), o;
}
function c0(e) {
  return e && e.__esModule && Object.prototype.hasOwnProperty.call(e, "default") ? e.default : e;
}
var Gs = { exports: {} }, To = { exports: {} }, pe = {};
...
function u0() {
  return bn || (bn = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function _(T) {
      ...
      T === o || T === d || T === i || T === s || T === h || T === p || typeof T == "object" && T !== null && (T.$$typeof === g || T.$$typeof === m || T.$$typeof === n || T.$$typeof === c || T.$$typeof === f || T.$$typeof === y || T.$$typeof === k || T.$$typeof === x || T.$$typeof === b);
    }
    function w(T) {
    ...
    var v = l, z = d, V = c, j = n, P = t, S = f, X = o, Y = g, ve = m, W = r, _e = i, ye = s, Le = h, Ot = !1;
    function mr(T) {
      return Ot || (Ot = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), $(T) || w(T) === l;
    }
    function $(T) {
      return w(T) === d;
    }
    ...
    fe.AsyncMode = v, fe.ConcurrentMode = z, fe.ContextConsumer = V, fe.ContextProvider = j, fe.Element = P, fe.ForwardRef = S, fe.Fragment = X, fe.Lazy = Y, fe.Memo = ve, fe.Portal = W, fe.Profiler = _e, fe.StrictMode = ye, fe.Suspense = Le, fe.isAsyncMode = mr, fe.isConcurrentMode = $, fe.isContextConsumer = O, fe.isContextProvider = Q, fe.isElement = J, fe.isForwardRef = q, fe.isFragment = se, fe.isLazy = G, fe.isMemo = Z, fe.isPortal = ie, fe.isProfiler = ce, fe.isStrictMode = ne, fe.isSuspense = Ke, fe.isValidElementType = _, fe.typeOf = w;
  }()), fe;
}
var vn;
function Ma() {
  return vn || (vn = 1, process.env.NODE_ENV === "production" ? To.exports = d0() : To.exports = u0()), To.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function f0() {
  if (kn)
    return Ts;
  kn = 1;
  var e = Ma(), t = h0(), r = bi(), o = Da(), s = p0(), i = function() {
  };
  ...
  return Ts = function(c, l) {
    ...
    function y($) {
      if (process.env.NODE_ENV !== "production")
        var O = {}, Q = 0;
      function J(se, G, Z, ie, ce, ne, Ke) {
        if (ie = ie || p, ne = ne || Z, Ke !== r) {
          if (l) {
            var T = new Error(
    ...
    function V($) {
      ...
      function O(Q, J, q, se, G) {
        for (var Z = Q[J], ie = 0; ie < $.length; ie++)
          if (g(Z, $[ie]))
            return null;
        var ce = JSON.stringify($, function(Ke, T) {
          var ct = Le(T);
    ...
    function P($) {
      ...
      for (var O = 0; O < $.length; O++) {
        ...
        if (typeof Q != "function")
          return i(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + Ot(Q) + " at index " + O + "."
          ), n;
      }
      function J(q, se, G, Z, ie) {
        for (var ce = [], ne = 0; ne < $.length; ne++) {
          var Ke = $[ne], T = Ke(q, se, G, Z, ie, r);
          if (T == null)
            return null;
          T.data && o(T.data, "expectedType") && ce.push(T.data.expectedType);
        }
        var ct = ce.length > 0 ? ", expected one of type [" + ce.join(", ") + "]" : "";
        return new b("Invalid " + Z + " `" + ie + "` supplied to " + ("`" + G + "`" + ct + "."));
      }
      return y(J);
    }
    function S() {
      function $(O, Q, J, q, se) {
        return W(O[Q]) ? null : new b("Invalid " + q + " `" + se + "` supplied to " + ("`" + J + "`, expected a ReactNode."));
      }
      return y($);
    }
    function X($, O, Q, J, q) {
      return new b(
        ($ || "React class") + ": " + O + " type `" + Q + "." + J + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + q + "`."
      );
    }
    function Y($) {
      function O(Q, J, q, se, G) {
        ...
        for (var ce in $) {
          ...
          if (typeof ne != "function")
            return X(q, se, G, ce, Le(ne));
          var Ke = ne(Z, ce, q, se, G + "." + ce, r);
          if (Ke)
            return Ke;
        }
        return null;
...
Valid keys: ` + JSON.stringify(Object.keys($), null, "  ")
    ...
    function ye($) {
      var O = typeof $;
      return Array.isArray($) ? "array" : $ instanceof RegExp ? "object" : _e(O, $) ? "symbol" : O;
    }
    function Le($) {
      if (typeof $ > "u" || $ === null)
        return "" + $;
...
if (process.env.NODE_ENV !== "production") {
  var g0 = Ma(), b0 = !0;
  Gs.exports = f0()(g0.isElement, b0);
} else
  Gs.exports = m0()();
var v0 = Gs.exports;
const we = /* @__PURE__ */ c0(v0);
function Ir(e) {
...
function w0() {
  return $n || ($n = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var z = n, V = i, j = e, P = l, S = r, X = p, Y = h, ve = t, W = s, _e = o, ye = d, Le = f, Ot = !1, mr = !1;
    function $(B) {
    ...
    ge.ContextConsumer = z, ge.ContextProvider = V, ge.Element = j, ge.ForwardRef = P, ge.Fragment = S, ge.Lazy = X, ge.Memo = Y, ge.Portal = ve, ge.Profiler = W, ge.StrictMode = _e, ge.Suspense = ye, ge.SuspenseList = Le, ge.isAsyncMode = $, ge.isConcurrentMode = O, ge.isContextConsumer = Q, ge.isContextProvider = J, ge.isElement = q, ge.isForwardRef = se, ge.isFragment = G, ge.isLazy = Z, ge.isMemo = ie, ge.isPortal = ce, ge.isProfiler = ne, ge.isStrictMode = Ke, ge.isSuspense = T, ge.isSuspenseList = ct, ge.isValidElementType = w, ge.typeOf = v;
  }()), ge;
}
process.env.NODE_ENV === "production" ? Js.exports = y0() : Js.exports = w0();
var En = Js.exports;
const x0 = /^\s*function(?:\s|\s*\/\*.*\*\/\s*)+([^(\s/]*)\s*/;
function _0(e) {
  const t = `${e}`.match(x0);
  return t && t[1] || "";
}
function La(e, t = "") {
  return e.displayName || e.name || _0(e) || t;
}
function zn(e, t, r) {
  const o = La(t);
...
function vi(e, t, r = "Mui") {
  const o = z0[t];
  return o ? `${r}-${o}` : `${E0.generate(e)}-${t}`;
}
function A0(e, t, r = "Mui") {
  const o = {};
  return t.forEach((s) => {
    o[s] = vi(e, s, r);
  }), o;
}
function T0(e, t = Number.MIN_SAFE_INTEGER, r = Number.MAX_SAFE_INTEGER) {
...
function O0() {
  for (var e, t, r = 0, o = "", s = arguments.length; r < s; r++)
    (e = arguments[r]) && (t = Va(e)) && (o && (o += " "), o += t);
  return o;
}
const N0 = ["values", "unit", "step"], I0 = (e) => {
...
function R0(e) {
  const {
    ...
    unit: r = "px",
    step: o = 5
  } = e, s = Ft(e, N0), i = I0(t), n = Object.keys(i);
  function c(p) {
...
const P0 = {
  borderRadius: 4
}, M0 = P0, D0 = process.env.NODE_ENV !== "production" ? we.oneOfType([we.number, we.string, we.object, we.array]) : {}, er = D0;
function ao(e, t) {
  return t ? xt(e, t, {
    clone: !1
...
function Ie(e) {
  const {
    ...
    return Pt(n, c, (h) => {
      let p = Wo(d, s, h);
      return h === p && typeof h == "string" && (p = Wo(d, s, `${t}${h === "default" ? "" : At(h)}`, h)), r === !1 ? p : {
        [r]: p
      };
    });
  };
...
function W0(e, t) {
  return (r) => e.reduce((o, s) => (o[s] = _o(t, r), o), {});
}
function q0(e, t, r, o) {
  if (t.indexOf(r) === -1)
    return null;
  const s = U0(r), i = W0(s, o), n = e[r];
  return Pt(e, n, i);
}
function Ha(e, t) {
  const r = Fa(e.theme);
  return Object.keys(e).map((o) => q0(e, t, o, r)).reduce(ao, {});
}
function ze(e) {
  return Ha(e, os);
}
ze.propTypes = process.env.NODE_ENV !== "production" ? os.reduce((e, t) => (e[t] = er, e), {}) : {};
ze.filterProps = os;
function Ae(e) {
  return Ha(e, ss);
}
Ae.propTypes = process.env.NODE_ENV !== "production" ? ss.reduce((e, t) => (e[t] = er, e), {}) : {};
Ae.filterProps = ss;
process.env.NODE_ENV !== "production" && j0.reduce((e, t) => (e[t] = er, e), {});
function K0(e = 8) {
  if (e.mui)
    return e;
  const t = Fa({
...
const Y0 = vt("border", ut), X0 = vt("borderTop", ut), G0 = vt("borderRight", ut), J0 = vt("borderBottom", ut), Z0 = vt("borderLeft", ut), Q0 = vt("borderColor"), em = vt("borderTopColor"), tm = vt("borderRightColor"), rm = vt("borderBottomColor"), om = vt("borderLeftColor"), sm = vt("outline", ut), im = vt("outlineColor"), ns = (e) => {
  if (e.borderRadius !== void 0 && e.borderRadius !== null) {
    const t = xo(e.theme, "shape.borderRadius", 4, "borderRadius"), r = (o) => ({
      borderRadius: _o(t, o)
    });
...
is(Y0, X0, G0, J0, Z0, Q0, em, tm, rm, om, ns, sm, im);
const as = (e) => {
  if (e.gap !== void 0 && e.gap !== null) {
    const t = xo(e.theme, "spacing", 8, "gap"), r = (o) => ({
      gap: _o(t, o)
    });
    return Pt(e, e.gap, r);
  }
...
const ls = (e) => {
  if (e.columnGap !== void 0 && e.columnGap !== null) {
    const t = xo(e.theme, "spacing", 8, "columnGap"), r = (o) => ({
      columnGap: _o(t, o)
    });
...
const cs = (e) => {
  if (e.rowGap !== void 0 && e.rowGap !== null) {
    const t = xo(e.theme, "spacing", 8, "rowGap"), r = (o) => ({
      rowGap: _o(t, o)
    });
...
is(as, ls, cs, nm, am, lm, cm, dm, um, hm, pm, fm);
function Ar(e, t) {
  return t === "grey" ? t : e;
}
const mm = Ie({
...
function Em() {
  function e(r, o, s, i) {
    ...
    const p = rs(s, d) || {};
    return h ? h(n) : Pt(n, o, (g) => {
      let b = Wo(p, f, g);
      return g === b && typeof g == "string" && (b = Wo(p, f, `${r}${g === "default" ? "" : At(g)}`, g)), l === !1 ? b : {
        [l]: b
      };
    });
  }
  function t(r) {
    ...
    if (!s)
      return null;
    const n = (o = i.unstable_sxConfig) != null ? o : xi;
    function c(l) {
      let d = l;
      ...
      if (!d)
        return null;
      const f = L0(i.breakpoints), h = Object.keys(f);
      let p = f;
...
const Ua = Em();
Ua.filterProps = ["sx"];
const _i = Ua, zm = ["breakpoints", "palette", "spacing", "shape"];
function ki(e = {}, ...t) {
  const {
    breakpoints: r = {},
    palette: o = {},
  ...
  return d = t.reduce((f, h) => xt(f, h), d), d.unstable_sxConfig = ae({}, xi, n == null ? void 0 : n.unstable_sxConfig), d.unstable_sx = function(h) {
    return _i({
      sx: h,
      theme: this
    });
...
function ja(e) {
  ...
  return Object.keys(r).sort().forEach((s) => {
    s === "color" ? o += Nn(o) ? e[s] : At(e[s]) : o += `${Nn(o) ? s : At(s)}${At(e[s].toString())}`;
  }), o;
}
...
const Dm = (e, t) => t.components && t.components[e] && t.components[e].styleOverrides ? t.components[e].styleOverrides : null, qo = (e) => {
  let t = 0;
  const r = {};
  return e && e.forEach((o) => {
    let s = "";
    typeof o.props == "function" ? (s = `callback${t}`, t += 1) : s = ja(o.props), r[s] = o.style;
  }), r;
}, Lm = (e, t) => {
  let r = [];
  ...
  return r && r.forEach((n) => {
    ...
    c && (typeof n.props == "function" ? s.push(t[`callback${i}`]) : s.push(t[ja(n.props)])), typeof n.props == "function" && (i += 1);
  }), s;
}, Bm = (e, t, r, o) => {
  var s;
...
const Vm = ki(), In = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Mo({
  defaultTheme: e,
  theme: t,
  themeId: r
...
function Hm(e = {}) {
  ...
  return i.__mui_systemSx = !0, (n, c = {}) => {
    fl(n, (w) => w.filter((v) => !(v != null && v.__mui_systemSx)));
    const {
      name: l,
      slot: d,
      ...
      overridesResolver: p = Fm(In(d))
    } = c, m = Ft(c, Rm), g = f !== void 0 ? f : (
    ...
    let k = Po;
    d === "Root" || d === "root" ? k = o : d ? k = s : Mm(n) && (k = void 0);
    const x = hl(n, ae({
      shouldForwardProp: k,
      label: y
    }, m)), _ = (w, ...v) => {
      const z = v ? v.map((S) => {
        ...
        if (jt(S)) {
          ...
          return S && S.variants && (Y = S.variants, delete X.variants, X = (ve) => {
            let W = S;
            return Ko(ve, qo(Y), Y).forEach((ye) => {
              W = xt(W, ye);
            }), W;
          }), X;
        }
      ...
      if (process.env.NODE_ENV !== "production") {
        let S;
        l && (S = `${l}${At(d || "")}`), S === void 0 && (S = `Styled(${k0(n)})`), P.displayName = S;
      }
...
function Um(e) {
  ...
  return !t || !t.components || !t.components[r] || !t.components[r].defaultProps ? o : Ba(t.components[r].defaultProps, o);
}
function jm({
  props: e,
  name: t,
...
function Wa(e, t = 0, r = 1) {
  return process.env.NODE_ENV !== "production" && (e < t || e > r) && console.error(`MUI: The value provided ${e} is out of range [${t}, ${r}].`), T0(e, t, r);
}
function Wm(e) {
  e = e.slice(1);
...
function Pn(e) {
  e = Rr(e);
  let t = e.type === "hsl" || e.type === "hsla" ? Rr(qm(e)).values : e.values;
...
function Km(e, t) {
  if (e = Rr(e), t = Wa(t), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - t;
...
const Gm = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, kr = sg, ig = ["mode", "contrastThreshold", "tonalOffset"], Dn = {
...
function Ln(e, t, r, o) {
  ...
  e[t] || (e.hasOwnProperty(r) ? e[t] = e[r] : t === "light" ? e.light = Ym(e.main, s) : t === "dark" && (e.dark = Km(e.main, i)));
}
function ng(e = "light") {
  return e === "dark" ? {
    main: xr[200],
...
function hg(e) {
  const {
    ...
    tonalOffset: o = 0.2
  } = e, s = Ft(e, ig), i = e.primary || ng(t), n = e.secondary || ag(t), c = e.error || lg(t), l = e.info || cg(t), d = e.success || dg(t), f = e.warning || ug(t);
  function h(b) {
    const y = Mn(b, Ns.text.primary) >= r ? Ns.text.primary : Dn.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const k = Mn(b, y);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return Ln(b, "light", x, o), Ln(b, "dark", _, o), b.contrastText || (b.contrastText = h(b.main)), b;
  }, m = {
    dark: Ns,
    light: Dn
  };
...
const gg = 0.2, bg = 0.14, vg = 0.12;
function ke(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${gg})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${bg})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${vg})`].join(",");
}
const yg = ["none", ke(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), ke(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), ke(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), ke(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), ke(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), ke(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), ke(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), ke(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), ke(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), ke(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), ke(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), ke(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), ke(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), ke(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), ke(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), ke(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), ke(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), ke(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), ke(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), ke(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), ke(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), ke(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), ke(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), ke(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], wg = yg, xg = ["duration", "easing", "delay"], _g = {
...
function Sg(e) {
  const t = ae({}, _g, e.easing), r = ae({}, kg, e.duration);
  return ae({
...
`)), Object.keys(d).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(d).join(",")}].`);
      ...
      return (Array.isArray(s) ? s : [s]).map((f) => `${f} ${typeof n == "string" ? n : Fn(n)} ${c} ${typeof l == "string" ? l : Fn(l)}`).join(",");
    }
  }, e, {
    easing: t,
    duration: r
...
const $g = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, Eg = $g, zg = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function Ag(e = {}, ...t) {
  const {
    mixins: r = {},
    palette: o = {},
...
`));
  ...
  return d.unstable_sxConfig = ae({}, xi, n == null ? void 0 : n.unstable_sxConfig), d.unstable_sx = function(h) {
    return _i({
      sx: h,
      theme: this
    });
...
const Ng = (e) => Po(e) && e !== "classes", Ig = Hm({
  themeId: Ka,
  defaultTheme: qa,
  rootShouldForwardProp: Ng
}), Rg = Ig;
function Pg(e) {
...
const Mg = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Dg = (e) => {
  const {
    color: t,
    fontSize: r,
    classes: o
...
}), Si = /* @__PURE__ */ N.forwardRef(function(t, r) {
  const o = Og({
    props: t,
    name: "MuiSvgIcon"
  }), {
    ...
    titleAccess: h,
    viewBox: p = "0 0 24 24"
  } = o, m = Ft(o, Mg), g = /* @__PURE__ */ N.isValidElement(s) && s.type === "svg", b = ae({}, o, {
    color: n,
    component: c,
    fontSize: l,
  ...
  f || (y.viewBox = p);
  const k = Dg(b);
  return /* @__PURE__ */ wt(Lg, ae({
    as: c,
    className: O0(k.root, i),
    focusable: "false",
    color: d,
    ...
    ownerState: b,
    children: [g ? s.props.children : s, h ? /* @__PURE__ */ D("title", {
      children: h
    }) : null]
  }));
});
...
function Bg(e, t) {
  ...
  return process.env.NODE_ENV !== "production" && (r.displayName = `${t}Icon`), r.muiName = Hn.muiName, /* @__PURE__ */ N.memo(/* @__PURE__ */ N.forwardRef(r));
}
const Vg = Bg(/* @__PURE__ */ D("path", {
...
function yb({
  ...
  let y = e;
  return !y && t && (y = t(l)), /* @__PURE__ */ D("div", { ref: p, style: { position: "relative" }, children: /* @__PURE__ */ D(al, { position: "static", id: s, children: /* @__PURE__ */ wt(ll, { className: `papi-toolbar ${o ?? ""}`, variant: "dense", children: [
    y ? /* @__PURE__ */ D(
      Kn,
      {
        edge: "start",
        ...
        onClick: h,
        children: /* @__PURE__ */ D(Vg, {})
      }
    ) : void 0,
    i ? /* @__PURE__ */ D("div", { className: "papi-menu-children", children: i }) : void 0,
    y ? /* @__PURE__ */ D(
      cl,
      {
        ...
        children: /* @__PURE__ */ D(a0, { commandHandler: b, columns: y.columns })
      }
    ) : void 0
  ] }) }) });
}
...
const Hg = (e, t, r = {}) => {
  ...
  o.current = t;
  const s = Rs(r);
  s.current = Fg(s.current);
  const [i, n] = nr(() => o.current), [c, l] = nr(!0);
  return Yo(() => {
    let d = !0;
    return l(!!e), (async () => {
      if (e) {
...
`, "top");
export {
  db as BookChapterControl,
  vr as Button,
  ub as ChapterRangeSelector,
  s0 as Checkbox,
  Xs as ComboBox,
  a0 as GridMenu,
  hb as IconButton,
