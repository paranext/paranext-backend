import is, { jsxs as de, jsx as T, Fragment as Un } from "react/jsx-runtime";
import * as x from "react";
import Rt, { forwardRef as ki, useCallback as Se, useState as Me, useRef as $t, useEffect as fn, useLayoutEffect as xo, useMemo as Lt } from "react";
import { getChaptersForBook as Oi, offsetBook as Eo, FIRST_SCR_BOOK_NUM as as, offsetChapter as To, FIRST_SCR_CHAPTER_NUM as ss, offsetVerse as ko, FIRST_SCR_VERSE_NUM as ls } from "platform-bible-utils";
import * as ge from "@radix-ui/react-dropdown-menu";
import { ChevronRight as cs, Check as us, Circle as ds, History as ps, ArrowDownWideNarrow as fs, Clock as ms, Bookmark as hs } from "lucide-react";
import we, { clsx as gs } from "clsx";
import { twMerge as bs } from "tailwind-merge";
import { Button as vs, Autocomplete as ys, TextField as Si, FormControlLabel as Oo, FormLabel as ws, Checkbox as xs, MenuItem as Es, ListItemText as Ts, ListItemIcon as Ci, Menu as ks, Grid as Pi, List as Os, IconButton as Ni, Drawer as Ss, Paper as Cs, Slider as Ps, Snackbar as Ns, Switch as Rs, AppBar as $s, Toolbar as Ms } from "@mui/material";
import Is, { ThemeContext as _s, internal_processStyles as As } from "@mui/styled-engine";
import * as Ds from "react-dom";
import kn from "react-dom";
import js, { SelectColumn as Bs } from "react-data-grid";
var Ls = Object.defineProperty, Fs = (e, t, n) => t in e ? Ls(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, te = (e, t, n) => (Fs(e, typeof t != "symbol" ? t + "" : t, n), n);
const mt = [
  "GEN",
  "EXO",
  "LEV",
...
function Xs(e) {
  return Ri[e - 1].includes("*obsolete*");
}
function Ys() {
  const e = {};
...
*/
te(Oe, "ValidStatusType", Ai);
class Gt extends Error {
}
function _e(...e) {
  return bs(gs(e));
}
const Js = ge.Root, Zs = ge.Trigger, Qs = x.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ de(
  ge.SubTrigger,
  {
    ref: o,
    className: _e(
    ...
    children: [
      n,
      /* @__PURE__ */ T(cs, { className: "pr-ml-auto pr-h-4 pr-w-4" })
    ]
  }
));
Qs.displayName = ge.SubTrigger.displayName;
const el = x.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ T(
  ge.SubContent,
  {
    ref: n,
    className: _e(
...
el.displayName = ge.SubContent.displayName;
const Di = x.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ T(ge.Portal, { children: /* @__PURE__ */ T(
  ge.Content,
  {
    ref: r,
    sideOffset: t,
...
Di.displayName = ge.Content.displayName;
const ji = x.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ T(
  ge.Item,
  {
    ref: r,
    className: _e(
...
const tl = x.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ de(
  ge.CheckboxItem,
  {
    ref: o,
    className: _e(
    ...
    ...r,
    children: [
      /* @__PURE__ */ T("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ T(ge.ItemIndicator, { children: /* @__PURE__ */ T(us, { className: "pr-h-4 pr-w-4" }) }) }),
      t
    ]
  }
));
tl.displayName = ge.CheckboxItem.displayName;
const nl = x.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ de(
  ge.RadioItem,
  {
    ref: r,
    className: _e(
    ...
    ...n,
    children: [
      /* @__PURE__ */ T("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ T(ge.ItemIndicator, { children: /* @__PURE__ */ T(ds, { className: "pr-h-2 pr-w-2 pr-fill-current" }) }) }),
      t
    ]
  }
));
nl.displayName = ge.RadioItem.displayName;
...
const Bi = x.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ T(
  ge.Separator,
  {
    ref: n,
...
Bi.displayName = ge.Separator.displayName;
...
const nn = ue.allBookIds, sl = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, Po = ["OT", "NT", "DC"], ll = 32 + 32 + 32, cl = [
  /^(\w+)$/i,
...
function Pm({ scrRef: e, handleSubmit: t }) {
  const [n, r] = Me(""), [o, i] = Me(
    ...
    (S) => ul(S).filter((R) => {
      const $ = ue.bookIdToEnglishName(R).toLowerCase(), F = n.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    cl.forEach((S) => {
      const R = n.match(S);
      if (R) {
        const [$, F = void 0, V = void 0] = R.slice(1), D = fl($);
        (ue.isBookIdValid($) || D) && w(
          D ?? $,
          !0,
          F ? parseInt(F, 10) : 1,
          V ? parseInt(V, 10) : 1
    ...
    const { key: R } = S;
    R === "ArrowRight" || R === "ArrowLeft" || R === "ArrowDown" || R === "ArrowUp" || R === "Enter" || v.current.focus();
  }, j = (S) => {
    const { key: R } = S;
    if (c === o) {
      if (R === "Enter") {
      ...
      s + $ <= 0 || s + $ > Kt(c) ? l(0) : (l(s + $), S.preventDefault());
    }
  };
  return fn(() => {
    ...
    const S = setTimeout(() => {
      if (p && g.current && m.current) {
        const $ = m.current.offsetTop - ll;
        g.current.scrollTo({ top: $, behavior: "instant" }), m.current.focus();
      }
    }, 10);
    return () => {
      clearTimeout(S);
    };
  }, [p]), /* @__PURE__ */ T("div", { children: /* @__PURE__ */ de(Js, { modal: !1, open: d, onOpenChange: y, children: [
    /* @__PURE__ */ T(Zs, { asChild: !0, children: /* @__PURE__ */ T(
      rl,
      {
        ref: v,
        value: n,
        ...
        children: [
          ...
          Po.map(
            (S, R) => E(S).length > 0 && /* @__PURE__ */ de("div", { children: [
              ...
              E(S).map(($) => /* @__PURE__ */ T("div", { children: /* @__PURE__ */ T(
                il,
                {
                  bookId: $,
                  handleSelectBook: () => w($, !1),
                  isSelected: o === $,
              ...
              Po.length - 1 !== R ? /* @__PURE__ */ T(Bi, {}) : void 0
            ] }, S)
          )
        ]
      }
...
function bl() {
  ...
  return ie.AsyncMode = c, ie.ConcurrentMode = u, ie.ContextConsumer = l, ie.ContextProvider = s, ie.Element = t, ie.ForwardRef = d, ie.Fragment = r, ie.Lazy = v, ie.Memo = b, ie.Portal = n, ie.Profiler = i, ie.StrictMode = o, ie.Suspense = f, ie.isAsyncMode = function(h) {
    ...
    return typeof h == "string" || typeof h == "function" || h === r || h === u || h === i || h === o || h === f || h === p || typeof h == "object" && h !== null && (h.$$typeof === v || h.$$typeof === b || h.$$typeof === s || h.$$typeof === l || h.$$typeof === d || h.$$typeof === m || h.$$typeof === E || h.$$typeof === M || h.$$typeof === g);
  }, ie.typeOf = y, ie;
}
var ae = {};
/** @license React v16.13.1
...
function vl() {
  return Ro || (Ro = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function y(_) {
      ...
      _ === r || _ === u || _ === i || _ === o || _ === f || _ === p || typeof _ == "object" && _ !== null && (_.$$typeof === v || _.$$typeof === b || _.$$typeof === s || _.$$typeof === l || _.$$typeof === d || _.$$typeof === m || _.$$typeof === E || _.$$typeof === M || _.$$typeof === g);
    }
    function w(_) {
    ...
    var h = c, C = u, P = l, B = s, j = t, S = d, R = r, $ = v, F = b, V = n, D = i, I = o, L = f, Q = !1;
    function Z(_) {
...
function xl() {
  if (Do)
    return dr;
  Do = 1;
  var e = Fi(), t = yl(), n = Lr(), r = Vi(), o = wl(), i = function() {
  };
...
function Ye(e, t, n = {
  ...
  return pt(e) && pt(t) && Object.keys(t).forEach((o) => {
    o !== "__proto__" && (pt(t[o]) && o in e && pt(e[o]) ? r[o] = Ye(e[o], t[o], n) : n.clone ? r[o] = pt(t[o]) ? zi(t[o]) : t[o] : r[o] = t[o]);
  }), r;
}
function Sl(e) {
  const {
...
const Hi = Vt(a.element, Ui);
Hi.isRequired = Vt(a.element.isRequired, Ui);
const mn = Hi;
function Cl(e) {
  const {
    prototype: t = {}
...
function Ml() {
  return Lo || (Lo = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), i = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), u = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), p = Symbol.for("react.lazy"), b = Symbol.for("react.offscreen"), v = !1, g = !1, m = !1, E = !1, M = !1, y;
    y = Symbol.for("react.module.reference");
    function w(N) {
      return !!(typeof N == "string" || typeof N == "function" || N === n || N === o || M || N === r || N === u || N === d || E || N === b || v || g || m || typeof N == "object" && N !== null && (N.$$typeof === p || N.$$typeof === f || N.$$typeof === i || N.$$typeof === s || N.$$typeof === c || // This needs to include all possible module reference object
    ...
    var C = s, P = i, B = e, j = c, S = n, R = p, $ = f, F = t, V = o, D = r, I = u, L = d, Q = !1, Z = !1;
    function O(N) {
...
Qi.isRequired = Zi;
Cr.isRequired = Cr;
const ea = process.env.NODE_ENV === "production" ? Cr : Qi;
function ta(e, t) {
  const n = k({}, t);
...
function cc(e) {
  ...
  const s = ia(k({}, o, r)), l = Wo(r), c = Wo(o), u = t(s), d = we(u == null ? void 0 : u.className, n == null ? void 0 : n.className, i, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = k({}, u == null ? void 0 : u.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), p = k({}, u, n, c, l);
...
`)), v.current.setAttribute("tabIndex", "-1")), b.current && v.current.focus()), () => {
    ...
    const y = xe(v.current), w = (P) => {
      ...
      if ((y.activeElement === u.current || y.activeElement === d.current) && (B = i(v.current)), B.length > 0) {
        var j, S;
        const R = !!((j = m.current) != null && j.shiftKey && ((S = m.current) == null ? void 0 : S.key) === "Tab"), $ = B[0], F = B[B.length - 1];
        typeof $ != "string" && typeof F != "string" && (R ? F.focus() : $.focus());
      } else
        P.focus();
    };
...
process.env.NODE_ENV !== "production" && (Dn["propTypes"] = Wi(Dn.propTypes));
function wc(e) {
...
const cn = /* @__PURE__ */ x.forwardRef(function(t, n) {
  ...
  return /* @__PURE__ */ T(x.Fragment, {
    children: s && /* @__PURE__ */ Ds.createPortal(r, s)
  });
});
...
process.env.NODE_ENV !== "production" && (cn["propTypes"] = Wi(cn.propTypes));
function xc(e) {
  const t = xe(e);
...
function Nc(e) {
  const {
    ...
    open: d,
    rootRef: f
  } = e, p = x.useRef({}), b = x.useRef(null), v = x.useRef(null), g = Le(v, f), [m, E] = x.useState(!d), M = Cc(c);
  let y = !0;
  ...
  const w = () => xe(b.current), h = () => (p.current.modalRef = v.current, p.current.mount = b.current, p.current), C = () => {
    ...
    b.current = I, I && (d && B() ? C() : v.current && rn(v.current, y));
  }), S = x.useCallback(() => {
    o.remove(h(), y);
  }, [y, o]);
  x.useEffect(() => () => {
  ...
  const R = (I) => (L) => {
    var Q;
    (Q = I.onKeyDown) == null || Q.call(I, L), !(L.key !== "Escape" || L.which === 229 || // Wait until IME is settled.
    !B()) && (n || (L.stopPropagation(), u && u(L, "escapeKeyDown")));
  }, $ = (I) => (L) => {
    var Q;
    (Q = I.onClick) == null || Q.call(I, L), L.target === L.currentTarget && u && u(L, "backdropClick");
  };
  return {
    getRootProps: (I = {}) => {
      const L = ia(e);
...
var Ce = "top", Fe = "bottom", Ve = "right", Pe = "left", Vr = "auto", gn = [Ce, Fe, Ve, Pe], At = "start", un = "end", Rc = "clippingParents", la = "viewport", Xt = "popper", $c = "reference", Ko = /* @__PURE__ */ gn.reduce(function(e, t) {
  return e.concat([t + "-" + At, t + "-" + un]);
}, []), ca = /* @__PURE__ */ [].concat(gn, [Vr]).reduce(function(e, t) {
...
function jt(e, t, n) {
  ...
  var s = bt(e) ? Ae(e) : window, l = s.visualViewport, c = !ua() && n, u = (r.left + (c && l ? l.offsetLeft : 0)) / o, d = (r.top + (c && l ? l.offsetTop : 0)) / i, f = r.width / o, p = r.height / i;
  return {
    width: f,
    height: p,
    top: d,
...
function bn(e) {
  for (var t = Ae(e), n = Xo(e); n && Wc(n) && Ze(n).position === "static"; )
    n = Xo(n);
...
var Kc = function(t, n) {
  ...
  })) : t, fa(typeof t != "number" ? t : ma(t, gn));
};
function Xc(e) {
  ...
  if (!(!i || !s)) {
    var f = Kc(o.padding, n), p = Ur(i), b = c === "y" ? Ce : Pe, v = c === "y" ? Fe : Ve, g = n.rects.reference[d] + n.rects.reference[c] - s[c] - n.rects.popper[d], m = s[c] - n.rects.reference[c], E = bn(i), M = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, y = g / 2 - m / 2, w = f[b], h = M - p[d] - f[v], C = M / 2 - p[d] / 2 + y, P = on(w, C, h), B = c;
...
function Yo(e) {
  ...
  b = m.x, g = m.y;
  var E = s.hasOwnProperty("x"), M = s.hasOwnProperty("y"), y = Pe, w = Ce, h = window;
  if (u) {
  ...
  if (b = $.x, g = $.y, c) {
    var F;
    return Object.assign({}, R, (F = {}, F[w] = M ? "0" : "", F[y] = E ? "0" : "", F.transform = (h.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + g + "px)" : "translate3d(" + b + "px, " + g + "px, 0)", F));
  }
  return Object.assign({}, R, (t = {}, t[w] = M ? g + "px" : "", t[y] = E ? b + "px" : "", t.transform = "", t));
}
function eu(e) {
...
function ha(e) {
  return ["html", "body", "#document"].indexOf(We(e)) >= 0 ? e.ownerDocument.body : Be(e) && Gr(e) ? e : ha(Wn(e));
}
function an(e, t) {
  var n;
  t === void 0 && (t = []);
  var r = ha(e), o = r === ((n = e.ownerDocument) == null ? void 0 : n.body), i = Ae(r), s = o ? [i].concat(i.visualViewport || [], Gr(r) ? r : []) : r, l = t.concat(s);
  return o ? l : (
...
function dn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, l = n.boundary, c = l === void 0 ? Rc : l, u = n.rootBoundary, d = u === void 0 ? la : u, f = n.elementContext, p = f === void 0 ? Xt : f, b = n.altBoundary, v = b === void 0 ? !1 : b, g = n.padding, m = g === void 0 ? 0 : g, E = fa(typeof m != "number" ? m : ma(m, gn)), M = p === Xt ? $c : Xt, y = e.rects.popper, w = e.elements[v ? M : p], h = uu(bt(w) ? w : w.contextElement || at(e.elements.popper), c, d, s), C = jt(e.elements.reference), P = ga({
    reference: C,
    element: y,
    strategy: "absolute",
    placement: o
  ...
  if (p === Xt && R) {
    ...
    Object.keys(S).forEach(function(F) {
      var V = [Ve, Fe].indexOf(F) >= 0 ? 1 : -1, D = [Ce, Fe].indexOf(F) >= 0 ? "y" : "x";
      S[F] += $[D] * V;
    });
  }
  return S;
...
function du(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, i = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, u = c === void 0 ? ca : c, d = Bt(r), f = d ? l ? Ko : Ko.filter(function(v) {
    return Bt(v) === d;
...
function fu(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, u = n.padding, d = n.boundary, f = n.rootBoundary, p = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, g = n.allowedAutoPlacements, m = t.options.placement, E = Ue(m), M = E === m, y = c || (M || !v ? [Rn(m)] : pu(m)), w = [m].concat(y).reduce(function(z, H) {
      ...
      var R = w[S], $ = Ue(R), F = Bt(R) === At, V = [Ce, Fe].indexOf($) >= 0, D = V ? "width" : "height", I = dn(t, {
        placement: R,
        boundary: d,
        rootBoundary: f,
        altBoundary: p,
      ...
      h[D] > C[D] && (L = Rn(L));
      var Q = Rn(L), Z = [];
      if (i && Z.push(I[$] <= 0), l && Z.push(I[L] <= 0, I[Q] <= 0), Z.every(function(z) {
        return z;
      })) {
        j = R, B = !1;
        break;
...
function hu(e) {
  var t = e.state, n = e.name, r = t.rects.reference, o = t.rects.popper, i = t.modifiersData.preventOverflow, s = dn(t, {
    ...
    altBoundary: !0
  }), c = Qo(s, r), u = Qo(l, o, i), d = ei(c), f = ei(u);
  t.modifiersData[n] = {
...
function vu(e) {
  var t = e.state, n = e.options, r = e.name, o = n.offset, i = o === void 0 ? [0, 0] : o, s = ca.reduce(function(d, f) {
...
function Tu(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, u = n.rootBoundary, d = n.altBoundary, f = n.padding, p = n.tether, b = p === void 0 ? !0 : p, v = n.tetherOffset, g = v === void 0 ? 0 : v, m = dn(t, {
    ...
    padding: f,
    altBoundary: d
  }), E = Ue(t.placement), M = Bt(t.placement), y = !M, w = Hr(E), h = Eu(w), C = t.modifiersData.popperOffsets, P = t.rects.reference, B = t.rects.popper, j = typeof g == "function" ? g(Object.assign({}, t.rects, {
    placement: t.placement
  })) : g, S = typeof j == "number" ? {
    mainAxis: j,
    altAxis: j
    ...
    mainAxis: 0,
    altAxis: 0
  }, j), R = t.modifiersData.offset ? t.modifiersData.offset[t.placement] : null, $ = {
    x: 0,
    y: 0
  };
  if (C) {
    if (i) {
      var F, V = w === "y" ? Ce : Pe, D = w === "y" ? Fe : Ve, I = w === "y" ? "height" : "width", L = C[w], Q = L + m[V], Z = L - m[D], O = b ? -B[I] / 2 : 0, A = M === At ? P[I] : B[I], U = M === At ? -B[I] : -P[I], K = t.elements.arrow, z = b && K ? Ur(K) : {
        width: 0,
        height: 0
      }, H = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : pa(), q = H[V], G = H[D], W = on(0, P[I], z[I]), X = y ? P[I] / 2 - O - W - q - S.mainAxis : A - W - q - S.mainAxis, Y = y ? -P[I] / 2 + O + W + G + S.mainAxis : U + W + G + S.mainAxis, ne = t.elements.arrow && bn(t.elements.arrow), _ = ne ? w === "y" ? ne.clientTop || 0 : ne.clientLeft || 0 : 0, J = (F = R == null ? void 0 : R[w]) != null ? F : 0, N = L + X - J - _, re = L + Y - J, ve = on(b ? jn(Q, N) : Q, L, b ? ft(Z, re) : Z);
      C[w] = ve, $[w] = ve - L;
    }
    if (l) {
      var Te, he = w === "x" ? Ce : Pe, lt = w === "x" ? Fe : Ve, ke = C[h], Ge = h === "y" ? "height" : "width", Ne = ke + m[he], Ke = ke - m[lt], ye = [Ce, Pe].indexOf(E) !== -1, yt = (Te = R == null ? void 0 : R[h]) != null ? Te : 0, ct = ye ? Ne : ke - P[Ge] - B[Ge] - yt + S.altAxis, zt = ye ? ke + P[Ge] + B[Ge] - yt - S.altAxis : Ke, xn = b && ye ? Gc(ct, ke, zt) : on(b ? ct : Ne, ke, b ? zt : Ke);
      C[h] = xn, $[h] = xn - ke;
    }
    t.modifiersData[r] = $;
  }
  ...
  return function(l, c, u) {
    ...
    var d = {
      ...
      forceUpdate: function() {
        if (!p) {
          var E = d.elements, M = E.reference, y = E.popper;
          if (ni(M, y)) {
            d.rects = {
              reference: Pu(M, bn(y), d.options.strategy === "fixed"),
              popper: Ur(y)
...
const Vu = () => et({
  ...
  } = t, m = ce(t, ju), E = x.useRef(null), M = Le(E, n), y = x.useRef(null), w = Le(y, p), h = x.useRef(w);
  ht(() => {
    h.current = w;
...
`));
  ...
  const $ = Vu(), F = (r = v.root) != null ? r : "div", V = gt({
    elementType: F,
  ...
  const {
    ...
    slotProps: m = {},
    slots: E = {}
  } = t, M = ce(t, Bu), [y, w] = x.useState(!0), h = () => {
    w(!1);
  }, C = () => {
    w(!0);
  };
...
const Xd = Zr(), ii = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Cn({
  defaultTheme: e,
  theme: t,
  themeId: n
...
function Jd(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, l = {}) => {
    As(s, (h) => h.filter((C) => !(C != null && C.__mui_systemSx)));
    const {
      name: c,
      slot: u,
    ...
    const M = Is(s, k({
      ...
      c && p && B.push((R) => {
        ...
        if (!$.components || !$.components[c] || !$.components[c].styleOverrides)
          return null;
        const F = $.components[c].styleOverrides, V = {};
        return Object.entries(F).forEach(([D, I]) => {
          V[D] = Mn(I, k({}, R, {
            theme: $
          }));
        }), p(R, V);
        ...
        const F = Cn(k({}, R, {
          defaultTheme: n,
          themeId: t
        })), V = F == null || ($ = F.components) == null || ($ = $[c]) == null ? void 0 : $.variants;
        return Mn({
          variants: V
        }, k({}, R, {
          theme: F
      ...
      if (Array.isArray(h) && j > 0) {
        const R = new Array(j).fill("");
        P = [...h, ...R], P.raw = [...h.raw, ...R];
      }
      const S = M(P, ...B);
      if (process.env.NODE_ENV !== "production") {
        let R;
        c && (R = `${c}${He(u || "")}`), R === void 0 && (R = `Styled(${Al(s)})`), S.displayName = R;
      }
...
function Zd(e) {
  ...
  return !t || !t.components || !t.components[n] || !t.components[n].defaultProps ? r : ta(t.components[n].defaultProps, r);
}
function Qd({
  props: e,
  name: t,
...
const ip = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Ot = fp, mp = ["mode", "contrastThreshold", "tonalOffset"], li = {
...
function xp(e) {
  ...
  function f(g) {
    const m = si(g, hr.text.primary) >= n ? hr.text.primary : li.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const E = si(g, m);
...
`)), Object.keys(u).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(u).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((d) => `${d} ${typeof s == "string" ? s : pi(s)} ${l} ${typeof c == "string" ? c : pi(c)}`).join(",");
    }
  }, e, {
    easing: t,
    duration: n
...
const Lp = Bp(), eo = Lp, to = "$$material", ka = (e) => $n(e) && e !== "classes", Fp = Jd({
  themeId: to,
  defaultTheme: eo,
...
const Oa = Rt.createContext(null);
var Up = function(t) {
  return t.scrollTop;
  ...
  return n.componentDidMount = function() {
    ...
    return (
      ...
      /* @__PURE__ */ Rt.createElement(Oa.Provider, {
        value: null
...
const Wp = {
  ...
  } = t, E = ce(t, Hp), M = Qt(), y = x.useRef(), w = wn(), h = x.useRef(null), C = Le(h, i.ref, n), P = (D) => (I) => {
    if (D) {
      const L = h.current;
      I === void 0 ? D(L) : D(L, I);
    }
...
}, mi = qp, Gp = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Kp = Ee(va, {
  name: "MuiPopper",
  slot: "Root",
  overridesResolver: (e, t) => t.root
})({}), Pa = /* @__PURE__ */ x.forwardRef(function(t, n) {
  var r;
  const o = Ea(), i = tt({
    props: t,
    name: "MuiPopper"
...
const Ra = /* @__PURE__ */ x.forwardRef(function(t, n) {
  var r, o, i, s, l, c, u, d, f, p, b, v, g, m, E, M, y, w, h;
  const C = tt({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: J
  } = C, N = ce(C, Jp), re = /* @__PURE__ */ x.isValidElement(B) ? B : /* @__PURE__ */ T("span", {
    children: B
  }), ve = wn(), Te = ve.direction === "rtl", [he, lt] = x.useState(), [ke, Ge] = x.useState(null), Ne = x.useRef(!1), Ke = V || Z, ye = Qt(), yt = Qt(), ct = Qt(), zt = Qt(), [xn, ao] = Xi({
    controlled: H,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const so = (ee) => {
    ...
    Ne.current && ee.type !== "touchstart" || (he && he.removeAttribute("title"), yt.clear(), ct.clear(), I || Pn && L ? yt.start(Pn ? L : I, () => {
      so(ee);
    }) : so(ee));
  }, lo = (ee) => {
    yt.clear(), ct.start(A, () => {
    ...
    onFocus: Ka,
    ref: Xa
  } = Yi(), [, uo] = x.useState(!1), po = (ee) => {
    Ga(ee), co.current === !1 && (uo(!1), lo(ee));
  }, fo = (ee) => {
    he || lt(ee.currentTarget), Ka(ee), co.current === !0 && (uo(!0), rr(ee));
  }, mo = (ee) => {
    Ne.current = !0;
    const Re = re.props;
  ...
  const Za = Le(re.ref, Xa, lt, n);
  !ne && ne !== 0 && (Xe = !1);
  const or = x.useRef(), Qa = (ee) => {
    const Re = re.props;
  ...
  R ? (Ht.title = !Xe && ir && !F ? ne : null, Ht["aria-describedby"] = Xe ? nr : null) : (Ht["aria-label"] = ir ? ne : null, Ht["aria-labelledby"] = Xe && !ir ? nr : null);
...
`));
  ...
  const Wt = {};
  D || (De.onTouchStart = Ya, De.onTouchEnd = Ja), F || (De.onMouseOver = Nn(ho, De.onMouseOver), De.onMouseLeave = Nn(go, De.onMouseLeave), Ke || (Wt.onMouseOver = ho, Wt.onMouseLeave = go)), $ || (De.onFocus = Nn(fo, De.onFocus), De.onBlur = Nn(po, De.onBlur), Ke || (Wt.onFocus = fo, Wt.onBlur = po)), process.env.NODE_ENV !== "production" && re.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${re.props.title}\` or the Tooltip component.`].join(`
`));
  const es = x.useMemo(() => {
    var ee;
    let Re = [{
    ...
    touch: Ne.current
  }), ar = Qp(qt), bo = (r = (o = Y.popper) != null ? o : j.Popper) != null ? r : ef, vo = (i = (s = (l = Y.transition) != null ? l : j.Transition) != null ? s : _) != null ? i : Ir, yo = (c = (u = Y.tooltip) != null ? u : j.Tooltip) != null ? c : tf, wo = (d = (f = Y.arrow) != null ? f : j.Arrow) != null ? d : nf, ts = en(bo, k({}, W, (p = X.popper) != null ? p : S.popper, {
    className: we(ar.popper, W == null ? void 0 : W.className, (b = (v = X.popper) != null ? v : S.popper) == null ? void 0 : b.className)
  }), qt), ns = en(vo, k({}, J, (g = X.transition) != null ? g : S.transition), qt), rs = en(yo, k({}, (m = X.tooltip) != null ? m : S.tooltip, {
    className: we(ar.tooltip, (E = (M = X.tooltip) != null ? M : S.tooltip) == null ? void 0 : E.className)
  }), qt), os = en(wo, k({}, (y = X.arrow) != null ? y : S.arrow, {
  ...
  return /* @__PURE__ */ de(x.Fragment, {
    children: [/* @__PURE__ */ x.cloneElement(re, De), /* @__PURE__ */ T(bo, k({
      ...
      children: ({
        ...
        children: /* @__PURE__ */ de(yo, k({}, rs, {
          children: [ne, P ? /* @__PURE__ */ T(wo, k({}, os, {
            ref: Ge
          })) : null]
        }))
      }))
...
var Ia = ro.default = void 0, hf = mf(ff()), gf = is;
Ia = ro.default = (0, hf.default)(/* @__PURE__ */ (0, gf.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function vi(e, t, n) {
  ...
  const {
    ...
    Es,
    {
      ...
      children: n ? /* @__PURE__ */ de(Un, { children: [
        vi(i, n, !0),
        /* @__PURE__ */ T(Ts, { primary: n, inset: !i && o }),
        f ? /* @__PURE__ */ T(Ci, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ T(Ia, {}) }) : vi(s, n, !1)
      ] }) : m
    }
  );
...
function bf(e) {
  const [t, n] = Me(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: i } = e, s = (u) => {
    ...
    let u = Aa(i).filter((d) => "menuItem" in d.group);
    if (!(r != null && r.id))
  ...
  return /* @__PURE__ */ de(Un, { children: [
    /* @__PURE__ */ T(_a, { onClick: s, ...o, isSubMenuParent: !0 }),
    /* @__PURE__ */ T(
      ks,
      {
        anchorEl: t,
...
function io(e) {
  const { menuDefinition: t, onClick: n, commandHandler: r, includedGroups: o } = e, { items: i, allowForLeadingIcons: s } = Lt(() => {
    const d = o && o.length > 0 ? o : (
      ...
      Aa(t).filter((v) => !("menuItem" in v.group))
  ...
  return /* @__PURE__ */ de(
    Pi,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ T(Os, { id: n, dense: !0, className: i ?? "", children: /* @__PURE__ */ T(
          yf,
          {
            commandHandler: e,
            menuDefinition: t,
...
const Da = /* @__PURE__ */ x.createContext({});
process.env.NODE_ENV !== "production" && (Da.displayName = "ListContext");
const Ef = Da;
function Tf(e) {
  return qe("MuiList", e);
}
...
const Cf = ja, Pf = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
function vr(e, t, n) {
...
function Zt(e, t, n, r, o, i) {
  ...
  for (; l; ) {
    ...
    if (!l.hasAttribute("tabindex") || !Ba(l, i) || c)
      l = o(e, l, n);
    else
      return l.focus(), !0;
  }
...
const La = /* @__PURE__ */ x.forwardRef(function(t, n) {
  const {
    // private
    // eslint-disable-next-line react/prop-types
    actions: r,
...
const Nf = La, Rf = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], $f = {
  entering: {
    opacity: 1
  },
  entered: {
  ...
  const r = wn(), o = {
    ...
    // eslint-disable-next-line react/prop-types
    TransitionComponent: M = Sa
  } = t, y = ce(t, Rf), w = x.useRef(null), h = Le(w, l.ref, n), C = (V) => (D) => {
    if (V) {
      const I = w.current;
      D === void 0 ? V(I) : V(I, D);
    }
    ...
    V.style.webkitTransition = r.transitions.create("opacity", I), V.style.transition = r.transitions.create("opacity", I), d && d(V, D);
  }), j = C(f), S = C(g), R = C((V) => {
    const D = Vn({
      style: m,
      timeout: E,
...
const Lf = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Ff = (e) => {
  ...
  const G = (r = (o = V == null ? void 0 : V.root) != null ? o : E.Root) != null ? r : Vf, W = (i = (s = V == null ? void 0 : V.backdrop) != null ? s : E.Backdrop) != null ? i : d, X = (l = F == null ? void 0 : F.root) != null ? l : M.root, Y = (c = F == null ? void 0 : F.backdrop) != null ? c : M.backdrop, ne = gt({
    elementType: G,
    externalSlotProps: X,
...
const Qf = (e) => {
  ...
  const s = tt({
  ...
  } = s, S = ce(s.TransitionProps, Yf), R = ce(s, Jf), $ = (r = w == null ? void 0 : w.paper) != null ? r : M, F = x.useRef(), V = Le(F, $.ref), D = k({}, s, {
    anchorOrigin: u,
    anchorReference: f,
    elevation: g,
    marginThreshold: m,
    ...
    TransitionProps: S
  }), I = Qf(D), L = x.useCallback(() => {
    if (f === "anchorPosition")
      return process.env.NODE_ENV !== "production" && (d || console.error('MUI: You need to provide a `anchorPosition` prop when using <Popover anchorReference="anchorPosition" />.')), d;
    const J = In(c), N = J && J.nodeType === 1 ? J : xe(F.current).body, re = N.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
...
`));
    ...
    const lt = Te + N.height, ke = he + N.width, Ge = _t(In(c)), Ne = Ge.innerHeight - m, Ke = Ge.innerWidth - m;
    if (m !== null && Te < m) {
      const ye = Te - m;
...
`)), m !== null && he < m) {
  ...
  const q = v || (c ? xe(In(c)).body : void 0), G = (o = y == null ? void 0 : y.root) != null ? o : em, W = (i = y == null ? void 0 : y.paper) != null ? i : Ha, X = gt({
    elementType: W,
    externalSlotProps: k({}, $, {
      style: O ? $.style : k({}, $.style, {
        opacity: 0
      })
    }),
    additionalProps: {
    ...
    ownerState: D,
    className: we(I.paper, $ == null ? void 0 : $.className)
  }), Y = gt({
    elementType: G,
    ...
    ownerState: D,
    className: we(I.root, b)
  }), {
    slotProps: ne
  } = Y, _ = ce(Y, Zf);
  return /* @__PURE__ */ T(G, k({}, _, !oa(G) && {
    slotProps: ne,
    disableScrollLock: j
  }, {
...
const rm = ["onEntering"], om = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], im = {
  ...
  const i = tt({
    ...
    TransitionProps: w,
    variant: E
  }), j = sm(B), S = s && !u && p, R = x.useRef(null), $ = (Z, O) => {
    R.current && R.current.adjustStyleForScrollbar(Z, C), m && m(Z, O);
  }, F = (Z) => {
...
`)), Z.props.disabled || (E === "selectedMenu" && Z.props.selected || V === -1) && (V = O));
  });
  const D = (r = M.paper) != null ? r : cm, I = (o = y.paper) != null ? o : b, L = gt({
    elementType: M.root,
...
function Im({ onSearch: e, placeholder: t, isFullWidth: n }) {
  ...
  return /* @__PURE__ */ T(Cs, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ T(
    zn,
    {
      isFullWidth: n,
...
function jm({
  ...
  return /* @__PURE__ */ T(
    js,
    {
      ...
      className: `papi-table ${R ?? "rdg-light"}`,
      "data-testid": $
    }
  );
}
function Bm({
  ...
  const i = $t(void 0);
  return /* @__PURE__ */ T("div", { ref: i, style: { position: "relative" }, children: /* @__PURE__ */ T($s, { position: "static", id: r, children: /* @__PURE__ */ de(Ms, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ T(
      mm,
      {
        commandHandler: t,
