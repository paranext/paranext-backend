import { jsxs as Pe, jsx as $, Fragment as Go } from "react/jsx-runtime";
import { MenuItem as Yn, ListItemIcon as Ii, ListItemText as Xa, TextField as oi, Menu as Ga, ListSubheader as Ja, Divider as Qa, Button as Za, Autocomplete as el, FormControlLabel as Ri, FormLabel as tl, Checkbox as rl, Grid as Xn, IconButton as Gn, Paper as ol, Slider as sl, Snackbar as il, Switch as nl, AppBar as al, Toolbar as ll, Drawer as cl } from "@mui/material";
import * as I from "react";
import { useCallback as Tt, useState as ft, useMemo as si, useRef as Ls, useEffect as Jo } from "react";
import { getChaptersForBook as ii, offsetBook as Pi, FIRST_SCR_BOOK_NUM as dl, offsetChapter as Mi, FIRST_SCR_CHAPTER_NUM as ul, offsetVerse as Di, FIRST_SCR_VERSE_NUM as hl } from "platform-bible-utils";
import pl, { ThemeContext as fl, internal_processStyles as ml } from "@mui/styled-engine";
import gl, { SelectColumn as bl } from "react-data-grid";
var Bs = "";
function Vs(e) {
  Bs = e;
}
function vl(e = "") {
  if (!Bs) {
    ...
    if (r)
      Vs(r.getAttribute("data-shoelace"));
    else {
      const o = t.find((i) => /shoelace(\.min)?\.js($|\?)/.test(i.src) || /shoelace-autoloader(\.min)?\.js($|\?)/.test(i.src));
      let s = "";
      o && (s = o.getAttribute("src")), Vs(s.split("/").slice(0, -1).join("/"));
    }
  }
  return Bs.replace(/\/$/, "") + (e ? `/${e.replace(/^\//, "")}` : "");
}
var Jn = Object.defineProperty, yl = Object.defineProperties, wl = Object.getOwnPropertyDescriptor, xl = Object.getOwnPropertyDescriptors, Li = Object.getOwnPropertySymbols, _l = Object.prototype.hasOwnProperty, kl = Object.prototype.propertyIsEnumerable, fs = (e, t) => (t = Symbol[e]) ? t : Symbol.for("Symbol." + e), Bi = (e, t, r) => t in e ? Jn(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, Lt = (e, t) => {
  for (var r in t || (t = {}))
    _l.call(t, r) && Bi(e, r, t[r]);
  if (Li)
    for (var r of Li(t))
      kl.call(t, r) && Bi(e, r, t[r]);
  return e;
}, go = (e, t) => yl(e, xl(t)), a = (e, t, r, o) => {
  for (var s = o > 1 ? void 0 : o ? wl(t, r) : t, i = e.length - 1, n; i >= 0; i--)
    (n = e[i]) && (s = (o ? n(t, r, s) : n(s)) || s);
  return o && s && Jn(t, r, s), s;
}, Cl = function(e, t) {
  this[0] = e, this[1] = t;
}, Sl = (e) => {
  var t = e[fs("asyncIterator")], r = !1, o, s = {};
  return t == null ? (t = e[fs("iterator")](), o = (i) => s[i] = (n) => t[i](n)) : (t = t.call(e), o = (i) => s[i] = (n) => {
    if (r) {
      if (r = !1, i === "throw")
        throw n;
      return n;
  ...
  }), s[fs("iterator")] = () => s, o("next"), "throw" in t ? o("throw") : s.throw = (i) => {
    throw i;
  }, "return" in t && o("return"), s;
}, $l = Object.defineProperty, El = (e, t, r) => t in e ? $l(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, ee = (e, t, r) => (El(e, typeof t != "symbol" ? t + "" : t, r), r);
const nr = [
  "GEN",
  "EXO",
  "LEV",
...
function Dr(e, t = !0) {
  return t && (e = e.toUpperCase()), e in Vi ? Vi[e] : 0;
}
function ai(e) {
  return Dr(e) > 0;
}
function zl(e) {
  const t = typeof e == "string" ? Dr(e) : e;
  return t >= 40 && t <= 66;
}
function Al(e) {
  return (typeof e == "string" ? Dr(e) : e) <= 39;
}
function Zn(e) {
  return e <= 66;
}
...
function* Ol() {
  for (let e = 1; e <= nr.length; e++)
    yield e;
}
const Nl = 1, ea = nr.length;
function Il() {
  return ["XXA", "XXB", "XXC", "XXD", "XXE", "XXF", "XXG"];
}
function li(e, t = "***") {
  const r = e - 1;
  return r < 0 || r >= nr.length ? t : nr[r];
}
function ta(e) {
  return e <= 0 || e > ea ? "******" : Qn[e - 1];
}
function Rl(e) {
  return ta(Dr(e));
}
function ra(e) {
  const t = typeof e == "number" ? li(e) : e;
  return ai(t) && !ni.includes(t);
}
function Pl(e) {
  const t = typeof e == "number" ? li(e) : e;
  return ai(t) && ni.includes(t);
...
function Ml(e) {
  return Qn[e - 1].includes("*obsolete*");
}
function Dl() {
  const e = {};
...
ee(it, "Original", new it(Ut.Original)), ee(it, "Septuagint", new it(Ut.Septuagint)), ee(it, "Vulgate", new it(Ut.Vulgate)), ee(it, "English", new it(Ut.English)), ee(it, "RussianProtestant", new it(Ut.RussianProtestant)), ee(it, "RussianOrthodox", new it(Ut.RussianOrthodox));
let Cr = it;
function Fi(e, t) {
  const r = t[0];
...
var oa = /* @__PURE__ */ ((e) => (e[e.Valid = 0] = "Valid", e[e.UnknownVersification = 1] = "UnknownVersification", e[e.OutOfRange = 2] = "OutOfRange", e[e.VerseOutOfOrder = 3] = "VerseOutOfOrder", e[e.VerseRepeated = 4] = "VerseRepeated", e))(oa || {});
const Qe = class le {
  constructor(t, r, o, s) {
    if (ee(this, "firstChapter"), ee(this, "lastChapter"), ee(this, "lastVerse"), ee(this, "hasSegmentsDefined"), ee(this, "text"), ee(this, "BBBCCCVVVS"), ee(this, "longHashCode"), ee(this, "versification"), ee(this, "rtlMark", "‏"), ee(this, "_bookNum", 0), ee(this, "_chapterNum", 0), ee(this, "_verseNum", 0), ee(this, "_verse"), o == null && s == null)
      if (t != null && typeof t == "string") {
        const i = t, n = r != null && r instanceof Cr ? r : void 0;
        this.setEmpty(n), this.parse(i);
      } else if (t != null && typeof t == "number") {
        const i = r != null && r instanceof Cr ? r : void 0;
        ...
        if (t != null && t instanceof le) {
          ...
          if (t == null)
            return;
          const i = t instanceof Cr ? t : le.defaultVersification;
          this.setEmpty(i);
        }
      else
  ...
  set versificationStr(t) {
    this.versification = this.versification != null ? new Cr(t) : void 0;
  }
  /**
  ...
  parse(t) {
    if (t = t.replace(this.rtlMark, ""), t.includes("/")) {
      ...
      if (t = i[0], i.length > 1)
        try {
          const n = +i[1].trim();
          this.versification = new Cr(Ut[n]);
        } catch {
          throw new qr("Invalid reference : " + t);
        }
    }
    ...
    if (o.length !== 2 || ce.bookIdToNumber(r[0]) === 0 || !Number.isInteger(s) || s < 0 || !le.isVerseParseable(o[1]))
      throw new qr("Invalid reference : " + t);
  ...
  allVerses(t = !1, r = le.verseRangeSeparators, o = le.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const s = [], i = Fi(this._verse, o);
    for (const n of i.map((c) => Fi(c, r))) {
      const c = this.clone();
      c.verse = n[0];
      const l = c.verseNum;
  ...
  updateInternal(t, r, o) {
    this.bookNum = ce.bookIdToNumber(t), this.chapter = r, this.verse = o;
  }
};
ee(Qe, "defaultVersification", Cr.English), ee(Qe, "verseRangeSeparator", "-"), ee(Qe, "verseSequenceIndicator", ","), ee(Qe, "verseRangeSeparators", [Qe.verseRangeSeparator]), ee(Qe, "verseSequenceIndicators", [Qe.verseSequenceIndicator]), ee(Qe, "chapterDigitShifter", 1e3), ee(Qe, "bookDigitShifter", Qe.chapterDigitShifter * Qe.chapterDigitShifter), ee(Qe, "bcvMaxValue", Qe.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
ee(Qe, "ValidStatusType", oa);
...
function Pt(e, t, r = {
  ...
  const o = r.clone ? Z({}, e) : e;
  return rr(e) && rr(t) && Object.keys(t).forEach((s) => {
    s !== "__proto__" && (rr(t[s]) && s in e && rr(e[s]) ? o[s] = Pt(e[s], t[s], r) : r.clone ? o[s] = rr(t[s]) ? sa(t[s]) : t[s] : o[s] = t[s]);
  }), o;
}
function Ll(e) {
  return e && e.__esModule && Object.prototype.hasOwnProperty.call(e, "default") ? e.default : e;
}
var Fs = { exports: {} }, zo = { exports: {} }, me = {};
...
function Bl() {
  ...
  return me.AsyncMode = l, me.ConcurrentMode = d, me.ContextConsumer = c, me.ContextProvider = n, me.Element = t, me.ForwardRef = f, me.Fragment = o, me.Lazy = b, me.Memo = m, me.Portal = r, me.Profiler = i, me.StrictMode = s, me.Suspense = h, me.isAsyncMode = function(y) {
    return w(y) || k(y) === l;
  }, me.isConcurrentMode = w, me.isContextConsumer = function(y) {
    return k(y) === c;
    ...
    return typeof y == "string" || typeof y == "function" || y === o || y === d || y === i || y === s || y === h || y === p || typeof y == "object" && y !== null && (y.$$typeof === b || y.$$typeof === m || y.$$typeof === n || y.$$typeof === c || y.$$typeof === f || y.$$typeof === g || y.$$typeof === x || y.$$typeof === _ || y.$$typeof === v);
  }, me.typeOf = k, me;
}
var ge = {};
/** @license React v16.13.1
...
function Vl() {
  return Ui || (Ui = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function k(T) {
      ...
      T === o || T === d || T === i || T === s || T === h || T === p || typeof T == "object" && T !== null && (T.$$typeof === b || T.$$typeof === m || T.$$typeof === n || T.$$typeof === c || T.$$typeof === f || T.$$typeof === g || T.$$typeof === x || T.$$typeof === _ || T.$$typeof === v);
    }
    function w(T) {
    ...
    var y = l, E = d, H = c, j = n, M = t, N = f, Y = o, K = b, _e = m, te = r, re = i, ke = s, Re = h, It = !1;
    function mr(T) {
      return It || (It = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), S(T) || w(T) === l;
    }
    function S(T) {
      return w(T) === d;
    }
    ...
    ge.AsyncMode = y, ge.ConcurrentMode = E, ge.ContextConsumer = H, ge.ContextProvider = j, ge.Element = M, ge.ForwardRef = N, ge.Fragment = Y, ge.Lazy = K, ge.Memo = _e, ge.Portal = te, ge.Profiler = re, ge.StrictMode = ke, ge.Suspense = Re, ge.isAsyncMode = mr, ge.isConcurrentMode = S, ge.isContextConsumer = O, ge.isContextProvider = Q, ge.isElement = G, ge.isForwardRef = W, ge.isFragment = ie, ge.isLazy = X, ge.isMemo = J, ge.isPortal = ne, ge.isProfiler = ue, ge.isStrictMode = ae, ge.isSuspense = Xe, ge.isValidElementType = k, ge.typeOf = w;
  }()), ge;
}
var ji;
function ia() {
  return ji || (ji = 1, process.env.NODE_ENV === "production" ? zo.exports = Bl() : zo.exports = Vl()), zo.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Fl() {
  ...
  return ms = s() ? Object.assign : function(i, n) {
...
var bs, Ki;
function na() {
  return Ki || (Ki = 1, bs = Function.call.bind(Object.prototype.hasOwnProperty)), bs;
}
var vs, Yi;
function Hl() {
  if (Yi)
...
function Ul() {
  if (Xi)
    return ys;
  Xi = 1;
  var e = ia(), t = Fl(), r = ci(), o = na(), s = Hl(), i = function() {
  };
  ...
  return ys = function(c, l) {
    ...
    function g(S) {
      if (process.env.NODE_ENV !== "production")
        var O = {}, Q = 0;
      function G(ie, X, J, ne, ue, ae, Xe) {
        if (ne = ne || p, ae = ae || J, Xe !== r) {
          if (l) {
            var T = new Error(
        ...
        return X[J] == null ? ie ? X[J] === null ? new v("The " + ue + " `" + ae + "` is marked as required " + ("in `" + ne + "`, but its value is `null`.")) : new v("The " + ue + " `" + ae + "` is marked as required in " + ("`" + ne + "`, but its value is `undefined`.")) : null : S(X, J, ne, ue, ae);
      }
      var W = G.bind(null, !1);
      return W.isRequired = G.bind(null, !0), W;
    }
    function x(S) {
      function O(Q, G, W, ie, X, J) {
        var ne = Q[G], ue = ke(ne);
        if (ue !== S) {
          var ae = Re(ne);
          return new v(
    ...
    function k(S) {
      function O(Q, G, W, ie, X) {
        if (typeof S != "function")
          return new v("Property `" + X + "` of component `" + W + "` has invalid PropType notation inside arrayOf.");
        var J = Q[G];
        if (!Array.isArray(J)) {
          var ne = ke(J);
          return new v("Invalid " + ie + " `" + X + "` of type " + ("`" + ne + "` supplied to `" + W + "`, expected an array."));
        }
        for (var ue = 0; ue < J.length; ue++) {
          var ae = S(J, ue, W, ie, X + "[" + ue + "]", r);
    ...
    function w() {
      function S(O, Q, G, W, ie) {
        var X = O[Q];
        if (!c(X)) {
          var J = ke(X);
          return new v("Invalid " + W + " `" + ie + "` of type " + ("`" + J + "` supplied to `" + G + "`, expected a single ReactElement."));
        }
        return null;
      }
      return g(S);
    ...
    function y() {
      function S(O, Q, G, W, ie) {
        ...
        if (!e.isValidElementType(X)) {
          var J = ke(X);
          return new v("Invalid " + W + " `" + ie + "` of type " + ("`" + J + "` supplied to `" + G + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return g(S);
    ...
    function E(S) {
      function O(Q, G, W, ie, X) {
        if (!(Q[G] instanceof S)) {
          var J = S.name || p, ne = mr(Q[G]);
          return new v("Invalid " + ie + " `" + X + "` of type " + ("`" + ne + "` supplied to `" + W + "`, expected ") + ("instance of `" + J + "`."));
        }
        return null;
      }
      return g(O);
    ...
    function H(S) {
      ...
      function O(Q, G, W, ie, X) {
        for (var J = Q[G], ne = 0; ne < S.length; ne++)
          if (b(J, S[ne]))
            return null;
        var ue = JSON.stringify(S, function(Xe, T) {
          var ht = Re(T);
          return ht === "symbol" ? String(T) : T;
        });
        return new v("Invalid " + ie + " `" + X + "` of value `" + String(J) + "` " + ("supplied to `" + W + "`, expected one of " + ue + "."));
      }
      return g(O);
    }
    function j(S) {
      function O(Q, G, W, ie, X) {
        if (typeof S != "function")
          return new v("Property `" + X + "` of component `" + W + "` has invalid PropType notation inside objectOf.");
        var J = Q[G], ne = ke(J);
        if (ne !== "object")
          return new v("Invalid " + ie + " `" + X + "` of type " + ("`" + ne + "` supplied to `" + W + "`, expected an object."));
        for (var ue in J)
          if (o(J, ue)) {
            var ae = S(J, ue, W, ie, X + "." + ue, r);
            if (ae instanceof Error)
    ...
    function M(S) {
      ...
      for (var O = 0; O < S.length; O++) {
        ...
        if (typeof Q != "function")
          return i(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + It(Q) + " at index " + O + "."
          ), n;
      }
      function G(W, ie, X, J, ne) {
        for (var ue = [], ae = 0; ae < S.length; ae++) {
          var Xe = S[ae], T = Xe(W, ie, X, J, ne, r);
          if (T == null)
            return null;
          T.data && o(T.data, "expectedType") && ue.push(T.data.expectedType);
        }
        var ht = ue.length > 0 ? ", expected one of type [" + ue.join(", ") + "]" : "";
        return new v("Invalid " + J + " `" + ne + "` supplied to " + ("`" + X + "`" + ht + "."));
      }
      return g(G);
    }
    function N() {
      function S(O, Q, G, W, ie) {
        return te(O[Q]) ? null : new v("Invalid " + W + " `" + ie + "` supplied to " + ("`" + G + "`, expected a ReactNode."));
      }
      return g(S);
    }
    function Y(S, O, Q, G, W) {
      return new v(
        (S || "React class") + ": " + O + " type `" + Q + "." + G + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + W + "`."
      );
    }
    function K(S) {
      function O(Q, G, W, ie, X) {
        var J = Q[G], ne = ke(J);
        if (ne !== "object")
          return new v("Invalid " + ie + " `" + X + "` of type `" + ne + "` " + ("supplied to `" + W + "`, expected `object`."));
        for (var ue in S) {
          var ae = S[ue];
          if (typeof ae != "function")
            return Y(W, ie, X, ue, Re(ae));
          var Xe = ae(J, ue, W, ie, X + "." + ue, r);
          if (Xe)
            return Xe;
        }
        return null;
    ...
    function _e(S) {
      function O(Q, G, W, ie, X) {
        ...
        for (var ae in ue) {
          var Xe = S[ae];
          if (o(S, ae) && typeof Xe != "function")
            return Y(W, ie, X, ae, Re(Xe));
          if (!Xe)
            return new v(
              "Invalid " + ie + " `" + X + "` key `" + ae + "` supplied to `" + W + "`.\nBad object: " + JSON.stringify(Q[G], null, "  ") + `
Valid keys: ` + JSON.stringify(Object.keys(S), null, "  ")
            );
          var T = Xe(J, ae, W, ie, X + "." + ae, r);
          if (T)
            return T;
        }
        return null;
    ...
    function ke(S) {
      var O = typeof S;
      return Array.isArray(S) ? "array" : S instanceof RegExp ? "object" : re(O, S) ? "symbol" : O;
    }
    function Re(S) {
...
if (process.env.NODE_ENV !== "production") {
  var Wl = ia(), ql = !0;
  Fs.exports = Ul()(Wl.isElement, ql);
} else
  Fs.exports = jl()();
var Kl = Fs.exports;
const we = /* @__PURE__ */ Ll(Kl);
function Nr(e) {
...
function Yl() {
  ...
  return be.ContextConsumer = n, be.ContextProvider = i, be.Element = e, be.ForwardRef = l, be.Fragment = r, be.Lazy = p, be.Memo = h, be.Portal = t, be.Profiler = s, be.StrictMode = o, be.Suspense = d, be.SuspenseList = f, be.isAsyncMode = function() {
    return !1;
    ...
    return typeof g == "string" || typeof g == "function" || g === r || g === s || g === o || g === d || g === f || g === m || typeof g == "object" && g !== null && (g.$$typeof === p || g.$$typeof === h || g.$$typeof === i || g.$$typeof === n || g.$$typeof === l || g.$$typeof === b || g.getModuleId !== void 0);
  }, be.typeOf = v, be;
}
var ve = {};
/**
...
function Xl() {
  return Qi || (Qi = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), r = Symbol.for("react.fragment"), o = Symbol.for("react.strict_mode"), s = Symbol.for("react.profiler"), i = Symbol.for("react.provider"), n = Symbol.for("react.context"), c = Symbol.for("react.server_context"), l = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), f = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), p = Symbol.for("react.lazy"), m = Symbol.for("react.offscreen"), b = !1, v = !1, g = !1, x = !1, _ = !1, k;
    k = Symbol.for("react.module.reference");
    function w(B) {
      return !!(typeof B == "string" || typeof B == "function" || B === r || B === s || _ || B === o || B === d || B === f || x || B === m || b || v || g || typeof B == "object" && B !== null && (B.$$typeof === p || B.$$typeof === h || B.$$typeof === i || B.$$typeof === n || B.$$typeof === l || // This needs to include all possible module reference object
    ...
    var E = n, H = i, j = e, M = l, N = r, Y = p, K = h, _e = t, te = s, re = o, ke = d, Re = f, It = !1, mr = !1;
    function S(B) {
    ...
    ve.ContextConsumer = E, ve.ContextProvider = H, ve.Element = j, ve.ForwardRef = M, ve.Fragment = N, ve.Lazy = Y, ve.Memo = K, ve.Portal = _e, ve.Profiler = te, ve.StrictMode = re, ve.Suspense = ke, ve.SuspenseList = Re, ve.isAsyncMode = S, ve.isConcurrentMode = O, ve.isContextConsumer = Q, ve.isContextProvider = G, ve.isElement = W, ve.isForwardRef = ie, ve.isFragment = X, ve.isLazy = J, ve.isMemo = ne, ve.isPortal = ue, ve.isProfiler = ae, ve.isStrictMode = Xe, ve.isSuspense = T, ve.isSuspenseList = ht, ve.isValidElementType = w, ve.typeOf = y;
  }()), ve;
}
process.env.NODE_ENV === "production" ? Hs.exports = Yl() : Hs.exports = Xl();
var Zi = Hs.exports;
...
function la(e, t) {
  ...
  return Object.keys(e).forEach((o) => {
    if (o.toString().match(/^(components|slots)$/))
      ...
      const s = e[o] || {}, i = t[o];
      r[o] = {}, !i || !Object.keys(i) ? r[o] = s : !s || !Object.keys(s) ? r[o] = i : (r[o] = Z({}, i), Object.keys(s).forEach((n) => {
        r[o][n] = la(s[n], i[n]);
      }));
    } else
      r[o] === void 0 && (r[o] = e[o]);
...
function di(e, t, r = "Mui") {
  const o = oc[t];
  return o ? `${r}-${o}` : `${rc.generate(e)}-${t}`;
}
function sc(e, t, r = "Mui") {
  const o = {};
  return t.forEach((s) => {
    o[s] = di(e, s, r);
  }), o;
...
function nc() {
  for (var e, t, r = 0, o = "", s = arguments.length; r < s; r++)
    (e = arguments[r]) && (t = ca(e)) && (o && (o += " "), o += t);
  return o;
}
const ac = ["values", "unit", "step"], lc = (e) => {
  const t = Object.keys(e).map((r) => ({
    key: r,
    val: e[r]
  })) || [];
  return t.sort((r, o) => r.val - o.val), t.reduce((r, o) => Z({}, r, {
    [o.key]: o.val
  }), {});
};
function cc(e) {
  const {
    ...
    unit: r = "px",
    step: o = 5
  } = e, s = Ot(e, ac), i = lc(t), n = Object.keys(i);
  function c(p) {
  ...
  function d(p, m) {
    const b = n.indexOf(m);
    return `@media (min-width:${typeof t[p] == "number" ? t[p] : p}${r}) and (max-width:${(b !== -1 && typeof t[n[b]] == "number" ? t[n[b]] : m) - o / 100}${r})`;
  }
  function f(p) {
...
const dc = {
  borderRadius: 4
}, uc = dc, hc = process.env.NODE_ENV !== "production" ? we.oneOfType([we.number, we.string, we.object, we.array]) : {}, Jt = hc;
function to(e, t) {
  return t ? Pt(e, t, {
    clone: !1
...
function Fo(e, t, r, o = r) {
  let s;
  return typeof e == "function" ? s = e(r) : Array.isArray(e) ? s = e[r] || o : s = Qo(e, r) || o, t && (s = t(s, o, e)), s;
}
function Me(e) {
  const {
    prop: t,
    ...
    if (n[t] == null)
      return null;
    const c = n[t], l = n.theme, d = Qo(l, o) || {};
    return Mt(n, c, (h) => {
      let p = Fo(d, s, h);
      return h === p && typeof h == "string" && (p = Fo(d, s, `${t}${h === "default" ? "" : ar(h)}`, h)), r === !1 ? p : {
        [r]: p
      };
    });
  };
...
const gc = {
  ...
  if (e.length > 2)
    if (on[e])
      ...
      return [e];
  const [t, r] = e.split(""), o = gc[t], s = bc[r] || "";
  return Array.isArray(s) ? s.map((i) => o + i) : [o + s];
}), Zo = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], es = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], yc = [...Zo, ...es];
function bo(e, t, r, o) {
  var s;
  const i = (s = Qo(e, t, !1)) != null ? s : r;
...
function wc(e, t) {
  return (r) => e.reduce((o, s) => (o[s] = vo(t, r), o), {});
}
function xc(e, t, r, o) {
  if (t.indexOf(r) === -1)
    return null;
  const s = vc(r), i = wc(s, o), n = e[r];
  return Mt(e, n, i);
}
function ua(e, t) {
  const r = da(e.theme);
  return Object.keys(e).map((o) => xc(e, t, o, r)).reduce(to, {});
}
function Ae(e) {
  return ua(e, Zo);
}
Ae.propTypes = process.env.NODE_ENV !== "production" ? Zo.reduce((e, t) => (e[t] = Jt, e), {}) : {};
Ae.filterProps = Zo;
function Te(e) {
  return ua(e, es);
}
Te.propTypes = process.env.NODE_ENV !== "production" ? es.reduce((e, t) => (e[t] = Jt, e), {}) : {};
Te.filterProps = es;
process.env.NODE_ENV !== "production" && yc.reduce((e, t) => (e[t] = Jt, e), {});
function _c(e = 8) {
  if (e.mui)
    return e;
  const t = da({
...
function ts(...e) {
  const t = e.reduce((o, s) => (s.filterProps.forEach((i) => {
    o[i] = s;
  }), o), {}), r = (o) => Object.keys(o).reduce((s, i) => t[i] ? to(s, t[i](o)) : s, {});
...
const kc = gt("border", pt), Cc = gt("borderTop", pt), Sc = gt("borderRight", pt), $c = gt("borderBottom", pt), Ec = gt("borderLeft", pt), zc = gt("borderColor"), Ac = gt("borderTopColor"), Tc = gt("borderRightColor"), Oc = gt("borderBottomColor"), Nc = gt("borderLeftColor"), Ic = gt("outline", pt), Rc = gt("outlineColor"), rs = (e) => {
  if (e.borderRadius !== void 0 && e.borderRadius !== null) {
    const t = bo(e.theme, "shape.borderRadius", 4, "borderRadius"), r = (o) => ({
      borderRadius: vo(t, o)
    });
...
ts(kc, Cc, Sc, $c, Ec, zc, Ac, Tc, Oc, Nc, rs, Ic, Rc);
const os = (e) => {
  if (e.gap !== void 0 && e.gap !== null) {
    const t = bo(e.theme, "spacing", 8, "gap"), r = (o) => ({
      gap: vo(t, o)
    });
    return Mt(e, e.gap, r);
  }
...
const ss = (e) => {
  if (e.columnGap !== void 0 && e.columnGap !== null) {
    const t = bo(e.theme, "spacing", 8, "columnGap"), r = (o) => ({
      columnGap: vo(t, o)
    });
...
const is = (e) => {
  if (e.rowGap !== void 0 && e.rowGap !== null) {
    const t = bo(e.theme, "spacing", 8, "rowGap"), r = (o) => ({
      rowGap: vo(t, o)
    });
...
ts(os, ss, is, Pc, Mc, Dc, Lc, Bc, Vc, Fc, Hc, Uc);
function Ar(e, t) {
  return t === "grey" ? t : e;
}
const jc = Me({
...
const Kc = Me({
  ...
  if (e.maxWidth !== void 0 && e.maxWidth !== null) {
    const t = (r) => {
      var o, s;
      const i = ((o = e.theme) == null || (o = o.breakpoints) == null || (o = o.values) == null ? void 0 : o[r]) || ui[r];
...
function rd() {
  function e(r, o, s, i) {
    ...
    const p = Qo(s, d) || {};
    return h ? h(n) : Mt(n, o, (b) => {
      let v = Fo(p, f, b);
      return b === v && typeof b == "string" && (v = Fo(p, f, `${r}${b === "default" ? "" : ar(b)}`, b)), l === !1 ? v : {
        [l]: v
      };
    });
  }
  function t(r) {
    ...
    if (!s)
      return null;
    const n = (o = i.unstable_sxConfig) != null ? o : pi;
    function c(l) {
      let d = l;
      ...
      if (!d)
        return null;
      const f = pc(i.breakpoints), h = Object.keys(f);
      let p = f;
...
function mi(e = {}, ...t) {
  ...
  return d.applyStyles = od, d = t.reduce((f, h) => Pt(f, h), d), d.unstable_sxConfig = Z({}, pi, n == null ? void 0 : n.unstable_sxConfig), d.unstable_sx = function(h) {
    return fi({
      sx: h,
      theme: this
    });
...
const cd = ["ownerState"], dd = ["variants"], ud = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function hd(e) {
  return Object.keys(e).length === 0;
}
function pd(e) {
...
const fd = mi(), sn = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Ao({
  defaultTheme: e,
  theme: t,
  themeId: r
...
function Do(e, t) {
  ...
  const s = typeof e == "function" ? e(Z({
    ownerState: r
  }, o)) : e;
  if (Array.isArray(s))
    return s.flatMap((i) => Do(i, Z({
      ownerState: r
    }, o)));
  if (s && typeof s == "object" && Array.isArray(s.variants)) {
    ...
    return i.forEach((l) => {
      let d = !0;
      typeof l.props == "function" ? d = l.props(Z({
        ownerState: r
      }, o)) : Object.keys(l.props).forEach((f) => {
        (r == null ? void 0 : r[f]) !== l.props[f] && o[f] !== l.props[f] && (d = !1);
      }), d && (Array.isArray(c) || (c = [c]), c.push(typeof l.style == "function" ? l.style(Z({
        ownerState: r
      }, o)) : l.style));
    }), c;
  }
...
function gd(e = {}) {
  const {
    themeId: t,
    defaultTheme: r = fd,
    rootShouldForwardProp: o = Mo,
    slotShouldForwardProp: s = Mo
  } = e, i = (n) => fi(Z({}, n, {
    theme: Ao(Z({}, n, {
      defaultTheme: r,
      themeId: t
  ...
  return i.__mui_systemSx = !0, (n, c = {}) => {
    ml(n, (y) => y.filter((E) => !(E != null && E.__mui_systemSx)));
    const {
      name: l,
      slot: d,
      ...
      overridesResolver: p = md(sn(d))
    } = c, m = Ot(c, ud), b = f !== void 0 ? f : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      d && d !== "Root" && d !== "root" || !1
    ), v = h || !1;
    let g;
    process.env.NODE_ENV !== "production" && l && (g = `${l}-${sn(d || "Root")}`);
    let x = Mo;
    d === "Root" || d === "root" ? x = o : d ? x = s : pd(n) && (x = void 0);
    const _ = pl(n, Z({
      shouldForwardProp: x,
      label: g
    }, m)), k = (y) => typeof y == "function" && y.__emotion_real !== y || rr(y) ? (E) => Do(y, Z({}, E, {
      theme: Ao({
        theme: E.theme,
        defaultTheme: r,
        themeId: t
      ...
      l && p && j.push((Y) => {
        ...
        if (!K.components || !K.components[l] || !K.components[l].styleOverrides)
          return null;
        const _e = K.components[l].styleOverrides, te = {};
        return Object.entries(_e).forEach(([re, ke]) => {
          te[re] = Do(ke, Z({}, Y, {
            theme: K
          }));
        }), p(Y, te);
        ...
        const _e = Ao(Z({}, Y, {
          defaultTheme: r,
          themeId: t
        })), te = _e == null || (K = _e.components) == null || (K = K[l]) == null ? void 0 : K.variants;
        return Do({
          variants: te
        }, Z({}, Y, {
          theme: _e
      ...
      if (process.env.NODE_ENV !== "production") {
        let Y;
        l && (Y = `${l}${ar(d || "")}`), Y === void 0 && (Y = `Styled(${Ql(n)})`), N.displayName = Y;
      }
      return n.muiName && (N.muiName = n.muiName), N;
    };
...
function bd(e) {
  ...
  return !t || !t.components || !t.components[r] || !t.components[r].defaultProps ? o : la(t.components[r].defaultProps, o);
}
function vd({
  props: e,
  name: t,
...
The following color spaces are supported: srgb, display-p3, a98-rgb, prophoto-rgb, rec-2020.` : Nr(10, s));
  } else
    o = o.split(",");
...
function wd(e) {
  ...
  return e.type === "hsla" && (c += "a", l.push(t[3])), gi({
    type: c,
    values: l
  });
}
function nn(e) {
  e = Ir(e);
  let t = e.type === "hsl" || e.type === "hsla" ? Ir(wd(e)).values : e.values;
...
function xd(e, t) {
  if (e = Ir(e), t = pa(t), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - t;
...
const Cd = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, xr = Nd, Id = ["mode", "contrastThreshold", "tonalOffset"], ln = {
...
function cn(e, t, r, o) {
  ...
  e[t] || (e.hasOwnProperty(r) ? e[t] = e[r] : t === "light" ? e.light = _d(e.main, s) : t === "dark" && (e.dark = xd(e.main, i)));
}
function Rd(e = "light") {
  return e === "dark" ? {
    main: yr[200],
...
function Vd(e) {
  const {
    ...
    tonalOffset: o = 0.2
  } = e, s = Ot(e, Id), i = e.primary || Rd(t), n = e.secondary || Pd(t), c = e.error || Md(t), l = e.info || Dd(t), d = e.success || Ld(t), f = e.warning || Bd(t);
  function h(v) {
    const g = an(v, xs.text.primary) >= r ? xs.text.primary : ln.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const x = an(v, g);
      x < 3 && console.error([`MUI: The contrast ratio of ${x}:1 for ${g} on ${v}`, "falls below the WCAG recommended absolute minimum contrast ratio of 3:1.", "https://www.w3.org/TR/2008/REC-WCAG20-20081211/#visual-audio-contrast-contrast"].join(`
`));
    }
    return g;
  }
  const p = ({
    ...
    if (v = Z({}, v), !v.main && v[x] && (v.main = v[x]), !v.hasOwnProperty("main"))
      throw new Error(process.env.NODE_ENV !== "production" ? `MUI: The color${g ? ` (${g})` : ""} provided to augmentColor(color) is invalid.
The color object needs to have a \`main\` property or a \`${x}\` property.` : Nr(11, g ? ` (${g})` : "", x));
...
} });` : Nr(12, g ? ` (${g})` : "", JSON.stringify(v.main)));
    return cn(v, "light", _, o), cn(v, "dark", k, o), v.contrastText || (v.contrastText = h(v.main)), v;
  }, m = {
    dark: xs,
    light: ln
  };
  return process.env.NODE_ENV !== "production" && (m[t] || console.error(`MUI: The palette mode \`${t}\` is not supported.`)), Pt(Z({
...
function Ud(e, t) {
  ...
  const m = s / 14, b = h || ((x) => `${x / d * m}rem`), v = (x, _, k, w, y) => Z({
    fontFamily: o,
    fontWeight: x,
    fontSize: b(_),
    ...
    letterSpacing: `${Hd(w / _)}em`
  } : {}, y, f), g = {
    h1: v(i, 96, 1.167, -1.5),
    h2: v(i, 60, 1.2, -0.5),
    h3: v(n, 48, 1.167, 0),
    h4: v(n, 34, 1.235, 0.25),
    h5: v(n, 24, 1.334, 0),
    h6: v(c, 20, 1.6, 0.15),
    subtitle1: v(n, 16, 1.75, 0.15),
    subtitle2: v(c, 14, 1.57, 0.1),
    body1: v(n, 16, 1.5, 0.15),
    body2: v(n, 14, 1.43, 0.15),
    button: v(c, 14, 1.75, 0.4, dn),
    caption: v(n, 12, 1.66, 0.4),
    overline: v(n, 12, 2.66, 1, dn),
...
const jd = 0.2, Wd = 0.14, qd = 0.12;
function Ce(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${jd})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${Wd})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${qd})`].join(",");
}
const Kd = ["none", Ce(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), Ce(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), Ce(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), Ce(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), Ce(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), Ce(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), Ce(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), Ce(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), Ce(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), Ce(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), Ce(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), Ce(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), Ce(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), Ce(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), Ce(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), Ce(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), Ce(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), Ce(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), Ce(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), Ce(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), Ce(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), Ce(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), Ce(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), Ce(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], Yd = Kd, Xd = ["duration", "easing", "delay"], Gd = {
...
function Zd(e) {
  const t = Z({}, Gd, e.easing), r = Z({}, Jd, e.duration);
  return Z({
...
`)), Object.keys(d).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(d).join(",")}].`);
      ...
      return (Array.isArray(s) ? s : [s]).map((f) => `${f} ${typeof n == "string" ? n : hn(n)} ${c} ${typeof l == "string" ? l : hn(l)}`).join(",");
    }
  }, e, {
    easing: t,
    duration: r
...
const eu = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, tu = eu, ru = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function ou(e = {}, ...t) {
  const {
    mixins: r = {},
    palette: o = {},
  ...
  if (e.vars)
    throw new Error(process.env.NODE_ENV !== "production" ? "MUI: `vars` is a private field used for CSS variables support.\nPlease use another name." : Nr(18));
  const c = Vd(o), l = mi(e);
  let d = Pt(l, {
    mixins: kd(l.breakpoints, r),
    palette: c,
  ...
  if (d = Pt(d, n), d = t.reduce((f, h) => Pt(f, h), d), process.env.NODE_ENV !== "production") {
    const f = ["active", "checked", "completed", "disabled", "error", "expanded", "focused", "focusVisible", "required", "selected"], h = (p, m) => {
      let b;
      for (b in p) {
        const v = p[b];
        if (f.indexOf(b) !== -1 && Object.keys(v).length > 0) {
          if (process.env.NODE_ENV !== "production") {
            const g = di("", b);
            console.error([`MUI: The \`${m}\` component increases the CSS specificity of the \`${b}\` internal state.`, "You can not override it like this: ", JSON.stringify(p, null, 2), "", `Instead, you need to use the '&.${g}' syntax:`, JSON.stringify({
              root: {
                [`&.${g}`]: v
              }
...
`));
  ...
  return d.unstable_sxConfig = Z({}, pi, n == null ? void 0 : n.unstable_sxConfig), d.unstable_sx = function(h) {
    return fi({
      sx: h,
      theme: this
    });
...
const nu = (e) => Mo(e) && e !== "classes", au = gd({
  themeId: ma,
  defaultTheme: fa,
  rootShouldForwardProp: nu
}), lu = au;
function cu(e) {
  return di("MuiSvgIcon", e);
}
sc("MuiSvgIcon", ["root", "colorPrimary", "colorSecondary", "colorAction", "colorError", "colorDisabled", "fontSizeInherit", "fontSizeSmall", "fontSizeMedium", "fontSizeLarge"]);
const du = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], uu = (e) => {
  const {
    color: t,
    fontSize: r,
    classes: o
  } = e, s = {
    root: ["root", t !== "inherit" && `color${ar(t)}`, `fontSize${ar(r)}`]
  };
  return Zl(s, cu, o);
}, hu = lu("svg", {
  name: "MuiSvgIcon",
  ...
  overridesResolver: (e, t) => {
    ...
    return [t.root, r.color !== "inherit" && t[`color${ar(r.color)}`], t[`fontSize${ar(r.fontSize)}`]];
  }
})(({
  theme: e,
  ownerState: t
}) => {
  var r, o, s, i, n, c, l, d, f, h, p, m, b;
  return {
    userSelect: "none",
    width: "1em",
    height: "1em",
...
}), bi = /* @__PURE__ */ I.forwardRef(function(t, r) {
  const o = iu({
    props: t,
    name: "MuiSvgIcon"
  }), {
    ...
    titleAccess: h,
    viewBox: p = "0 0 24 24"
  } = o, m = Ot(o, du), b = /* @__PURE__ */ I.isValidElement(s) && s.type === "svg", v = Z({}, o, {
    color: n,
    component: c,
    fontSize: l,
  ...
  f || (g.viewBox = p);
  const x = uu(v);
  return /* @__PURE__ */ Pe(hu, Z({
    as: c,
    className: nc(x.root, i),
    focusable: "false",
    color: d,
    ...
    ownerState: v,
    children: [b ? s.props.children : s, h ? /* @__PURE__ */ $("title", {
      children: h
    }) : null]
  }));
});
...
function ns(e, t) {
  ...
  return process.env.NODE_ENV !== "production" && (r.displayName = `${t}Icon`), r.muiName = pn.muiName, /* @__PURE__ */ I.memo(/* @__PURE__ */ I.forwardRef(r));
}
const pu = ns(/* @__PURE__ */ $("path", {
  d: "M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9m-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8z"
}), "History"), fu = ns(/* @__PURE__ */ $("path", {
  d: "M7.41 15.41 12 10.83l4.59 4.58L18 14l-6-6-6 6z"
}), "KeyboardArrowUp"), mu = ns(/* @__PURE__ */ $("path", {
  d: "M3 18h18v-2H3zm0-5h18v-2H3zm0-7v2h18V6z"
}), "Menu"), gu = ns(/* @__PURE__ */ $("path", {
  ...
  return /* @__PURE__ */ Pe("div", { children: [
    /* @__PURE__ */ Pe(
      Yn,
      {
        ...
        onClick: () => t(e),
        children: [
          r ? /* @__PURE__ */ $(Ii, { children: /* @__PURE__ */ $("div", { className: `selected-book-color-label ${o.toLowerCase()}`, slot: "prefix" }) }) : /* @__PURE__ */ $(Ii, { children: /* @__PURE__ */ $("div", { className: `book-color-label ${o.toLowerCase()}`, slot: "prefix" }) }),
          /* @__PURE__ */ $(Xa, { children: ce.bookIdToEnglishName(e) }),
          r ? /* @__PURE__ */ $(fu, {}) : void 0
        ]
      },
      e
    ),
...
function vu({
  ...
  return /* @__PURE__ */ $(
    oi,
    {
      ...
      onClick: t,
      InputProps: {
        startAdornment: /* @__PURE__ */ $(gu, { fontSize: "small" }),
        endAdornment: /* @__PURE__ */ $(pu, { fontSize: "small" })
      }
    }
  );
}
function yu({ endChapter: e, activeChapter: t, handleSelectChapter: r }) {
  const o = Array.from({ length: e }, (s, i) => i + 1);
  return /* @__PURE__ */ $("div", { className: "chapter-select", children: o.map((s) => (
...
function pb({ scrRef: e, handleSubmit: t }) {
  const { allBookIds: r } = ce, o = Tt(
    (g) => ({
      OT: r.filter((_) => ce.isBookOT(_)),
      NT: r.filter((_) => ce.isBookNT(_)),
      DC: r.filter((_) => ce.isBookDC(_))
    })[g],
    [r]
  ), [s, i] = ft(""), [n, c] = ft(""), [l, d] = ft(!1), f = Tt(
    (g) => o(g).filter(
      (x) => ce.bookIdToEnglishName(x).toLowerCase().includes(n.toLowerCase()) || x.toLowerCase().includes(n.toLowerCase())
    ),
    [o, n]
  ), h = Tt((g) => ii(ce.bookIdToNumber(g)), []), p = (g) => {
    i(s !== g ? g : ""), h(g) === -1 && (t({
      bookNum: ce.bookIdToNumber(g),
      chapterNum: 1,
      verseNum: 1
    }), d(!1));
  }, m = (g) => {
    ...
    d(!1), t({
      bookNum: ce.bookIdToNumber(s),
      chapterNum: g,
      verseNum: 1
    });
  };
  return /* @__PURE__ */ Pe(Go, { children: [
    /* @__PURE__ */ $(
      vu,
      {
        value: n,
    ...
    /* @__PURE__ */ $("div", { className: "book-chapter-menu", children: /* @__PURE__ */ $(
      Ga,
      {
        tabIndex: -1,
        open: l,
        style: { maxWidth: "289px", maxHeight: "500px", overflowY: "auto" },
        children: xu.map((g) => /* @__PURE__ */ Pe("div", { children: [
          /* @__PURE__ */ $(Ja, { children: wu[g] }),
          f(g).map((x) => /* @__PURE__ */ $("div", { children: /* @__PURE__ */ $(
            bu,
            {
              bookId: x,
              handleSelectBook: () => p(x),
              isSelected: s === x,
              bookType: g,
              children: /* @__PURE__ */ $(
                yu,
                {
                  ...
                  endChapter: h(x),
                  activeChapter: e.bookNum === ce.bookIdToNumber(x) ? e.chapterNum : 0
                }
              )
            },
            x
          ) }, x)),
          g === "OT" || g === "NT" ? /* @__PURE__ */ $(Qa, {}) : void 0
        ] }, g))
      }
    ) })
  ] });
 ...
 */
const Lo = globalThis, vi = Lo.ShadowRoot && (Lo.ShadyCSS === void 0 || Lo.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, yi = Symbol(), fn = /* @__PURE__ */ new WeakMap();
let ga = class {
  constructor(t, r, o) {
    if (this._$cssResult$ = !0, o !== yi)
...
const _u = (e) => new ga(typeof e == "string" ? e : e + "", void 0, yi), L = (e, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Cu, defineProperty: Su, getOwnPropertyDescriptor: $u, getOwnPropertyNames: Eu, getOwnPropertySymbols: zu, getPrototypeOf: Au } = Object, qt = globalThis, gn = qt.trustedTypes, Tu = gn ? gn.emptyScript : "", _s = qt.reactiveElementPolyfillSupport, ro = (e, t) => e, Rr = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Tu : null;
      break;
  ...
  return r;
} }, wi = (e, t) => !Cu(e, t), bn = { attribute: !0, type: String, converter: Rr, reflect: !1, hasChanged: wi };
...
class Sr extends HTMLElement {
  ...
  static createProperty(t, r = bn) {
    if (r.state && (r.attribute = !1), this._$Ei(), this.elementProperties.set(t, r), !r.noAccessor) {
      ...
      s !== void 0 && Su(this.prototype, t, s);
    }
  }
  static getPropertyDescriptor(t, r, o) {
    const { get: s, set: i } = $u(this.prototype, t) ?? { get() {
      return this[r];
    }, set(n) {
      this[r] = n;
    } };
  ...
  static getPropertyOptions(t) {
    return this.elementProperties.get(t) ?? bn;
  }
  static _$Ei() {
    if (this.hasOwnProperty(ro("elementProperties")))
      return;
    const t = Au(this);
    t.finalize(), t.l !== void 0 && (this.l = [...t.l]), this.elementProperties = new Map(t.elementProperties);
  }
  static finalize() {
    if (this.hasOwnProperty(ro("finalized")))
      return;
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(ro("properties"))) {
      const r = this.properties, o = [...Eu(r), ...zu(r)];
      for (const s of o)
  ...
  createRenderRoot() {
    ...
    return ku(t, this.constructor.elementStyles), t;
  }
  connectedCallback() {
    var t;
  ...
  _$EC(t, r) {
    ...
    if (s !== void 0 && o.reflect === !0) {
      const n = (((i = o.converter) == null ? void 0 : i.toAttribute) !== void 0 ? o.converter : Rr).toAttribute(r, o.type);
  ...
  _$AK(t, r) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const n = o.getPropertyOptions(s), c = typeof n.converter == "function" ? { fromAttribute: n.converter } : ((i = n.converter) == null ? void 0 : i.fromAttribute) !== void 0 ? n.converter : Rr;
      this._$Em = s, this[s] = c.fromAttribute(r, n.type), this._$Em = null;
    }
  }
  requestUpdate(t, r, o) {
    if (t !== void 0) {
      if (o ?? (o = this.constructor.getPropertyOptions(t)), !(o.hasChanged ?? wi)(this[t], r))
        return;
      this.P(t, r, o);
    }
...
Sr.elementStyles = [], Sr.shadowRootOptions = { mode: "open" }, Sr[ro("elementProperties")] = /* @__PURE__ */ new Map(), Sr[ro("finalized")] = /* @__PURE__ */ new Map(), _s == null || _s({ ReactiveElement: Sr }), (qt.reactiveElementVersions ?? (qt.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const oo = globalThis, Ho = oo.trustedTypes, vn = Ho ? Ho.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, ba = "$lit$", jt = `lit$${(Math.random() + "").slice(9)}$`, va = "?" + jt, Ou = `<${va}>`, lr = document, ho = () => lr.createComment(""), po = (e) => e === null || typeof e != "object" && typeof e != "function", ya = Array.isArray, Nu = (e) => ya(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", ks = `[ 	
\f\r]`, Yr = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, yn = /-->/g, wn = />/g, tr = RegExp(`>|${ks}(?:([^\\s"'>=/]+)(${ks}*=${ks}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), xn = /'/g, _n = /"/g, wa = /^(?:script|style|textarea|title)$/i, Iu = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r }), C = Iu(1), ct = Symbol.for("lit-noChange"), Se = Symbol.for("lit-nothing"), kn = /* @__PURE__ */ new WeakMap(), sr = lr.createTreeWalker(lr, 129);
function xa(e, t) {
...
const Ru = (e, t) => {
  ...
  let s, i = t === 2 ? "<svg>" : "", n = Yr;
  for (let c = 0; c < r; c++) {
    const l = e[c];
    let d, f, h = -1, p = 0;
    for (; p < l.length && (n.lastIndex = p, f = n.exec(l), f !== null); )
      p = n.lastIndex, n === Yr ? f[1] === "!--" ? n = yn : f[1] !== void 0 ? n = wn : f[2] !== void 0 ? (wa.test(f[2]) && (s = RegExp("</" + f[2], "g")), n = tr) : f[3] !== void 0 && (n = tr) : n === tr ? f[0] === ">" ? (n = s ?? Yr, h = -1) : f[1] === void 0 ? h = -2 : (h = n.lastIndex - f[2].length, d = f[1], n = f[3] === void 0 ? tr : f[3] === '"' ? _n : xn) : n === _n || n === xn ? n = tr : n === yn || n === wn ? n = Yr : (n = tr, s = void 0);
    const m = n === tr && e[c + 1].startsWith("/>") ? " " : "";
    i += n === Yr ? l + Ou : h >= 0 ? (o.push(d), l.slice(0, h) + ba + l.slice(h) + jt + m) : l + jt + (h === -2 ? c : m);
  }
  return [xa(e, i + (e[r] || "<?>") + (t === 2 ? "</svg>" : "")), o];
};
class fo {
  constructor({ strings: t, _$litType$: r }, o) {
    ...
    this.parts = [];
    let i = 0, n = 0;
    const c = t.length - 1, l = this.parts, [d, f] = Ru(t, r);
    if (this.el = fo.createElement(d, o), sr.currentNode = this.el.content, r === 2) {
      const h = this.el.content.firstChild;
      h.replaceWith(...h.childNodes);
    }
    for (; (s = sr.nextNode()) !== null && l.length < c; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes())
          for (const h of s.getAttributeNames())
            if (h.endsWith(ba)) {
              const p = f[n++], m = s.getAttribute(h).split(jt), b = /([.?@])?(.*)/.exec(p);
              l.push({ type: 1, index: i, name: b[2], strings: m, ctor: b[1] === "." ? Mu : b[1] === "?" ? Du : b[1] === "@" ? Lu : as }), s.removeAttribute(h);
            } else
              h.startsWith(jt) && (l.push({ type: 6, index: i }), s.removeAttribute(h));
        if (wa.test(s.tagName)) {
          const h = s.textContent.split(jt), p = h.length - 1;
          if (p > 0) {
            s.textContent = Ho ? Ho.emptyScript : "";
            for (let m = 0; m < p; m++)
              s.append(h[m], ho()), sr.nextNode(), l.push({ type: 2, index: ++i });
            s.append(h[p], ho());
          }
        }
  ...
  static createElement(t, r) {
    const o = lr.createElement("template");
    return o.innerHTML = t, o;
  }
}
function Pr(e, t, r = e, o) {
  var n, c;
  if (t === ct)
    return t;
  let s = o !== void 0 ? (n = r._$Co) == null ? void 0 : n[o] : r._$Cl;
  const i = po(t) ? void 0 : t._$litDirective$;
  return (s == null ? void 0 : s.constructor) !== i && ((c = s == null ? void 0 : s._$AO) == null || c.call(s, !1), i === void 0 ? s = void 0 : (s = new i(e), s._$AT(e, r, o)), o !== void 0 ? (r._$Co ?? (r._$Co = []))[o] = s : r._$Cl = s), s !== void 0 && (t = Pr(e, s._$AS(e, t.values), s, o)), t;
}
class Pu {
  constructor(t, r) {
  ...
  u(t) {
    const { el: { content: r }, parts: o } = this._$AD, s = ((t == null ? void 0 : t.creationScope) ?? lr).importNode(r, !0);
    sr.currentNode = s;
    let i = sr.nextNode(), n = 0, c = 0, l = o[0];
    for (; l !== void 0; ) {
      if (n === l.index) {
        let d;
        l.type === 2 ? d = new yo(i, i.nextSibling, this, t) : l.type === 1 ? d = new l.ctor(i, l.name, l.strings, this, t) : l.type === 6 && (d = new Bu(i, this, t)), this._$AV.push(d), l = o[++c];
      }
      n !== (l == null ? void 0 : l.index) && (i = sr.nextNode(), n++);
    }
    return sr.currentNode = lr, s;
  }
  p(t) {
    let r = 0;
...
class yo {
  ...
  _$AI(t, r = this) {
    t = Pr(this, t, r), po(t) ? t === Se || t == null || t === "" ? (this._$AH !== Se && this._$AR(), this._$AH = Se) : t !== this._$AH && t !== ct && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Nu(t) ? this.k(t) : this._(t);
  }
  S(t) {
  ...
  _(t) {
    this._$AH !== Se && po(this._$AH) ? this._$AA.nextSibling.data = t : this.T(lr.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var i;
    const { values: r, _$litType$: o } = t, s = typeof o == "number" ? this._$AC(t) : (o.el === void 0 && (o.el = fo.createElement(xa(o.h, o.h[0]), this.options)), o);
    if (((i = this._$AH) == null ? void 0 : i._$AD) === s)
      this._$AH.p(r);
    else {
      const n = new Pu(s, this), c = n.u(this.options);
      n.p(r), this.T(c), this._$AH = n;
    }
  }
  _$AC(t) {
    let r = kn.get(t.strings);
    return r === void 0 && kn.set(t.strings, r = new fo(t)), r;
  }
  k(t) {
    ...
    let o, s = 0;
    for (const i of t)
      s === r.length ? r.push(o = new yo(this.S(ho()), this.S(ho()), this, this.options)) : o = r[s], o._$AI(i), s++;
...
class as {
  ...
  _$AI(t, r = this, o, s) {
    ...
    let n = !1;
    if (i === void 0)
      t = Pr(this, t, r, 0), n = !po(t) || t !== this._$AH && t !== ct, n && (this._$AH = t);
    else {
      const c = t;
      let l, d;
      for (t = i[0], l = 0; l < i.length - 1; l++)
        d = Pr(this, c[o + l], r, l), d === ct && (d = this._$AH[l]), n || (n = !po(d) || d !== this._$AH[l]), d === Se ? t = Se : t !== Se && (t += (d ?? "") + i[l + 1]), this._$AH[l] = d;
    }
    n && !s && this.j(t);
  }
  j(t) {
...
const Cs = oo.litHtmlPolyfillSupport;
Cs == null || Cs(fo, yo), (oo.litHtmlVersions ?? (oo.litHtmlVersions = [])).push("3.1.2");
const Vu = (e, t, r) => {
  const o = (r == null ? void 0 : r.renderBefore) ?? t;
  let s = o._$litPart$;
  if (s === void 0) {
    const i = (r == null ? void 0 : r.renderBefore) ?? null;
    o._$litPart$ = s = new yo(t.insertBefore(ho(), i), i, void 0, r ?? {});
  }
  return s._$AI(e), s;
};
/**
...
var Kn;
so._$litElement$ = !0, so.finalized = !0, (Kn = globalThis.litElementHydrateSupport) == null || Kn.call(globalThis, { LitElement: so });
const Ss = globalThis.litElementPolyfillSupport;
Ss == null || Ss({ LitElement: so });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Hu = { attribute: !0, type: String, converter: Rr, reflect: !1, hasChanged: wi }, Uu = (e = Hu, t, r) => {
...
function u(e) {
  return (t, r) => typeof r == "object" ? Uu(e, t, r) : ((o, s, i) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Wu = /* @__PURE__ */ new Set(["children", "localName", "ref", "style", "className"]), Cn = /* @__PURE__ */ new WeakMap(), qu = (e, t, r, o, s) => {
  const i = s == null ? void 0 : s[t];
  i === void 0 || r === o ? (e[t] = r, r == null && t in HTMLElement.prototype && e.removeAttribute(t)) : ((n, c, l) => {
    let d = Cn.get(n);
    d === void 0 && Cn.set(n, d = /* @__PURE__ */ new Map());
    let f = d.get(c);
  ...
  const i = new Set(Object.keys(o ?? {})), n = e.forwardRef((c, l) => {
    ...
    for (const [m, b] of Object.entries(c))
      Wu.has(m) ? h[m === "className" ? "class" : m] = b : i.has(m) || m in r.prototype ? p[m] = b : h[m] = b;
    return e.useLayoutEffect(() => {
      if (f.current !== null) {
        for (const m in p)
          qu(f.current, m, c[m], d.current ? d.current[m] : void 0, o);
        d.current = c;
      }
    }), e.useLayoutEffect(() => {
      var m;
...
var Ku = "sl-visually-hidden";
ls.define("sl-visually-hidden");
D({
  tagName: Ku,
  elementClass: ls,
  react: I,
...
`, ur = (e = "value") => (t, r) => {
  ...
  o.prototype.attributeChangedCallback = function(i, n, c) {
    ...
    if (i === f) {
      const h = d.converter || Rr, m = (typeof h == "function" ? h : (l = h == null ? void 0 : h.fromAttribute) != null ? l : Rr.fromAttribute)(c, d.type);
      this[e] !== m && (this[r] = m);
    }
    s.call(this, i, n, c);
  };
}, Xr = /* @__PURE__ */ new WeakMap(), Gr = /* @__PURE__ */ new WeakMap(), Jr = /* @__PURE__ */ new WeakMap(), $s = /* @__PURE__ */ new WeakSet(), To = /* @__PURE__ */ new WeakMap(), Bt = class {
  constructor(e, t) {
    this.handleFormData = (r) => {
      ...
      this.form && !this.form.noValidate && ((o = Xr.get(this.form)) == null || o.forEach((n) => {
        this.setUserInteracted(n, !0);
      })), this.form && !this.form.noValidate && !s && !i(this.host) && (r.preventDefault(), r.stopImmediatePropagation());
    }, this.handleFormReset = () => {
      this.options.setValue(this.host, this.options.defaultValue(this.host)), this.setUserInteracted(this.host, !1), To.set(this.host, []);
    }, this.handleInteraction = (r) => {
      const o = To.get(this.host);
  ...
  hostConnected() {
    ...
    e && this.attachForm(e), To.set(this.host, []), this.options.assumeInteractionOn.forEach((t) => {
      this.host.addEventListener(t, this.handleInteraction);
    });
  }
  hostDisconnected() {
    this.detachForm(), To.delete(this.host), this.options.assumeInteractionOn.forEach((e) => {
  ...
  attachForm(e) {
    e ? (this.form = e, Xr.has(this.form) ? Xr.get(this.form).add(this.host) : Xr.set(this.form, /* @__PURE__ */ new Set([this.host])), this.form.addEventListener("formdata", this.handleFormData), this.form.addEventListener("submit", this.handleFormSubmit), this.form.addEventListener("reset", this.handleFormReset), Gr.has(this.form) || (Gr.set(this.form, this.form.reportValidity), this.form.reportValidity = () => this.reportFormValidity()), Jr.has(this.form) || (Jr.set(this.form, this.form.checkValidity), this.form.checkValidity = () => this.checkFormValidity())) : this.form = void 0;
  }
  detachForm() {
    if (!this.form)
      return;
    const e = Xr.get(this.form);
    e && (e.delete(this.host), e.size <= 0 && (this.form.removeEventListener("formdata", this.handleFormData), this.form.removeEventListener("submit", this.handleFormSubmit), this.form.removeEventListener("reset", this.handleFormReset), Gr.has(this.form) && (this.form.reportValidity = Gr.get(this.form), Gr.delete(this.form)), Jr.has(this.form) && (this.form.checkValidity = Jr.get(this.form), Jr.delete(this.form)), this.form = void 0));
  }
  setUserInteracted(e, t) {
    t ? $s.add(e) : $s.delete(e), e.requestUpdate();
  }
  doAction(e, t) {
    if (this.form) {
   ...
   */
  setValidity(e) {
    const t = this.host, r = !!$s.has(t), o = !!t.required;
  ...
  valid: !0,
  valueMissing: !1
}), Gu = Object.freeze(go(Lt({}, cs), {
  valid: !1,
  valueMissing: !0
})), Ju = Object.freeze(go(Lt({}, cs), {
  valid: !1,
  customError: !0
})), Je = class {
  constructor(e, ...t) {
...
var Zu = {
  ...
  name: "system",
  resolver: (e) => e in Sn ? `data:image/svg+xml,${encodeURIComponent(Sn[e])}` : ""
}, rh = th, oh = [eh, rh], js = [];
function sh(e) {
  js.push(e);
}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ah = (e, t) => t === void 0 ? (e == null ? void 0 : e._$litType$) !== void 0 : (e == null ? void 0 : e._$litType$) === t, _a = (e) => e.strings === void 0, lh = {}, ch = (e, t = lh) => e._$AH = t;
var Qr = Symbol(), Oo = Symbol(), Es, zs = /* @__PURE__ */ new Map(), xe = class extends R {
  constructor() {
  ...
  async resolveIcon(e, t) {
    ...
    try {
      ...
      if (((r = i == null ? void 0 : i.tagName) == null ? void 0 : r.toLowerCase()) !== "svg")
        return Qr;
      Es || (Es = new DOMParser());
      const c = Es.parseFromString(i.outerHTML, "text/html").body.querySelector("svg");
  ...
  connectedCallback() {
    super.connectedCallback(), sh(this);
  }
  firstUpdated() {
    this.initialRender = !0, this.setIcon();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), ih(this);
  }
  getIconSource() {
    const e = $n(this.library);
    return this.name && e ? {
  ...
  async setIcon() {
    var e;
    const { url: t, fromLibrary: r } = this.getIconSource(), o = r ? $n(this.library) : void 0;
    if (!t) {
      this.svg = null;
      return;
    }
    let s = zs.get(t);
    if (s || (s = this.resolveIcon(t, o), zs.set(t, s)), !this.initialRender)
      return;
    const i = await s;
    if (i === Oo && zs.delete(t), t === this.getIconSource().url) {
      if (ah(i)) {
        this.svg = i;
        return;
      }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const At = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, wo = (e) => (...t) => ({ _$litDirective$: e, values: t });
let xo = class {
  constructor(t) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const F = wo(class extends xo {
  constructor(e) {
    var t;
    if (super(e), e.type !== At.ATTRIBUTE || e.name !== "class" || ((t = e.strings) == null ? void 0 : t.length) > 2)
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const cr = wo(class extends xo {
  constructor(e) {
    if (super(e), e.type !== At.PROPERTY && e.type !== At.ATTRIBUTE && e.type !== At.BOOLEAN_ATTRIBUTE)
  ...
  update(e, [t]) {
    ...
    if (e.type === At.PROPERTY) {
      if (t === r[o])
        return ct;
    } else if (e.type === At.BOOLEAN_ATTRIBUTE) {
      if (!!t === r.hasAttribute(o))
        return ct;
    } else if (e.type === At.ATTRIBUTE && r.getAttribute(o) === t + "")
      return ct;
    return ch(e), t;
  }
});
var Be = class extends R {
  constructor() {
    super(...arguments), this.formControlController = new Bt(this, {
...
Be.styles = [V, Xu];
Be.dependencies = { "sl-icon": xe };
a([
  A('input[type="checkbox"]')
], Be.prototype, "input", 2);
a([
  U()
...
`;
const Ws = /* @__PURE__ */ new Set(), uh = new MutationObserver($a), zr = /* @__PURE__ */ new Map();
let ka = document.documentElement.dir || "ltr", Ca = document.documentElement.lang || navigator.language, or;
uh.observe(document.documentElement, {
  attributes: !0,
...
function Sa(...e) {
  e.map((t) => {
    ...
    zr.has(r) ? zr.set(r, Object.assign(Object.assign({}, zr.get(r)), t)) : zr.set(r, t), or || (or = t);
  }), $a();
}
function $a() {
  ka = document.documentElement.dir || "ltr", Ca = document.documentElement.lang || navigator.language, [...Ws.keys()].map((e) => {
...
let hh = class {
  ...
  dir() {
    return `${this.host.dir || ka}`.toLowerCase();
  }
  lang() {
    return `${this.host.lang || Ca}`.toLowerCase();
  }
  getTranslationData(t) {
    var r, o;
    const s = new Intl.Locale(t.replace(/_/g, "-")), i = s == null ? void 0 : s.language.toLowerCase(), n = (o = (r = s == null ? void 0 : s.region) === null || r === void 0 ? void 0 : r.toLowerCase()) !== null && o !== void 0 ? o : "", c = zr.get(`${i}-${n}`), l = zr.get(i);
  ...
  exists(t, r) {
    ...
    return r = Object.assign({ includeFallback: !1 }, r), !!(s && s[t] || i && i[t] || r.includeFallback && or && or[t]);
  }
  term(t, ...r) {
...
Sa(Ea);
var ph = Ea, he = class extends hh {
};
Sa(ph);
var Lr = class extends R {
  constructor() {
    super(...arguments), this.localize = new he(this);
  }
  render() {
    return C`
...
Lr.styles = [V, dh];
var za = /* @__PURE__ */ new Map(), fh = /* @__PURE__ */ new WeakMap();
function mh(e) {
...
function Ne(e, t, r) {
  return new Promise((o) => {
    ...
    const s = e.animate(t, go(Lt({}, r), {
      duration: qs() ? 0 : r.duration
    }));
...
var Ie = class Ks extends R {
  constructor() {
    super(...arguments), this.localize = new he(this), this.indeterminate = !1, this.isLeaf = !1, this.loading = !1, this.selectable = !1, this.expanded = !1, this.selected = !1, this.disabled = !1, this.lazy = !1;
  }
  static isTreeItem(t) {
  ...
  async animateCollapse() {
    this.emit("sl-collapse"), await Le(this.childrenContainer);
    const { keyframes: t, options: r } = $e(this, "tree-item.collapse", { dir: this.localize.dir() });
    await Ne(
      this.childrenContainer,
      Uo(t, this.childrenContainer.scrollHeight),
      r
  ...
  async animateExpand() {
    this.emit("sl-expand"), await Le(this.childrenContainer), this.childrenContainer.hidden = !1;
  ...
  getChildrenItems({ includeDisabled: t = !0 } = {}) {
    return this.childrenSlot ? [...this.childrenSlot.assignedElements({ flatten: !0 })].filter(
      (r) => Ks.isTreeItem(r) && (t || !r.disabled)
    ) : [];
  }
  render() {
    ...
    return C`
      ...
      "tree-item__expand-button--visible": r
            ...
            aria-hidden="true"
          >
            ${An(this.loading, () => C` <sl-spinner></sl-spinner> `)}
...
], qe.prototype, "handleCheckedChange", 1);
a([
  z("disabled", { waitUntilFirstUpdate: !0 })
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Aa = Symbol.for(""), xh = (e) => {
  if ((e == null ? void 0 : e.r) === Aa)
    return e == null ? void 0 : e._$litStatic$;
}, jo = (e, ...t) => ({ _$litStatic$: t.reduce((r, o, s) => r + ((i) => {
...
})(o) + e[s + 1], e[0]), r: Aa }), Tn = /* @__PURE__ */ new Map(), _h = (e) => (t, ...r) => {
  const o = r.length;
  let s, i;
  const n = [], c = [];
  let l, d = 0, f = !1;
  for (; d < o; ) {
    for (l = t[d]; d < o && (i = r[d], (s = xh(i)) !== void 0); )
      l += s + t[++d], f = !0;
    d !== o && c.push(i), n.push(l), d++;
  }
  if (d === o && n.push(t[o]), f) {
    const h = n.join("$$lit$$");
    (t = Tn.get(h)) === void 0 && (n.raw = n, Tn.set(h, t = n)), r = c;
  }
  return e(t, ...r);
}, io = _h(C);
var Ve = class extends R {
  ...
  render() {
    const e = !!this.href, t = e ? jo`a` : jo`button`;
    return io`
      <${t}
        part="base"
        class=${F({
...
Ve.styles = [V, wh];
Ve.dependencies = { "sl-icon": xe };
a([
  A(".icon-button")
], Ve.prototype, "button", 2);
a([
  U()
], Ve.prototype, "hasFocus", 2);
a([
  u()
], Ve.prototype, "name", 2);
a([
  u()
], Ve.prototype, "library", 2);
a([
  u()
], Ve.prototype, "src", 2);
a([
...
var kh = 0, kt = class extends R {
  constructor() {
    super(...arguments), this.localize = new he(this), this.attrId = ++kh, this.componentId = `sl-tab-${this.attrId}`, this.panel = "", this.active = !1, this.closable = !1, this.disabled = !1;
  }
  connectedCallback() {
...
kt.styles = [V, yh];
kt.dependencies = { "sl-icon-button": Ve };
a([
  A(".tab")
], kt.prototype, "tab", 2);
a([
  u({ reflect: !0 })
], kt.prototype, "panel", 2);
a([
  u({ type: Boolean, reflect: !0 })
], kt.prototype, "active", 2);
a([
  u({ type: Boolean })
], kt.prototype, "closable", 2);
a([
  u({ type: Boolean, reflect: !0 })
], kt.prototype, "disabled", 2);
a([
  z("active")
], kt.prototype, "handleActiveChange", 1);
a([
  z("disabled")
...
`, $h = 0, Vr = class extends R {
  constructor() {
    super(...arguments), this.attrId = ++$h, this.componentId = `sl-tab-panel-${this.attrId}`, this.name = "", this.active = !1;
  }
  connectedCallback() {
...
a([
  z("active")
], Vr.prototype, "handleActiveChange", 1);
var Eh = "sl-tab-panel";
Vr.define("sl-tab-panel");
D({
  tagName: Eh,
  elementClass: Vr,
  react: I,
...
function no(e) {
  if (Ys.add(e), !document.body.classList.contains("sl-scroll-lock")) {
    const t = Th();
    document.body.classList.add("sl-scroll-lock"), document.body.style.setProperty("--sl-scroll-lock-size", `${t}px`);
  }
}
function ao(e) {
  Ys.delete(e), Ys.size === 0 && (document.body.classList.remove("sl-scroll-lock"), document.body.style.removeProperty("--sl-scroll-lock-size"));
}
function Xs(e, t, r = "vertical", o = "smooth") {
  const s = Ah(e, t), i = s.top + t.scrollTop, n = s.left + t.scrollLeft, c = t.scrollLeft, l = t.scrollLeft + t.offsetWidth, d = t.scrollTop, f = t.scrollTop + t.offsetHeight;
...
var et = class extends R {
  constructor() {
    super(...arguments), this.localize = new he(this), this.tabs = [], this.panels = [], this.hasScrollControls = !1, this.placement = "top", this.activation = "auto", this.noScrollControls = !1;
  }
  connectedCallback() {
    const e = Promise.all([
  ...
  setActiveTab(e, t) {
    if (t = Lt({
      ...
      }), this.syncIndicator(), ["top", "bottom"].includes(this.placement) && Xs(this.activeTab, this.nav, "horizontal", t.scrollBehavior), t.emitEvents && (r && this.emit("sl-tab-hide", { detail: { name: r.panel } }), this.emit("sl-tab-show", { detail: { name: this.activeTab.panel } }));
    }
  }
  setAriaLabels() {
    this.tabs.forEach((e) => {
...
et.styles = [V, zh];
et.dependencies = { "sl-icon-button": Ve };
a([
  A(".tab-group")
], et.prototype, "tabGroup", 2);
a([
  A(".tab-group__body")
], et.prototype, "body", 2);
a([
...
], et.prototype, "indicator", 2);
a([
  U()
], et.prototype, "hasScrollControls", 2);
a([
  u()
], et.prototype, "placement", 2);
a([
  u()
], et.prototype, "activation", 2);
a([
  u({ attribute: "no-scroll-controls", type: Boolean })
], et.prototype, "noScrollControls", 2);
a([
  z("noScrollControls", { waitUntilFirstUpdate: !0 })
], et.prototype, "updateScrollControls", 1);
a([
  z("placement", { waitUntilFirstUpdate: !0 })
], et.prototype, "syncIndicator", 1);
var Oh = "sl-tab-group";
et.define("sl-tab-group");
D({
  tagName: Oh,
  elementClass: et,
  react: I,
...
`, Vt = class extends R {
  constructor() {
    super(...arguments), this.localize = new he(this), this.variant = "neutral", this.size = "medium", this.pill = !1, this.removable = !1;
  }
  handleRemoveClick() {
    this.emit("sl-remove");
  }
...
Vt.styles = [V, Nh];
Vt.dependencies = { "sl-icon-button": Ve };
a([
  u({ reflect: !0 })
...
`;
const Kt = Math.min, at = Math.max, Wo = Math.round, No = Math.floor, Yt = (e) => ({
  x: e,
  y: e
}), Mh = {
  left: "right",
...
function Lh(e, t, r) {
  r === void 0 && (r = !1);
  const o = Hr(e), s = ki(e), i = _i(s);
  let n = s === "x" ? o === (r ? "end" : "start") ? "right" : "left" : o === "start" ? "bottom" : "top";
  return t.reference[i] > t.floating[i] && (n = qo(n)), [n, qo(n)];
}
function Bh(e) {
  const t = qo(e);
  return [Js(e), t, Js(t)];
...
function Fh(e, t, r, o) {
  const s = Hr(e);
  let i = Vh(Xt(e), r === "start", o);
  return s && (i = i.map((n) => n + "-" + s), t && (i = i.concat(i.map(Js)))), i;
}
function qo(e) {
...
function On(e, t, r) {
  ...
  const i = _o(t), n = ki(t), c = _i(n), l = Xt(t), d = i === "y", f = o.x + o.width / 2 - s.width / 2, h = o.y + o.height / 2 - s.height / 2, p = o[c] / 2 - s[c] / 2;
  let m;
  switch (l) {
    case "top":
      m = {
...
const Uh = async (e, t, r) => {
  ...
  for (let v = 0; v < c.length; v++) {
    ...
    }, y && b <= 50 && (b++, typeof y == "object" && (y.placement && (p = y.placement), y.rects && (d = y.rects === !0 ? await n.getElementRects({
      reference: e,
      floating: t,
      strategy: s
    }) : y.rects), {
...
async function Ci(e, t) {
  ...
  const {
    ...
    altBoundary: p = !1,
    padding: m = 0
  } = Fr(t, e), b = Oa(m), g = c[p ? h === "floating" ? "reference" : "floating" : h], x = Ko(await i.getClippingRect({
    element: (r = await (i.isElement == null ? void 0 : i.isElement(g))) == null || r ? g : g.contextElement || await (i.getDocumentElement == null ? void 0 : i.getDocumentElement(c.floating)),
    boundary: d,
    rootBoundary: f,
    strategy: l
  })), _ = h === "floating" ? {
  ...
  return {
    top: (x.top - y.top + b.top) / w.y,
    bottom: (y.bottom - x.bottom + b.bottom) / w.y,
    left: (x.left - y.left + b.left) / w.x,
    right: (y.right - x.right + b.right) / w.x
  };
}
const jh = (e) => ({
  name: "arrow",
  ...
  async fn(t) {
    ...
    const h = Oa(f), p = {
      x: r,
      y: o
    }, m = ki(s), b = _i(m), v = await n.getDimensions(d), g = m === "y", x = g ? "top" : "left", _ = g ? "bottom" : "right", k = g ? "clientHeight" : "clientWidth", w = i.reference[b] + i.reference[m] - p[m] - i.floating[b], y = p[m] - i.reference[m], E = await (n.getOffsetParent == null ? void 0 : n.getOffsetParent(d));
    let H = E ? E[k] : 0;
    (!H || !await (n.isElement == null ? void 0 : n.isElement(E))) && (H = c.floating[k] || i.floating[b]);
    const j = w / 2 - y / 2, M = H / 2 - v[b] / 2 - 1, N = Kt(h[x], M), Y = Kt(h[_], M), K = N, _e = H - v[b] - Y, te = H / 2 - v[b] / 2 + j, re = Gs(K, te, _e), ke = !l.arrow && Hr(s) != null && te !== re && i.reference[b] / 2 - (te < K ? N : Y) - v[b] / 2 < 0, Re = ke ? te < K ? te - K : te - _e : 0;
    return {
      [m]: p[m] + Re,
      data: {
        [m]: re,
        centerOffset: te - re - Re,
        ...ke && {
          alignmentOffset: Re
        }
      },
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((r = i.arrow) != null && r.alignmentOffset)
        return {};
      const x = Xt(s), _ = Xt(c) === c, k = await (l.isRTL == null ? void 0 : l.isRTL(d.floating)), w = p || (_ || !v ? [qo(c)] : Bh(c));
      !p && b !== "none" && w.push(...Fh(c, v, b, k));
      const y = [c, ...w], E = await Ci(t, g), H = [];
      ...
      if (j = [...j, {
        ...
        var M, N;
        const K = (((M = i.flip) == null ? void 0 : M.index) || 0) + 1, _e = y[K];
        if (_e)
          return {
            data: {
              index: K,
        ...
        let te = (N = j.filter((re) => re.overflows[0] <= 0).sort((re, ke) => re.overflows[1] - ke.overflows[1])[0]) == null ? void 0 : N.placement;
        if (!te)
          switch (m) {
            case "bestFit": {
              var Y;
              const re = (Y = j.map((ke) => [ke.placement, ke.overflows.filter((Re) => Re > 0).reduce((Re, It) => Re + It, 0)]).sort((ke, Re) => ke[1] - Re[1])[0]) == null ? void 0 : Y[0];
              re && (te = re);
              break;
            }
...
async function qh(e, t) {
  const {
    ...
    platform: o,
    elements: s
  } = e, i = await (o.isRTL == null ? void 0 : o.isRTL(s.floating)), n = Xt(r), c = Hr(r), l = _o(r) === "y", d = ["left", "top"].includes(n) ? -1 : 1, f = i && l ? -1 : 1, h = Fr(t, e);
  let {
    mainAxis: p,
    crossAxis: m,
    alignmentAxis: b
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: r,
        y: o
      }, f = await Ci(t, l), h = _o(Xt(s)), p = Ta(h);
      let m = d[p], b = d[h];
      if (i) {
        const g = p === "y" ? "top" : "left", x = p === "y" ? "bottom" : "right", _ = m + f[g], k = m - f[x];
        m = Gs(_, m, k);
      }
      if (n) {
        const g = h === "y" ? "top" : "left", x = h === "y" ? "bottom" : "right", _ = b + f[g], k = b - f[x];
        b = Gs(_, b, k);
      }
      const v = c.fn({
        ...t,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        ...c
      } = Fr(e, t), l = await Ci(t, c), d = Xt(r), f = Hr(r), h = _o(r) === "y", {
        width: p,
        height: m
      } = o.floating;
      let b, v;
      d === "top" || d === "bottom" ? (b = d, v = f === (await (s.isRTL == null ? void 0 : s.isRTL(i.floating)) ? "start" : "end") ? "left" : "right") : (v = d, b = f === "end" ? "top" : "bottom");
      const g = m - l[b], x = p - l[v], _ = !t.middlewareData.shift;
      let k = g, w = x;
      if (h) {
        const E = p - l.left - l.right;
        w = f || _ ? Kt(x, E) : E;
      } else {
        const E = m - l.top - l.bottom;
        k = f || _ ? Kt(g, E) : E;
      }
      if (_ && !f) {
        const E = at(l.left, 0), H = at(l.right, 0), j = at(l.top, 0), M = at(l.bottom, 0);
        h ? w = p - 2 * (E !== 0 || H !== 0 ? E + H : at(l.left, l.right)) : k = m - 2 * (j !== 0 || M !== 0 ? j + M : at(l.top, l.bottom));
      }
      await n({
        ...t,
        availableWidth: w,
...
function Ia(e) {
  const t = Mr(e);
  return ds(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : Nt(t) && ko(t) ? t : Ia(t);
}
function mo(e, t, r) {
  var o;
  t === void 0 && (t = []), r === void 0 && (r = !0);
  const s = Ia(e), i = s === ((o = e.ownerDocument) == null ? void 0 : o.body), n = dt(s);
  return i ? t.concat(n, n.visualViewport || [], ko(s) ? s : [], n.frameElement && r ? mo(n.frameElement) : []) : t.concat(s, mo(s, [], r));
}
function Ra(e) {
  const t = mt(e);
  let r = parseFloat(t.width) || 0, o = parseFloat(t.height) || 0;
  const s = Nt(e), i = s ? e.offsetWidth : r, n = s ? e.offsetHeight : o, c = Wo(r) !== i || Wo(o) !== n;
  return c && (r = i, o = n), {
    width: r,
    height: o,
    $: c
...
function Or(e) {
  ...
  let n = (i ? Wo(r.width) : r.width) / o, c = (i ? Wo(r.height) : r.height) / s;
  return (!n || !Number.isFinite(n)) && (n = 1), (!c || !Number.isFinite(c)) && (c = 1), {
    x: n,
    y: c
  };
}
const Qh = /* @__PURE__ */ Yt(0);
function Pa(e) {
  const t = dt(e);
  return !$i() || !t.visualViewport ? Qh : {
    x: t.visualViewport.offsetLeft,
    y: t.visualViewport.offsetTop
  };
}
function Zh(e, t, r) {
  return t === void 0 && (t = !1), !r || t && r !== dt(e) ? !1 : t;
}
function dr(e, t, r, o) {
  t === void 0 && (t = !1), r === void 0 && (r = !1);
  const s = e.getBoundingClientRect(), i = Ei(e);
  let n = Yt(1);
  t && (o ? Dt(o) && (n = Or(o)) : n = Or(e));
  const c = Zh(i, r, o) ? Pa(i) : Yt(0);
  let l = (s.left + c.x) / n.x, d = (s.top + c.y) / n.y, f = s.width / n.x, h = s.height / n.y;
  if (i) {
    const p = dt(i), m = o && Dt(o) ? dt(o) : o;
    let b = p, v = b.frameElement;
    for (; v && o && m !== b; ) {
      const g = Or(v), x = v.getBoundingClientRect(), _ = mt(v), k = x.left + (v.clientLeft + parseFloat(_.paddingLeft)) * g.x, w = x.top + (v.clientTop + parseFloat(_.paddingTop)) * g.y;
      l *= g.x, d *= g.y, f *= g.x, h *= g.y, l += k, d += w, b = dt(v), v = b.frameElement;
    }
  }
  return Ko({
    width: f,
...
function tp(e) {
  ...
  const i = s === "fixed", n = Ft(o), c = t ? Ma(t.floating) : !1;
  if (o === n || c && i)
    return r;
  let l = {
    scrollLeft: 0,
  ...
  const f = Yt(0), h = Nt(o);
  if ((h || !h && !i) && ((Gt(o) !== "body" || ko(n)) && (l = us(o)), Nt(o))) {
    const p = dr(o);
    d = Or(o), f.x = p.x + o.clientLeft, f.y = p.y + o.clientTop;
  }
  return {
    width: r.width * d.x,
    height: r.height * d.y,
...
function Da(e) {
  return dr(Ft(e)).left + us(e).scrollLeft;
}
function op(e) {
  const t = Ft(e), r = us(e), o = e.ownerDocument.body, s = at(t.scrollWidth, t.clientWidth, o.scrollWidth, o.clientWidth), i = at(t.scrollHeight, t.clientHeight, o.scrollHeight, o.clientHeight);
  let n = -r.scrollLeft + Da(e);
  const c = -r.scrollTop;
  return mt(o).direction === "rtl" && (n += at(t.clientWidth, o.clientWidth) - s), {
    width: s,
    height: i,
    x: n,
    y: c
...
function sp(e, t) {
  const r = dt(e), o = Ft(e), s = r.visualViewport;
...
function ip(e, t) {
  const r = dr(e, !0, t === "fixed"), o = r.top + e.clientTop, s = r.left + e.clientLeft, i = Nt(e) ? Or(e) : Yt(1), n = e.clientWidth * i.x, c = e.clientHeight * i.y, l = s * i.x, d = o * i.y;
  return {
    width: n,
    height: c,
    x: l,
...
function La(e, t) {
  const r = Mr(e);
  return r === t || !Dt(r) || ds(r) ? !1 : mt(r).position === "fixed" || La(r, t);
}
function np(e, t) {
  const r = t.get(e);
  if (r)
    return r;
  let o = mo(e, [], !1).filter((c) => Dt(c) && Gt(c) !== "body"), s = null;
  const i = mt(e).position === "fixed";
  let n = i ? Mr(e) : e;
  for (; Dt(n) && !ds(n); ) {
    const c = mt(n), l = Si(n);
    !l && c.position === "fixed" && (s = null), (i ? !l && !s : !l && c.position === "static" && !!s && ["absolute", "fixed"].includes(s.position) || ko(n) && !l && La(e, n)) ? o = o.filter((f) => f !== n) : s = c, n = Mr(n);
  }
  return t.set(e, o), o;
}
function ap(e) {
  ...
  const n = [...r === "clippingAncestors" ? np(t, this._c) : [].concat(r), o], c = n[0], l = n.reduce((d, f) => {
    const h = In(t, f, s);
    return d.top = at(h.top, d.top), d.right = Kt(h.right, d.right), d.bottom = Kt(h.bottom, d.bottom), d.left = at(h.left, d.left), d;
  }, In(t, c, s));
  return {
...
function cp(e, t, r) {
  const o = Nt(t), s = Ft(t), i = r === "fixed", n = dr(e, !0, i, t);
  let c = {
    scrollLeft: 0,
    scrollTop: 0
  };
...
function Rn(e, t) {
  return !Nt(e) || mt(e).position === "fixed" ? null : t ? t(e) : e.offsetParent;
}
function Ba(e, t) {
  const r = dt(e);
  if (!Nt(e) || Ma(e))
    return r;
  let o = Rn(e, t);
  for (; o && Gh(o) && mt(o).position === "static"; )
    o = Rn(o, t);
  return o && (Gt(o) === "html" || Gt(o) === "body" && mt(o).position === "static" && !Si(o)) ? r : o || Jh(e) || r;
}
...
function hp(e, t) {
  ...
  function n(c, l) {
    ...
    if (c || t(), !h || !p)
      return;
    const m = No(f), b = No(s.clientWidth - (d + h)), v = No(s.clientHeight - (f + p)), g = No(d), _ = {
      rootMargin: -m + "px " + -b + "px " + -v + "px " + -g + "px",
      threshold: at(0, Kt(1, l)) || 1
    };
    let k = !0;
    function w(y) {
...
function pp(e, t, r, o) {
  ...
  return r(), () => {
    var x;
    f.forEach((_) => {
      s && _.removeEventListener("scroll", r), i && _.removeEventListener("resize", r);
    }), h == null || h(), (x = m) == null || x.disconnect(), m = null, l && cancelAnimationFrame(b);
  };
}
const fp = Yh, mp = Wh, Pn = Xh, gp = jh, bp = (e, t, r) => {
...
var pe = class extends R {
  ...
  async handleAnchorChange() {
    if (await this.stop(), this.anchor && typeof this.anchor == "string") {
      ...
      this.anchor instanceof Element || wp(this.anchor) ? this.anchorEl = this.anchor : this.anchorEl = this.querySelector('[slot="anchor"]');
  ...
  start() {
    this.anchorEl && (this.cleanup = pp(this.anchorEl, this.popup, () => {
      this.reposition();
    }));
  }
  async stop() {
  ...
  reposition() {
    ...
    const e = [
      ...
      Kh({ mainAxis: this.distance, crossAxis: this.skidding })
    ];
    this.sync ? e.push(
      Pn({
        apply: ({ rects: r }) => {
    ...
    const t = this.strategy === "absolute" ? (r) => Bo.getOffsetParent(r, vp) : Bo.getOffsetParent;
    bp(this.anchorEl, this.popup, {
      ...
      if (this.setAttribute("data-current-placement", i), Object.assign(this.popup.style, {
        ...
        if (this.arrowPlacement === "start") {
          ...
          f = typeof d == "number" ? `calc(${this.arrowPadding}px - var(--arrow-padding-offset))` : "", h = n ? b : "", m = n ? "" : b;
        } else if (this.arrowPlacement === "end") {
          const b = typeof l == "number" ? `calc(${this.arrowPadding}px - var(--arrow-padding-offset))` : "";
          h = n ? "" : b, m = n ? b : "", p = typeof d == "number" ? `calc(${this.arrowPadding}px - var(--arrow-padding-offset))` : "";
        } else
...
var Fe = class extends R {
  constructor() {
    super(), this.localize = new he(this), this.content = "", this.placement = "top", this.disabled = !1, this.distance = 8, this.open = !1, this.skidding = 0, this.trigger = "hover focus", this.hoist = !1, this.handleBlur = () => {
      ...
      if (this.hasTrigger("hover")) {
        const e = zn(getComputedStyle(this).getPropertyValue("--show-delay"));
        clearTimeout(this.hoverTimeout), this.hoverTimeout = window.setTimeout(() => this.show(), e);
      }
    }, this.handleMouseOut = () => {
      if (this.hasTrigger("hover")) {
        const e = zn(getComputedStyle(this).getPropertyValue("--hide-delay"));
  ...
  async handleOpenChange() {
    ...
    if (this.open) {
      ...
      this.emit("sl-show"), "CloseWatcher" in window ? ((e = this.closeWatcher) == null || e.destroy(), this.closeWatcher = new CloseWatcher(), this.closeWatcher.onclose = () => {
        this.hide();
      }) : document.addEventListener("keydown", this.handleDocumentKeyDown), await Le(this.body), this.body.hidden = !1, this.popup.active = !0;
      ...
      this.emit("sl-hide"), (t = this.closeWatcher) == null || t.destroy(), document.removeEventListener("keydown", this.handleDocumentKeyDown), await Le(this.body);
...
], Fe.prototype, "handleOpenChange", 1);
a([
  z(["content", "distance", "hoist", "placement", "skidding"])
], Fe.prototype, "handleOptionsChange", 1);
a([
  z("disabled")
], Fe.prototype, "handleDisabledChange", 1);
ye("tooltip.show", {
  keyframes: [
    { opacity: 0, scale: 0.8 },
    { opacity: 1, scale: 1 }
...
var Qt = class extends R {
  constructor() {
    super(), this.selection = "single", this.localize = new he(this), this.clickTarget = null, this.initTreeItem = (e) => {
      ...
      for (const t of e) {
        const r = [...t.addedNodes].filter(Tr.isTreeItem), o = [...t.removedNodes].filter(Tr.isTreeItem);
      ...
      const t = e.target;
      e.target === this && this.focusItem(this.lastFocusedItem || this.getAllTreeItems()[0]), Tr.isTreeItem(t) && !t.disabled && (this.lastFocusedItem && (this.lastFocusedItem.tabIndex = -1), this.lastFocusedItem = t, this.tabIndex = -1, t.tabIndex = 0);
  ...
  selectItem(e) {
    ...
    if (this.selection === "multiple")
      e.selected = !e.selected, e.lazy && (e.expanded = !0), Mn(e);
...
], Qt.prototype, "expandedIconSlot", 2);
a([
  A("slot[name=collapse-icon]")
], Qt.prototype, "collapsedIconSlot", 2);
a([
  u()
], Qt.prototype, "selection", 2);
a([
  z("selection")
], Qt.prototype, "handleSelectionChange", 1);
var kp = "sl-tree";
Qt.define("sl-tree");
D({
  tagName: kp,
...
a([
  u({ type: Number })
], de.prototype, "minlength", 2);
a([
  u({ type: Number })
], de.prototype, "maxlength", 2);
a([
  u()
], de.prototype, "autocapitalize", 2);
a([
  u()
], de.prototype, "autocorrect", 2);
a([
  u()
], de.prototype, "autocomplete", 2);
a([
  u({ type: Boolean })
], de.prototype, "autofocus", 2);
a([
  u()
], de.prototype, "enterkeyhint", 2);
a([
  u({
    type: Boolean,
    converter: {
...
], de.prototype, "spellcheck", 2);
a([
  u()
], de.prototype, "inputmode", 2);
a([
  ur()
...
], de.prototype, "handleRowsChange", 1);
a([
  z("value", { waitUntilFirstUpdate: !0 })
], de.prototype, "handleValueChange", 1);
var Sp = "sl-textarea";
de.define("sl-textarea");
D({
  tagName: Sp,
  elementClass: de,
  react: I,
...
a([
  u({ type: Boolean, reflect: !0 })
], Co.prototype, "disabled", 2);
a([
  z("disabled", { waitUntilFirstUpdate: !0 })
], Co.prototype, "handleDisabledChange", 1);
var Op = "sl-resize-observer";
Co.define("sl-resize-observer");
D({
  tagName: Op,
  elementClass: Co,
  react: I,
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Va = "important", Ip = " !" + Va, Ze = wo(class extends xo {
  constructor(e) {
    var t;
    if (super(e), e.type !== At.ATTRIBUTE || e.name !== "style" || ((t = e.strings) == null ? void 0 : t.length) > 2)
  ...
  update(e, [t]) {
    ...
    for (const o in t) {
      ...
      if (s != null) {
        this.ft.add(o);
        const i = typeof s == "string" && s.endsWith(Ip);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
let Qs = class extends xo {
  constructor(t) {
    if (super(t), this.it = Se, t.type !== At.CHILD)
...
var Ke = class extends R {
  constructor() {
    super(...arguments), this.localize = new he(this), this.hoverValue = 0, this.isHovering = !1, this.label = "", this.value = 0, this.max = 5, this.precision = 1, this.readonly = !1, this.disabled = !1, this.getSymbol = () => '<sl-icon name="star-fill" library="system"></sl-icon>';
  }
...
Ke.styles = [V, Np];
Ke.dependencies = { "sl-icon": xe };
a([
  A(".rating")
], Ke.prototype, "rating", 2);
a([
  U()
], Ke.prototype, "hoverValue", 2);
a([
  U()
], Ke.prototype, "isHovering", 2);
a([
  u()
...
a([
  u()
], Ke.prototype, "getSymbol", 2);
a([
  xi({ passive: !0 })
], Ke.prototype, "handleTouchMove", 1);
a([
  z("hoverValue")
], Ke.prototype, "handleHoverValueChange", 1);
a([
  z("isHovering")
], Ke.prototype, "handleIsHoveringChange", 1);
var Rp = "sl-rating";
Ke.define("sl-rating");
D({
  tagName: Rp,
...
var Pp = [
  ...
  constructor() {
    super(...arguments), this.localize = new he(this), this.isoTime = "", this.relativeTime = "", this.titleTime = "", this.date = /* @__PURE__ */ new Date(), this.format = "long", this.numeric = "auto", this.sync = !1;
  }
  disconnectedCallback() {
  ...
  render() {
    ...
    const r = t.getTime() - e.getTime(), { unit: o, value: s } = Pp.find((i) => Math.abs(r) < i.max);
    if (this.isoTime = t.toISOString(), this.titleTime = this.localize.date(t, {
      ...
      let i;
      o === "minute" ? i = Io("second") : o === "hour" ? i = Io("minute") : o === "day" ? i = Io("hour") : i = Io("day"), this.updateTimeout = window.setTimeout(() => this.requestUpdate(), i);
    }
...
a([
  U()
], Ht.prototype, "isoTime", 2);
a([
  U()
], Ht.prototype, "relativeTime", 2);
a([
  U()
], Ht.prototype, "titleTime", 2);
a([
  u()
], Ht.prototype, "date", 2);
a([
  u()
], Ht.prototype, "format", 2);
a([
  u()
], Ht.prototype, "numeric", 2);
a([
  u({ type: Boolean })
], Ht.prototype, "sync", 2);
function Io(e) {
...
var Mp = "sl-relative-time";
Ht.define("sl-relative-time");
D({
  tagName: Mp,
  elementClass: Ht,
  react: I,
...
`, oe = class extends R {
  ...
  async handleOpenChange() {
    if (this.open && !this.disabled) {
      this.setCurrentOption(this.selectedOptions[0] || this.getFirstOption()), this.emit("sl-show"), this.addOpenListeners(), await Le(this), this.listbox.hidden = !1, this.popup.active = !0, requestAnimationFrame(() => {
        this.setCurrentOption(this.currentOption);
      });
      const { keyframes: e, options: t } = $e(this, "select.show", { dir: this.localize.dir() });
      await Ne(this.popup.popup, e, t), this.currentOption && Xs(this.currentOption, this.listbox, "vertical", "auto"), this.emit("sl-after-show");
    } else {
...
a([
  u()
], hs.prototype, "effect", 2);
var Vp = "sl-skeleton";
hs.define("sl-skeleton");
D({
  tagName: Vp,
  elementClass: hs,
  react: I,
...
var tt = class extends R {
  constructor() {
    super(...arguments), this.localize = new he(this), this.position = 50, this.vertical = !1, this.disabled = !1, this.snapThreshold = 12;
  }
  connectedCallback() {
  ...
  handleDrag(e) {
    ...
    this.disabled || (e.cancelable && e.preventDefault(), lo(this, {
      onMove: (r, o) => {
        ...
        }), this.position = De(this.pixelsToPercentage(s), 0, 100);
      },
      initialEvent: e
    }));
  }
  handleKeyDown(e) {
    if (!this.disabled && ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Home", "End"].includes(e.key)) {
      ...
      e.preventDefault(), (e.key === "ArrowLeft" && !this.vertical || e.key === "ArrowUp" && this.vertical) && (t -= r), (e.key === "ArrowRight" && !this.vertical || e.key === "ArrowDown" && this.vertical) && (t += r), e.key === "Home" && (t = this.primary === "end" ? 100 : 0), e.key === "End" && (t = this.primary === "end" ? 0 : 100), this.position = De(t, 0, 100);
    }
  }
  handleResize(e) {
...
], tt.prototype, "positionInPixels", 2);
a([
  u({ type: Boolean, reflect: !0 })
...
`, ut = class extends R {
  constructor() {
    super(...arguments), this.localize = new he(this), this.current = !1, this.selected = !1, this.hasHover = !1, this.value = "", this.disabled = !1;
  }
  connectedCallback() {
...
ut.styles = [V, jp];
ut.dependencies = { "sl-icon": xe };
a([
  A(".option__label")
], ut.prototype, "defaultSlot", 2);
a([
  U()
], ut.prototype, "current", 2);
a([
  U()
], ut.prototype, "selected", 2);
a([
  U()
], ut.prototype, "hasHover", 2);
a([
  u({ reflect: !0 })
...
a([
  z("disabled")
], ut.prototype, "handleDisabledChange", 1);
a([
  z("selected")
], ut.prototype, "handleSelectedChange", 1);
a([
  z("value")
], ut.prototype, "handleValueChange", 1);
var Wp = "sl-option";
ut.define("sl-option");
D({
  tagName: Wp,
...
`, hr = class extends R {
  constructor() {
    super(...arguments), this.localize = new he(this), this.value = 0, this.label = "";
  }
  updated(e) {
...
`, Ur = class extends R {
  constructor() {
    super(...arguments), this.localize = new he(this), this.value = 0, this.indeterminate = !1, this.label = "";
  }
  render() {
    return C`
      <div
...
a([
  u({ type: Boolean, reflect: !0 })
], Ur.prototype, "indeterminate", 2);
a([
  u()
], Ur.prototype, "label", 2);
var Xp = "sl-progress-bar";
Ur.define("sl-progress-bar");
D({
  tagName: Xp,
  elementClass: Ur,
  react: I,
...
(function(e) {
  function t(c, l, d, f) {
    ...
    p.u(c), p.J(), f = f || 0;
    var m = p.h(), b = p.h() + 2 * f;
    return h.text = c, h.level = l, h.version = d, h.O = b, h.a = function(v, g) {
      return v -= f, g -= f, 0 > v || v >= m || 0 > g || g >= m ? !1 : p.a(v, g);
    }, h;
  }
  function r(c, l, d, f, h, p, m, b, v, g) {
    function x(_, k, w, y, E, H, j) {
      _ ? (c.lineTo(k + H, w + j), c.arcTo(k, w, y, E, p)) : c.lineTo(k, w);
    }
    m ? c.moveTo(l + p, d) : c.moveTo(l, d), x(b, f, d, f, h, -p, 0), x(v, f, h, l, h, 0, -p), x(g, l, h, l, d, p, 0), x(m, l, d, f, d, 0, p);
  }
  function o(c, l, d, f, h, p, m, b, v, g) {
    function x(_, k, w, y) {
      c.moveTo(_ + w, k), c.lineTo(
        _,
        k
      ), c.lineTo(_, k + y), c.arcTo(_, k, _ + w, k, p);
    }
    m && x(l, d, p, p), b && x(f, d, -p, p), v && x(f, h, -p, -p), g && x(l, h, p, -p);
  }
  function s(c, l) {
    var d = l.fill;
    if (typeof d == "string")
  ...
  function i(c, l) {
    ...
    if (!b)
      return null;
    for (d = c.getContext("2d"), l.background && (d.fillStyle = l.background, d.fillRect(l.left, l.top, l.size, l.size)), f = b.O, p = l.size / f, d.beginPath(), m = 0; m < f; m += 1)
      for (h = 0; h < f; h += 1) {
        var v = d, g = l.left + h * p, x = l.top + m * p, _ = m, k = h, w = b.a, y = g + p, E = x + p, H = _ - 1, j = _ + 1, M = k - 1, N = k + 1, Y = Math.floor(Math.min(0.5, Math.max(0, l.R)) * p), K = w(_, k), _e = w(H, M), te = w(H, k);
        H = w(H, N);
        var re = w(_, N);
        N = w(j, N), k = w(
          j,
          k
        ), j = w(j, M), _ = w(_, M), g = Math.round(g), x = Math.round(x), y = Math.round(y), E = Math.round(E), K ? r(v, g, x, y, E, Y, !te && !_, !te && !re, !k && !re, !k && !_) : o(v, g, x, y, E, Y, te && _ && _e, te && re && H, k && re && N, k && _ && j);
      }
  ...
  function r(l, d) {
    function f(_, k) {
      for (var w = -1; 7 >= w; w += 1)
        if (!(-1 >= _ + w || b <= _ + w))
          for (var y = -1; 7 >= y; y += 1)
            -1 >= k + y || b <= k + y || (m[_ + w][k + y] = 0 <= w && 6 >= w && (y == 0 || y == 6) || 0 <= y && 6 >= y && (w == 0 || w == 6) || 2 <= w && 4 >= w && 2 <= y && 4 >= y);
    }
    function h(_, k) {
      for (var w = b = 4 * l + 17, y = Array(w), E = 0; E < w; E += 1) {
        y[E] = Array(w);
        for (var H = 0; H < w; H += 1)
          y[E][H] = null;
      }
      for (m = y, f(0, 0), f(b - 7, 0), f(0, b - 7), w = i.G(l), y = 0; y < w.length; y += 1)
        for (E = 0; E < w.length; E += 1) {
          ...
          if (m[H][j] == null)
            for (var M = -2; 2 >= M; M += 1)
              for (var N = -2; 2 >= N; N += 1)
                m[H + M][j + N] = M == -2 || M == 2 || N == -2 || N == 2 || M == 0 && N == 0;
        }
      for (w = 8; w < b - 8; w += 1)
      ...
      for (w = i.w(p << 3 | k), y = 0; 15 > y; y += 1)
        E = !_ && (w >> y & 1) == 1, m[6 > y ? y : 8 > y ? y + 1 : b - 15 + y][8] = E, m[8][8 > y ? b - y - 1 : 9 > y ? 15 - y : 14 - y] = E;
      if (m[b - 8][8] = !_, 7 <= l) {
        for (w = i.A(l), y = 0; 18 > y; y += 1)
          E = !_ && (w >> y & 1) == 1, m[Math.floor(y / 3)][y % 3 + b - 8 - 3] = E;
        for (y = 0; 18 > y; y += 1)
          E = !_ && (w >> y & 1) == 1, m[y % 3 + b - 8 - 3][Math.floor(y / 3)] = E;
      }
      if (v == null) {
        for (_ = c.I(l, p), w = t(), y = 0; y < g.length; y += 1)
          E = g[y], w.put(4, 4), w.put(E.b(), i.f(4, l)), E.write(w);
        for (y = E = 0; y < _.length; y += 1)
          E += _[y].j;
        if (w.f() > 8 * E)
        ...
        for (; !(w.f() >= 8 * E) && (w.put(236, 8), !(w.f() >= 8 * E)); )
          w.put(17, 8);
        var Y = 0;
        for (E = y = 0, H = Array(_.length), j = Array(_.length), M = 0; M < _.length; M += 1) {
          var K = _[M].j, _e = _[M].o - K;
          for (y = Math.max(y, K), E = Math.max(E, _e), H[M] = Array(K), N = 0; N < H[M].length; N += 1)
            H[M][N] = 255 & w.B()[N + Y];
          for (Y += K, N = i.C(_e), K = o(H[M], N.b() - 1).l(N), j[M] = Array(N.b() - 1), N = 0; N < j[M].length; N += 1)
            _e = N + K.b() - j[M].length, j[M][N] = 0 <= _e ? K.c(_e) : 0;
        }
        for (N = w = 0; N < _.length; N += 1)
          w += _[N].o;
        for (w = Array(w), N = Y = 0; N < y; N += 1)
          for (M = 0; M < _.length; M += 1)
            N < H[M].length && (w[Y] = H[M][N], Y += 1);
        for (N = 0; N < E; N += 1)
          for (M = 0; M < _.length; M += 1)
            N < j[M].length && (w[Y] = j[M][N], Y += 1);
        v = w;
      }
      for (_ = v, w = -1, y = b - 1, E = 7, H = 0, k = i.F(k), j = b - 1; 0 < j; j -= 2)
        for (j == 6 && --j; ; ) {
          for (M = 0; 2 > M; M += 1)
            m[y][j - M] == null && (N = !1, H < _.length && (N = (_[H] >>> E & 1) == 1), k(y, j - M) && (N = !N), m[y][j - M] = N, --E, E == -1 && (H += 1, E = 7));
          if (y += w, 0 > y || b <= y) {
            y -= w, w = -w;
            break;
          }
    ...
    var p = s[d], m = null, b = 0, v = null, g = [], x = { u: function(_) {
      _ = e(_), g.push(_), v = null;
    }, a: function(_, k) {
      if (0 > _ || b <= _ || 0 > k || b <= k)
        throw Error(_ + "," + k);
      return m[_][k];
  ...
  function o(l, d) {
    ...
    var f = function() {
      for (var p = 0; p < l.length && l[p] == 0; )
        p += 1;
      for (var m = Array(l.length - p + d), b = 0; b < l.length - p; b += 1)
        m[b] = l[b + p];
      return m;
    }(), h = { c: function(p) {
      return f[p];
      ...
      for (var m = Array(h.b() + p.b() - 1), b = 0; b < h.b(); b += 1)
        for (var v = 0; v < p.b(); v += 1)
          m[b + v] ^= n.i(n.g(h.c(b)) + n.g(p.c(v)));
      return o(m, 0);
    }, l: function(p) {
      if (0 > h.b() - p.b())
        return h;
      for (var m = n.g(h.c(0)) - n.g(p.c(0)), b = Array(h.b()), v = 0; v < h.b(); v += 1)
        b[v] = h.c(v);
      for (v = 0; v < p.b(); v += 1)
        b[v] ^= n.i(n.g(p.c(v)) + m);
      return o(b, 0).l(p);
  ...
  var s = { L: 1, M: 0, Q: 3, H: 2 }, i = function() {
    ...
    var d = [
      ...
      for (var p = h.h(), m = 0, b = 0; b < p; b += 1)
        for (var v = 0; v < p; v += 1) {
          for (var g = 0, x = h.a(b, v), _ = -1; 1 >= _; _ += 1)
            if (!(0 > b + _ || p <= b + _))
              for (var k = -1; 1 >= k; k += 1)
                0 > v + k || p <= v + k || (_ != 0 || k != 0) && x == h.a(b + _, v + k) && (g += 1);
          5 < g && (m += 3 + g - 5);
        }
      for (b = 0; b < p - 1; b += 1)
        for (v = 0; v < p - 1; v += 1)
          g = 0, h.a(b, v) && (g += 1), h.a(b + 1, v) && (g += 1), h.a(b, v + 1) && (g += 1), h.a(b + 1, v + 1) && (g += 1), (g == 0 || g == 4) && (m += 3);
      for (b = 0; b < p; b += 1)
        for (v = 0; v < p - 6; v += 1)
          h.a(b, v) && !h.a(b, v + 1) && h.a(b, v + 2) && h.a(b, v + 3) && h.a(b, v + 4) && !h.a(b, v + 5) && h.a(b, v + 6) && (m += 40);
      for (v = 0; v < p; v += 1)
        for (b = 0; b < p - 6; b += 1)
          h.a(b, v) && !h.a(b + 1, v) && h.a(b + 2, v) && h.a(b + 3, v) && h.a(b + 4, v) && !h.a(b + 5, v) && h.a(b + 6, v) && (m += 40);
      for (v = g = 0; v < p; v += 1)
        for (b = 0; b < p; b += 1)
          h.a(b, v) && (g += 1);
      return m += Math.abs(100 * g / p / p - 50) / 5 * 10;
    } };
    return f;
  }(), n = function() {
    ...
    var d = [
      ...
      h = m.length / 3, p = [];
      for (var b = 0; b < h; b += 1)
        for (var v = m[3 * b], g = m[3 * b + 1], x = m[3 * b + 2], _ = 0; _ < v; _ += 1) {
          var k = x, w = {};
          w.o = g, w.j = k, p.push(w);
        }
      return p;
    } };
    return f;
...
a([
  u({ type: Number })
], bt.prototype, "radius", 2);
a([
  u({ attribute: "error-correction" })
], bt.prototype, "errorCorrection", 2);
a([
  z(["background", "errorCorrection", "fill", "radius", "size", "value"])
], bt.prototype, "generate", 1);
var Zp = "sl-qr-code";
bt.define("sl-qr-code");
D({
  tagName: Zp,
  elementClass: bt,
  react: I,
...
a([
  z("checked")
], Ct.prototype, "handleCheckedChange", 1);
a([
  z("disabled", { waitUntilFirstUpdate: !0 })
...
var of = "sl-radio-button";
vt.define("sl-radio-button");
D({
  tagName: of,
  elementClass: vt,
  react: I,
...
var je = class extends R {
  constructor() {
    super(...arguments), this.formControlController = new Bt(this), this.hasSlotController = new Je(this, "help-text", "label"), this.customValidityMessage = "", this.hasButtonGroup = !1, this.errorMessage = "", this.defaultValue = "", this.label = "", this.helpText = "", this.name = "option", this.value = "", this.size = "medium", this.form = "", this.required = !1;
  }
  /** Gets the validity state object */
  get validity() {
    const e = this.required && !this.value;
    return this.customValidityMessage !== "" ? Ju : e ? Gu : cs;
  }
  /** Gets the validation message */
  get validationMessage() {
    const e = this.required && !this.value;
...
je.styles = [V, Br, sf];
je.dependencies = { "sl-button-group": Zt };
a([
  A("slot:not([name])")
], je.prototype, "defaultSlot", 2);
a([
  A(".radio-group__validation-input")
], je.prototype, "validationInput", 2);
a([
  U()
], je.prototype, "hasButtonGroup", 2);
a([
  U()
], je.prototype, "errorMessage", 2);
a([
  U()
...
a([
  u({ type: Boolean, reflect: !0 })
], je.prototype, "required", 2);
a([
  z("size", { waitUntilFirstUpdate: !0 })
], je.prototype, "handleSizeChange", 1);
a([
  z("value")
], je.prototype, "handleValueChange", 1);
var af = "sl-radio-group";
je.define("sl-radio-group");
D({
  tagName: af,
  elementClass: je,
  react: I,
...
var lf = "sl-icon-button";
Ve.define("sl-icon-button");
D({
  tagName: lf,
  elementClass: Ve,
  react: I,
...
var pr = class extends R {
  ...
  async handleSrcChange() {
    try {
      const e = this.src, t = await ff(e, this.mode);
      if (e !== this.src)
        return;
      if (!t.ok) {
...
`, er = class extends R {
  constructor() {
    super(...arguments), this.localize = new he(this), this.position = 50;
  }
  handleDrag(e) {
    const { width: t } = this.base.getBoundingClientRect(), r = this.localize.dir() === "rtl";
    e.preventDefault(), lo(this.base, {
      onMove: (o) => {
        this.position = parseFloat(De(o / t * 100, 0, 100).toFixed(2)), r && (this.position = 100 - this.position);
      },
      initialEvent: e
    });
  }
  handleKeyDown(e) {
    ...
    if (["ArrowLeft", "ArrowRight", "Home", "End"].includes(e.key)) {
      ...
      let s = this.position;
      e.preventDefault(), (t && e.key === "ArrowLeft" || r && e.key === "ArrowRight") && (s -= o), (t && e.key === "ArrowRight" || r && e.key === "ArrowLeft") && (s += o), e.key === "Home" && (s = 0), e.key === "End" && (s = 100), s = De(s, 0, 100), this.position = s;
    }
  }
  handlePositionChange() {
    this.emit("sl-change");
...
const co = (e, t) => {
  ...
  if (r === void 0)
    return !1;
  for (const s of r)
    (o = s._$AO) == null || o.call(s, t, !1), co(s, t);
  return !0;
}, Yo = (e) => {
  let t, r;
  do {
...
function _f(e) {
  this._$AN !== void 0 ? (Yo(this), this._$AM = e, ja(this)) : this._$AM = e;
}
function kf(e, t = !1, r = 0) {
...
const Cf = (e) => {
  e.type == At.CHILD && (e._$AP ?? (e._$AP = kf), e._$AQ ?? (e._$AQ = _f));
};
class Sf extends xo {
  constructor() {
  ...
  _$AT(t, r, o) {
    super._$AT(t, r, o), ja(this), this.isConnected = t._$AU;
  }
  _$AO(t, r = !0) {
    var o, s;
    t !== this.isConnected && (this.isConnected = t, t ? (o = this.reconnected) == null || o.call(this) : (s = this.disconnected) == null || s.call(this)), r && (co(this, t), Yo(this));
  }
  setValue(t) {
    if (_a(this._$Ct))
...
const Os = /* @__PURE__ */ new WeakMap(), zf = wo(class extends Sf {
  render(e) {
    return Se;
  }
  update(e, [t]) {
  ...
  rt(e) {
    if (typeof this.Y == "function") {
      ...
      let r = Os.get(t);
      r === void 0 && (r = /* @__PURE__ */ new WeakMap(), Os.set(t, r)), r.get(this.Y) !== void 0 && this.Y.call(this.ht, void 0), r.set(this.Y, e), e !== void 0 && this.Y.call(this.ht, e);
    } else
      this.Y.value = e;
  }
  get lt() {
    var e, t;
    return typeof this.Y == "function" ? (e = Os.get(this.ht ?? globalThis)) == null ? void 0 : e.get(this.Y) : (t = this.Y) == null ? void 0 : t.value;
  }
  disconnected() {
...
var Af = class {
  constructor(e, t, r) {
    this.popupRef = $f(), this.enableSubmenuTimer = -1, this.isConnected = !1, this.isPopupConnected = !1, this.skidding = 0, this.submenuOpenDelay = 100, this.handleMouseMove = (o) => {
  ...
  constructor() {
    super(...arguments), this.type = "normal", this.checked = !1, this.value = "", this.loading = !1, this.disabled = !1, this.localize = new he(this), this.hasSlotController = new Je(this, "submenu"), this.submenuController = new Af(this, this.hasSlotController, this.localize), this.handleHostClick = (e) => {
...
zi.styles = [V, Nf];
var If = "sl-menu-label";
zi.define("sl-menu-label");
var Rf = D({
  tagName: If,
  elementClass: zi,
  react: I,
...
], St.prototype, "handleChange", 1);
var Df = "sl-mutation-observer";
St.define("sl-mutation-observer");
D({
  tagName: Df,
  elementClass: St,
  react: I,
...
`, yt = class extends R {
  constructor() {
    super(...arguments), this.localize = new he(this), this.open = !1, this.disabled = !1;
  }
  firstUpdated() {
  ...
  async handleOpenChange() {
    if (this.open) {
      ...
      await Ne(this.body, Uo(t, this.body.scrollHeight), r), this.body.style.height = "auto", this.emit("sl-after-show");
    } else {
      ...
      await Ne(this.body, Uo(t, this.body.scrollHeight), r), this.body.style.height = "auto", this.details.open = !1, this.emit("sl-after-hide");
    }
  }
  /** Shows the details. */
  async show() {
...
], yt.prototype, "expandIconSlot", 2);
a([
  u({ type: Boolean, reflect: !0 })
], yt.prototype, "open", 2);
a([
  u()
], yt.prototype, "summary", 2);
a([
  u({ type: Boolean, reflect: !0 })
...
function Wa(e) {
  let t = Ln.get(e);
  return t || (t = window.getComputedStyle(e, null), Ln.set(e, t)), t;
}
function Ff(e) {
...
function Hf(e) {
  const t = Wa(e), { overflowY: r, overflowX: o } = t;
...
function Uf(e) {
  ...
  return e.hasAttribute("tabindex") && (isNaN(r) || r <= -1) || e.hasAttribute("disabled") || e.closest("[inert]") || t === "input" && e.getAttribute("type") === "radio" && !e.hasAttribute("checked") || !Ff(e) ? !1 : (t === "audio" || t === "video") && e.hasAttribute("controls") || e.hasAttribute("tabindex") || e.hasAttribute("contenteditable") && e.getAttribute("contenteditable") !== "false" || [
    "button",
    "input",
    "select",
    "textarea",
...
function jf(e) {
  var t, r;
  const o = Zs(e), s = (t = o[0]) != null ? t : null, i = (r = o[o.length - 1]) != null ? r : null;
  ...
  function o(s) {
    if (s instanceof Element) {
      if (s.hasAttribute("inert") || s.closest("[inert]") || t.has(s))
        return;
      t.set(s, !0), !r.includes(s) && Uf(s) && r.push(s), s instanceof HTMLSlotElement && Wf(s, e) && s.assignedElements({ flatten: !0 }).forEach((i) => {
        o(i);
...
function* Ai(e = document.activeElement) {
  e != null && (yield e, "shadowRoot" in e && e.shadowRoot && e.shadowRoot.mode !== "closed" && (yield* Sl(Ai(e.shadowRoot.activeElement))));
}
function qf() {
  return [...Ai()].pop();
}
var eo = [], qa = class {
  ...
  activate() {
    eo.push(this.element), document.addEventListener("focusin", this.handleFocusIn), document.addEventListener("keydown", this.handleKeyDown), document.addEventListener("keyup", this.handleKeyUp);
  }
  /** Deactivates focus trapping. */
  deactivate() {
    eo = eo.filter((e) => e !== this.element), this.currentFocus = null, document.removeEventListener("focusin", this.handleFocusIn), document.removeEventListener("keydown", this.handleKeyDown), document.removeEventListener("keyup", this.handleKeyUp);
  }
  /** Determines if this modal element is currently active or not. */
  isActive() {
    return eo[eo.length - 1] === this.element;
  }
...
var ot = class extends R {
  constructor() {
    super(...arguments), this.hasSlotController = new Je(this, "footer"), this.localize = new he(this), this.modal = new qa(this), this.open = !1, this.label = "", this.placement = "end", this.contained = !1, this.noHeader = !1, this.handleDocumentKeyDown = (e) => {
      this.contained || e.key === "Escape" && this.modal.isActive() && this.open && (e.stopImmediatePropagation(), this.requestClose("keyboard"));
    };
  }
  firstUpdated() {
    this.drawer.hidden = !this.open, this.open && (this.addOpenListeners(), this.contained || (this.modal.activate(), no(this)));
  }
  disconnectedCallback() {
    var e;
    super.disconnectedCallback(), ao(this), (e = this.closeWatcher) == null || e.destroy();
  }
  requestClose(e) {
  ...
  async handleOpenChange() {
    if (this.open) {
      this.emit("sl-show"), this.addOpenListeners(), this.originalTrigger = document.activeElement, this.contained || (this.modal.activate(), no(this));
      const e = this.querySelector("[autofocus]");
      e && e.removeAttribute("autofocus"), await Promise.all([Le(this.drawer), Le(this.overlay)]), this.drawer.hidden = !1, requestAnimationFrame(() => {
      ...
      const t = $e(this, `drawer.show${Bn(this.placement)}`, {
      ...
      this.emit("sl-hide"), this.removeOpenListeners(), this.contained || (this.modal.deactivate(), ao(this)), await Promise.all([Le(this.drawer), Le(this.overlay)]);
      const e = $e(this, `drawer.hide${Bn(this.placement)}`, {
        dir: this.localize.dir()
  ...
  handleNoModalChange() {
    this.open && !this.contained && (this.modal.activate(), no(this)), this.open && this.contained && (this.modal.deactivate(), ao(this));
  }
  /** Shows the drawer. */
  async show() {
    if (!this.open)
...
ot.styles = [V, Vf];
ot.dependencies = { "sl-icon-button": Ve };
a([
  A(".drawer")
...
ye("drawer.overlay.show", {
  keyframes: [{ opacity: 0 }, { opacity: 1 }],
  options: { duration: 250 }
});
ye("drawer.overlay.hide", {
...
`, $t = class extends R {
  constructor() {
    super(...arguments), this.hasSlotController = new Je(this, "footer"), this.localize = new he(this), this.modal = new qa(this), this.open = !1, this.label = "", this.noHeader = !1, this.handleDocumentKeyDown = (e) => {
      e.key === "Escape" && this.modal.isActive() && this.open && (e.stopPropagation(), this.requestClose("keyboard"));
    };
  }
  firstUpdated() {
    this.dialog.hidden = !this.open, this.open && (this.addOpenListeners(), this.modal.activate(), no(this));
  }
  disconnectedCallback() {
    var e;
    super.disconnectedCallback(), this.modal.deactivate(), ao(this), (e = this.closeWatcher) == null || e.destroy();
  }
  requestClose(e) {
    if (this.emit("sl-request-close", {
      cancelable: !0,
  ...
  async handleOpenChange() {
    if (this.open) {
      this.emit("sl-show"), this.addOpenListeners(), this.originalTrigger = document.activeElement, this.modal.activate(), no(this);
      const e = this.querySelector("[autofocus]");
      e && e.removeAttribute("autofocus"), await Promise.all([Le(this.dialog), Le(this.overlay)]), this.dialog.hidden = !1, requestAnimationFrame(() => {
        this.emit("sl-initial-focus", { cancelable: !0 }).defaultPrevented || (e ? e.focus({ preventScroll: !0 }) : this.panel.focus({ preventScroll: !0 })), e && e.setAttribute("autofocus", "");
      });
      ...
      this.emit("sl-hide"), this.removeOpenListeners(), this.modal.deactivate(), await Promise.all([Le(this.dialog), Le(this.overlay)]);
      ...
      ]), this.dialog.hidden = !0, this.overlay.hidden = !1, this.panel.hidden = !1, ao(this);
      const r = this.originalTrigger;
      typeof (r == null ? void 0 : r.focus) == "function" && setTimeout(() => r.focus()), this.emit("sl-after-hide");
    }
  }
...
ye("dialog.overlay.show", {
  keyframes: [{ opacity: 0 }, { opacity: 1 }],
  options: { duration: 250 }
});
ye("dialog.overlay.hide", {
  keyframes: [{ opacity: 1 }, { opacity: 0 }],
  options: { duration: 250 }
});
var Xf = "sl-dialog";
...
`, Ye = class extends R {
  constructor() {
    super(...arguments), this.localize = new he(this), this.open = !1, this.placement = "bottom-start", this.disabled = !1, this.stayOpenOnSelect = !1, this.distance = 0, this.skidding = 0, this.hoist = !1, this.handleKeyDown = (e) => {
  ...
  updateAccessibleTrigger() {
    const t = this.trigger.assignedElements({ flatten: !0 }).find((o) => jf(o).start);
    let r;
    if (t) {
  ...
  async handleOpenChange() {
    ...
    if (this.updateAccessibleTrigger(), this.open) {
      this.emit("sl-show"), this.addOpenListeners(), await Le(this), this.panel.hidden = !1, this.popup.active = !0;
...
Ye.styles = [V, Gf];
Ye.dependencies = { "sl-popup": pe };
a([
  A(".dropdown")
], Ye.prototype, "popup", 2);
a([
  A(".dropdown__trigger")
...
a([
  z("open", { waitUntilFirstUpdate: !0 })
], Ye.prototype, "handleOpenChange", 1);
ye("dropdown.show", {
  keyframes: [
    { opacity: 0, scale: 0.9 },
    { opacity: 1, scale: 1 }
...
}), Zf = Qf, So = class extends R {
  constructor() {
    super(...arguments), this.localize = new he(this), this.value = 0, this.unit = "byte", this.display = "short";
  }
  render() {
    if (isNaN(this.value))
      return "";
...
a([
  u()
], So.prototype, "display", 2);
var e0 = "sl-format-bytes";
So.define("sl-format-bytes");
D({
  tagName: e0,
  elementClass: So,
  react: I,
...
var st = class extends R {
  constructor() {
    super(...arguments), this.localize = new he(this), this.date = /* @__PURE__ */ new Date(), this.hourFormat = "auto";
  }
  render() {
...
a([
  u()
], st.prototype, "minute", 2);
a([
  u()
], st.prototype, "second", 2);
a([
  u({ attribute: "time-zone-name" })
], st.prototype, "timeZoneName", 2);
a([
  u({ attribute: "time-zone" })
], st.prototype, "timeZone", 2);
a([
  u({ attribute: "hour-format" })
], st.prototype, "hourFormat", 2);
var t0 = "sl-format-date";
st.define("sl-format-date");
D({
  tagName: t0,
  elementClass: st,
  react: I,
...
var o0 = D({
  ...
  displayName: "SlIcon"
}), ei = o0, wt = class extends R {
  constructor() {
    super(...arguments), this.localize = new he(this), this.value = 0, this.type = "decimal", this.noGrouping = !1, this.currency = "USD", this.currencyDisplay = "symbol";
  }
  render() {
...
var i0 = "sl-button-group";
Zt.define("sl-button-group");
D({
  tagName: i0,
  elementClass: Zt,
  react: I,
...
if (!p0) {
  ...
  document.addEventListener("touchstart", r, !0), document.addEventListener("touchend", o, !0), document.addEventListener("touchcancel", o, !0), Vn(EventTarget.prototype, "addEventListener", function(s, i) {
    if (i !== "scrollend")
      return;
    const n = h0(() => {
  ...
  }), Vn(EventTarget.prototype, "removeEventListener", function(s, i) {
    if (i !== "scrollend")
      return;
    const n = t.get(this);
...
var ze = class extends R {
  constructor() {
    super(...arguments), this.loop = !1, this.navigation = !1, this.pagination = !1, this.autoplay = !1, this.autoplayInterval = 3e3, this.slidesPerPage = 1, this.slidesPerMove = 1, this.orientation = "horizontal", this.mouseDragging = !1, this.activeSlide = 0, this.scrolling = !1, this.dragging = !1, this.autoplayController = new l0(this, () => this.next()), this.intersectionObserverEntries = /* @__PURE__ */ new Map(), this.localize = new he(this), this.handleMouseDrag = (e) => {
  ...
  goToSlide(e, t = "smooth") {
    ...
    if (!s.length)
      return;
    const n = o ? (e + s.length) % s.length : De(e, 0, s.length - 1);
    this.activeSlide = n;
    const c = De(e + (o ? r : 0), 0, i.length - 1), l = i[c];
    this.scrollToSlide(l, qs() ? "auto" : t);
  }
...
Oi.styles = [V, m0];
var g0 = "sl-carousel-item";
Oi.define("sl-carousel-item");
D({
  tagName: g0,
  elementClass: Oi,
  react: I,
...
`, fe = class extends R {
  ...
  render() {
    const e = this.isLink(), t = e ? jo`a` : jo`button`;
    return io`
      <${t}
        part="base"
        class=${F({
...
a([
  A(".button")
], fe.prototype, "button", 2);
a([
  U()
], fe.prototype, "hasFocus", 2);
a([
  U()
], fe.prototype, "invalid", 2);
a([
  u()
...
a([
  u({ type: Boolean, reflect: !0 })
], fe.prototype, "outline", 2);
a([
  u({ type: Boolean, reflect: !0 })
], fe.prototype, "pill", 2);
a([
  u({ type: Boolean, reflect: !0 })
], fe.prototype, "circle", 2);
a([
  u()
], fe.prototype, "type", 2);
a([
...
], fe.prototype, "formAction", 2);
a([
  u({ attribute: "formenctype" })
], fe.prototype, "formEnctype", 2);
a([
  u({ attribute: "formmethod" })
], fe.prototype, "formMethod", 2);
a([
  u({ attribute: "formnovalidate", type: Boolean })
], fe.prototype, "formNoValidate", 2);
a([
  u({ attribute: "formtarget" })
], fe.prototype, "formTarget", 2);
a([
  z("disabled", { waitUntilFirstUpdate: !0 })
], fe.prototype, "handleDisabledChange", 1);
function We(e, t) {
...
function _0(e, t, r) {
  ...
  if (e = We(e, 360), t = We(t, 100), r = We(r, 100), t === 0)
    ...
    o = Ns(c, n, e + 1 / 3), s = Ns(c, n, e), i = Ns(c, n, e - 1 / 3);
  }
...
function E0(e) {
  ...
  return typeof e == "string" && (e = T0(e)), typeof e == "object" && (Rt(e.r) && Rt(e.g) && Rt(e.b) ? (t = x0(e.r, e.g, e.b), n = !0, c = String(e.r).substr(-1) === "%" ? "prgb" : "rgb") : Rt(e.h) && Rt(e.s) && Rt(e.v) ? (o = Po(e.s), s = Po(e.v), t = k0(e.h, o, s), n = !0, c = "hsv") : Rt(e.h) && Rt(e.s) && Rt(e.l) && (o = Po(e.s), i = Po(e.l), t = _0(e.h, o, i), n = !0, c = "hsl"), Object.prototype.hasOwnProperty.call(e, "a") && (r = e.a)), r = Ka(r), {
    ok: n,
    format: e.format || c,
...
const z0 = "[-\\+]?\\d+%?", A0 = "[-\\+]?\\d*\\.\\d+%?", Wt = "(?:" + A0 + ")|(?:" + z0 + ")", Is = "[\\s|\\(]+(" + Wt + ")[,|\\s]+(" + Wt + ")[,|\\s]+(" + Wt + ")\\s*\\)?", Rs = (
  // eslint-disable-next-line prettier/prettier
  "[\\s|\\(]+(" + Wt + ")[,|\\s]+(" + Wt + ")[,|\\s]+(" + Wt + ")[,|\\s]+(" + Wt + ")\\s*\\)?"
), _t = {
  CSS_UNIT: new RegExp(Wt),
...
function T0(e) {
  ...
  let r = _t.rgb.exec(e);
  return r ? { r: r[1], g: r[2], b: r[3] } : (r = _t.rgba.exec(e), r ? { r: r[1], g: r[2], b: r[3], a: r[4] } : (r = _t.hsl.exec(e), r ? { h: r[1], s: r[2], l: r[3] } : (r = _t.hsla.exec(e), r ? { h: r[1], s: r[2], l: r[3], a: r[4] } : (r = _t.hsv.exec(e), r ? { h: r[1], s: r[2], v: r[3] } : (r = _t.hsva.exec(e), r ? { h: r[1], s: r[2], v: r[3], a: r[4] } : (r = _t.hex8.exec(e), r ? {
    r: nt(r[1]),
    g: nt(r[2]),
    b: nt(r[3]),
    a: jn(r[4]),
...
function Rt(e) {
  return !!_t.CSS_UNIT.exec(String(e));
}
class Oe {
  constructor(t = "", r = {}) {
    if (t instanceof Oe)
      return t;
    typeof t == "number" && (t = $0(t)), this.originalInput = t;
    const o = E0(t);
   ...
   */
  setAlpha(t) {
    return this.a = Ka(t), this.roundA = Math.round(100 * this.a) / 100, this;
  }
  /**
   ...
   */
  toHsv() {
    const t = Hn(this.r, this.g, this.b);
   ...
   */
  toHsvString() {
    const t = Hn(this.r, this.g, this.b), r = Math.round(t.h * 360), o = Math.round(t.s * 100), s = Math.round(t.v * 100);
   ...
   */
  toHsl() {
    const t = Fn(this.r, this.g, this.b);
   ...
   */
  toHslString() {
    const t = Fn(this.r, this.g, this.b), r = Math.round(t.h * 360), o = Math.round(t.s * 100), s = Math.round(t.l * 100);
   ...
   */
  toHex(t = !1) {
    return Un(this.r, this.g, this.b, t);
  }
  /**
   ...
   */
  toPercentageRgb() {
    const t = (r) => `${Math.round(We(r, 255) * 100)}%`;
    return {
      r: t(this.r),
      g: t(this.g),
      b: t(this.b),
  ...
  toName() {
    ...
    if (this.a < 1)
      return !1;
    const t = "#" + Un(this.r, this.g, this.b, !1);
    for (const [r, o] of Object.entries(ti))
      if (t === o)
        return r;
    return !1;
  }
  ...
  lighten(t = 10) {
    const r = this.toHsl();
    return r.l += t / 100, r.l = Ro(r.l), new Oe(r);
  }
  /**
  ...
  desaturate(t = 10) {
    const r = this.toHsl();
    return r.s -= t / 100, r.s = Ro(r.s), new Oe(r);
  }
  /**
...
var Wn = "EyeDropper" in window, se = class extends R {
  constructor() {
    super(), this.formControlController = new Bt(this), this.isSafeValue = !1, this.localize = new he(this), this.hasFocus = !1, this.isDraggingGridHandle = !1, this.isEmpty = !1, this.inputValue = "", this.hue = 0, this.saturation = 100, this.brightness = 100, this.alpha = 100, this.value = "", this.defaultValue = "", this.label = "", this.format = "hex", this.inline = !1, this.size = "medium", this.noFormatToggle = !1, this.name = "", this.disabled = !1, this.hoist = !1, this.opacity = !1, this.uppercase = !1, this.swatches = "", this.form = "", this.required = !1, this.handleFocusIn = () => {
      this.hasFocus = !0, this.emit("sl-focus");
    }, this.handleFocusOut = () => {
      this.hasFocus = !1, this.emit("sl-blur");
  ...
  handleAlphaDrag(e) {
    ...
    r.focus(), e.preventDefault(), lo(t, {
      onMove: (n) => {
        this.alpha = De(n / o * 100, 0, 100), this.syncValues(), this.value !== i && (i = this.value, this.emit("sl-input"));
      },
      onStop: () => {
  ...
  handleHueDrag(e) {
    ...
    r.focus(), e.preventDefault(), lo(t, {
      onMove: (n) => {
        this.hue = De(n / o * 360, 0, 360), this.syncValues(), this.value !== i && (i = this.value, this.emit("sl-input"));
      },
      onStop: () => {
        this.value !== s && (s = this.value, this.emit("sl-change"));
      },
  ...
  handleGridDrag(e) {
    ...
    r.focus(), e.preventDefault(), this.isDraggingGridHandle = !0, lo(t, {
      onMove: (c, l) => {
        this.saturation = De(c / o * 100, 0, 100), this.brightness = De(100 - l / s * 100, 0, 100), this.syncValues(), this.value !== n && (n = this.value, this.emit("sl-input"));
      },
      onStop: () => {
  ...
  handleAlphaKeyDown(e) {
    ...
    e.key === "ArrowLeft" && (e.preventDefault(), this.alpha = De(this.alpha - t, 0, 100), this.syncValues()), e.key === "ArrowRight" && (e.preventDefault(), this.alpha = De(this.alpha + t, 0, 100), this.syncValues()), e.key === "Home" && (e.preventDefault(), this.alpha = 0, this.syncValues()), e.key === "End" && (e.preventDefault(), this.alpha = 100, this.syncValues()), this.value !== r && (this.emit("sl-change"), this.emit("sl-input"));
  }
  handleHueKeyDown(e) {
    const t = e.shiftKey ? 10 : 1, r = this.value;
    e.key === "ArrowLeft" && (e.preventDefault(), this.hue = De(this.hue - t, 0, 360), this.syncValues()), e.key === "ArrowRight" && (e.preventDefault(), this.hue = De(this.hue + t, 0, 360), this.syncValues()), e.key === "Home" && (e.preventDefault(), this.hue = 0, this.syncValues()), e.key === "End" && (e.preventDefault(), this.hue = 360, this.syncValues()), this.value !== r && (this.emit("sl-change"), this.emit("sl-input"));
  }
  handleGridKeyDown(e) {
    const t = e.shiftKey ? 10 : 1, r = this.value;
    e.key === "ArrowLeft" && (e.preventDefault(), this.saturation = De(this.saturation - t, 0, 100), this.syncValues()), e.key === "ArrowRight" && (e.preventDefault(), this.saturation = De(this.saturation + t, 0, 100), this.syncValues()), e.key === "ArrowUp" && (e.preventDefault(), this.brightness = De(this.brightness + t, 0, 100), this.syncValues()), e.key === "ArrowDown" && (e.preventDefault(), this.brightness = De(this.brightness - t, 0, 100), this.syncValues()), this.value !== r && (this.emit("sl-change"), this.emit("sl-input"));
  }
  handleInputChange(e) {
...
`, He = class extends R {
  constructor() {
    super(...arguments), this.localize = new he(this), this.isCopying = !1, this.status = "rest", this.value = "", this.from = "", this.disabled = !1, this.copyLabel = "", this.successLabel = "", this.errorLabel = "", this.feedbackDuration = 1e3, this.tooltipPlacement = "top", this.hoist = !1;
  }
  async handleCopy() {
...
], He.prototype, "copyIcon", 2);
a([
  A('slot[name="success-icon"]')
], He.prototype, "successIcon", 2);
a([
  A('slot[name="error-icon"]')
], He.prototype, "errorIcon", 2);
a([
  A("sl-tooltip")
], He.prototype, "tooltip", 2);
a([
  U()
], He.prototype, "isCopying", 2);
a([
  U()
...
var I0 = "sl-copy-button";
He.define("sl-copy-button");
D({
  tagName: I0,
  elementClass: He,
  react: I,
...
`, _r = Object.assign(document.createElement("div"), { className: "sl-toast-stack" }), Et = class extends R {
  constructor() {
    super(...arguments), this.hasSlotController = new Je(this, "icon", "suffix"), this.localize = new he(this), this.open = !1, this.closable = !1, this.variant = "primary", this.duration = 1 / 0;
  }
  firstUpdated() {
  ...
  async handleOpenChange() {
    if (this.open) {
      this.emit("sl-show"), this.duration < 1 / 0 && this.restartAutoHide(), await Le(this.base), this.base.hidden = !1;
      const { keyframes: e, options: t } = $e(this, "alert.show", { dir: this.localize.dir() });
      await Ne(this.base, e, t), this.emit("sl-after-show");
    } else {
      this.emit("sl-hide"), clearTimeout(this.autoHideTimeout), await Le(this.base);
  ...
  async toast() {
    return new Promise((e) => {
      _r.parentElement === null && document.body.append(_r), _r.appendChild(this), requestAnimationFrame(() => {
        this.clientWidth, this.show();
      }), this.addEventListener(
        "sl-after-hide",
        () => {
          _r.removeChild(this), e(), _r.querySelector("sl-alert") === null && _r.remove();
        },
        { once: !0 }
      );
    });
...
a([
  z("duration")
], Et.prototype, "handleDurationChange", 1);
ye("alert.show", {
  keyframes: [
    { opacity: 0, scale: 0.8 },
    { opacity: 1, scale: 1 }
...
xt.styles = [V, V0];
xt.dependencies = { "sl-icon": xe };
a([
  A(".animated-image__animated")
], xt.prototype, "animatedImage", 2);
a([
  U()
], xt.prototype, "frozenFrame", 2);
a([
  U()
], xt.prototype, "isLoaded", 2);
a([
  u()
], xt.prototype, "src", 2);
a([
...
], xt.prototype, "handlePlayChange", 1);
a([
  z("src")
], xt.prototype, "handleSrcChange", 1);
var F0 = "sl-animated-image";
...
const H0 = [
  ...
  fadeInUpBig: Om,
  fadeOut: Nm,
  fadeOutBottomLeft: Im,
  fadeOutBottomRight: Rm,
  fadeOutDown: Pm,
  fadeOutDownBig: Mm,
  fadeOutLeft: Dm,
  fadeOutLeftBig: Lm,
  ...
  jello: q0,
  lightSpeedInLeft: Gm,
  lightSpeedInRight: Jm,
  lightSpeedOutLeft: Qm,
  lightSpeedOutRight: Zm,
  pulse: K0,
  rollIn: wg,
  rollOut: xg,
  rotateIn: eg,
  rotateInDownLeft: tg,
  rotateInDownRight: rg,
  rotateInUpLeft: og,
  rotateInUpRight: sg,
  rotateOut: ig,
  rotateOutDownLeft: ng,
  rotateOutDownRight: ag,
  rotateOutUpLeft: lg,
  rotateOutUpRight: cg,
  rubberBand: Y0,
  shake: X0,
...
`, Ue = class extends R {
  ...
  async createAnimation() {
    var e, t;
    const r = (e = Ya[this.easing]) != null ? e : this.easing, o = (t = this.keyframes) != null ? t : Ng[this.name], i = (await this.defaultSlot).assignedElements()[0];
...
a([
  u()
], Ue.prototype, "direction", 2);
a([
  u({ type: Number })
], Ue.prototype, "duration", 2);
a([
  u()
], Ue.prototype, "easing", 2);
a([
  u({ attribute: "end-delay", type: Number })
], Ue.prototype, "endDelay", 2);
a([
  u()
], Ue.prototype, "fill", 2);
a([
  u({ type: Number })
], Ue.prototype, "iterations", 2);
a([
  u({ attribute: "iteration-start", type: Number })
], Ue.prototype, "iterationStart", 2);
a([
  u({ attribute: !1 })
], Ue.prototype, "keyframes", 2);
a([
  u({ attribute: "playback-rate", type: Number })
], Ue.prototype, "playbackRate", 2);
a([
  z([
    "name",
    "delay",
...
], Ue.prototype, "handleAnimationChange", 1);
a([
  z("play")
], Ue.prototype, "handlePlayChange", 1);
a([
  z("playbackRate")
], Ue.prototype, "handlePlaybackRateChange", 1);
var Rg = "sl-animation";
Ue.define("sl-animation");
D({
  tagName: Rg,
  elementClass: Ue,
  react: I,
...
`, fr = class extends R {
  constructor() {
    super(...arguments), this.localize = new he(this), this.separatorDir = this.localize.dir(), this.label = "";
  }
...
var Ug = "sl-breadcrumb-item";
jr.define("sl-breadcrumb-item");
D({
  tagName: Ug,
  elementClass: jr,
  react: I,
...
a([
  u({ reflect: !0 })
], Wr.prototype, "variant", 2);
a([
  u({ type: Boolean, reflect: !0 })
], Wr.prototype, "pill", 2);
a([
  u({ type: Boolean, reflect: !0 })
], Wr.prototype, "pulse", 2);
var Wg = "sl-badge";
Wr.define("sl-badge");
D({
  tagName: Wg,
  ...
  return /* @__PURE__ */ Pe("div", { children: [
    /* @__PURE__ */ Pe(
      $r,
      {
        ...
        onClick: () => t(e),
        children: [
          ce.bookIdToEnglishName(e),
          r ? /* @__PURE__ */ Pe(Go, { children: [
            /* @__PURE__ */ $("div", { className: `selected-book-color-label ${o.toLowerCase()}`, slot: "prefix" }),
            /* @__PURE__ */ $(ei, { name: "chevron-up", slot: "suffix" })
          ] }) : /* @__PURE__ */ $("div", { className: `book-color-label ${o.toLowerCase()}`, slot: "prefix" })
        ]
      },
      e
    ),
...
function Kg({
  ...
  return /* @__PURE__ */ Pe(
    hf,
    {
      ...
      onClick: t,
      children: [
        /* @__PURE__ */ $(ei, { name: "search", slot: "prefix" }),
        /* @__PURE__ */ $(ei, { name: "clock-history", slot: "suffix" })
      ]
    }
  );
}
function Yg({ endChapter: e, activeChapter: t, handleSelectChapter: r }) {
  const o = Array.from({ length: e }, (s, i) => i + 1);
  return /* @__PURE__ */ $("div", { className: "chapter-select", children: o.map((s) => (
    // When adding onClick to <div> get error: Visible, non-interactive elements with click handlers must have at least one keyboard listener.
    // eslint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-static-element-interactions
...
function wb({ scrRef: e, handleSubmit: t }) {
  ...
  return /* @__PURE__ */ Pe(Go, { children: [
    ...
    /* @__PURE__ */ $("div", { className: "book-chapter-menu", children: l && /* @__PURE__ */ Pe(
      Dn,
      {
        tabIndex: -1,
        children: [
          /* @__PURE__ */ Pe($r, { onClick: (g) => g.preventDefault(), style: { fontSize: "14px" }, children: [
            "Zoom",
            /* @__PURE__ */ $("span", { children: "50%" }),
            /* @__PURE__ */ $(Ap, { min: 50, max: 200, onSlChange: () => d(!1) }),
            /* @__PURE__ */ $("span", { children: "200%" })
          ] }),
          /* @__PURE__ */ Pe($r, { onClick: (g) => g.preventDefault(), style: { fontSize: "14px" }, children: [
            "View",
            /* @__PURE__ */ Pe(Zf, { children: [
              /* @__PURE__ */ $(Fg, { slot: "trigger", caret: !0, children: "Publish" }),
              /* @__PURE__ */ Pe(Dn, { onSlSelect: () => d(!1), children: [
                /* @__PURE__ */ $($r, { children: "Publish" }),
                /* @__PURE__ */ $($r, { children: "Draft" }),
                /* @__PURE__ */ $($r, { children: "Reading" })
              ] })
            ] })
          ] }),
          Gg.map((g) => /* @__PURE__ */ Pe("div", { children: [
            /* @__PURE__ */ $(Pf, { children: Xg[g] }),
            f(g).map((x) => /* @__PURE__ */ $("div", { children: /* @__PURE__ */ $(
              qg,
              {
                bookId: x,
...
var Er = /* @__PURE__ */ ((e) => (e.After = "after", e.Before = "before", e.Above = "above", e.Below = "below", e))(Er || {});
function Jg({
  id: e,
  isChecked: t,
  labelText: r = "",
  labelPosition: o = Er.After,
  isIndeterminate: s = !1,
  isDefaultChecked: i,
  isDisabled: n = !1,
  hasError: c = !1,
  ...
  let h;
  if (r) {
    const p = o === Er.Before || o === Er.Above, m = /* @__PURE__ */ $("span", { className: `papi-checkbox-label ${c ? "error" : ""} ${l ?? ""}`, children: r }), b = o === Er.Before || o === Er.After, v = b ? m : /* @__PURE__ */ $("div", { children: m }), g = b ? f : /* @__PURE__ */ $("div", { children: f });
    h = /* @__PURE__ */ Pe(
      tl,
      {
...
function Zg({ commandHandler: e, name: t, className: r, items: o, id: s }) {
  return /* @__PURE__ */ Pe(Xn, { id: s, item: !0, xs: "auto", className: `papi-menu-column ${r ?? ""}`, children: [
    /* @__PURE__ */ $("h3", { className: `papi-menu ${r ?? ""}`, children: t }),
    o.map((i, n) => /* @__PURE__ */ $(
      Qg,
      {
...
function eb({ commandHandler: e, className: t, columns: r, id: o }) {
  return /* @__PURE__ */ $(
    Xn,
    {
      container: !0,
...
let Ps;
const Ms = () => (Ps || (Ps = ce.allBookIds.map((e) => ({
  bookId: e,
  label: ce.bookIdToEnglishName(e)
}))), Ps);
function kb({ scrRef: e, handleSubmit: t, id: r }) {
  const o = (l) => {
    t(l);
  }, s = (l, d) => {
    const h = { bookNum: ce.bookIdToNumber(d.bookId), chapterNum: 1, verseNum: 1 };
    o(h);
  }, i = (l) => {
    t({ ...e, chapterNum: +l.target.value });
  }, n = (l) => {
    t({ ...e, verseNum: +l.target.value });
  }, c = si(() => Ms()[e.bookNum - 1], [e.bookNum]);
  return /* @__PURE__ */ Pe("span", { id: r, children: [
    /* @__PURE__ */ $(
      ri,
      {
        title: "Book",
    ...
    /* @__PURE__ */ $(
      ...
      {
        onClick: () => o(Pi(e, 1)),
        isDisabled: e.bookNum >= Ms().length,
        children: ">"
      }
    ),
    /* @__PURE__ */ $(
    ...
    /* @__PURE__ */ $(
      ...
      {
        onClick: () => t(Mi(e, 1)),
        isDisabled: e.chapterNum >= ii(e.bookNum),
        children: ">"
      }
    ),
    /* @__PURE__ */ $(
    ...
    /* @__PURE__ */ $(kr, { onClick: () => t(Di(e, 1)), children: ">" })
  ] });
}
function Cb({ onSearch: e, placeholder: t, isFullWidth: r }) {
  const [o, s] = ft(""), i = (n) => {
    s(n), e(n);
  };
  return /* @__PURE__ */ $(ol, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ $(
    Xo,
    {
      isFullWidth: r,
...
function qn({ onRowChange: e, row: t, column: r }) {
  const o = (s) => {
    e({ ...t, [r.key]: s.target.value });
  };
  return /* @__PURE__ */ $(Xo, { defaultValue: t[r.key], onChange: o });
}
const tb = ({ onChange: e, disabled: t, checked: r, ...o }) => /* @__PURE__ */ $(
  Jg,
  {
    ...o,
    isChecked: r,
...
function zb({
  ...
  const _e = si(() => {
    const te = e.map((re) => typeof re.editable == "function" ? {
      ...re,
      editable: (Re) => !!re.editable(Re),
      renderEditCell: re.renderEditCell || qn
    } : re.editable && !re.renderEditCell ? { ...re, renderEditCell: qn } : re.renderEditCell && !re.editable ? { ...re, editable: !1 } : re);
    return f ? [{ ...bl, minWidth: h }, ...te] : te;
  }, [e, f, h]);
  return /* @__PURE__ */ $(
    gl,
    {
...
function Ab({
  ...
  }, []), p = Ls(void 0), [m, b] = ft(0);
  Jo(() => {
    n && p.current && b(p.current.clientHeight);
  }, [n]);
  const v = Tt(
    (x) => (f(), r(x)),
    [r, f]
  ...
  let g = e;
  return !g && t && (g = t(l)), /* @__PURE__ */ $("div", { ref: p, style: { position: "relative" }, children: /* @__PURE__ */ $(al, { position: "static", id: s, children: /* @__PURE__ */ Pe(ll, { className: `papi-toolbar ${o ?? ""}`, variant: "dense", children: [
    g ? /* @__PURE__ */ $(
      Gn,
      {
        edge: "start",
        ...
        onClick: h,
        children: /* @__PURE__ */ $(mu, {})
      }
    ) : void 0,
    i ? /* @__PURE__ */ $("div", { className: "papi-menu-children", children: i }) : void 0,
    g ? /* @__PURE__ */ $(
      cl,
      {
        ...
        children: /* @__PURE__ */ $(eb, { commandHandler: v, columns: g.columns })
      }
    ) : void 0
  ] }) }) });
}
...
const ob = (e, t, r = {}) => {
  ...
  o.current = t;
  const s = Ls(r);
  s.current = rb(s.current);
  const [i, n] = ft(() => o.current), [c, l] = ft(!0);
  return Jo(() => {
    let d = !0;
    return l(!!e), (async () => {
      if (e) {
...
Vs("https://cdn.jsdelivr.net/npm/@shoelace-style/shoelace@2.14.0/cdn/");
function sb(e, t = "top") {
