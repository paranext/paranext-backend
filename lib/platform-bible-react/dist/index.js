import { jsxs as je, jsx as E, Fragment as Xo } from "react/jsx-runtime";
import { MenuItem as qn, ListItemIcon as Ni, ListItemText as Ya, TextField as ri, Menu as Xa, ListSubheader as Ga, Divider as Ja, Slider as Qa, Button as Za, Autocomplete as el, FormControlLabel as Ii, FormLabel as tl, Checkbox as rl, Grid as Kn, IconButton as Yn, Paper as ol, Snackbar as sl, Switch as il, AppBar as nl, Toolbar as al, Drawer as ll } from "@mui/material";
import * as I from "react";
import { useCallback as Tt, useState as ft, useMemo as oi, useRef as Ls, useEffect as Go } from "react";
import { getChaptersForBook as si, offsetBook as Ri, FIRST_SCR_BOOK_NUM as cl, offsetChapter as Pi, FIRST_SCR_CHAPTER_NUM as dl, offsetVerse as Mi, FIRST_SCR_VERSE_NUM as ul } from "platform-bible-utils";
import hl, { ThemeContext as pl, internal_processStyles as fl } from "@mui/styled-engine";
import ml, { SelectColumn as gl } from "react-data-grid";
var Ds = "";
function Bs(e) {
  Ds = e;
}
function bl(e = "") {
  ...
  return Ds.replace(/\/$/, "") + (e ? `/${e.replace(/^\//, "")}` : "");
}
var Xn = Object.defineProperty, vl = Object.defineProperties, yl = Object.getOwnPropertyDescriptor, wl = Object.getOwnPropertyDescriptors, Li = Object.getOwnPropertySymbols, xl = Object.prototype.hasOwnProperty, _l = Object.prototype.propertyIsEnumerable, ps = (e, t) => (t = Symbol[e]) ? t : Symbol.for("Symbol." + e), Di = (e, t, r) => t in e ? Xn(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, Dt = (e, t) => {
  for (var r in t || (t = {}))
    xl.call(t, r) && Di(e, r, t[r]);
  if (Li)
    for (var r of Li(t))
      _l.call(t, r) && Di(e, r, t[r]);
  return e;
}, mo = (e, t) => vl(e, wl(t)), a = (e, t, r, o) => {
  for (var s = o > 1 ? void 0 : o ? yl(t, r) : t, i = e.length - 1, n; i >= 0; i--)
    (n = e[i]) && (s = (o ? n(t, r, s) : n(s)) || s);
  return o && s && Xn(t, r, s), s;
}, kl = function(e, t) {
  this[0] = e, this[1] = t;
}, Cl = (e) => {
  var t = e[ps("asyncIterator")], r = !1, o, s = {};
  return t == null ? (t = e[ps("iterator")](), o = (i) => s[i] = (n) => t[i](n)) : (t = t.call(e), o = (i) => s[i] = (n) => {
    if (r) {
      if (r = !1, i === "throw")
        throw n;
      return n;
  ...
  }), s[ps("iterator")] = () => s, o("next"), "throw" in t ? o("throw") : s.throw = (i) => {
    throw i;
  }, "return" in t && o("return"), s;
}, Sl = Object.defineProperty, $l = (e, t, r) => t in e ? Sl(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, ee = (e, t, r) => ($l(e, typeof t != "symbol" ? t + "" : t, r), r);
const nr = [
  "GEN",
  "EXO",
  "LEV",
...
function Mr(e, t = !0) {
  return t && (e = e.toUpperCase()), e in Bi ? Bi[e] : 0;
}
function ni(e) {
  return Mr(e) > 0;
}
...
function Zn(e) {
  return e <= 0 || e > Qn ? "******" : Gn[e - 1];
}
function Il(e) {
  return Zn(Mr(e));
}
function ea(e) {
  const t = typeof e == "number" ? ai(e) : e;
  return ni(t) && !ii.includes(t);
}
function Rl(e) {
  const t = typeof e == "number" ? ai(e) : e;
  return ni(t) && ii.includes(t);
...
function Pl(e) {
  return Gn[e - 1].includes("*obsolete*");
}
function Ml() {
  const e = {};
...
const Qe = class le {
  ...
  allVerses(t = !1, r = le.verseRangeSeparators, o = le.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const s = [], i = Vi(this._verse, o);
    for (const n of i.map((c) => Vi(c, r))) {
      const c = this.clone();
      c.verse = n[0];
      const l = c.verseNum;
...
function Pt(e, t, r = {
  ...
  return rr(e) && rr(t) && Object.keys(t).forEach((s) => {
    s !== "__proto__" && (rr(t[s]) && s in e && rr(e[s]) ? o[s] = Pt(e[s], t[s], r) : r.clone ? o[s] = rr(t[s]) ? ra(t[s]) : t[s] : o[s] = t[s]);
  }), o;
}
function Ll(e) {
  return e && e.__esModule && Object.prototype.hasOwnProperty.call(e, "default") ? e.default : e;
}
var Vs = { exports: {} }, Eo = { exports: {} }, me = {};
...
function Dl() {
  ...
  return me.AsyncMode = l, me.ConcurrentMode = d, me.ContextConsumer = c, me.ContextProvider = n, me.Element = t, me.ForwardRef = f, me.Fragment = o, me.Lazy = g, me.Memo = m, me.Portal = r, me.Profiler = i, me.StrictMode = s, me.Suspense = h, me.isAsyncMode = function(y) {
    return w(y) || k(y) === l;
    ...
    return typeof y == "string" || typeof y == "function" || y === o || y === d || y === i || y === s || y === h || y === p || typeof y == "object" && y !== null && (y.$$typeof === g || y.$$typeof === m || y.$$typeof === n || y.$$typeof === c || y.$$typeof === f || y.$$typeof === b || y.$$typeof === x || y.$$typeof === _ || y.$$typeof === v);
  }, me.typeOf = k, me;
}
var ge = {};
/** @license React v16.13.1
...
function Bl() {
  return Hi || (Hi = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function k(T) {
      ...
      T === o || T === d || T === i || T === s || T === h || T === p || typeof T == "object" && T !== null && (T.$$typeof === g || T.$$typeof === m || T.$$typeof === n || T.$$typeof === c || T.$$typeof === f || T.$$typeof === b || T.$$typeof === x || T.$$typeof === _ || T.$$typeof === v);
    }
    function w(T) {
    ...
    var y = l, $ = d, H = c, j = n, M = t, N = f, Y = o, K = g, _e = m, te = r, re = i, ke = s, Re = h, It = !1;
    function mr(T) {
    ...
    ge.AsyncMode = y, ge.ConcurrentMode = $, ge.ContextConsumer = H, ge.ContextProvider = j, ge.Element = M, ge.ForwardRef = N, ge.Fragment = Y, ge.Lazy = K, ge.Memo = _e, ge.Portal = te, ge.Profiler = re, ge.StrictMode = ke, ge.Suspense = Re, ge.isAsyncMode = mr, ge.isConcurrentMode = S, ge.isContextConsumer = O, ge.isContextProvider = Q, ge.isElement = G, ge.isForwardRef = W, ge.isFragment = ie, ge.isLazy = X, ge.isMemo = J, ge.isPortal = ne, ge.isProfiler = ue, ge.isStrictMode = ae, ge.isSuspense = Xe, ge.isValidElementType = k, ge.typeOf = w;
  }()), ge;
}
var Ui;
function oa() {
  return Ui || (Ui = 1, process.env.NODE_ENV === "production" ? Eo.exports = Dl() : Eo.exports = Bl()), Eo.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Vl() {
  ...
  return fs = s() ? Object.assign : function(i, n) {
...
var gs, qi;
function sa() {
  return qi || (qi = 1, gs = Function.call.bind(Object.prototype.hasOwnProperty)), gs;
}
var bs, Ki;
function Fl() {
  if (Ki)
...
function Hl() {
  if (Yi)
    return vs;
  Yi = 1;
  var e = oa(), t = Vl(), r = li(), o = sa(), s = Fl(), i = function() {
  };
...
if (process.env.NODE_ENV !== "production") {
  var jl = oa(), Wl = !0;
  Vs.exports = Hl()(jl.isElement, Wl);
} else
  Vs.exports = Ul()();
var ql = Vs.exports;
const we = /* @__PURE__ */ Ll(ql);
function Or(e) {
...
function Kl() {
  ...
  return be.ContextConsumer = n, be.ContextProvider = i, be.Element = e, be.ForwardRef = l, be.Fragment = r, be.Lazy = p, be.Memo = h, be.Portal = t, be.Profiler = s, be.StrictMode = o, be.Suspense = d, be.SuspenseList = f, be.isAsyncMode = function() {
    ...
    return typeof b == "string" || typeof b == "function" || b === r || b === s || b === o || b === d || b === f || b === m || typeof b == "object" && b !== null && (b.$$typeof === p || b.$$typeof === h || b.$$typeof === i || b.$$typeof === n || b.$$typeof === l || b.$$typeof === g || b.getModuleId !== void 0);
  }, be.typeOf = v, be;
}
var ve = {};
/**
...
function Yl() {
  return Ji || (Ji = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), r = Symbol.for("react.fragment"), o = Symbol.for("react.strict_mode"), s = Symbol.for("react.profiler"), i = Symbol.for("react.provider"), n = Symbol.for("react.context"), c = Symbol.for("react.server_context"), l = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), f = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), p = Symbol.for("react.lazy"), m = Symbol.for("react.offscreen"), g = !1, v = !1, b = !1, x = !1, _ = !1, k;
    k = Symbol.for("react.module.reference");
    function w(B) {
      return !!(typeof B == "string" || typeof B == "function" || B === r || B === s || _ || B === o || B === d || B === f || x || B === m || g || v || b || typeof B == "object" && B !== null && (B.$$typeof === p || B.$$typeof === h || B.$$typeof === i || B.$$typeof === n || B.$$typeof === l || // This needs to include all possible module reference object
    ...
    var $ = n, H = i, j = e, M = l, N = r, Y = p, K = h, _e = t, te = s, re = o, ke = d, Re = f, It = !1, mr = !1;
    function S(B) {
...
function ci(e, t, r = "Mui") {
  const o = rc[t];
  return o ? `${r}-${o}` : `${tc.generate(e)}-${t}`;
}
...
function sc(e, t = Number.MIN_SAFE_INTEGER, r = Number.MAX_SAFE_INTEGER) {
...
function ic() {
  for (var e, t, r = 0, o = "", s = arguments.length; r < s; r++)
    (e = arguments[r]) && (t = aa(e)) && (o && (o += " "), o += t);
  return o;
}
const nc = ["values", "unit", "step"], ac = (e) => {
...
function lc(e) {
  const {
    ...
    unit: r = "px",
    step: o = 5
  } = e, s = Ot(e, nc), i = ac(t), n = Object.keys(i);
  function c(p) {
...
const cc = {
  borderRadius: 4
}, dc = cc, uc = process.env.NODE_ENV !== "production" ? we.oneOfType([we.number, we.string, we.object, we.array]) : {}, Jt = uc;
function eo(e, t) {
  return t ? Pt(e, t, {
    clone: !1
...
function Mt(e, t, r) {
  ...
  if (typeof t == "object") {
    ...
    return Object.keys(t).reduce((n, c) => {
      if (Object.keys(i.values || di).indexOf(c) !== -1) {
        const l = i.up(c);
        n[l] = r(t[c], c);
      } else {
        const l = c;
...
function Vo(e, t, r, o = r) {
  let s;
  return typeof e == "function" ? s = e(r) : Array.isArray(e) ? s = e[r] || o : s = Jo(e, r) || o, t && (s = t(s, o, e)), s;
}
function Pe(e) {
  const {
    prop: t,
    ...
    if (n[t] == null)
      return null;
    const c = n[t], l = n.theme, d = Jo(l, o) || {};
    return Mt(n, c, (h) => {
      let p = Vo(d, s, h);
      return h === p && typeof h == "string" && (p = Vo(d, s, `${t}${h === "default" ? "" : ar(h)}`, h)), r === !1 ? p : {
        [r]: p
      };
    });
  };
...
const mc = {
  ...
  if (e.length > 2)
    if (rn[e])
      ...
      return [e];
  const [t, r] = e.split(""), o = mc[t], s = gc[r] || "";
  return Array.isArray(s) ? s.map((i) => o + i) : [o + s];
}), Qo = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], Zo = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], vc = [...Qo, ...Zo];
function go(e, t, r, o) {
  var s;
  const i = (s = Jo(e, t, !1)) != null ? s : r;
...
function yc(e, t) {
  return (r) => e.reduce((o, s) => (o[s] = bo(t, r), o), {});
}
function wc(e, t, r, o) {
  if (t.indexOf(r) === -1)
    return null;
  const s = bc(r), i = yc(s, o), n = e[r];
  return Mt(e, n, i);
}
function ca(e, t) {
  const r = la(e.theme);
  return Object.keys(e).map((o) => wc(e, t, o, r)).reduce(eo, {});
}
function Ae(e) {
  return ca(e, Qo);
}
Ae.propTypes = process.env.NODE_ENV !== "production" ? Qo.reduce((e, t) => (e[t] = Jt, e), {}) : {};
Ae.filterProps = Qo;
function Te(e) {
  return ca(e, Zo);
}
Te.propTypes = process.env.NODE_ENV !== "production" ? Zo.reduce((e, t) => (e[t] = Jt, e), {}) : {};
Te.filterProps = Zo;
process.env.NODE_ENV !== "production" && vc.reduce((e, t) => (e[t] = Jt, e), {});
function xc(e = 8) {
  if (e.mui)
    return e;
  const t = la({
...
const _c = gt("border", pt), kc = gt("borderTop", pt), Cc = gt("borderRight", pt), Sc = gt("borderBottom", pt), $c = gt("borderLeft", pt), Ec = gt("borderColor"), zc = gt("borderTopColor"), Ac = gt("borderRightColor"), Tc = gt("borderBottomColor"), Oc = gt("borderLeftColor"), Nc = gt("outline", pt), Ic = gt("outlineColor"), ts = (e) => {
  if (e.borderRadius !== void 0 && e.borderRadius !== null) {
    const t = go(e.theme, "shape.borderRadius", 4, "borderRadius"), r = (o) => ({
      borderRadius: bo(t, o)
    });
...
es(_c, kc, Cc, Sc, $c, Ec, zc, Ac, Tc, Oc, ts, Nc, Ic);
const rs = (e) => {
  if (e.gap !== void 0 && e.gap !== null) {
    const t = go(e.theme, "spacing", 8, "gap"), r = (o) => ({
      gap: bo(t, o)
    });
    return Mt(e, e.gap, r);
  }
...
const os = (e) => {
  if (e.columnGap !== void 0 && e.columnGap !== null) {
    const t = go(e.theme, "spacing", 8, "columnGap"), r = (o) => ({
      columnGap: bo(t, o)
    });
...
const ss = (e) => {
  if (e.rowGap !== void 0 && e.rowGap !== null) {
    const t = go(e.theme, "spacing", 8, "rowGap"), r = (o) => ({
      rowGap: bo(t, o)
    });
...
es(rs, os, ss, Rc, Pc, Mc, Lc, Dc, Bc, Vc, Fc, Hc);
function zr(e, t) {
  return t === "grey" ? t : e;
}
const Uc = Pe({
...
const qc = Pe({
  ...
  if (e.maxWidth !== void 0 && e.maxWidth !== null) {
    const t = (r) => {
      var o, s;
      const i = ((o = e.theme) == null || (o = o.breakpoints) == null || (o = o.values) == null ? void 0 : o[r]) || di[r];
...
function td() {
  function e(r, o, s, i) {
    ...
    return h ? h(n) : Mt(n, o, (g) => {
      let v = Vo(p, f, g);
      return g === v && typeof g == "string" && (v = Vo(p, f, `${r}${g === "default" ? "" : ar(g)}`, g)), l === !1 ? v : {
        [l]: v
      };
    });
  }
  function t(r) {
    ...
    if (!s)
      return null;
    const n = (o = i.unstable_sxConfig) != null ? o : hi;
    function c(l) {
      let d = l;
      ...
      if (!d)
        return null;
      const f = hc(i.breakpoints), h = Object.keys(f);
      let p = f;
...
function fi(e = {}, ...t) {
  ...
  return d.applyStyles = rd, d = t.reduce((f, h) => Pt(f, h), d), d.unstable_sxConfig = Z({}, hi, n == null ? void 0 : n.unstable_sxConfig), d.unstable_sx = function(h) {
    return pi({
      sx: h,
      theme: this
    });
...
const ld = ["ownerState"], cd = ["variants"], dd = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function ud(e) {
  return Object.keys(e).length === 0;
}
function hd(e) {
...
const pd = fi(), on = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function zo({
  defaultTheme: e,
  theme: t,
  themeId: r
...
function md(e = {}) {
  const {
    themeId: t,
    defaultTheme: r = pd,
    rootShouldForwardProp: o = Po,
    slotShouldForwardProp: s = Po
  } = e, i = (n) => pi(Z({}, n, {
    theme: zo(Z({}, n, {
      defaultTheme: r,
      themeId: t
  ...
  return i.__mui_systemSx = !0, (n, c = {}) => {
    fl(n, (y) => y.filter(($) => !($ != null && $.__mui_systemSx)));
    const {
      name: l,
      slot: d,
      ...
      overridesResolver: p = fd(on(d))
    } = c, m = Ot(c, dd), g = f !== void 0 ? f : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      d && d !== "Root" && d !== "root" || !1
    ), v = h || !1;
    let b;
    process.env.NODE_ENV !== "production" && l && (b = `${l}-${on(d || "Root")}`);
    let x = Po;
    d === "Root" || d === "root" ? x = o : d ? x = s : hd(n) && (x = void 0);
    const _ = hl(n, Z({
      shouldForwardProp: x,
      label: b
    }, m)), k = (y) => typeof y == "function" && y.__emotion_real !== y || rr(y) ? ($) => Mo(y, Z({}, $, {
      theme: zo({
        theme: $.theme,
        defaultTheme: r,
        themeId: t
      ...
      if (process.env.NODE_ENV !== "production") {
        let Y;
        l && (Y = `${l}${ar(d || "")}`), Y === void 0 && (Y = `Styled(${Jl(n)})`), N.displayName = Y;
      }
...
function gd(e) {
  ...
  return !t || !t.components || !t.components[r] || !t.components[r].defaultProps ? o : na(t.components[r].defaultProps, o);
}
function bd({
  props: e,
  name: t,
...
function ua(e, t = 0, r = 1) {
  return process.env.NODE_ENV !== "production" && (e < t || e > r) && console.error(`MUI: The value provided ${e} is out of range [${t}, ${r}].`), sc(e, t, r);
}
function vd(e) {
  e = e.slice(1);
...
function yd(e) {
  ...
  return e.type === "hsla" && (c += "a", l.push(t[3])), mi({
    type: c,
    values: l
  });
}
function sn(e) {
  e = Nr(e);
  let t = e.type === "hsl" || e.type === "hsla" ? Nr(yd(e)).values : e.values;
...
function wd(e, t) {
  if (e = Nr(e), t = ua(t), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - t;
...
const kd = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, xr = Od, Nd = ["mode", "contrastThreshold", "tonalOffset"], an = {
...
function ln(e, t, r, o) {
  ...
  e[t] || (e.hasOwnProperty(r) ? e[t] = e[r] : t === "light" ? e.light = xd(e.main, s) : t === "dark" && (e.dark = wd(e.main, i)));
}
function Id(e = "light") {
  return e === "dark" ? {
    main: yr[200],
...
function Bd(e) {
  const {
    ...
    tonalOffset: o = 0.2
  } = e, s = Ot(e, Nd), i = e.primary || Id(t), n = e.secondary || Rd(t), c = e.error || Pd(t), l = e.info || Md(t), d = e.success || Ld(t), f = e.warning || Dd(t);
  function h(v) {
    const b = nn(v, ws.text.primary) >= r ? ws.text.primary : an.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const x = nn(v, b);
      x < 3 && console.error([`MUI: The contrast ratio of ${x}:1 for ${b} on ${v}`, "falls below the WCAG recommended absolute minimum contrast ratio of 3:1.", "https://www.w3.org/TR/2008/REC-WCAG20-20081211/#visual-audio-contrast-contrast"].join(`
`));
    }
    return b;
  }
...
} });` : Or(12, b ? ` (${b})` : "", JSON.stringify(v.main)));
    return ln(v, "light", _, o), ln(v, "dark", k, o), v.contrastText || (v.contrastText = h(v.main)), v;
  }, m = {
    dark: ws,
    light: an
  };
...
function Hd(e, t) {
  ...
  const m = s / 14, g = h || ((x) => `${x / d * m}rem`), v = (x, _, k, w, y) => Z({
    fontFamily: o,
    fontWeight: x,
    fontSize: g(_),
    ...
    button: v(c, 14, 1.75, 0.4, cn),
    caption: v(n, 12, 1.66, 0.4),
    overline: v(n, 12, 2.66, 1, cn),
...
const Ud = 0.2, jd = 0.14, Wd = 0.12;
function Ce(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${Ud})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${jd})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${Wd})`].join(",");
}
const qd = ["none", Ce(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), Ce(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), Ce(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), Ce(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), Ce(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), Ce(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), Ce(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), Ce(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), Ce(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), Ce(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), Ce(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), Ce(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), Ce(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), Ce(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), Ce(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), Ce(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), Ce(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), Ce(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), Ce(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), Ce(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), Ce(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), Ce(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), Ce(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), Ce(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], Kd = qd, Yd = ["duration", "easing", "delay"], Xd = {
...
function Qd(e) {
  const t = Z({}, Xd, e.easing), r = Z({}, Gd, e.duration);
  return Z({
...
`)), Object.keys(d).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(d).join(",")}].`);
      ...
      return (Array.isArray(s) ? s : [s]).map((f) => `${f} ${typeof n == "string" ? n : un(n)} ${c} ${typeof l == "string" ? l : un(l)}`).join(",");
    }
  }, e, {
    easing: t,
    duration: r
...
const Zd = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, eu = Zd, tu = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function ru(e = {}, ...t) {
  const {
    mixins: r = {},
    palette: o = {},
  ...
  if (d = Pt(d, n), d = t.reduce((f, h) => Pt(f, h), d), process.env.NODE_ENV !== "production") {
    const f = ["active", "checked", "completed", "disabled", "error", "expanded", "focused", "focusVisible", "required", "selected"], h = (p, m) => {
      ...
      for (g in p) {
        const v = p[g];
        if (f.indexOf(g) !== -1 && Object.keys(v).length > 0) {
          if (process.env.NODE_ENV !== "production") {
            const b = ci("", g);
            console.error([`MUI: The \`${m}\` component increases the CSS specificity of the \`${g}\` internal state.`, "You can not override it like this: ", JSON.stringify(p, null, 2), "", `Instead, you need to use the '&.${b}' syntax:`, JSON.stringify({
              root: {
                [`&.${b}`]: v
              }
...
`));
  ...
  return d.unstable_sxConfig = Z({}, hi, n == null ? void 0 : n.unstable_sxConfig), d.unstable_sx = function(h) {
    return pi({
      sx: h,
      theme: this
    });
...
const iu = (e) => Po(e) && e !== "classes", nu = md({
  themeId: pa,
  defaultTheme: ha,
  rootShouldForwardProp: iu
}), au = nu;
function lu(e) {
...
const cu = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], du = (e) => {
  const {
    color: t,
    fontSize: r,
    classes: o
  ...
  const o = su({
    ...
    titleAccess: h,
    viewBox: p = "0 0 24 24"
  } = o, m = Ot(o, cu), g = /* @__PURE__ */ I.isValidElement(s) && s.type === "svg", v = Z({}, o, {
    color: n,
    component: c,
    fontSize: l,
  ...
  f || (b.viewBox = p);
  const x = du(v);
  return /* @__PURE__ */ je(uu, Z({
    as: c,
    className: ic(x.root, i),
    focusable: "false",
    color: d,
    ...
    ownerState: v,
    children: [g ? s.props.children : s, h ? /* @__PURE__ */ E("title", {
      children: h
    }) : null]
  }));
});
...
function is(e, t) {
  ...
  return process.env.NODE_ENV !== "production" && (r.displayName = `${t}Icon`), r.muiName = hn.muiName, /* @__PURE__ */ I.memo(/* @__PURE__ */ I.forwardRef(r));
}
const hu = is(/* @__PURE__ */ E("path", {
  d: "M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9m-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8z"
}), "History"), pu = is(/* @__PURE__ */ E("path", {
  d: "M7.41 15.41 12 10.83l4.59 4.58L18 14l-6-6-6 6z"
}), "KeyboardArrowUp"), fu = is(/* @__PURE__ */ E("path", {
  d: "M3 18h18v-2H3zm0-5h18v-2H3zm0-7v2h18V6z"
}), "Menu"), mu = is(/* @__PURE__ */ E("path", {
  ...
  return /* @__PURE__ */ je("div", { children: [
    /* @__PURE__ */ je(
      qn,
      {
        ...
        onClick: () => t(e),
        children: [
          r ? /* @__PURE__ */ E(Ni, { children: /* @__PURE__ */ E("div", { className: `selected-book-color-label ${o.toLowerCase()}`, slot: "prefix" }) }) : /* @__PURE__ */ E(Ni, { children: /* @__PURE__ */ E("div", { className: `book-color-label ${o.toLowerCase()}`, slot: "prefix" }) }),
          /* @__PURE__ */ E(Ya, { children: ce.bookIdToEnglishName(e) }),
          r ? /* @__PURE__ */ E(pu, {}) : void 0
        ]
      },
      e
    ),
...
function bu({
  ...
  return /* @__PURE__ */ E(
    ri,
    {
      ...
      onClick: t,
      InputProps: {
        startAdornment: /* @__PURE__ */ E(mu, { fontSize: "small" }),
        endAdornment: /* @__PURE__ */ E(hu, { fontSize: "small" })
      }
    }
  );
}
function vu({ endChapter: e, activeChapter: t, handleSelectChapter: r }) {
  const o = Array.from({ length: e }, (s, i) => i + 1);
  return /* @__PURE__ */ E("div", { className: "chapter-select", children: o.map((s) => (
...
function lb({ scrRef: e, handleSubmit: t }) {
  const { allBookIds: r } = ce, o = Tt(
    ...
    [o, n]
  ), h = Tt((b) => si(ce.bookIdToNumber(b)), []), p = (b) => {
    i(s !== b ? b : ""), h(b) === -1 && (t({
      bookNum: ce.bookIdToNumber(b),
      chapterNum: 1,
      verseNum: 1
    }), d(!1));
  }, m = (b) => {
  ...
  return /* @__PURE__ */ je(Xo, { children: [
    /* @__PURE__ */ E(
      bu,
      {
        value: n,
    ...
    /* @__PURE__ */ E("div", { className: "book-chapter-menu", children: /* @__PURE__ */ E(
      Xa,
      {
        tabIndex: -1,
        open: l,
        style: { maxWidth: "289px", maxHeight: "500px", overflowY: "auto" },
        children: wu.map((b) => /* @__PURE__ */ je("div", { children: [
          /* @__PURE__ */ E(Ga, { children: yu[b] }),
          f(b).map((x) => /* @__PURE__ */ E("div", { children: /* @__PURE__ */ E(
            gu,
            {
              bookId: x,
          ...
          b === "OT" || b === "NT" ? /* @__PURE__ */ E(Ja, {}) : void 0
        ] }, b))
      }
    ) })
  ] });
 ...
 */
const Lo = globalThis, bi = Lo.ShadowRoot && (Lo.ShadyCSS === void 0 || Lo.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, vi = Symbol(), pn = /* @__PURE__ */ new WeakMap();
let fa = class {
  constructor(t, r, o) {
    if (this._$cssResult$ = !0, o !== vi)
  ...
  get styleSheet() {
    ...
    if (bi && t === void 0) {
      ...
      o && (t = pn.get(r)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), o && pn.set(r, t));
    }
    return t;
  }
  toString() {
...
const xu = (e) => new fa(typeof e == "string" ? e : e + "", void 0, vi), D = (e, ...t) => {
...
}, fn = bi ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let r = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ku, defineProperty: Cu, getOwnPropertyDescriptor: Su, getOwnPropertyNames: $u, getOwnPropertySymbols: Eu, getPrototypeOf: zu } = Object, qt = globalThis, mn = qt.trustedTypes, Au = mn ? mn.emptyScript : "", xs = qt.reactiveElementPolyfillSupport, to = (e, t) => e, Ir = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Au : null;
      break;
  ...
  return r;
} }, yi = (e, t) => !ku(e, t), gn = { attribute: !0, type: String, converter: Ir, reflect: !1, hasChanged: yi };
...
class Sr extends HTMLElement {
  ...
  static createProperty(t, r = gn) {
    if (r.state && (r.attribute = !1), this._$Ei(), this.elementProperties.set(t, r), !r.noAccessor) {
      ...
      s !== void 0 && Cu(this.prototype, t, s);
    }
  }
  static getPropertyDescriptor(t, r, o) {
    const { get: s, set: i } = Su(this.prototype, t) ?? { get() {
      return this[r];
    }, set(n) {
      this[r] = n;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(to("properties"))) {
      const r = this.properties, o = [...$u(r), ...Eu(r)];
      for (const s of o)
  ...
  requestUpdate(t, r, o) {
    if (t !== void 0) {
      if (o ?? (o = this.constructor.getPropertyOptions(t)), !(o.hasChanged ?? yi)(this[t], r))
        return;
      this.P(t, r, o);
    }
...
Sr.elementStyles = [], Sr.shadowRootOptions = { mode: "open" }, Sr[to("elementProperties")] = /* @__PURE__ */ new Map(), Sr[to("finalized")] = /* @__PURE__ */ new Map(), xs == null || xs({ ReactiveElement: Sr }), (qt.reactiveElementVersions ?? (qt.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ro = globalThis, Fo = ro.trustedTypes, bn = Fo ? Fo.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, ma = "$lit$", jt = `lit$${(Math.random() + "").slice(9)}$`, ga = "?" + jt, Tu = `<${ga}>`, lr = document, uo = () => lr.createComment(""), ho = (e) => e === null || typeof e != "object" && typeof e != "function", ba = Array.isArray, Ou = (e) => ba(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", _s = `[ 	
\f\r]`, Kr = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, vn = /-->/g, yn = />/g, tr = RegExp(`>|${_s}(?:([^\\s"'>=/]+)(${_s}*=${_s}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), wn = /'/g, xn = /"/g, va = /^(?:script|style|textarea|title)$/i, Nu = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r }), C = Nu(1), ct = Symbol.for("lit-noChange"), Se = Symbol.for("lit-nothing"), _n = /* @__PURE__ */ new WeakMap(), sr = lr.createTreeWalker(lr, 129);
function ya(e, t) {
...
const Iu = (e, t) => {
  ...
  for (let c = 0; c < r; c++) {
    ...
    for (; p < l.length && (n.lastIndex = p, f = n.exec(l), f !== null); )
      p = n.lastIndex, n === Kr ? f[1] === "!--" ? n = vn : f[1] !== void 0 ? n = yn : f[2] !== void 0 ? (va.test(f[2]) && (s = RegExp("</" + f[2], "g")), n = tr) : f[3] !== void 0 && (n = tr) : n === tr ? f[0] === ">" ? (n = s ?? Kr, h = -1) : f[1] === void 0 ? h = -2 : (h = n.lastIndex - f[2].length, d = f[1], n = f[3] === void 0 ? tr : f[3] === '"' ? xn : wn) : n === xn || n === wn ? n = tr : n === vn || n === yn ? n = Kr : (n = tr, s = void 0);
    const m = n === tr && e[c + 1].startsWith("/>") ? " " : "";
    i += n === Kr ? l + Tu : h >= 0 ? (o.push(d), l.slice(0, h) + ma + l.slice(h) + jt + m) : l + jt + (h === -2 ? c : m);
  }
  return [ya(e, i + (e[r] || "<?>") + (t === 2 ? "</svg>" : "")), o];
};
class po {
  constructor({ strings: t, _$litType$: r }, o) {
    ...
    this.parts = [];
    let i = 0, n = 0;
    const c = t.length - 1, l = this.parts, [d, f] = Iu(t, r);
        ...
        if (s.hasAttributes())
          for (const h of s.getAttributeNames())
            if (h.endsWith(ma)) {
              ...
              l.push({ type: 1, index: i, name: g[2], strings: m, ctor: g[1] === "." ? Pu : g[1] === "?" ? Mu : g[1] === "@" ? Lu : ns }), s.removeAttribute(h);
            } else
              h.startsWith(jt) && (l.push({ type: 6, index: i }), s.removeAttribute(h));
        if (va.test(s.tagName)) {
...
class Ru {
  ...
  u(t) {
    ...
    for (; l !== void 0; ) {
      if (n === l.index) {
        let d;
        l.type === 2 ? d = new vo(i, i.nextSibling, this, t) : l.type === 1 ? d = new l.ctor(i, l.name, l.strings, this, t) : l.type === 6 && (d = new Du(i, this, t)), this._$AV.push(d), l = o[++c];
      }
...
class vo {
  ...
  _$AI(t, r = this) {
    t = Rr(this, t, r), ho(t) ? t === Se || t == null || t === "" ? (this._$AH !== Se && this._$AR(), this._$AH = Se) : t !== this._$AH && t !== ct && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Ou(t) ? this.k(t) : this._(t);
  }
  S(t) {
  ...
  $(t) {
    var i;
    const { values: r, _$litType$: o } = t, s = typeof o == "number" ? this._$AC(t) : (o.el === void 0 && (o.el = po.createElement(ya(o.h, o.h[0]), this.options)), o);
    if (((i = this._$AH) == null ? void 0 : i._$AD) === s)
      this._$AH.p(r);
    else {
      const n = new Ru(s, this), c = n.u(this.options);
      n.p(r), this.T(c), this._$AH = n;
    }
  }
  _$AC(t) {
    let r = _n.get(t.strings);
    return r === void 0 && _n.set(t.strings, r = new po(t)), r;
  }
  k(t) {
    ...
    let o, s = 0;
    for (const i of t)
      s === r.length ? r.push(o = new vo(this.S(uo()), this.S(uo()), this, this.options)) : o = r[s], o._$AI(i), s++;
...
const ks = ro.litHtmlPolyfillSupport;
ks == null || ks(po, vo), (ro.litHtmlVersions ?? (ro.litHtmlVersions = [])).push("3.1.2");
const Bu = (e, t, r) => {
  const o = (r == null ? void 0 : r.renderBefore) ?? t;
  let s = o._$litPart$;
  if (s === void 0) {
    const i = (r == null ? void 0 : r.renderBefore) ?? null;
    o._$litPart$ = s = new vo(t.insertBefore(uo(), i), i, void 0, r ?? {});
  }
  return s._$AI(e), s;
};
/**
...
let oo = class extends Sr {
  ...
  update(t) {
    const r = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = Bu(r, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var t;
...
var Wn;
oo._$litElement$ = !0, oo.finalized = !0, (Wn = globalThis.litElementHydrateSupport) == null || Wn.call(globalThis, { LitElement: oo });
const Cs = globalThis.litElementPolyfillSupport;
Cs == null || Cs({ LitElement: oo });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Fu = { attribute: !0, type: String, converter: Ir, reflect: !1, hasChanged: yi }, Hu = (e = Fu, t, r) => {
...
function u(e) {
  return (t, r) => typeof r == "object" ? Hu(e, t, r) : ((o, s, i) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ju = /* @__PURE__ */ new Set(["children", "localName", "ref", "style", "className"]), kn = /* @__PURE__ */ new WeakMap(), Wu = (e, t, r, o, s) => {
  const i = s == null ? void 0 : s[t];
  i === void 0 || r === o ? (e[t] = r, r == null && t in HTMLElement.prototype && e.removeAttribute(t)) : ((n, c, l) => {
    let d = kn.get(n);
    d === void 0 && kn.set(n, d = /* @__PURE__ */ new Map());
    let f = d.get(c);
...
}, L = ({ react: e, tagName: t, elementClass: r, events: o, displayName: s }) => {
  const i = new Set(Object.keys(o ?? {})), n = e.forwardRef((c, l) => {
    ...
    for (const [m, g] of Object.entries(c))
      ju.has(m) ? h[m === "className" ? "class" : m] = g : i.has(m) || m in r.prototype ? p[m] = g : h[m] = g;
    return e.useLayoutEffect(() => {
      if (f.current !== null) {
        for (const m in p)
          Wu(f.current, m, c[m], d.current ? d.current[m] : void 0, o);
        d.current = c;
      }
    }), e.useLayoutEffect(() => {
      var m;
...
var qu = "sl-visually-hidden";
as.define("sl-visually-hidden");
L({
  tagName: qu,
  elementClass: as,
  react: I,
...
`, ur = (e = "value") => (t, r) => {
...
}, Yr = /* @__PURE__ */ new WeakMap(), Xr = /* @__PURE__ */ new WeakMap(), Gr = /* @__PURE__ */ new WeakMap(), Ss = /* @__PURE__ */ new WeakSet(), Ao = /* @__PURE__ */ new WeakMap(), Bt = class {
  constructor(e, t) {
    this.handleFormData = (r) => {
      ...
      this.options.setValue(this.host, this.options.defaultValue(this.host)), this.setUserInteracted(this.host, !1), Ao.set(this.host, []);
    }, this.handleInteraction = (r) => {
      const o = Ao.get(this.host);
  ...
  hostConnected() {
    ...
    e && this.attachForm(e), Ao.set(this.host, []), this.options.assumeInteractionOn.forEach((t) => {
      this.host.addEventListener(t, this.handleInteraction);
    });
  }
  hostDisconnected() {
    this.detachForm(), Ao.delete(this.host), this.options.assumeInteractionOn.forEach((e) => {
  ...
  setUserInteracted(e, t) {
    t ? Ss.add(e) : Ss.delete(e), e.requestUpdate();
  }
  doAction(e, t) {
    if (this.form) {
   ...
   */
  setValidity(e) {
    const t = this.host, r = !!Ss.has(t), o = !!t.required;
  ...
  valid: !0,
  valueMissing: !1
}), Xu = Object.freeze(mo(Dt({}, ls), {
  valid: !1,
  valueMissing: !0
})), Gu = Object.freeze(mo(Dt({}, ls), {
  valid: !1,
  customError: !0
})), Je = class {
  constructor(e, ...t) {
...
var Qu = {
  name: "default",
  resolver: (e) => bl(`assets/icons/${e}.svg`)
}, Zu = Qu, Cn = {
  caret: `
  ...
  name: "system",
  resolver: (e) => e in Cn ? `data:image/svg+xml,${encodeURIComponent(Cn[e])}` : ""
}, th = eh, rh = [Zu, th], Us = [];
function oh(e) {
  Us.push(e);
}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const nh = (e, t) => t === void 0 ? (e == null ? void 0 : e._$litType$) !== void 0 : (e == null ? void 0 : e._$litType$) === t, wa = (e) => e.strings === void 0, ah = {}, lh = (e, t = ah) => e._$AH = t;
var Jr = Symbol(), To = Symbol(), $s, Es = /* @__PURE__ */ new Map(), xe = class extends R {
  constructor() {
  ...
  async resolveIcon(e, t) {
    ...
    try {
      ...
      if (((r = i == null ? void 0 : i.tagName) == null ? void 0 : r.toLowerCase()) !== "svg")
        return Jr;
      $s || ($s = new DOMParser());
      const c = $s.parseFromString(i.outerHTML, "text/html").body.querySelector("svg");
  ...
  connectedCallback() {
    super.connectedCallback(), oh(this);
  }
  firstUpdated() {
    this.initialRender = !0, this.setIcon();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), sh(this);
  }
  getIconSource() {
    const e = Sn(this.library);
    return this.name && e ? {
  ...
  async setIcon() {
    var e;
    const { url: t, fromLibrary: r } = this.getIconSource(), o = r ? Sn(this.library) : void 0;
    if (!t) {
      this.svg = null;
      return;
    }
    let s = Es.get(t);
    if (s || (s = this.resolveIcon(t, o), Es.set(t, s)), !this.initialRender)
      return;
    const i = await s;
    if (i === To && Es.delete(t), t === this.getIconSource().url) {
      if (nh(i)) {
        this.svg = i;
        return;
      }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const At = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, yo = (e) => (...t) => ({ _$litDirective$: e, values: t });
let wo = class {
  constructor(t) {
  }
  get _$AU() {
...
`;
const js = /* @__PURE__ */ new Set(), dh = new MutationObserver(Ca), Er = /* @__PURE__ */ new Map();
let xa = document.documentElement.dir || "ltr", _a = document.documentElement.lang || navigator.language, or;
dh.observe(document.documentElement, {
  attributes: !0,
...
function Ca() {
  xa = document.documentElement.dir || "ltr", _a = document.documentElement.lang || navigator.language, [...js.keys()].map((e) => {
...
let uh = class {
  ...
  dir() {
    return `${this.host.dir || xa}`.toLowerCase();
  }
  lang() {
    return `${this.host.lang || _a}`.toLowerCase();
  }
...
Lr.styles = [V, ch];
var $a = /* @__PURE__ */ new Map(), ph = /* @__PURE__ */ new WeakMap();
function fh(e) {
...
function Ne(e, t, r) {
  return new Promise((o) => {
    ...
    const s = e.animate(t, mo(Dt({}, r), {
      duration: Ws() ? 0 : r.duration
    }));
...
var Ie = class qs extends R {
  ...
  getChildrenItems({ includeDisabled: t = !0 } = {}) {
    return this.childrenSlot ? [...this.childrenSlot.assignedElements({ flatten: !0 })].filter(
      (r) => qs.isTreeItem(r) && (t || !r.disabled)
    ) : [];
  }
  render() {
    ...
    return C`
      ...
      "tree-item__expand-button--visible": r
            ...
            aria-hidden="true"
          >
            ${zn(this.loading, () => C` <sl-spinner></sl-spinner> `)}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ea = Symbol.for(""), wh = (e) => {
  if ((e == null ? void 0 : e.r) === Ea)
    return e == null ? void 0 : e._$litStatic$;
}, Uo = (e, ...t) => ({ _$litStatic$: t.reduce((r, o, s) => r + ((i) => {
...
})(o) + e[s + 1], e[0]), r: Ea }), An = /* @__PURE__ */ new Map(), xh = (e) => (t, ...r) => {
  const o = r.length;
  let s, i;
  const n = [], c = [];
  let l, d = 0, f = !1;
  for (; d < o; ) {
    for (l = t[d]; d < o && (i = r[d], (s = wh(i)) !== void 0); )
      l += s + t[++d], f = !0;
    d !== o && c.push(i), n.push(l), d++;
  }
  if (d === o && n.push(t[o]), f) {
    const h = n.join("$$lit$$");
    (t = An.get(h)) === void 0 && (n.raw = n, An.set(h, t = n)), r = c;
  }
  return e(t, ...r);
}, so = xh(C);
var Be = class extends R {
  ...
  render() {
    const e = !!this.href, t = e ? Uo`a` : Uo`button`;
    return so`
      <${t}
        part="base"
        class=${F({
...
var _h = 0, kt = class extends R {
  constructor() {
    super(...arguments), this.localize = new he(this), this.attrId = ++_h, this.componentId = `sl-tab-${this.attrId}`, this.panel = "", this.active = !1, this.closable = !1, this.disabled = !1;
  }
  connectedCallback() {
...
kt.styles = [V, vh];
kt.dependencies = { "sl-icon-button": Be };
a([
  A(".tab")
], kt.prototype, "tab", 2);
a([
...
`, Sh = 0, Br = class extends R {
  constructor() {
    super(...arguments), this.attrId = ++Sh, this.componentId = `sl-tab-panel-${this.attrId}`, this.name = "", this.active = !1;
  }
  connectedCallback() {
...
function io(e) {
  if (Ks.add(e), !document.body.classList.contains("sl-scroll-lock")) {
    const t = Ah();
    document.body.classList.add("sl-scroll-lock"), document.body.style.setProperty("--sl-scroll-lock-size", `${t}px`);
  }
}
function no(e) {
  Ks.delete(e), Ks.size === 0 && (document.body.classList.remove("sl-scroll-lock"), document.body.style.removeProperty("--sl-scroll-lock-size"));
}
function Ys(e, t, r = "vertical", o = "smooth") {
  const s = zh(e, t), i = s.top + t.scrollTop, n = s.left + t.scrollLeft, c = t.scrollLeft, l = t.scrollLeft + t.offsetWidth, d = t.scrollTop, f = t.scrollTop + t.offsetHeight;
...
var et = class extends R {
  ...
  setActiveTab(e, t) {
    if (t = Dt({
      ...
      }), this.syncIndicator(), ["top", "bottom"].includes(this.placement) && Ys(this.activeTab, this.nav, "horizontal", t.scrollBehavior), t.emitEvents && (r && this.emit("sl-tab-hide", { detail: { name: r.panel } }), this.emit("sl-tab-show", { detail: { name: this.activeTab.panel } }));
    }
  }
  setAriaLabels() {
    this.tabs.forEach((e) => {
...
et.styles = [V, Eh];
et.dependencies = { "sl-icon-button": Be };
a([
  A(".tab-group")
...
Vt.styles = [V, Oh];
Vt.dependencies = { "sl-icon-button": Be };
a([
  u({ reflect: !0 })
...
`;
const Kt = Math.min, at = Math.max, jo = Math.round, Oo = Math.floor, Yt = (e) => ({
  x: e,
  y: e
}), Ph = {
  left: "right",
...
function Lh(e, t, r) {
  r === void 0 && (r = !1);
  const o = Fr(e), s = _i(e), i = xi(s);
  let n = s === "x" ? o === (r ? "end" : "start") ? "right" : "left" : o === "start" ? "bottom" : "top";
  return t.reference[i] > t.floating[i] && (n = Wo(n)), [n, Wo(n)];
}
function Dh(e) {
  const t = Wo(e);
  return [Gs(e), t, Gs(t)];
...
function Vh(e, t, r, o) {
  const s = Fr(e);
  let i = Bh(Xt(e), r === "start", o);
  return s && (i = i.map((n) => n + "-" + s), t && (i = i.concat(i.map(Gs)))), i;
}
function Wo(e) {
  return e.replace(/left|right|bottom|top/g, (t) => Ph[t]);
}
function Fh(e) {
  return {
    top: 0,
...
function Tn(e, t, r) {
  ...
  const i = xo(t), n = _i(t), c = xi(n), l = Xt(t), d = i === "y", f = o.x + o.width / 2 - s.width / 2, h = o.y + o.height / 2 - s.height / 2, p = o[c] / 2 - s[c] / 2;
  let m;
  switch (l) {
    case "top":
      m = {
...
async function ki(e, t) {
  ...
  const {
    ...
    altBoundary: p = !1,
    padding: m = 0
  } = Vr(t, e), g = Aa(m), b = c[p ? h === "floating" ? "reference" : "floating" : h], x = qo(await i.getClippingRect({
  ...
  return {
    top: (x.top - y.top + g.top) / w.y,
    bottom: (y.bottom - x.bottom + g.bottom) / w.y,
    left: (x.left - y.left + g.left) / w.x,
    right: (y.right - x.right + g.right) / w.x
  };
}
const Uh = (e) => ({
  name: "arrow",
  ...
  async fn(t) {
    ...
    const h = Aa(f), p = {
      x: r,
      y: o
    }, m = _i(s), g = xi(m), v = await n.getDimensions(d), b = m === "y", x = b ? "top" : "left", _ = b ? "bottom" : "right", k = b ? "clientHeight" : "clientWidth", w = i.reference[g] + i.reference[m] - p[m] - i.floating[g], y = p[m] - i.reference[m], $ = await (n.getOffsetParent == null ? void 0 : n.getOffsetParent(d));
    let H = $ ? $[k] : 0;
    (!H || !await (n.isElement == null ? void 0 : n.isElement($))) && (H = c.floating[k] || i.floating[g]);
    const j = w / 2 - y / 2, M = H / 2 - v[g] / 2 - 1, N = Kt(h[x], M), Y = Kt(h[_], M), K = N, _e = H - v[g] - Y, te = H / 2 - v[g] / 2 + j, re = Xs(K, te, _e), ke = !l.arrow && Fr(s) != null && te !== re && i.reference[g] / 2 - (te < K ? N : Y) - v[g] / 2 < 0, Re = ke ? te < K ? te - K : te - _e : 0;
    return {
      [m]: p[m] + Re,
      data: {
        [m]: re,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((r = i.arrow) != null && r.alignmentOffset)
        return {};
      const x = Xt(s), _ = Xt(c) === c, k = await (l.isRTL == null ? void 0 : l.isRTL(d.floating)), w = p || (_ || !v ? [Wo(c)] : Dh(c));
      !p && g !== "none" && w.push(...Vh(c, v, g, k));
      const y = [c, ...w], $ = await ki(t, b), H = [];
...
async function Wh(e, t) {
  const {
    ...
    platform: o,
    elements: s
  } = e, i = await (o.isRTL == null ? void 0 : o.isRTL(s.floating)), n = Xt(r), c = Fr(r), l = xo(r) === "y", d = ["left", "top"].includes(n) ? -1 : 1, f = i && l ? -1 : 1, h = Vr(t, e);
  let {
    mainAxis: p,
    crossAxis: m,
    alignmentAxis: g
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: r,
        y: o
      }, f = await ki(t, l), h = xo(Xt(s)), p = za(h);
      let m = d[p], g = d[h];
      if (i) {
        const b = p === "y" ? "top" : "left", x = p === "y" ? "bottom" : "right", _ = m + f[b], k = m - f[x];
        m = Xs(_, m, k);
      }
      if (n) {
        const b = h === "y" ? "top" : "left", x = h === "y" ? "bottom" : "right", _ = g + f[b], k = g - f[x];
        g = Xs(_, g, k);
      }
      const v = c.fn({
        ...t,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        ...c
      } = Vr(e, t), l = await ki(t, c), d = Xt(r), f = Fr(r), h = xo(r) === "y", {
        width: p,
        height: m
      } = o.floating;
      let g, v;
      d === "top" || d === "bottom" ? (g = d, v = f === (await (s.isRTL == null ? void 0 : s.isRTL(i.floating)) ? "start" : "end") ? "left" : "right") : (v = d, g = f === "end" ? "top" : "bottom");
      const b = m - l[g], x = p - l[v], _ = !t.middlewareData.shift;
      let k = b, w = x;
      if (h) {
      ...
      if (_ && !f) {
        const $ = at(l.left, 0), H = at(l.right, 0), j = at(l.top, 0), M = at(l.bottom, 0);
        h ? w = p - 2 * ($ !== 0 || H !== 0 ? $ + H : at(l.left, l.right)) : k = m - 2 * (j !== 0 || M !== 0 ? j + M : at(l.top, l.bottom));
      }
      await n({
        ...t,
        availableWidth: w,
...
function Oa(e) {
  const t = Pr(e);
  return cs(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : Nt(t) && _o(t) ? t : Oa(t);
}
function fo(e, t, r) {
  var o;
  t === void 0 && (t = []), r === void 0 && (r = !0);
  const s = Oa(e), i = s === ((o = e.ownerDocument) == null ? void 0 : o.body), n = dt(s);
  return i ? t.concat(n, n.visualViewport || [], _o(s) ? s : [], n.frameElement && r ? fo(n.frameElement) : []) : t.concat(s, fo(s, [], r));
}
function Na(e) {
  const t = mt(e);
  let r = parseFloat(t.width) || 0, o = parseFloat(t.height) || 0;
  const s = Nt(e), i = s ? e.offsetWidth : r, n = s ? e.offsetHeight : o, c = jo(r) !== i || jo(o) !== n;
  return c && (r = i, o = n), {
    width: r,
    height: o,
    $: c
...
function Tr(e) {
  ...
  let n = (i ? jo(r.width) : r.width) / o, c = (i ? jo(r.height) : r.height) / s;
  return (!n || !Number.isFinite(n)) && (n = 1), (!c || !Number.isFinite(c)) && (c = 1), {
    x: n,
    y: c
  };
}
const Jh = /* @__PURE__ */ Yt(0);
function Ia(e) {
  const t = dt(e);
  return !Si() || !t.visualViewport ? Jh : {
...
function dr(e, t, r, o) {
  ...
  const s = e.getBoundingClientRect(), i = $i(e);
  let n = Yt(1);
  t && (o ? Lt(o) && (n = Tr(o)) : n = Tr(e));
  const c = Qh(i, r, o) ? Ia(i) : Yt(0);
  let l = (s.left + c.x) / n.x, d = (s.top + c.y) / n.y, f = s.width / n.x, h = s.height / n.y;
  if (i) {
    const p = dt(i), m = o && Lt(o) ? dt(o) : o;
    let g = p, v = g.frameElement;
    for (; v && o && m !== g; ) {
      const b = Tr(v), x = v.getBoundingClientRect(), _ = mt(v), k = x.left + (v.clientLeft + parseFloat(_.paddingLeft)) * b.x, w = x.top + (v.clientTop + parseFloat(_.paddingTop)) * b.y;
      l *= b.x, d *= b.y, f *= b.x, h *= b.y, l += k, d += w, g = dt(v), v = g.frameElement;
    }
  }
  return qo({
    width: f,
...
function ep(e) {
  ...
  const i = s === "fixed", n = Ft(o), c = t ? Ra(t.floating) : !1;
  if (o === n || c && i)
    return r;
  let l = {
    scrollLeft: 0,
  ...
  const f = Yt(0), h = Nt(o);
  if ((h || !h && !i) && ((Gt(o) !== "body" || _o(n)) && (l = ds(o)), Nt(o))) {
    const p = dr(o);
...
function Pa(e) {
  return dr(Ft(e)).left + ds(e).scrollLeft;
}
function rp(e) {
  const t = Ft(e), r = ds(e), o = e.ownerDocument.body, s = at(t.scrollWidth, t.clientWidth, o.scrollWidth, o.clientWidth), i = at(t.scrollHeight, t.clientHeight, o.scrollHeight, o.clientHeight);
  let n = -r.scrollLeft + Pa(e);
  const c = -r.scrollTop;
...
function Ma(e, t) {
  const r = Pr(e);
  return r === t || !Lt(r) || cs(r) ? !1 : mt(r).position === "fixed" || Ma(r, t);
}
function ip(e, t) {
  const r = t.get(e);
  if (r)
    return r;
  let o = fo(e, [], !1).filter((c) => Lt(c) && Gt(c) !== "body"), s = null;
  const i = mt(e).position === "fixed";
  let n = i ? Pr(e) : e;
  for (; Lt(n) && !cs(n); ) {
    const c = mt(n), l = Ci(n);
    !l && c.position === "fixed" && (s = null), (i ? !l && !s : !l && c.position === "static" && !!s && ["absolute", "fixed"].includes(s.position) || _o(n) && !l && Ma(e, n)) ? o = o.filter((f) => f !== n) : s = c, n = Pr(n);
  }
  return t.set(e, o), o;
}
function np(e) {
  ...
  const n = [...r === "clippingAncestors" ? ip(t, this._c) : [].concat(r), o], c = n[0], l = n.reduce((d, f) => {
    const h = Nn(t, f, s);
...
function La(e, t) {
  ...
  if (!Nt(e) || Ra(e))
    return r;
  let o = In(e, t);
  for (; o && Xh(o) && mt(o).position === "static"; )
    o = In(o, t);
  return o && (Gt(o) === "html" || Gt(o) === "body" && mt(o).position === "static" && !Ci(o)) ? r : o || Gh(e) || r;
}
const cp = async function(e) {
  const t = this.getOffsetParent || La, r = this.getDimensions;
  return {
...
function up(e, t) {
  ...
  function n(c, l) {
    ...
    if (c || t(), !h || !p)
      return;
    const m = Oo(f), g = Oo(s.clientWidth - (d + h)), v = Oo(s.clientHeight - (f + p)), b = Oo(d), _ = {
...
function hp(e, t, r, o) {
  ...
  function b() {
    const x = dr(e);
    v && (x.x !== v.x || x.y !== v.y || x.width !== v.width || x.height !== v.height) && r(), v = x, g = requestAnimationFrame(b);
  }
  return r(), () => {
    var x;
    f.forEach((_) => {
      s && _.removeEventListener("scroll", r), i && _.removeEventListener("resize", r);
    }), h == null || h(), (x = m) == null || x.disconnect(), m = null, l && cancelAnimationFrame(g);
  };
}
const pp = Kh, fp = jh, Rn = Yh, mp = Uh, gp = (e, t, r) => {
...
var pe = class extends R {
  ...
  async handleAnchorChange() {
    if (await this.stop(), this.anchor && typeof this.anchor == "string") {
      ...
      this.anchor instanceof Element || yp(this.anchor) ? this.anchorEl = this.anchor : this.anchorEl = this.querySelector('[slot="anchor"]');
  ...
  start() {
    this.anchorEl && (this.cleanup = hp(this.anchorEl, this.popup, () => {
      this.reposition();
    }));
  }
  async stop() {
  ...
  reposition() {
    ...
    const e = [
      ...
      qh({ mainAxis: this.distance, crossAxis: this.skidding })
    ];
    this.sync ? e.push(
      Rn({
        apply: ({ rects: r }) => {
    ...
    const t = this.strategy === "absolute" ? (r) => Do.getOffsetParent(r, bp) : Do.getOffsetParent;
    gp(this.anchorEl, this.popup, {
  ...
  constructor() {
    super(), this.localize = new he(this), this.content = "", this.placement = "top", this.disabled = !1, this.distance = 8, this.open = !1, this.skidding = 0, this.trigger = "hover focus", this.hoist = !1, this.handleBlur = () => {
      ...
      if (this.hasTrigger("hover")) {
        const e = En(getComputedStyle(this).getPropertyValue("--show-delay"));
        clearTimeout(this.hoverTimeout), this.hoverTimeout = window.setTimeout(() => this.show(), e);
      }
    }, this.handleMouseOut = () => {
      if (this.hasTrigger("hover")) {
        const e = En(getComputedStyle(this).getPropertyValue("--hide-delay"));
...
var Qt = class extends R {
  ...
  selectItem(e) {
    ...
    if (this.selection === "multiple")
      e.selected = !e.selected, e.lazy && (e.expanded = !0), Pn(e);
...
a([
  u({ type: Boolean, reflect: !0 })
], ko.prototype, "disabled", 2);
a([
  z("disabled", { waitUntilFirstUpdate: !0 })
], ko.prototype, "handleDisabledChange", 1);
var zp = "sl-resize-observer";
ko.define("sl-resize-observer");
L({
  tagName: zp,
  elementClass: ko,
  react: I,
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Da = "important", Tp = " !" + Da, Ze = yo(class extends wo {
  constructor(e) {
    var t;
  ...
  update(e, [t]) {
    ...
    for (const o in t) {
      ...
      if (s != null) {
        this.ft.add(o);
        const i = typeof s == "string" && s.endsWith(Tp);
        o.includes("-") || i ? r.setProperty(o, i ? s.slice(0, -11) : s, i ? Da : "") : r[o] = s;
      }
    }
    return ct;
  }
...
var Np = [
  ...
  render() {
    ...
    const r = t.getTime() - e.getTime(), { unit: o, value: s } = Np.find((i) => Math.abs(r) < i.max);
    if (this.isoTime = t.toISOString(), this.titleTime = this.localize.date(t, {
      ...
      let i;
      o === "minute" ? i = No("second") : o === "hour" ? i = No("minute") : o === "day" ? i = No("hour") : i = No("day"), this.updateTimeout = window.setTimeout(() => this.requestUpdate(), i);
    }
...
`, oe = class extends R {
  ...
  async handleOpenChange() {
    if (this.open && !this.disabled) {
      ...
      await Ne(this.popup.popup, e, t), this.currentOption && Ys(this.currentOption, this.listbox, "vertical", "auto"), this.emit("sl-after-show");
    } else {
...
a([
  u()
], us.prototype, "effect", 2);
var Lp = "sl-skeleton";
us.define("sl-skeleton");
L({
  tagName: Lp,
  elementClass: us,
  react: I,
...
(function(e) {
  function t(c, l, d, f) {
    ...
    p.u(c), p.J(), f = f || 0;
    var m = p.h(), g = p.h() + 2 * f;
    return h.text = c, h.level = l, h.version = d, h.O = g, h.a = function(v, b) {
      return v -= f, b -= f, 0 > v || v >= m || 0 > b || b >= m ? !1 : p.a(v, b);
    }, h;
  }
  function r(c, l, d, f, h, p, m, g, v, b) {
    function x(_, k, w, y, $, H, j) {
      _ ? (c.lineTo(k + H, w + j), c.arcTo(k, w, y, $, p)) : c.lineTo(k, w);
    }
    m ? c.moveTo(l + p, d) : c.moveTo(l, d), x(g, f, d, f, h, -p, 0), x(v, f, h, l, h, 0, -p), x(b, l, h, l, d, p, 0), x(m, l, d, f, d, 0, p);
  }
  function o(c, l, d, f, h, p, m, g, v, b) {
    function x(_, k, w, y) {
    ...
    m && x(l, d, p, p), g && x(f, d, -p, p), v && x(f, h, -p, -p), b && x(l, h, p, -p);
  }
  function s(c, l) {
    var d = l.fill;
    if (typeof d == "string")
  ...
  function i(c, l) {
    ...
    for (d = c.getContext("2d"), l.background && (d.fillStyle = l.background, d.fillRect(l.left, l.top, l.size, l.size)), f = g.O, p = l.size / f, d.beginPath(), m = 0; m < f; m += 1)
      for (h = 0; h < f; h += 1) {
        var v = d, b = l.left + h * p, x = l.top + m * p, _ = m, k = h, w = g.a, y = b + p, $ = x + p, H = _ - 1, j = _ + 1, M = k - 1, N = k + 1, Y = Math.floor(Math.min(0.5, Math.max(0, l.R)) * p), K = w(_, k), _e = w(H, M), te = w(H, k);
        H = w(H, N);
        var re = w(_, N);
        N = w(j, N), k = w(
          j,
          k
        ), j = w(j, M), _ = w(_, M), b = Math.round(b), x = Math.round(x), y = Math.round(y), $ = Math.round($), K ? r(v, b, x, y, $, Y, !te && !_, !te && !re, !k && !re, !k && !_) : o(v, b, x, y, $, Y, te && _ && _e, te && re && H, k && re && N, k && _ && j);
      }
  ...
  function r(l, d) {
    function f(_, k) {
      for (var w = -1; 7 >= w; w += 1)
        if (!(-1 >= _ + w || g <= _ + w))
          for (var y = -1; 7 >= y; y += 1)
            -1 >= k + y || g <= k + y || (m[_ + w][k + y] = 0 <= w && 6 >= w && (y == 0 || y == 6) || 0 <= y && 6 >= y && (w == 0 || w == 6) || 2 <= w && 4 >= w && 2 <= y && 4 >= y);
    }
    function h(_, k) {
      ...
      for (w = i.w(p << 3 | k), y = 0; 15 > y; y += 1)
        $ = !_ && (w >> y & 1) == 1, m[6 > y ? y : 8 > y ? y + 1 : g - 15 + y][8] = $, m[8][8 > y ? g - y - 1 : 9 > y ? 15 - y : 14 - y] = $;
      if (m[g - 8][8] = !_, 7 <= l) {
        for (w = i.A(l), y = 0; 18 > y; y += 1)
          $ = !_ && (w >> y & 1) == 1, m[Math.floor(y / 3)][y % 3 + g - 8 - 3] = $;
        for (y = 0; 18 > y; y += 1)
          $ = !_ && (w >> y & 1) == 1, m[y % 3 + g - 8 - 3][Math.floor(y / 3)] = $;
      }
      if (v == null) {
        for (_ = c.I(l, p), w = t(), y = 0; y < b.length; y += 1)
          $ = b[y], w.put(4, 4), w.put($.b(), i.f(4, l)), $.write(w);
        ...
        for (; !(w.f() >= 8 * $) && (w.put(236, 8), !(w.f() >= 8 * $)); )
          w.put(17, 8);
        var Y = 0;
        for ($ = y = 0, H = Array(_.length), j = Array(_.length), M = 0; M < _.length; M += 1) {
          var K = _[M].j, _e = _[M].o - K;
          for (y = Math.max(y, K), $ = Math.max($, _e), H[M] = Array(K), N = 0; N < H[M].length; N += 1)
            H[M][N] = 255 & w.B()[N + Y];
      ...
      for (_ = v, w = -1, y = g - 1, $ = 7, H = 0, k = i.F(k), j = g - 1; 0 < j; j -= 2)
        for (j == 6 && --j; ; ) {
          for (M = 0; 2 > M; M += 1)
            m[y][j - M] == null && (N = !1, H < _.length && (N = (_[H] >>> $ & 1) == 1), k(y, j - M) && (N = !N), m[y][j - M] = N, --$, $ == -1 && (H += 1, $ = 7));
          if (y += w, 0 > y || g <= y) {
            y -= w, w = -w;
            break;
          }
    ...
    var p = s[d], m = null, g = 0, v = null, b = [], x = { u: function(_) {
      _ = e(_), b.push(_), v = null;
    }, a: function(_, k) {
      if (0 > _ || g <= _ || 0 > k || g <= k)
        throw Error(_ + "," + k);
      return m[_][k];
    ...
    var f = function() {
      ...
      for (var m = Array(h.b() + p.b() - 1), g = 0; g < h.b(); g += 1)
        for (var v = 0; v < p.b(); v += 1)
          m[g + v] ^= n.i(n.g(h.c(g)) + n.g(p.c(v)));
      return o(m, 0);
    }, l: function(p) {
      if (0 > h.b() - p.b())
        return h;
      for (var m = n.g(h.c(0)) - n.g(p.c(0)), g = Array(h.b()), v = 0; v < h.b(); v += 1)
        g[v] = h.c(v);
      for (v = 0; v < p.b(); v += 1)
        g[v] ^= n.i(n.g(p.c(v)) + m);
      return o(g, 0).l(p);
  ...
  var s = { L: 1, M: 0, Q: 3, H: 2 }, i = function() {
    ...
    var d = [
      ...
      for (var p = h.h(), m = 0, g = 0; g < p; g += 1)
        for (var v = 0; v < p; v += 1) {
          for (var b = 0, x = h.a(g, v), _ = -1; 1 >= _; _ += 1)
            if (!(0 > g + _ || p <= g + _))
              for (var k = -1; 1 >= k; k += 1)
                0 > v + k || p <= v + k || (_ != 0 || k != 0) && x == h.a(g + _, v + k) && (b += 1);
          5 < b && (m += 3 + b - 5);
        }
      for (g = 0; g < p - 1; g += 1)
        for (v = 0; v < p - 1; v += 1)
          b = 0, h.a(g, v) && (b += 1), h.a(g + 1, v) && (b += 1), h.a(g, v + 1) && (b += 1), h.a(g + 1, v + 1) && (b += 1), (b == 0 || b == 4) && (m += 3);
      for (g = 0; g < p; g += 1)
        for (v = 0; v < p - 6; v += 1)
          h.a(g, v) && !h.a(g, v + 1) && h.a(g, v + 2) && h.a(g, v + 3) && h.a(g, v + 4) && !h.a(g, v + 5) && h.a(g, v + 6) && (m += 40);
      for (v = 0; v < p; v += 1)
        for (g = 0; g < p - 6; g += 1)
          h.a(g, v) && !h.a(g + 1, v) && h.a(g + 2, v) && h.a(g + 3, v) && h.a(g + 4, v) && !h.a(g + 5, v) && h.a(g + 6, v) && (m += 40);
      for (v = b = 0; v < p; v += 1)
        for (g = 0; g < p; g += 1)
          h.a(g, v) && (b += 1);
      return m += Math.abs(100 * b / p / p - 50) / 5 * 10;
    } };
    return f;
  }(), n = function() {
    ...
    var d = [
      ...
      h = m.length / 3, p = [];
      for (var g = 0; g < h; g += 1)
        for (var v = m[3 * g], b = m[3 * g + 1], x = m[3 * g + 2], _ = 0; _ < v; _ += 1) {
          var k = x, w = {};
          w.o = b, w.j = k, p.push(w);
        }
      return p;
    } };
    return f;
...
var Ue = class extends R {
  ...
  get validity() {
    ...
    return this.customValidityMessage !== "" ? Gu : e ? Xu : ls;
  }
  /** Gets the validation message */
  get validationMessage() {
    const e = this.required && !this.value;
...
Ue.styles = [V, Dr, tf];
Ue.dependencies = { "sl-button-group": Zt };
a([
  A("slot:not([name])")
...
var pr = class extends R {
  ...
  async handleSrcChange() {
    try {
      const e = this.src, t = await uf(e, this.mode);
      if (e !== this.src)
        return;
      if (!t.ok) {
...
function wf(e) {
  this._$AN !== void 0 ? (Ko(this), this._$AM = e, Ha(this)) : this._$AM = e;
}
function xf(e, t = !1, r = 0) {
...
const _f = (e) => {
  e.type == At.CHILD && (e._$AP ?? (e._$AP = xf), e._$AQ ?? (e._$AQ = wf));
};
class kf extends wo {
  constructor() {
  ...
  _$AT(t, r, o) {
    super._$AT(t, r, o), Ha(this), this.isConnected = t._$AU;
  }
  _$AO(t, r = !0) {
    var o, s;
    t !== this.isConnected && (this.isConnected = t, t ? (o = this.reconnected) == null || o.call(this) : (s = this.disconnected) == null || s.call(this)), r && (lo(this, t), Ko(this));
  }
  setValue(t) {
    if (wa(this._$Ct))
...
const Ts = /* @__PURE__ */ new WeakMap(), $f = yo(class extends kf {
  render(e) {
    return Se;
  }
  update(e, [t]) {
  ...
  rt(e) {
    if (typeof this.Y == "function") {
      ...
      let r = Ts.get(t);
      r === void 0 && (r = /* @__PURE__ */ new WeakMap(), Ts.set(t, r)), r.get(this.Y) !== void 0 && this.Y.call(this.ht, void 0), r.set(this.Y, e), e !== void 0 && this.Y.call(this.ht, e);
    } else
      this.Y.value = e;
  }
  get lt() {
    var e, t;
    return typeof this.Y == "function" ? (e = Ts.get(this.ht ?? globalThis)) == null ? void 0 : e.get(this.Y) : (t = this.Y) == null ? void 0 : t.value;
  }
  disconnected() {
...
var Ef = class {
  constructor(e, t, r) {
    this.popupRef = Cf(), this.enableSubmenuTimer = -1, this.isConnected = !1, this.isPopupConnected = !1, this.skidding = 0, this.submenuOpenDelay = 100, this.handleMouseMove = (o) => {
  ...
  constructor() {
    super(...arguments), this.type = "normal", this.checked = !1, this.value = "", this.loading = !1, this.disabled = !1, this.localize = new he(this), this.hasSlotController = new Je(this, "submenu"), this.submenuController = new Ef(this, this.hasSlotController, this.localize), this.handleHostClick = (e) => {
...
Ei.styles = [V, Tf];
var Of = "sl-menu-label";
Ei.define("sl-menu-label");
var Nf = L({
  tagName: Of,
  elementClass: Ei,
  react: I,
...
`, yt = class extends R {
  ...
  async handleOpenChange() {
    if (this.open) {
      ...
      await Ne(this.body, Ho(t, this.body.scrollHeight), r), this.body.style.height = "auto", this.emit("sl-after-show");
    } else {
      ...
      await Ne(this.body, Ho(t, this.body.scrollHeight), r), this.body.style.height = "auto", this.details.open = !1, this.emit("sl-after-hide");
    }
  }
  /** Shows the details. */
  async show() {
...
function ja(e) {
  let t = Mn.get(e);
  return t || (t = window.getComputedStyle(e, null), Mn.set(e, t)), t;
}
function Bf(e) {
...
function Vf(e) {
  const t = ja(e), { overflowY: r, overflowX: o } = t;
...
function Ff(e) {
  ...
  return e.hasAttribute("tabindex") && (isNaN(r) || r <= -1) || e.hasAttribute("disabled") || e.closest("[inert]") || t === "input" && e.getAttribute("type") === "radio" && !e.hasAttribute("checked") || !Bf(e) ? !1 : (t === "audio" || t === "video") && e.hasAttribute("controls") || e.hasAttribute("tabindex") || e.hasAttribute("contenteditable") && e.getAttribute("contenteditable") !== "false" || [
    "button",
    "input",
    "select",
    "textarea",
...
function Hf(e) {
  var t, r;
  const o = Qs(e), s = (t = o[0]) != null ? t : null, i = (r = o[o.length - 1]) != null ? r : null;
  ...
  function o(s) {
    if (s instanceof Element) {
      if (s.hasAttribute("inert") || s.closest("[inert]") || t.has(s))
        return;
      t.set(s, !0), !r.includes(s) && Ff(s) && r.push(s), s instanceof HTMLSlotElement && Uf(s, e) && s.assignedElements({ flatten: !0 }).forEach((i) => {
        o(i);
...
function* zi(e = document.activeElement) {
  e != null && (yield e, "shadowRoot" in e && e.shadowRoot && e.shadowRoot.mode !== "closed" && (yield* Cl(zi(e.shadowRoot.activeElement))));
}
function jf() {
  return [...zi()].pop();
}
...
var ot = class extends R {
  constructor() {
    super(...arguments), this.hasSlotController = new Je(this, "footer"), this.localize = new he(this), this.modal = new Wa(this), this.open = !1, this.label = "", this.placement = "end", this.contained = !1, this.noHeader = !1, this.handleDocumentKeyDown = (e) => {
...
`, $t = class extends R {
  constructor() {
    super(...arguments), this.hasSlotController = new Je(this, "footer"), this.localize = new he(this), this.modal = new Wa(this), this.open = !1, this.label = "", this.noHeader = !1, this.handleDocumentKeyDown = (e) => {
...
`, Ye = class extends R {
  ...
  updateAccessibleTrigger() {
    const t = this.trigger.assignedElements({ flatten: !0 }).find((o) => Hf(o).start);
    let r;
    if (t) {
...
a([
  u()
], Co.prototype, "display", 2);
var Gf = "sl-format-bytes";
Co.define("sl-format-bytes");
L({
  tagName: Gf,
  elementClass: Co,
  react: I,
...
if (!c0) {
  ...
  document.addEventListener("touchstart", r, !0), document.addEventListener("touchend", o, !0), document.addEventListener("touchcancel", o, !0), Dn(EventTarget.prototype, "addEventListener", function(s, i) {
    if (i !== "scrollend")
      return;
    const n = l0(() => {
  ...
  }), Dn(EventTarget.prototype, "removeEventListener", function(s, i) {
    if (i !== "scrollend")
      return;
    const n = t.get(this);
...
var ze = class extends R {
  ...
  goToSlide(e, t = "smooth") {
    ...
    this.scrollToSlide(l, Ws() ? "auto" : t);
  }
...
Ti.styles = [V, u0];
var h0 = "sl-carousel-item";
Ti.define("sl-carousel-item");
L({
  tagName: h0,
  elementClass: Ti,
  react: I,
...
`, fe = class extends R {
  ...
  /** Gets the validity state object */
  get validity() {
    return this.isButton() ? this.button.validity : ls;
  }
  /** Gets the validation message */
  get validationMessage() {
  ...
  render() {
    const e = this.isLink(), t = e ? Uo`a` : Uo`button`;
    return so`
      <${t}
        part="base"
        class=${F({
...
function v0(e, t, r) {
  ...
  if (e = We(e, 360), t = We(t, 100), r = We(r, 100), t === 0)
    ...
    o = Os(c, n, e + 1 / 3), s = Os(c, n, e), i = Os(c, n, e - 1 / 3);
  }
...
function k0(e) {
  ...
  return typeof e == "string" && (e = $0(e)), typeof e == "object" && (Rt(e.r) && Rt(e.g) && Rt(e.b) ? (t = b0(e.r, e.g, e.b), n = !0, c = String(e.r).substr(-1) === "%" ? "prgb" : "rgb") : Rt(e.h) && Rt(e.s) && Rt(e.v) ? (o = Ro(e.s), s = Ro(e.v), t = y0(e.h, o, s), n = !0, c = "hsv") : Rt(e.h) && Rt(e.s) && Rt(e.l) && (o = Ro(e.s), i = Ro(e.l), t = v0(e.h, o, i), n = !0, c = "hsl"), Object.prototype.hasOwnProperty.call(e, "a") && (r = e.a)), r = qa(r), {
    ok: n,
    format: e.format || c,
...
const C0 = "[-\\+]?\\d+%?", S0 = "[-\\+]?\\d*\\.\\d+%?", Wt = "(?:" + S0 + ")|(?:" + C0 + ")", Ns = "[\\s|\\(]+(" + Wt + ")[,|\\s]+(" + Wt + ")[,|\\s]+(" + Wt + ")\\s*\\)?", Is = (
  // eslint-disable-next-line prettier/prettier
  "[\\s|\\(]+(" + Wt + ")[,|\\s]+(" + Wt + ")[,|\\s]+(" + Wt + ")[,|\\s]+(" + Wt + ")\\s*\\)?"
), _t = {
  CSS_UNIT: new RegExp(Wt),
  rgb: new RegExp("rgb" + Ns),
  rgba: new RegExp("rgba" + Is),
  hsl: new RegExp("hsl" + Ns),
  hsla: new RegExp("hsla" + Is),
  hsv: new RegExp("hsv" + Ns),
  hsva: new RegExp("hsva" + Is),
...
class Oe {
   ...
   */
  toHsv() {
    const t = Vn(this.r, this.g, this.b);
   ...
   */
  toHsvString() {
    const t = Vn(this.r, this.g, this.b), r = Math.round(t.h * 360), o = Math.round(t.s * 100), s = Math.round(t.v * 100);
   ...
   */
  toHsl() {
    const t = Bn(this.r, this.g, this.b);
   ...
   */
  toHslString() {
    const t = Bn(this.r, this.g, this.b), r = Math.round(t.h * 360), o = Math.round(t.s * 100), s = Math.round(t.l * 100);
   ...
   */
  toHex(t = !1) {
    return Fn(this.r, this.g, this.b, t);
  }
  /**
   ...
   */
  toHex8(t = !1) {
    return w0(this.r, this.g, this.b, this.a, t);
  }
  /**
  ...
  toName() {
    ...
    if (this.a < 1)
      return !1;
    const t = "#" + Fn(this.r, this.g, this.b, !1);
  ...
  lighten(t = 10) {
    const r = this.toHsl();
    return r.l += t / 100, r.l = Io(r.l), new Oe(r);
  }
  /**
  ...
  desaturate(t = 10) {
    const r = this.toHsl();
    return r.s -= t / 100, r.s = Io(r.s), new Oe(r);
  }
  /**
...
var Un = "EyeDropper" in window, se = class extends R {
  constructor() {
...
a([
  u({ type: Boolean, reflect: !0 })
], So.prototype, "vertical", 2);
a([
  z("vertical")
], So.prototype, "handleVerticalChange", 1);
var O0 = "sl-divider";
So.define("sl-divider");
var N0 = L({
  tagName: O0,
  elementClass: So,
  react: I,
...
const D0 = [
  ...
  fadeInUpBig: Em,
  fadeOut: zm,
  fadeOutBottomLeft: Am,
  fadeOutBottomRight: Tm,
  fadeOutDown: Om,
  fadeOutDownBig: Nm,
  fadeOutLeft: Im,
  fadeOutLeftBig: Rm,
  ...
  jello: H0,
  lightSpeedInLeft: qm,
  lightSpeedInRight: Km,
  lightSpeedOutLeft: Ym,
  lightSpeedOutRight: Xm,
  pulse: U0,
  rollIn: gg,
  rollOut: bg,
  rotateIn: Gm,
  rotateInDownLeft: Jm,
  rotateInDownRight: Qm,
  rotateInUpLeft: Zm,
  rotateInUpRight: eg,
  rotateOut: tg,
  rotateOutDownLeft: rg,
  rotateOutDownRight: og,
  rotateOutUpLeft: sg,
  rotateOutUpRight: ig,
  rubberBand: j0,
  shake: W0,
...
`, He = class extends R {
  ...
  async createAnimation() {
    var e, t;
    const r = (e = Ka[this.easing]) != null ? e : this.easing, o = (t = this.keyframes) != null ? t : zg[this.name], i = (await this.defaultSlot).assignedElements()[0];
    ...
    /* @__PURE__ */ je(
      Ua,
      {
        ...
        children: [
          ...
          r ? /* @__PURE__ */ je(Xo, { children: [
            /* @__PURE__ */ E("div", { className: `selected-book-color-label ${o.toLowerCase()}`, slot: "prefix" }),
            /* @__PURE__ */ E(Zs, { name: "chevron-up", slot: "suffix" })
          ] }) : /* @__PURE__ */ E("div", { className: `book-color-label ${o.toLowerCase()}`, slot: "prefix" })
        ]
      },
      e
    ),
...
function Fg({
  ...
  return /* @__PURE__ */ je(
    cf,
    {
      ...
      onClick: t,
      children: [
        /* @__PURE__ */ E(Zs, { name: "search", slot: "prefix" }),
        /* @__PURE__ */ E(Zs, { name: "clock-history", slot: "suffix" })
      ]
    }
  );
}
function Hg({ endChapter: e, activeChapter: t, handleSelectChapter: r }) {
  const o = Array.from({ length: e }, (s, i) => i + 1);
  return /* @__PURE__ */ E("div", { className: "chapter-select", children: o.map((s) => (
    // When adding onClick to <div> get error: Visible, non-interactive elements with click handlers must have at least one keyboard listener.
    // eslint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-static-element-interactions
...
function mb({ scrRef: e, handleSubmit: t }) {
  const { allBookIds: r } = ce, o = Tt(
    (b) => ({
      OT: r.filter((_) => ce.isBookOT(_)),
      NT: r.filter((_) => ce.isBookNT(_)),
  ...
  return /* @__PURE__ */ je(Xo, { children: [
    ...
    /* @__PURE__ */ E("div", { className: "book-chapter-menu", children: l && /* @__PURE__ */ E(
      vf,
      {
        tabIndex: -1,
        onBlur: () => {
        ...
        children: Wg.map((b) => /* @__PURE__ */ je("div", { children: [
          /* @__PURE__ */ je(Ua, { children: [
            "Zoom ",
            /* @__PURE__ */ E(Ug, {})
          ] }),
          /* @__PURE__ */ E(If, { children: jg[b] }),
          f(b).map((x) => /* @__PURE__ */ E("div", { children: /* @__PURE__ */ E(
            Vg,
            {
              bookId: x,
          ...
          b === "OT" || b === "NT" ? /* @__PURE__ */ E(I0, {}) : void 0
        ] }, b))
      }
    ) })
  ] });
...
function qg({
  ...
  let h;
  if (r) {
    const p = o === $r.Before || o === $r.Above, m = /* @__PURE__ */ E("span", { className: `papi-checkbox-label ${c ? "error" : ""} ${l ?? ""}`, children: r }), g = o === $r.Before || o === $r.After, v = g ? m : /* @__PURE__ */ E("div", { children: m }), b = g ? f : /* @__PURE__ */ E("div", { children: f });
    h = /* @__PURE__ */ je(
      tl,
      {
...
function Yg({ commandHandler: e, name: t, className: r, items: o, id: s }) {
  return /* @__PURE__ */ je(Kn, { id: s, item: !0, xs: "auto", className: `papi-menu-column ${r ?? ""}`, children: [
    /* @__PURE__ */ E("h3", { className: `papi-menu ${r ?? ""}`, children: t }),
    o.map((i, n) => /* @__PURE__ */ E(
      Kg,
      {
...
function Xg({ commandHandler: e, className: t, columns: r, id: o }) {
  return /* @__PURE__ */ E(
    Kn,
    {
      container: !0,
...
let Rs;
const Ps = () => (Rs || (Rs = ce.allBookIds.map((e) => ({
  bookId: e,
  label: ce.bookIdToEnglishName(e)
}))), Rs);
function vb({ scrRef: e, handleSubmit: t, id: r }) {
  const o = (l) => {
    t(l);
  }, s = (l, d) => {
  ...
  }, c = oi(() => Ps()[e.bookNum - 1], [e.bookNum]);
  return /* @__PURE__ */ je("span", { id: r, children: [
    /* @__PURE__ */ E(
      ti,
      {
        title: "Book",
    ...
    /* @__PURE__ */ E(
      ...
      {
        onClick: () => o(Ri(e, 1)),
        isDisabled: e.bookNum >= Ps().length,
        children: ">"
      }
    ),
    /* @__PURE__ */ E(
    ...
    /* @__PURE__ */ E(
      ...
      {
        onClick: () => t(Mi(e, -1)),
        isDisabled: e.verseNum <= ul,
        children: "<"
      }
    ),
    /* @__PURE__ */ E(kr, { onClick: () => t(Mi(e, 1)), children: ">" })
  ] });
}
function yb({ onSearch: e, placeholder: t, isFullWidth: r }) {
  const [o, s] = ft(""), i = (n) => {
    s(n), e(n);
  };
  return /* @__PURE__ */ E(ol, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ E(
    Yo,
    {
      isFullWidth: r,
...
function jn({ onRowChange: e, row: t, column: r }) {
  const o = (s) => {
    e({ ...t, [r.key]: s.target.value });
  };
  return /* @__PURE__ */ E(Yo, { defaultValue: t[r.key], onChange: o });
}
const Gg = ({ onChange: e, disabled: t, checked: r, ...o }) => /* @__PURE__ */ E(
  qg,
  {
    ...o,
    isChecked: r,
...
function _b({
  ...
  const _e = oi(() => {
    const te = e.map((re) => typeof re.editable == "function" ? {
      ...
      renderEditCell: re.renderEditCell || jn
    } : re.editable && !re.renderEditCell ? { ...re, renderEditCell: jn } : re.renderEditCell && !re.editable ? { ...re, editable: !1 } : re);
    return f ? [{ ...gl, minWidth: h }, ...te] : te;
  }, [e, f, h]);
  return /* @__PURE__ */ E(
    ml,
    {
...
function kb({
  ...
  let b = e;
  return !b && t && (b = t(l)), /* @__PURE__ */ E("div", { ref: p, style: { position: "relative" }, children: /* @__PURE__ */ E(nl, { position: "static", id: s, children: /* @__PURE__ */ je(al, { className: `papi-toolbar ${o ?? ""}`, variant: "dense", children: [
    b ? /* @__PURE__ */ E(
      Yn,
      {
        edge: "start",
        ...
        onClick: h,
        children: /* @__PURE__ */ E(fu, {})
      }
    ) : void 0,
    i ? /* @__PURE__ */ E("div", { className: "papi-menu-children", children: i }) : void 0,
    b ? /* @__PURE__ */ E(
      ll,
      {
        ...
        children: /* @__PURE__ */ E(Xg, { commandHandler: v, columns: b.columns })
      }
    ) : void 0
  ] }) }) });
}
...
Bs("https://cdn.jsdelivr.net/npm/@shoelace-style/shoelace@2.14.0/cdn/");
function Zg(e, t = "top") {
